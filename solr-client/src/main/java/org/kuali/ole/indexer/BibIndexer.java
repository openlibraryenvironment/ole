...
import org.kuali.ole.common.Languages;
...
import org.kuali.ole.common.exception.OleException;
...
public class BibIndexer extends OleDsNgIndexer {
    ...
    public SolrInputDocumentAndDocumentMap buildSolrInputDocument(Object object, Map<String,SolrInputDocument> parameterMap) {
        ...
        try {
            ...
            parameterMap = addSolrInputDocumentToMap(parameterMap,solrInputDocument);
        } catch (Exception e) {
    ...
    protected void setCommonFields(BibRecord bibRecord, SolrInputDocument solrInputDocument) {
        ...
        solrInputDocument.setField(LOCALID_SEARCH, DocumentLocalId.getDocumentId(bibRecord.getBibId().toString()));
        solrInputDocument.setField(LOCALID_DISPLAY, DocumentLocalId.getDocumentIdDisplay(bibRecord.getBibId().toString()));
