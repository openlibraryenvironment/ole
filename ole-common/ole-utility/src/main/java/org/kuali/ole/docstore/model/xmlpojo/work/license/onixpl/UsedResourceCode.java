 ...
 * <p/>
 * <p>Java class for UsedResourceCode.
 * <p/>
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p/>
 * <pre>
 * &lt;simpleType name="UsedResourceCode">
 ...
 * </pre>
 */
@XmlType(name = "UsedResourceCode", namespace = "http://www.editeur.org/onix-pl")
@XmlEnum
public enum UsedResourceCode {
    ...
    /**
     * A work such as an assignment, portfolio, thesis or dissertation, in printed or digital form, produced in the course of study or research, and intended for personal use and library deposit, that includes one or more extracts from licensed content.
     */
    ...
    /**
     * A brief excerpt from licensed content; this may for example be a figure or table and/or a short piece of text.
     */
    ...
    public static UsedResourceCode fromValue(String v) {
        for (UsedResourceCode c : UsedResourceCode.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
