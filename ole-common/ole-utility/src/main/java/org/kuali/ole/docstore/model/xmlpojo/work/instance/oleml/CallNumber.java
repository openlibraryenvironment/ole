...
@XmlType(name = "callNumber", namespace = "http://ole.kuali.org/standards/ole-instance", propOrder = {
        "type",
        "prefix",
        "number",
        "classificationPart",
...
public class CallNumber {
    @XmlElement(name = "Type", namespace = "http://ole.kuali.org/standards/ole-instance", required = true)
    protected String type;
    @XmlElement(name = "Prefix", namespace = "http://ole.kuali.org/standards/ole-instance", required = true)
    protected String prefix;
    @XmlElement(name = "Number", namespace = "http://ole.kuali.org/standards/ole-instance", required = true)
