 ...
 */
public class BibMarcNamedFieldsBean implements Serializable {
    private String title;
    private String author;
    private String publisher;
    private String description;
    private BibMarcRecord bibliographicRecord;
    ...
    public BibMarcRecord getBibliographicRecord() {
        if (null == bibliographicRecord) {
            bibliographicRecord = new BibMarcRecord();
        }
        return bibliographicRecord;
    }

    public void setBibliographicRecord(BibMarcRecord bibliographicRecord) {
    ...
    private void setFieldValue(String title, String dfTag, String sfCode) {
        ...
        if (!titleDataFieldExists) {
            ...
            getBibliographicRecord().addDataFields(marcDataField);
        }
    }
