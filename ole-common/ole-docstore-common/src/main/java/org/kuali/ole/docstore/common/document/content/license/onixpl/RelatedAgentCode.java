 ...
 * <p/>
 * <p>Java class for RelatedAgentCode.
 * <p/>
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p/>
 * <pre>
 * &lt;simpleType name="RelatedAgentCode">
...
public enum RelatedAgentCode {
    ...
    public static RelatedAgentCode fromValue(String v) {
        for (RelatedAgentCode c : RelatedAgentCode.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
