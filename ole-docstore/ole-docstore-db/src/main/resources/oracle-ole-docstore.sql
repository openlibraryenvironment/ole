...
CREATE SEQUENCE OLE_DS_HIGH_DENSITY_STORAGE_S
  INCREMENT BY 1
  START WITH 1
  MAXVALUE 9999999999999999999999999999
  NOMINVALUE
...
CREATE  TABLE OLE_DS_HIGH_DENSITY_STORAGE_T (
  HIGH_DENSITY_STORAGE_ID INTEGER NOT NULL,
  HIGH_DENSITY_ROW VARCHAR2(30)  DEFAULT NULL ,
  HIGH_DENSITY_MODULE VARCHAR2(30)  DEFAULT NULL ,
  HIGH_DENSITY_SHELF VARCHAR2(30)  DEFAULT NULL ,
  HIGH_DENSITY_TRAY VARCHAR2(30)  DEFAULT NULL ,
...
CREATE  TABLE OLE_DS_ITEM_T (
  ...
  SHELVING_ORDER VARCHAR2(300) DEFAULT NULL ,
  CALL_NUMBER_TYPE_ID INTEGER DEFAULT NULL ,
  HIGH_DENSITY_STORAGE_ID INTEGER  DEFAULT NULL ,
  ...
  CONSTRAINT HIGH_DENSITY_CONSTRAINT FOREIGN KEY (HIGH_DENSITY_STORAGE_ID) REFERENCES OLE_DS_HIGH_DENSITY_STORAGE_T (HIGH_DENSITY_STORAGE_ID)
)
/
