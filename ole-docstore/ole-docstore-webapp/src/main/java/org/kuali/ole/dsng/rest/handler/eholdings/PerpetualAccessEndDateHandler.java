 ...
 */
public class PerpetualAccessEndDateHandler extends HoldingsHandler {

    private final String TYPE = "Perpetual Access End Date";
        ...
        if(CollectionUtils.isNotEmpty(listFromJSONArray)) {
            ...
            if(CollectionUtils.isNotEmpty(eInstancePerpetualAccessRecords)) {
                for (Iterator<String> iterator = listFromJSONArray.iterator(); iterator.hasNext(); ) {
                    String perpetualAccessEndDate = iterator.next();
