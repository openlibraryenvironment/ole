 ...
 */
public class ShelvingOrderHandler extends ItemHandler  {
    ...
    public void processDataMappings(JSONObject requestJsonObject, Exchange exchange) {
        ...
        if(CollectionUtils.isNotEmpty(listFromJSONArray)) {
            ...
            itemRecord.setShelvingOrder(shelvingOrder);
        }
    }
    ...
    public void process(JSONObject requestJsonObject, Exchange exchange) {
        ...
        for (Iterator<String> iterator = parsedValues.iterator(); iterator.hasNext(); ) {
            ...
            if(StringUtils.equals(itemRecord.getCallNumberPrefix(), shelvingOrderValue)) {
                exchange.add(OleNGConstants.ITEM_RECORD, Boolean.TRUE);
