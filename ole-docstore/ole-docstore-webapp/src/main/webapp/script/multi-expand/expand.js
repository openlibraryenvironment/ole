       ...
       (o.switchPosition == 'before') ? ($.fn.findSibling = $.fn.prev, $.fn.insrt = $.fn.before) : ($.fn.findSibling = $.fn.next, $.fn.insrt = $.fn.after);
        ...
        $sw.click(function() {
            ...
            if ($switch.text() == o.expTxt) {
              ...
              if (o.scroll && cOffset < $(window).scrollTop()) {$(scrollElem).animate({scrollTop: cOffset},0);}
          }
          return false;
        });
        /* -----------------------------------------------
          ...
          if (localLink.length) {
            ...
            $(localLink).click(function() {
              ...
              if ($target.length) {
                ...
                $(scrollElem).animate({scrollTop: tOffset},0);
                return false;
              }
            });
          }
...
$.fn.expandAll.defaults = {
        ...
        speed : 0, // the speed of the animation in m.s. or 'slow', 'normal', 'fast'
