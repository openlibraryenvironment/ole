...
TRUNCATE TABLE bk_order_entry_t DROP STORAGE
/
TRUNCATE TABLE bk_order_doc_t DROP STORAGE
/
TRUNCATE TABLE bk_book_typ_t DROP STORAGE
/
DELETE FROM bk_book_t
/
...
INSERT INTO bk_book_t (book_id,title,author,typ_cd,isbn,publisher,pub_date,obj_id,ver_nbr,price,rating)
  VALUES ('1','i See','','ROM','9781402894626','Rupa Publishers Ltd.','01-SEP-02','482b3394-0327-4e93-bd80-c5dc3b2a9e34','1','34.43','87')
/
INSERT INTO bk_book_t (book_id,title,author,typ_cd,isbn,publisher,pub_date,obj_id,ver_nbr,price,rating)
  VALUES ('2','Galactico','','SCI-FI','9781402894634','Rupa Publishers Ltd.','01-SEP-02','482b3394-0327-4ee5-bd80-c5dc3b2a9e34','1','12.43','90')
/
