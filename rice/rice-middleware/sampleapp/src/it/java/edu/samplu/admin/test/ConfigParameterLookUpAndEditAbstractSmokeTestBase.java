 ...
 */
public abstract class ConfigParameterLookUpAndEditAbstractSmokeTestBase extends AdminTmplMthdSTNavBase{
    ...
    public void testConfigParameterLookUpAndEditBookmark(Failable failable) throws Exception {
    ...
    public void testConfigParameterLookUpAndEdit() throws Exception
    {
