 ...
 */
public abstract class LocationStateBlanketAppAbstractSmokeTestBase extends AdminTmplMthdSTNavBase{
    ...
    public void testLocationStateBlanketAppBookmark(Failable failable) throws Exception {
