 ...
 */
public abstract class MaintenanceButtonsAbstractSmokeTestBase extends KradTmplMthdSTNavBase{
    ...
    public void testMaintenanceButtonsBookmark(Failable failable) throws Exception {
