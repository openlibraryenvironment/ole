 ...
 */
public abstract class ConfigParameterTypeLookUpAndEditAbstractSmokeTestBase extends AdminTmplMthdSTNavBase{
    ...
    public void testConfigParameterTypeLookUpAndEditBookmark(Failable failable) throws Exception {
        testConfigParameterTypeLookUpAndEdit();
        passed();
    }

    public void testConfigParameterTypeLookUpAndEditNav(Failable failable) throws Exception {
        testConfigParameterTypeLookUpAndEdit();
        passed();
    }    
    ...
    public void testConfigParameterTypeLookUpAndEdit() throws Exception
    {
        ...
        waitAndTypeByName("document.documentHeader.documentDescription","Test description of parameter type " + ITUtil.createUniqueDtsPlusTwoRandomCharsNot9Digits());
