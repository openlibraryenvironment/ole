 ...
 */
public abstract class LocationPostCodeBlanketAppAbstractSmokeTestBase extends AdminTmplMthdSTNavBase{
    ...
    public void testLocationPostCodeBlanketAppBookmark(Failable failable) throws Exception {
