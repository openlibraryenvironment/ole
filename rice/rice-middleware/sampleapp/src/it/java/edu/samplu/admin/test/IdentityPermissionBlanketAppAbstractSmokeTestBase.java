 ...
 */
public abstract class IdentityPermissionBlanketAppAbstractSmokeTestBase extends AdminTmplMthdSTNavBase{
    ...
    public void testIdentityPermissionBlanketAppBookmark(Failable failable) throws Exception {
