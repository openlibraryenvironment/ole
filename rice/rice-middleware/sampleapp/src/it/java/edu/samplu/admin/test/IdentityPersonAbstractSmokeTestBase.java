 ...
 */
public abstract class IdentityPersonAbstractSmokeTestBase extends AdminTmplMthdSTNavBase{
    ...
    public void testIdentityPersonBookmark(Failable failable) throws Exception {
