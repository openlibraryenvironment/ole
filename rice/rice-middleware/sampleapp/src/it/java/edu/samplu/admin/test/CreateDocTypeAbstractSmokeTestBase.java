 ...
 */
public abstract class CreateDocTypeAbstractSmokeTestBase extends AdminTmplMthdSTNavBase{

    /**
     * ITUtil.PORTAL+"?channelTitle=Document%20Type&channelUrl="+ITUtil.getBaseUrlString()+ITUtil.KNS_LOOKUP_METHOD
