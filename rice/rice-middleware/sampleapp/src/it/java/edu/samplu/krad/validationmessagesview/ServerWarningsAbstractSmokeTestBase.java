 ...
 */
public abstract class ServerWarningsAbstractSmokeTestBase extends WebDriverLegacyITBase {
     ...
     * Bookmark Tests should override and return {@link edu.samplu.krad.validationmessagesview.ServerWarningsAbstractSmokeTestBase#BOOKMARK_URL}
     * {@inheritDoc}
     * @return
     */
    @Override
