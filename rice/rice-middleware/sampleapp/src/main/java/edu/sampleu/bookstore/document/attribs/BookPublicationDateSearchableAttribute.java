...
public class BookPublicationDateSearchableAttribute extends XPathSearchableAttribute {
    public BookPublicationDateSearchableAttribute() {
        super("book_publication_date", KewApiConstants.SearchableAttributeConstants.DATA_TYPE_DATE, "//newMaintainableObject/businessObject/publicationDate/text()", "Book Publication Date");
    }
}
