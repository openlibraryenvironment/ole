...
<html>
<head>
<title>Kuali Rice Acknowledgements</title>
<link href="css/screen.css" rel="stylesheet" type="text/css">
</head>
<body onload="placeFocus()">
 <table width="100%" border=0 cellpadding=0 cellspacing=0 class="headercell1">
	<tr>
		<td width="50%" align="left"><img src="kr/static/images/ricelogo.gif" alt="Kuali Rice" hspace=5 vspace=5></td>
    	<td width="50%" align="right"><img src="kr/static/images/kuali_logo.gif" alt="Kuali" hspace=5 vspace=5></td>
  	</tr>
</table>
...
<p>This product includes software developed by ANTLR (<a href="http://www.antlr.org/" rel="nofollow">http://www.antlr.org/</a>). <!-- Rice 1.0.0 --></p>

<p>This product includes software developed by Displaytag (<a href="http://displaytag.sourceforge.net/11/" rel="nofollow">http://displaytag.sourceforge.net/11/</a>). <!-- Rice 1.0.0 --></p>

<p>This product includes software developed by the JDOM Project (<a href="http://www.jdom.org/" rel="nofollow">http://www.jdom.org/</a>). <!-- Rice 1.0.0 --></p>

<p>This product includes software developed by the University Corporation for Advanced Internet Development  Internet2 Project (<a href="http://www.ucaid.edu" rel="nofollow">http://www.ucaid.edu</a>). <!-- Rice 1.0.0 --></p>

<p>This product includes software developed by the Open Symphony Group (<a href="http://www.opensymphony.com/" rel="nofollow">http://www.opensymphony.com/</a>). <!-- Rice 1.0.0 --></p>
...
<p>This product includes software licensed under the GNU Lesser General Public License (<a href="http://www.opensource.org/licenses/lgpl-license.php" rel="nofollow">http://www.opensource.org/licenses/lgpl-license.php</a>). <!-- Rice 1.0.0 --></p>

<p>This product includes software licensed under the Eclipse Public License (<a href="http://www.eclipse.org/legal/epl-v10.html" rel="nofollow">http://www.eclipse.org/legal/epl-v10.html</a>). <!-- Rice 1.0.0 --></p>

<p>This product includes software licensed under the Common Development and Distribution License (<a href="http://www.opensource.org/licenses/cddl1.php" rel="nofollow">http://www.opensource.org/licenses/cddl1.php</a>). <!-- Rice 1.0.0 --></p>

<p>This product includes software licensed under the Creative Commons Public Domain License (<a href="http://creativecommons.org/licenses/publicdomain/" rel="nofollow">http://creativecommons.org/licenses/publicdomain/</a>). <!-- Rice 1.0.0 --></p>

<p>This product includes software licensed under the Common Public License. (<a href="http://www.opensource.org/licenses/cpl1.0.php" rel="nofollow">http://www.opensource.org/licenses/cpl1.0.php</a>) <!-- Rice 1.0.0 --></p>
...
<p>Portions Copyright (c) 1999-2004 Bull S. A. All Rights Reserved. <!-- Rice 1.0.0 --></p>
