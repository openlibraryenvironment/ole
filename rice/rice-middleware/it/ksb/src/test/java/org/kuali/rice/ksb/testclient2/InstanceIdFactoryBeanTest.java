 ...
 *   <li>If {@link org.kuali.rice.ksb.util.KSBConstants.Config#INSTANCE_ID} has been set in the configuration context, that value will be used.</li>
 ...
 * from the configuration context using the {@link org.kuali.rice.ksb.util.KSBConstants.Config#INSTANCE_ID} configuration parameter which
 * should always have a value.
 * 
 * @author Kuali Rice Team (rice.collab@kuali.org)
 *
 */
public class InstanceIdFactoryBeanTest extends AbstractFactoryBean<String> {
