...
class LookupDaoJpaTest {
    ...
    void testCaseSensitive() {
        //insensitive
        lookupDaoJpa.createCriteria(countryBo,"searchValue","code",true,false,criteria);
        String t = criteria.toString();
        assertEquals("[]",criteria.toString());

        //sensitive
        criteria = new Criteria();
        lookupDaoJpa.createCriteria(countryBo,"searchValue","code",false,false,criteria);
        assertEquals("[]",criteria.toString());
    }
