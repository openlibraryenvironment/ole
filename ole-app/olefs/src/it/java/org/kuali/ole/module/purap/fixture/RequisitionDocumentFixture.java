...
import org.kuali.ole.module.purap.fixture.TaxFixture.TaxTestCaseFixture;
...
public enum RequisitionDocumentFixture {
    ...
    REQ_ONLY_REQUIRED_FIELDS(null, // requisitionOrganizationReference1Text
            ...
            "YBP Library Services", // vendorName,
    ...
    private RequisitionDocumentFixture(String requisitionOrganizationReference1Text, String requisitionOrganizationReference2Text, String requisitionOrganizationReference3Text, String vendorName, String alternate1VendorName, String alternate2VendorName, String alternate3VendorName, String alternate4VendorName, String alternate5VendorName, KualiDecimal organizationAutomaticPurchaseOrderLimit,BigDecimal purchaseOrderTypeId, PurchasingAccountsPayableDocumentFixture purapDocumentFixture, PurchasingDocumentFixture purchasingDocumentFixture, RequisitionItemFixture[] requisitionItemFixtures) {
    ...
    public RequisitionDocument createRequisitionDocumentForTax(TaxTestCaseFixture taxTestCaseFixture) {
        ...
        if (taxTestCaseFixture.isDeliveryStateTaxable()){
            TestUtils.setSystemParameter(OleParameterConstants.PURCHASING_DOCUMENT.class, TaxParameters.TAXABLE_DELIVERY_STATES, doc.getDeliveryStateCode());
            parameterSuffix = "FOR_TAXABLE_STATES";
        } else {
            TestUtils.setSystemParameter(OleParameterConstants.PURCHASING_DOCUMENT.class, TaxParameters.TAXABLE_DELIVERY_STATES, INVALID_VALUE);
            parameterSuffix = "FOR_NON_TAXABLE_STATES";
        }
        
        if (taxTestCaseFixture.isFundGroupCodeTaxable()){
            TestUtils.setSystemParameter(OleParameterConstants.PURCHASING_DOCUMENT.class, "TAXABLE_FUND_GROUPS_" + parameterSuffix, fundGroupCode);
            TestUtils.setSystemParameter(OleParameterConstants.PURCHASING_DOCUMENT.class, "TAXABLE_SUB_FUND_GROUPS_" + parameterSuffix, subFundGroupCode);
        }else{
           //Just put some invalid value
            TestUtils.setSystemParameter(OleParameterConstants.PURCHASING_DOCUMENT.class, "TAXABLE_FUND_GROUPS_" + parameterSuffix, INVALID_VALUE);
            TestUtils.setSystemParameter(OleParameterConstants.PURCHASING_DOCUMENT.class, "TAXABLE_SUB_FUND_GROUPS_" + parameterSuffix, INVALID_VALUE);
        }
        
        if (taxTestCaseFixture.isObjectCodeTaxable()){
            TestUtils.setSystemParameter(OleParameterConstants.PURCHASING_DOCUMENT.class, "TAXABLE_OBJECT_LEVELS_" + parameterSuffix, objectLevelCode);
            TestUtils.setSystemParameter(OleParameterConstants.PURCHASING_DOCUMENT.class, "TAXABLE_OBJECT_CONSOLIDATIONS_" + parameterSuffix, consolidationObjectCode);
        }else{
            TestUtils.setSystemParameter(OleParameterConstants.PURCHASING_DOCUMENT.class, "TAXABLE_OBJECT_LEVELS_" + parameterSuffix, INVALID_VALUE);
            TestUtils.setSystemParameter(OleParameterConstants.PURCHASING_DOCUMENT.class, "TAXABLE_OBJECT_CONSOLIDATIONS_" + parameterSuffix, INVALID_VALUE);
        }
        
        if (taxTestCaseFixture.isSalesTaxEnabled()){
            TestUtils.setSystemParameter(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapParameterConstants.ENABLE_SALES_TAX_IND,"Y");
        }else{
            TestUtils.setSystemParameter(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapParameterConstants.ENABLE_SALES_TAX_IND,"N");
        }
    ...
    public String toString() {
        ...
        return new ToStringBuilder(this).append("requisitionOrganizationReference1Text", requisitionOrganizationReference1Text).append("requisitionOrganizationReference2Text", requisitionOrganizationReference2Text).append("requisitionOrganizationReference3Text", requisitionOrganizationReference3Text).append("alternate1VendorName", alternate1VendorName).append("alternate2VendorName", alternate2VendorName).append("alternate3VendorName", alternate3VendorName)
                .append("alternate4VendorName", alternate4VendorName).append("alternate5VendorName", alternate5VendorName).append("organizationAutomaticPurchaseOrderLimit", organizationAutomaticPurchaseOrderLimit).append("purchaseOrderTypeId",purchaseOrderTypeId).append("purapDocumentFixture", purapDocumentFixture).append("purchasingDocumentFixture", purchasingDocumentFixture).append("requisitionItemFixtures", requisitionItemFixtures).toString();
    }
}
