...
public class PurapTestConstants {
    ...
    static class AmountsLimits {
        ...
        static final KualiDecimal SMALL_POSITIVE_AMOUNT = new KualiDecimal(1);
        static final KualiDecimal LARGE_POSITIVE_AMOUNT = new KualiDecimal(1024);
    }

    static class ItemsAccounts {
        static RequisitionItem REQ_ITEM = new OleRequisitionItem();
        static PurchaseOrderItem PO_ITEM = new OlePurchaseOrderItem();
