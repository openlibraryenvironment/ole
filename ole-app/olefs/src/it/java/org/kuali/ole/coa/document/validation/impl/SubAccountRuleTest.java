...
public class SubAccountRuleTest extends KFSTestCaseBase {
    ...
    private void proveNotAllFinReportCodesEntered(SubAccount subAccount) {
        ...
        assertGlobalErrorExists(OLEKeyConstants.ERROR_DOCUMENT_SUBACCTMAINT_RPTCODE_ALL_FIELDS_IF_ANY_FIELDS);
    ...
    public void testCheckCgRules_badA21SubAccountAccountType() throws Exception {
        ...
        assertFieldErrorExists(fieldName, OLEKeyConstants.ERROR_DOCUMENT_SUBACCTMAINT_INVALI_SUBACCOUNT_TYPE_CODES);
        assertGlobalMessageMapSize(1);
    }
