...
import org.kuali.ole.vnd.fixture.VendorTestConstants.AddressRequiredFields;
import org.kuali.ole.vnd.fixture.VendorTestConstants.AddressTypes;
...
public enum VendorRuleAddressTypeFixture {
    ...
    public VendorDetail populateVendor(VendorDetail vndr) {
        ...
        addr1.setVendorCountryCode(OLEConstants.COUNTRY_CODE_UNITED_STATES);
        ...
        addr2.setVendorCountryCode(OLEConstants.COUNTRY_CODE_UNITED_STATES);
