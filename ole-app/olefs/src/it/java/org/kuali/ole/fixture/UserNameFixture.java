...
public enum UserNameFixture {
    ...
    ole, // This is the KualiUser.SYSTEM_USER, which certain automated document type authorizers require.
    ...
    public Person getPerson() {
        if ( this != ole && this != admin && this != admin1) {
            return SpringContext.getBean(PersonService.class).getPersonByPrincipalName("ole-"+toString());
        } else {
