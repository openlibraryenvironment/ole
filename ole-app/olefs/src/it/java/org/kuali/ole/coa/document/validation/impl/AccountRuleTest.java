...
import org.kuali.ole.sys.OLEConstants.SystemGroupParameterNames;
...
public class AccountRuleTest extends ChartRuleTestBase {
    ...
    private class Accounts {
        ...
        private class User {
            private class McafeeAlan {
                private static final String UNIVERSAL_ID = "OLE1509103107";
                private static final String USER_ID = "OLE_AEMCAFEE";
                private static final String EMP_ID = "OLE0000000013";
            ...
            private class PhamAnibal {
                private static final String UNIVERSAL_ID = "OLE1195901455";
                private static final String USER_ID = "OLE_AAPHAM";
                private static final String EMP_ID = "OLE0000004686";
            ...
            private class AhlersEsteban {
                private static final String UNIVERSAL_ID = "OLE1959008511";
                private static final String USER_ID = "OLE_AHLERS";
                private static final String EMP_ID = "OLE0000002820";
        ...
        private class FiscalOfficer {
            private static final String GOOD1 = "OLE4318506633";
        }

        private class Supervisor {
            private static final String GOOD1 = "OLE4052406505";
        }
        ...
        private class UserIds {
            private static final String SUPER1 = "OLE_HEAGLE";
            private static final String GOOD1 = "ole-kcopley";
            private static final String GOOD2 = "ole-khuntley";
        }
    ...
    /**
     *
     * This method is called by testHasTemporaryRestrictedStatusCodeButRestrictedStatusDateisGreaterThanCurrentDate and takes time as a string and converts into TimaStamp.
...
/* modified for jira ole-2341
    ...
    public void testCheckFringeBenefitAccountRule_FringeBenefitChartCodeMissing() {
        ...
        assertFieldErrorExists("reportsToChartOfAccountsCode", OLEKeyConstants.ERROR_DOCUMENT_ACCMAINT_RPTS_TO_ACCT_REQUIRED_IF_FRINGEBENEFIT_FALSE);
        assertGlobalMessageMapSize(1);
    ...
    public void testCheckFringeBenefitAccountRule_FringeBenefitAccountNumberMissing() {
        ...
        assertFieldErrorExists("reportsToAccountNumber", OLEKeyConstants.ERROR_DOCUMENT_ACCMAINT_RPTS_TO_ACCT_REQUIRED_IF_FRINGEBENEFIT_FALSE);
        assertGlobalMessageMapSize(1);
    ...
    public void testCheckFringeBenefitAccountRule_FringeBenefitAccountDoesntExist() {
        ...
        assertEquals("FringeBenefit doesnt exist causes error.", false, true);
        assertFieldErrorExists("reportsToAccountNumber", OLEKeyConstants.ERROR_EXISTENCE);
        assertGlobalMessageMapSize(1);
    ...
    public void testCheckFringeBenefitAccountRule_FringeBenefitAccountClosed() {
        ...
        assertEquals("FringeBenefit Closed causes error.", false, true);
        assertFieldErrorExists("reportsToAccountNumber", OLEKeyConstants.ERROR_DOCUMENT_ACCMAINT_RPTS_TO_ACCT_MUST_BE_FLAGGED_FRINGEBENEFIT);
        assertGlobalMessageMapSize(1);
    ...
    public void testCheckFringeBenefitAccountRule_FringeBenefitGood() {
        ...
        assertEquals("Good FringeBenefit Account should not fail.", true, true);
        assertGlobalMessageMapEmpty();
...
@Test
    ...
    public void testCheckAccountExpirationDateTodayOrEarlier_NullDate() {
        ...
        assertFieldErrorExists("accountExpirationDate", OLEKeyConstants.ERROR_DOCUMENT_ACCMAINT_ACCT_CANNOT_BE_CLOSED_EXP_DATE_INVALID);
        assertGlobalMessageMapSize(1);
    ...
    public void testCheckCloseAccountContinuation_NullContinuationCoaCode() {
        ...
        assertFieldErrorExists("continuationFinChrtOfAcctCd", OLEKeyConstants.ERROR_DOCUMENT_ACCMAINT_ACCT_CLOSE_CONTINUATION_ACCT_REQD);
        assertGlobalMessageMapSize(1);
    ...
    public void testCGFields_RequiredCGFields_Missing() {
        ...
        assertFieldErrorExists("acctIndirectCostRcvyTypeCd", OLEKeyConstants.ERROR_REQUIRED);
        assertFieldErrorExists("financialIcrSeriesIdentifier", OLEKeyConstants.ERROR_REQUIRED);
    ...
    public void testCGFields_NotCGSubFund_NoFieldsPresent() {
        ...
        assertFieldErrorExists("acctIndirectCostRcvyTypeCd", OLEKeyConstants.ERROR_DOCUMENT_ACCMAINT_CG_FIELDS_FILLED_FOR_NON_CG_ACCOUNT);
        assertFieldErrorExists("financialIcrSeriesIdentifier", OLEKeyConstants.ERROR_DOCUMENT_ACCMAINT_CG_FIELDS_FILLED_FOR_NON_CG_ACCOUNT);
        assertFieldErrorExists(OLEPropertyConstants.INDIRECT_COST_RECOVERY_ACCOUNTS, OLEKeyConstants.ERROR_DOCUMENT_ACCMAINT_CG_ICR_FIELDS_FILLED_FOR_NON_CG_ACCOUNT);
    ...
    public void testCGFields_AccountMustBeReal() {
        ...
        rule.setActiveIndirectCostRecoveryAccountList(newAccount.getIndirectCostRecoveryAccounts());
        result = rule.checkCgRequiredFields(newAccount);
        assertFieldErrorExists("contractControlAccountNumber", OLEKeyConstants.ERROR_EXISTENCE);
    ...
    public void testCheckIncomeStreamRequired_CGAcctNoIncomeStreamFields() {
        ...
        assertFieldErrorExists("incomeStreamFinancialCoaCode", OLEKeyConstants.ERROR_DOCUMENT_ACCMAINT_INCOME_STREAM_ACCT_COA_CANNOT_BE_EMPTY);
        assertFieldErrorExists("incomeStreamAccountNumber", OLEKeyConstants.ERROR_DOCUMENT_ACCMAINT_INCOME_STREAM_ACCT_NBR_CANNOT_BE_EMPTY);
    ...
    public void testCheckIncomeStreamRequired_CGAcctInvalidIncomeStreamAccount() {
        ...
        assertFieldErrorExists("incomeStreamAccountNumber", OLEKeyConstants.ERROR_EXISTENCE);
        assertGlobalMessageMapSize(1);
    ...
    public void testCheckUniqueAccountNumber_AccountsCanCrossCharts() {
        ...
        this.assertFieldErrorDoesNotExist("accountNumber", OLEKeyConstants.ERROR_DOCUMENT_ACCMAINT_ACCT_NMBR_NOT_UNIQUE);
    ...
    public void testCheckUniqueAccountNumber_AccountsCantCrossCharts() {
        ...
        assertFieldErrorExists("accountNumber", OLEKeyConstants.ERROR_DOCUMENT_ACCMAINT_ACCT_NMBR_NOT_UNIQUE);
        assertGlobalMessageMapSize(1);
    }
    ...
    public void testDataDictionaryValidation_AccountPurpose_GoodLength() {
        ...
        assertFieldErrorDoesNotExist("accountGuideline.accountPurposeText", OLEKeyConstants.ERROR_MAX_LENGTH);
    }
}
