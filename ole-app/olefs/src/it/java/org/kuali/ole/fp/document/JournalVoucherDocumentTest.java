...
import static org.kuali.ole.KualiTestAssertionUtils.assertEquality;
import static org.kuali.ole.KualiTestAssertionUtils.assertInequality;
import static org.kuali.ole.fixture.AccountingLineFixture.LINE5;
import static org.kuali.ole.fixture.UserNameFixture.dfogle;
...
import org.kuali.ole.monitor.FinancialSystemDocumentStatusMonitor;
...
public class JournalVoucherDocumentTest extends KualiTestBase {
    ...
    private JournalVoucherDocument buildDocument() throws Exception {
        ...
        document.setBalanceTypeCode(OLEConstants.BALANCE_TYPE_ACTUAL);
        return document;
    }
    ...
    public void testConvertIntoErrorCorrection() throws Exception {
        ...
        for (int i = 0; i < preCorrectSourceLines.size(); ++i) {
            ...
            assertEquality(postCorrectLine.getDebitCreditCode(), OLEConstants.GL_CREDIT_CODE);
        }
    ...
    public void testRouteDocument() throws Exception {
        ...
        FinancialSystemDocumentStatusMonitor statusMonitor = new FinancialSystemDocumentStatusMonitor(SpringContext.getBean(DocumentService.class), document.getDocumentHeader().getDocumentNumber(), OLEConstants.DocumentStatusCodes.APPROVED);
