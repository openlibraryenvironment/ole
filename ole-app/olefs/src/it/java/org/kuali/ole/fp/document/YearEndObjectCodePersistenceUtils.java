...
public class YearEndObjectCodePersistenceUtils {
    ...
    protected static void persistPreviousYearObjectCode(AccountingLine accountingLine, Set<String> storedObjectCodes) {
        ...
        final OffsetDefinition offsetDefinition = offsetDefinitionService.getByPrimaryId(accountingLine.getPostingYear(), accountingLine.getChartOfAccountsCode(), "YEGE", OLEConstants.BALANCE_TYPE_ACTUAL);
