...
public class TestUtils {
    ...
    public static void setSystemParameter(Class componentClass, String parameterName, String parameterText) {
            ...
            try {
                ...
                if ( KualiTestBase.class.isAssignableFrom(clazz) ) {
                    ...
                    try {
                        ...
                        a = m.getAnnotation(ConfigureContext.class);
                        if ( a != null ) {
                            willCommit = a.shouldCommitTransactions();
                        }
        ...
        getParameterService().updateParameter(pb.build());
    }
    ...
    public static Object getUnproxiedService(String serviceName) throws Exception {
        ...
        return getUnproxiedObject(service);
//        if ( service == null ) {
//            return null;
//        }
//        try {
...
//            if ( proxyFactory.getTargetSource().getTarget() != null && proxyFactory.getTargetSource().getTarget().getClass().getName().contains( "$Proxy" ) ) {
//                return getUnproxiedService(proxyFactory.getTargetSource().getTarget());
//            }
...
//        }
    ...
    public static Object getUnproxiedObject(Object service) throws Exception {
        if ( service == null ) {
            return null;
        }
        try {
            ...
            ProxyFactory proxyFactory = (ProxyFactory) privateAdvisedField.get(invocationHandler);
            if ( proxyFactory.getTargetSource().getTarget() != null && proxyFactory.getTargetSource().getTarget().getClass().getName().contains( "$Proxy" ) ) {
                return getUnproxiedObject(proxyFactory.getTargetSource().getTarget());
            }
            return proxyFactory.getTargetSource().getTarget();
        } catch ( IllegalArgumentException ex ) {
            return service;
