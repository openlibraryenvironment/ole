...
public class DocumentVersionMonitor extends ChangeMonitor {
     ...
     * 
     * @see org.kuali.ole.sys.document.routing.ChangeMonitor#valueChanged()
     */
    ...
    public String toString() {
        ...
        builder.append("DocumentVersionMonitor [");
        if (documentHeaderId != null)
            builder.append("documentHeaderId=").append(documentHeaderId).append(", ");
        if (startVersion != null)
            builder.append("startVersion=").append(startVersion);
        builder.append("]");
