 ...
 */
public class MockLocationFunction implements Function {
    ...
    public Object invoke(Object... arguments) {
        ...
        String location = (String)((ArrayList) argument).get(1);
        boolean exists = getDiscoveryHelperService().isLocationExists(location);
        return exists;
    }
