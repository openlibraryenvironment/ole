...
public enum PurApItemFixture {
    BASIC_QTY_ITEM_1(null, // itemIdentifier
           ...
           // "PCS", // itemUnitOfMeasureCode
    ...
    ), BASIC_QTY_ITEM_FOR_COPIES(null, // itemIdentifier
            new Integer(1), // itemLineNumber
            "EA",  // itemUnitOfMeasureCode
            // "PCS", // itemUnitOfMeasureCode
            "", // itemCatalogNumber
            ...
            false, // itemAssignedToTradeInIndicator
            new KualiDecimal(1), // extendedPrice
            new KualiDecimal(3) // itemQuantity
    ),
    BASIC_QTY_ITEM_FOR_PO(null, // itemIdentifier
            new Integer(1), // itemLineNumber
            "EA",  // itemUnitOfMeasureCode
            // "PCS", // itemUnitOfMeasureCode
            "", // itemCatalogNumber
    ...
    //       "PCS", // itemUnitOfMeasureCode
            ...
            new KualiDecimal(1), // extendedPrice
            new KualiDecimal(1) // itemQuantity
    ), BASIC_QTY_ITEM_3(null, // itemIdentifier
            new Integer(1), // itemLineNumber
            "EA",  // itemUnitOfMeasureCode
           // "PCS", // itemUnitOfMeasureCode
            "", // itemCatalogNumber
