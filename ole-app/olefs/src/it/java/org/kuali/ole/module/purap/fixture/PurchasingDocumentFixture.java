...
import org.kuali.ole.module.purap.PurapConstants.POCostSources;
import org.kuali.ole.module.purap.PurapConstants.POTransmissionMethods;
...
public enum PurchasingDocumentFixture {
    ...
    public RequisitionDocument createRequisitionDocument(PurchasingAccountsPayableDocumentFixture purapFixture) {
        return (RequisitionDocument) createPurchasingDocument(OleRequisitionDocument.class, purapFixture);
    }

    public PurchaseOrderDocument createPurchaseOrderDocument(PurchasingAccountsPayableDocumentFixture purapFixture) {
        return (PurchaseOrderDocument) createPurchasingDocument(OlePurchaseOrderDocument.class, purapFixture);
    }
    ...
    public OleRequisitionDocument createOleRequisitionDocument(PurchasingAccountsPayableDocumentFixture purapFixture) {
        return (OleRequisitionDocument) createPurchasingDocument(OleRequisitionDocument.class, purapFixture);
    }
}
