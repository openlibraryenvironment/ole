...
public enum PaymentRequestDocumentFixture {
    ...
    public PaymentRequestDocument createPaymentRequestDocument() {
        ...
        OlePaymentRequestDocument doc = (OlePaymentRequestDocument) apDocumentFixture.createPaymentRequestDocument(purapDocumentFixture);
        ...
        doc.setPaymentMethodId(1);
        OlePaymentMethod olePaymentMethod = new OlePaymentMethod();
        olePaymentMethod.setPaymentMethodId(1);
        olePaymentMethod.setPaymentMethod("Cash");
        doc.setPaymentMethod(olePaymentMethod);
