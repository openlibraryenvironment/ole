 ...
 */
public class CircPolicies_IT extends DroolsKieBaseTestCase {
    ...
    public void testDateFormat() throws Exception {
        ...
        String rulesDirectory = System.getProperty("user.home") + fileSeperator + "/main/local/rules";

        System.out.println("Rules directory: " + rulesDirectory);
