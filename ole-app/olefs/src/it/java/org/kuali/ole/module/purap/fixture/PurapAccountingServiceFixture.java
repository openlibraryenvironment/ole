    ...
    private PurapAccountingServiceFixture(RequisitionItemFixture[] itemFixtures, AccountingLineFixture[] acctLineFixtures, Integer[] positions) {
        ...
        for( int i = 0; i < acctLineFixtures.length; i++ ) {
            ...
            try {
                ...
                PurApAccountingLine purApAccountingLine = PurApAccountingLineFixture.BASIC_ACCOUNT_1.createPurApAccountingLine(OleRequisitionAccount.class, acctLineFixture);
                if(positions[i] != null) {
