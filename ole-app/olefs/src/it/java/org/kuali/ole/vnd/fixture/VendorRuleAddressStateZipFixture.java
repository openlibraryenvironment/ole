...
import org.kuali.ole.vnd.fixture.VendorTestConstants.StatesZips;
...
public enum VendorRuleAddressStateZipFixture {
    ...
    BOTH_US_BOTH_STATES_BOTH_ZIPS(OLEConstants.COUNTRY_CODE_UNITED_STATES, StatesZips.stateCd, StatesZips.zipCode, OLEConstants.COUNTRY_CODE_UNITED_STATES, StatesZips.stateCd, StatesZips.zipCode)
//    , BOTH_US_WITHOUT_STATES_WITHOUT_ZIPS(OLEConstants.COUNTRY_CODE_UNITED_STATES, null, null, OLEConstants.COUNTRY_CODE_UNITED_STATES, null, null)
//    , BOTH_US_EMPTY_STATES_EMPTY_ZIPS(OLEConstants.COUNTRY_CODE_UNITED_STATES, "", "", OLEConstants.COUNTRY_CODE_UNITED_STATES, "", "")
    , BOTH_US_BOTH_STATES_ONE_ZIP_ONE_NULL(OLEConstants.COUNTRY_CODE_UNITED_STATES, StatesZips.stateCd, StatesZips.zipCode, OLEConstants.COUNTRY_CODE_UNITED_STATES, StatesZips.stateCd, null)
    , BOTH_US_BOTH_STATES_ONE_ZIP_ONE_EMPTY(OLEConstants.COUNTRY_CODE_UNITED_STATES, StatesZips.stateCd, StatesZips.zipCode, OLEConstants.COUNTRY_CODE_UNITED_STATES, StatesZips.stateCd, "")
...
//    , WITHOUT_US_BOTH_STATES_BOTH_ZIPS("", StatesZips.stateCd, StatesZips.zipCode, "", StatesZips.stateCd, StatesZips.zipCode),
    ...
    // Country and State were moved from OLE, so any module cannot instantiate a country or state object directly
     ...
     *
     * @param country1 Any String, really, but possibly a country value from OLEConstants.
