...
public class DelegateGlobalTest extends KualiTestBase {
    ...
    private static final String DOC_TYPE_ALL = OLEConstants.ROOT_DOCUMENT_TYPE;
    private static final String DOC_TYPE_ACCT = "OLE_ACCT";
    private static final String DOC_TYPE_CR = "OLE_CR";
    private static final String DOC_TYPE_TF = "OLE_TF";
