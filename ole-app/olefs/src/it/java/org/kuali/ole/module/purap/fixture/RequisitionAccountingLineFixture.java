...
public enum RequisitionAccountingLineFixture {
    ...
    ), BASIC_REQ_ACCOUNT_3(PurApAccountingLineFixture.BASIC_ACCOUNT_1, // PurApAccountingLineFixture
            AccountingLineFixture.PURAP_LINE4 // AccountingLineFixture
    ...
    public PurApAccountingLine createPurApAccountingLine(Class clazz, PurApAccountingLineFixture puralFixture, AccountingLineFixture alFixture) {
        ...
        line = puralFixture.createPurApAccountingLine(OleRequisitionAccount.class, alFixture);
