...
public class NoticeMailContentFormatterTest {
    ...
    public void generateMissingPieceNoticeMailContentForPatron() throws Exception {
      ...
      /*  OleCirculationDesk oleCirculationDesk = new OleCirculationDesk();
        oleCirculationDesk.setCirculationDeskPublicName("UC Regenstein Library,1st Floor");
        oleCirculationDesk.setLocationId(location.getLocationId());*/
        OleNoticeBo oleNoticeBo = new OleNoticeBo();
       ...
       // Mockito.when(mockCircDeskLocationResolver.getOleCirculationDesk(location.getLocationId())).thenReturn(oleCirculationDesk);
