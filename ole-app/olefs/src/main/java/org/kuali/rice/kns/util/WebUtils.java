...
public class WebUtils {
	...
	public static boolean canDeleteNoteAttachment(final Document document, final String attachmentTypeCode, final String authorUniversalIdentifier) {
        TransactionTemplate template = new TransactionTemplate(getTransactionManager());
        return template.execute(new TransactionCallback<Boolean>() {
            @Override
            public Boolean doInTransaction(TransactionStatus status) {
	...
	public static ConfigurationService getKualiConfigurationService() {
		if (configurationService == null) {
			configurationService = GlobalResourceLoader.getService("kualiConfigurationService");
		}
