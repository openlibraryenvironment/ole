...
/**
 *
 * An implementation of {@link org.kuali.rice.krms.framework.engine.Proposition} which holds other Propositions and a {@link org.kuali.rice.krms.api.repository.LogicalOperator}.
 *
...
public final class CompoundProposition implements Proposition {
     ...
     * @param logicalOperator {@link org.kuali.rice.krms.api.repository.LogicalOperator} to set logicalOperator to
    ...
    /**
     * Evaluates then {@link org.kuali.rice.krms.api.engine.ExecutionEnvironment}
     *
     * @param environment {@link org.kuali.rice.krms.api.engine.ExecutionEnvironment} to use for evaluation
     * @return PropositionResult {@link org.kuali.rice.krms.framework.engine.PropositionResult} the results of the evaluation
    ...
    /**
     * Returns an unmodifiableList of {@link org.kuali.rice.krms.framework.engine.Proposition}s.
     * @return an unmodifiableList of {@link org.kuali.rice.krms.framework.engine.Proposition}s
     */
    @Override
