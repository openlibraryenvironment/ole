 ...
 *
 * Overridden for fixing the issue with setting maxLength for the lookup fields.
 * Modified method name: copyFromAttributeDefinition.
 * Changes description : Getting the maxLength from attributeDefinition if the attribute definition is having maxLength.
 */
...
public class LookupInputField extends InputField {
    ...
    public void copyFromAttributeDefinition(View view, AttributeDefinition attributeDefinition) {
        ...
        setMaxLength(100);
        /* Modified by 'Angelin Dayana' for fixing the issue with setting maxLength for the lookup fields.
        * Getting the maxLength from attributeDefinition if the attribute definition is having maxLength. */
