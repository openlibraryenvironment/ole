...
public abstract class KualiDocumentFormBase extends KualiForm implements Serializable {
	...
	/**
	 * This method returns a list of {@link org.kuali.rice.kns.web.ui.HeaderField} objects that are used by default on Kuali document display pages. To
	 * use this list and override an individual {@link org.kuali.rice.kns.web.ui.HeaderField} object the id constants from
    ...
    protected List<HeaderField> getStandardHeaderFields(WorkflowDocument workflowDocument) {
        ...
        if(workflowDocument != null && workflowDocument.getDateCreated() != null) {
            createDateStr = CoreApiServiceLocator.getDateTimeService().toString(workflowDocument.getDateCreated().toDate(), "hh:mm a "+ RiceConstants.SIMPLE_DATE_FORMAT_FOR_DATE);
        }
