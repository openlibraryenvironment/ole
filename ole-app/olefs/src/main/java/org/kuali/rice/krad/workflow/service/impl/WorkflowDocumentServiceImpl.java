            ...
            for (AdHocRouteRecipient recipient : adHocRecipients) {
                if (StringUtils.isNotEmpty(recipient.getId())) {
                    ...
                    if (AdHocRouteRecipient.PERSON_TYPE.equals(recipient.getType())) {
                        ...
                        if (principal == null) {
                            if(((AdHocRoutePerson)recipient)!=null && ((AdHocRoutePerson)recipient).getPerson()!=null){
                                principal = KimApiServiceLocator.getIdentityService().getPrincipalByPrincipalName(((AdHocRoutePerson)recipient).getPerson().getPrincipalName());
                            }
                            if(principal == null){
