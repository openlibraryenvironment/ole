...
public interface PurapGeneralLedgerService {
    ...
    public final static String CREATE_INVOICE = "create";
    public final static String CANCEL_INVOICE = "cancel";
    public final static String MODIFY_INVOICE = "modify";
     ...
     *
     * @param inv InvoiceDocument which holds the accounts to create the entries
     */
