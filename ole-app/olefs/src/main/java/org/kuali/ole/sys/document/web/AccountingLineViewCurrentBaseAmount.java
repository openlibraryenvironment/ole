...
import org.kuali.ole.sys.document.datadictionary.AccountingLineViewCurrentBaseAmountFieldDefinition;
...
public class AccountingLineViewCurrentBaseAmount implements TableJoiningWithHeader, ReadOnlyable {
     ...
     * @see org.kuali.ole.sys.document.web.FieldTableJoining#readOnlyizeReadOnlyBlocks(java.util.Set)
     */
     ...
     * @see org.kuali.ole.sys.document.web.FieldTableJoining#removeUnviewableBlocks(java.util.Set)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.web.FieldTableJoining#performFieldTransformations(java.util.List, org.kuali.ole.sys.businessobject.AccountingLine, java.util.Map, java.util.Map)
     */
