...
public class OleKimDocDelegateMember extends PersistableBusinessObjectBase implements DelegateMemberContract {
    ...
    public OleKimDocDelegateMember() {}
    
    public OleKimDocDelegateMember( String roleMemberId, MemberType type ) {
        this.roleMemberId = roleMemberId;
        this.type = type;
    }
    
    public OleKimDocDelegateMember( DelegateMemberContract delegateMember ) {
