...
public class BudgetAdjustmentDocumentPresentationController extends AccountingDocumentPresentationControllerBase {
    ...
    /**
     * @see org.kuali.ole.sys.document.authorization.LedgerPostingDocumentPresentationControllerBase#canErrorCorrect(org.kuali.ole.sys.document.FinancialSystemTransactionalDocument)
     */
    @Override
