...
import org.kuali.ole.select.businessobject.OleLegacyFundCode;
import org.kuali.ole.select.businessobject.OleStewardshipRequirement;
...
public class Account extends PersistableBusinessObjectBase implements AccountIntf, MutableInactivatable {
    ...
    public static final String CACHE_NAME = OLEConstants.APPLICATION_NAMESPACE_CODE + "/" + "Account";
...
//    protected LaborBenefitRateCategory laborBenefitRateCategory;
   // changes for jira ole-2341
    protected List<OleStewardshipRequirement> oleStewardshipRequirements;
    protected List<OleLegacyFundCode> oleLegacyFundCodes;

    // Modified for jira OLE-2519 starts
    protected String universityAccountNumber;

    protected OleStewardshipRequirement stewardshipRequirement;

    protected boolean restricted;
    // Modified for jira OLE-2519 starts

    protected OleLegacyFundCode oleLegacyFundCode;

    protected Integer vendorHeaderGeneratedIdentifier;
    protected Integer vendorDetailAssignedIdentifier;
    protected VendorDetail vendorDetail;
    private boolean vendorDepositAccount;
    private OleSufficientFundCheck oleSufficientFundCheck;
    protected String vendorName;
    protected KualiDecimal thresholdPercentage;
    protected KualiDecimal thresholdAmount;

    public OleSufficientFundCheck getOleSufficientFundCheck() {
        return oleSufficientFundCheck;
    }

    public void setOleSufficientFundCheck(OleSufficientFundCheck oleSufficientFundCheck) {
        this.oleSufficientFundCheck = oleSufficientFundCheck;
    }

    /**
     * Gets the vendorDepositAccount attribute.
     * @return Returns the vendorDepositAccount.
     */
    public boolean isVendorDepositAccount() {
        return vendorDepositAccount;
    }

    /**
     * Sets the vendorDepositAccount attribute value.
     * @param vendorDepositAccount The vendorDepositAccount to set.
     */
    public void setVendorDepositAccount(boolean vendorDepositAccount) {
        this.vendorDepositAccount = vendorDepositAccount;
    }
    ...
    public String getVendorName() {
        ...
        if (!StringUtils.isEmpty(headerId) && !StringUtils.isEmpty(detailId)) {
            ...
            pkMap.put("vendorHeaderGeneratedIdentifier", headerId);
            pkMap.put("vendorDetailAssignedIdentifier", detailId);
            vendorDetail = SpringContext.getBean(BusinessObjectService.class).findByPrimaryKey(VendorDetail.class,
                    pkMap);
    ...
    public void setVendorName(String vendorName) {
        VendorDetail tempVendorDetail = new VendorDetail();
        tempVendorDetail.setVendorName(vendorName);
    ...
    /**
     * Gets the stewardshipRequirement attribute.
     * @return Returns the stewardshipRequirement.
     */
    public OleStewardshipRequirement getStewardshipRequirement() {
        return stewardshipRequirement;
    }

    /**
     * Sets the stewardshipRequirement attribute value.
     * @param stewardshipRequirement The stewardshipRequirement to set.
     */
    public void setStewardshipRequirement(OleStewardshipRequirement stewardshipRequirement) {
        this.stewardshipRequirement = stewardshipRequirement;
    }
    // Modified for jira OLE-2519 starts

    public OleLegacyFundCode getOleLegacyFundCode() {
        return oleLegacyFundCode;
    }

    public void setOleLegacyFundCode(OleLegacyFundCode oleLegacyFundCode) {
        this.oleLegacyFundCode = oleLegacyFundCode;
    }
    ...
    public List<OleLegacyFundCode> getOleLegacyFundCodes() {
        return oleLegacyFundCodes;
    }

    public void setOleLegacyFundCodes(List<OleLegacyFundCode> oleLegacyFundCodes) {
        this.oleLegacyFundCodes = oleLegacyFundCodes;
    }

    public List<OleStewardshipRequirement> getOleStewardshipRequirements() {
        return oleStewardshipRequirements;
    }

    public void setOleStewardshipRequirements(List<OleStewardshipRequirement> oleStewardshipRequirements) {
        this.oleStewardshipRequirements = oleStewardshipRequirements;
    }
    ...
    public Account() {
        ...
        oleStewardshipRequirements = new ArrayList<OleStewardshipRequirement>();
        oleLegacyFundCodes = new ArrayList<OleLegacyFundCode>();
    }
    ...
    public List<PersistableBusinessObject> generateDeactivationsToPersist() {
        ...
        if (!isActive()) {
            ...
            fieldValues.put(OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, getChartOfAccountsCode());
            fieldValues.put(OLEPropertyConstants.ACCOUNT_NUMBER, getAccountNumber());
            fieldValues.put(OLEPropertyConstants.ACTIVE, true);
   ...
   /**
    ...
    public String getLaborBenefitRateCategoryCode() {
        // added default value for jira OLE-3713
        if(laborBenefitRateCategoryCode != null) {
            return laborBenefitRateCategoryCode;
        }
        return OLEConstants.Account.LABOR_BENEFIT_RATE_CATEGORY_CODE;
    }
...
//    }
   ...
   public void setContractControlChartOfAccounts(Chart contractControlChartOfAccounts) {
    ...
    public KualiDecimal getThresholdPercentage() {
        return thresholdPercentage;
    }

    public void setThresholdPercentage(KualiDecimal thresholdPercentage) {
   ...
   /**
    * Used by the Spring Framework to correctly retrieve the Legacy Fund Code as a single
    * attribute. The oleLegacyFundCodes is a collection of legacyFundCodes, and without this method,
    * there was no way to get a single attribute for it.
    *
    * @return the Legacy Fund Codes as a single attribute
    */
   public String getLegacyFundCodeAsString() {

       // Modified for jira OLE-2543 starts
       StringBuilder sb = new StringBuilder();

       boolean first = true;
       for (OleLegacyFundCode legacyFundCode : oleLegacyFundCodes) {
           if (!first) {
            sb.append(", ");
        }
        else {
           ...
           sb.append(legacyFundCode.getLegacyFundCode().toString());
       }

       // Modified for jira OLE-2543 ends
       return sb.toString();
   }
