 ...
 */
package org.kuali.ole.gl.document.service.impl;
...
import org.kuali.ole.gl.batch.service.impl.OriginEntryFileIterator;
import org.kuali.ole.gl.businessobject.CorrectionChangeGroup;
import org.kuali.ole.gl.businessobject.OriginEntryFull;
import org.kuali.ole.gl.businessobject.OriginEntryStatistics;
import org.kuali.ole.gl.dataaccess.CorrectionChangeDao;
import org.kuali.ole.gl.dataaccess.CorrectionChangeGroupDao;
import org.kuali.ole.gl.dataaccess.CorrectionCriteriaDao;
import org.kuali.ole.gl.document.CorrectionDocumentUtils;
import org.kuali.ole.gl.document.GeneralLedgerCorrectionProcessDocument;
import org.kuali.ole.gl.document.dataaccess.CorrectionDocumentDao;
import org.kuali.ole.gl.document.service.CorrectionDocumentService;
import org.kuali.ole.gl.document.web.CorrectionDocumentEntryMetadata;
import org.kuali.ole.gl.report.CorrectionDocumentReport;
...
import org.kuali.ole.sys.service.ReportAggregatorService;
...
public class CorrectionDocumentServiceImpl extends InitiateDirectoryBase implements CorrectionDocumentService {
     ...
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#findByDocumentNumberAndCorrectionChangeGroupNumber(java.lang.String,
     *      int)
     */
     ...
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#findByDocumentHeaderIdAndCorrectionGroupNumber(java.lang.String,
     *      int)
     */
     ...
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#findByDocumentNumberAndCorrectionGroupNumber(java.lang.String,
     *      int)
     */
     ...
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#findByCorrectionDocumentHeaderId(java.lang.String)
     */
     ...
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#getTableRenderColumnMetadata(java.lang.String)
     *
    ...
    public List<Column> getTableRenderColumnMetadata(String docId) {
        synchronized (this) {
            if (cachedColumns == null) {
                ...
                columnToAdd.setPropertyName(OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR);
                ...
                columnToAdd.setPropertyName(OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Account Number");
                columnToAdd.setPropertyName(OLEPropertyConstants.ACCOUNT_NUMBER);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Sub Account Number");
                columnToAdd.setPropertyName(OLEPropertyConstants.SUB_ACCOUNT_NUMBER);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Object Code");
                columnToAdd.setPropertyName(OLEPropertyConstants.FINANCIAL_OBJECT_CODE);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Sub Object Code");
                columnToAdd.setPropertyName(OLEPropertyConstants.FINANCIAL_SUB_OBJECT_CODE);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Balance Type");
                columnToAdd.setPropertyName(OLEPropertyConstants.FINANCIAL_BALANCE_TYPE_CODE);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Object Type");
                columnToAdd.setPropertyName(OLEPropertyConstants.FINANCIAL_OBJECT_TYPE_CODE);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Fiscal Period");
                columnToAdd.setPropertyName(OLEPropertyConstants.UNIVERSITY_FISCAL_PERIOD_CODE);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Document Type");
                columnToAdd.setPropertyName(OLEPropertyConstants.FINANCIAL_DOCUMENT_TYPE_CODE);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Origin Code");
                columnToAdd.setPropertyName(OLEPropertyConstants.FINANCIAL_SYSTEM_ORIGINATION_CODE);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Document Number");
                columnToAdd.setPropertyName(OLEPropertyConstants.DOCUMENT_NUMBER);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);
                ...
                columnToAdd.setValueComparator(NumericValueComparator.getInstance());
                columnToAdd.setPropertyName(OLEPropertyConstants.TRANSACTION_ENTRY_SEQUENCE_NUMBER);
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Description");
                columnToAdd.setPropertyName(OLEPropertyConstants.TRANSACTION_LEDGER_ENTRY_DESC);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);
                ...
                columnToAdd.setValueComparator(NumericValueComparator.getInstance());
                columnToAdd.setPropertyName(OLEPropertyConstants.TRANSACTION_LEDGER_ENTRY_AMOUNT);
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Debit Credit Indicator");
                columnToAdd.setPropertyName(OLEPropertyConstants.TRANSACTION_DEBIT_CREDIT_CODE);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Transaction Date");
                columnToAdd.setPropertyName(OLEPropertyConstants.TRANSACTION_DATE);
                columnToAdd.setValueComparator(TemporalValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Org Doc Number");
                columnToAdd.setPropertyName(OLEPropertyConstants.ORGANIZATION_DOCUMENT_NUMBER);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Project Code");
                columnToAdd.setPropertyName(OLEPropertyConstants.PROJECT_CODE);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Org Ref ID");
                columnToAdd.setPropertyName(OLEPropertyConstants.ORGANIZATION_REFERENCE_ID);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Ref Doc Type");
                columnToAdd.setPropertyName(OLEPropertyConstants.REFERENCE_FIN_DOCUMENT_TYPE_CODE);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Ref Origin Code");
                columnToAdd.setPropertyName(OLEPropertyConstants.REFERENCE_FINANCIAL_SYSTEM_ORIGINATION_CODE);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Ref Doc Number");
                columnToAdd.setPropertyName(OLEPropertyConstants.FINANCIAL_DOCUMENT_REFERENCE_NBR);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Reversal Date");
                columnToAdd.setPropertyName(OLEPropertyConstants.FINANCIAL_DOCUMENT_REVERSAL_DATE);
                columnToAdd.setValueComparator(TemporalValueComparator.getInstance());
                cachedColumns.add(columnToAdd);

                columnToAdd = new Column();
                columnToAdd.setColumnTitle("Enc Update Code");
                columnToAdd.setPropertyName(OLEPropertyConstants.TRANSACTION_ENCUMBRANCE_UPDT_CD);
                columnToAdd.setValueComparator(StringValueComparator.getInstance());
                cachedColumns.add(columnToAdd);
     ...
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#persistOriginEntriesToFile(java.lang.String,
     *      java.util.Iterator)
     */
     ...
     * @param document an initiated or saved document
     * @param entries an Iterator of origin entries
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#persistOutputOriginEntriesForInitiatedOrSavedDocument(org.kuali.ole.gl.document.CorrectionDocument,
     *      java.util.Iterator)
     */
     ...
     * 
     * @param document a GLCP document
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#removePersistedInputOriginEntriesForInitiatedOrSavedDocument(org.kuali.ole.gl.document.CorrectionDocument)
     */
     ...
     * 
     * @param document a GLCP document
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#removePersistedOutputOriginEntriesForInitiatedOrSavedDocument(org.kuali.ole.gl.document.CorrectionDocument)
     */
     ...
     * 
     * @param docId the document id of a GLCP document
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#removePersistedInputOriginEntries(java.lang.String)
     */
     ...
     * 
     * @param docId the document id of a GLCP document
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#removePersistedOutputOriginEntries(java.lang.String)
     */
     ...
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#retrievePersistedInputOriginEntries(org.kuali.ole.gl.document.CorrectionDocument,
     *      int)
     */
     ...
     * @return the list, or null if there are too many origin entries
     * @throws RuntimeException several reasons, primarily relating to underlying persistence layer problems
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#retrievePersistedOutputOriginEntries(org.kuali.ole.gl.document.CorrectionDocument,
     *      int)
     */
     ...
     * @param document the document
     * @return the iterator
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#retrievePersistedInputOriginEntriesAsIterator(org.kuali.ole.gl.document.CorrectionDocument)
     */
     ...
     * @return the iterator
     * @throws RuntimeException several reasons, primarily relating to underlying persistence layer problems
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#retrievePersistedOutputOriginEntriesAsIterator(org.kuali.ole.gl.document.CorrectionDocument)
     */
     ...
     * 
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#areInputOriginEntriesPersisted(org.kuali.ole.gl.document.CorrectionDocument)
     */
     ...
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#areOutputOriginEntriesPersisted(org.kuali.ole.gl.document.CorrectionDocument)
     */
     ...
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#writePersistedInputOriginEntriesToStream(java.io.OutputStream)
     */
     ...
     * @param out axn open and ready output stream
     * @throws IOException thrown if IOExceptions occurred in writing the persisted origin entries
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#writePersistedOutputOriginEntriesToStream(java.io.OutputStream)
     */
     ...
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#persistOriginEntryGroupsForDocumentSave(org.kuali.ole.gl.document.CorrectionDocument,
     *      org.kuali.ole.gl.document.web.CorrectionDocumentEntryMetadata)
     */
    ...
    /**
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#generateCorrectionReport(org.kuali.ole.gl.document.GeneralLedgerCorrectionProcessDocument)
     */
    ...
    /**
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#getCorrectionDocumentsFinalizedOn(java.sql.Date)
     */
    ...
    /**
     * @see org.kuali.ole.gl.document.service.CorrectionDocumentService#aggregateCorrectionDocumentReports()
     */
