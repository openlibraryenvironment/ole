    ...
    public boolean doPrompts(Document document) {
        ...
        if (!(financialObjectLevel == null)) {
            if (!financialObjectLevel.isActive()) {
                ...
                String questionText = SpringContext.getBean(ConfigurationService.class).getPropertyValueAsString(OLEKeyConstants.ObjectCode.QUESTION_INACTIVE_OBJECT_LEVEL_CONFIRMATION);
                ...
                boolean useInactiveObjectLevel = super.askOrAnalyzeYesNoQuestion(OLEConstants.ObjectCodeConstants.INACTIVE_OBJECT_LEVEL_QUESTION_ID, questionText);
