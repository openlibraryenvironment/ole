...
import org.kuali.ole.module.purap.PurapConstants.CMDocumentsStrings;
...
//    }
     ...
     * @return An ActionForward
     * @throws Exception
     * @see org.kuali.ole.module.purap.document.service.CreditMemoService
     */
    protected ActionForward performDuplicateCreditMemoCheck(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response, VendorCreditMemoDocument creditMemoDocument) throws Exception {
        ...
        if (StringUtils.isNotBlank(duplicateMessage)) {
            ...
            if (question == null) {
                ...
                return this.performQuestionWithoutInput(mapping, form, request, response, PurapConstants.PREQDocumentsStrings.DUPLICATE_INVOICE_QUESTION, duplicateMessage, OLEConstants.CONFIRMATION_QUESTION, "continueCreditMemo", "");
            }
