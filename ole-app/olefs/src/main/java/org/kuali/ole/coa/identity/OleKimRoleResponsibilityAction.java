...
public class OleKimRoleResponsibilityAction extends PersistableBusinessObjectBase implements RoleResponsibilityActionContract {
    ...
    public OleKimRoleResponsibilityAction() {}
    
    public OleKimRoleResponsibilityAction( RoleResponsibilityActionContract b ) {
        id = b.getId();
