...
public class VendorPropertyConstants {
    ...
    public static final String VENDOR_PHONE_NUMBER = "vendorPhoneNumber";
    public static final String VENDOR_ADDRESS = "vendorAddresses";
    public static final String VENDOR_CONTACT = "vendorContacts";
    public static final String VENDOR_PHONE_NUMBERS = "vendorPhoneNumbers";
    ...
    public static final String VENDOR_INACTIVE_REFERENCE = "vendorInactiveReference";
    public static final String VENDOR_ACTIVE_INDICATOR = "activeIndicator";
    public static final String VENDOR_LINKING_NUMBER = "vendorLinkingNumber";

    public static final String PO_STATUS_CLOSED = "CLOS";

    public static final String OLE_VND = "OLE-VND";
    public static final String PERMISSION_NAME_INACTIVATE_VENDOR = "Inactivate Vendor";
    ...
    public static final String VENDOR_ALIAS_ID = "vendorAliasTypeId";
    ...
    public static final String VENDOR_PREFERRED_TRANSMISSION = "vendorPreferredTransmissionFormat";
    public static final String VENDOR_TRANSMISSION_FORMAT = "vendorTransmissionFormat";
    ...
    public static final String VENDOR_CARRIER_CODE = "vendorStandardDeliveryCarrier";
