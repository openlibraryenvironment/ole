...
import org.kuali.ole.gl.businessobject.PosterOutputSummaryBalanceTypeFiscalYearAndPeriodTotal;
import org.kuali.ole.gl.businessobject.PosterOutputSummaryBalanceTypeFiscalYearTotal;
import org.kuali.ole.gl.businessobject.PosterOutputSummaryBalanceTypeTotal;
import org.kuali.ole.gl.businessobject.PosterOutputSummaryEntry;
import org.kuali.ole.gl.businessobject.PosterOutputSummaryTotal;
...
public class PosterOutputSummaryReport {
    ...
    public void writeReport(ReportWriterService reportWriterService) {
        ...
        if (entries.size() > 0) {
            ...
            final String titleMessage = configurationService.getPropertyValueAsString(OLEKeyConstants.MESSAGE_REPORT_POSTER_OUTPUT_SUMMARY_TITLE_LINE);
