...
import org.kuali.ole.fp.businessobject.PaymentReasonCode;
...
public class DisbursementVoucherPaymentReasonServiceImpl implements DisbursementVoucherPaymentReasonService {
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPaymentReasonService#isPayeeQualifiedForPayment(org.kuali.ole.fp.businessobject.DisbursementPayee,
     *      java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPaymentReasonService#isMovingPaymentReason(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPaymentReasonService#isPrepaidTravelPaymentReason(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPaymentReasonService#isNonEmployeeTravelPaymentReason(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPaymentReasonService#isResearchPaymentReason(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPaymentReasonService#isRevolvingFundPaymentReason(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPaymentReasonService#isDecedentCompensationPaymentReason(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPaymentReasonService#isPaymentReasonOfType(java.lang.String,
     *      java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPaymentReasonService#getReserchNonVendorPayLimit()
     */
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPaymentReasonService#getPayeeTypesByPaymentReason(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPaymentReasonService#getVendorOwnershipTypesByPaymentReason(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPaymentReasonService#getPaymentReasonByPrimaryId(java.lang.String)
     */
    public PaymentReasonCode getPaymentReasonByPrimaryId(String paymentReasonCode) {
        Map<String, Object> primaryKeys = new HashMap<String, Object>();
        primaryKeys.put(OLEPropertyConstants.CODE, paymentReasonCode);

        return (PaymentReasonCode) businessObjectService.findByPrimaryKey(PaymentReasonCode.class, primaryKeys);
    }
    
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPaymentReasonService#isTaxReviewRequired(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPaymentReasonService#postPaymentReasonCodeUsage(java.lang.String,
    ...
    public void postPaymentReasonCodeUsage(String paymentReasonCode, MessageList messageList) {
        ...
        if (payeeTypeCodes.size() > 1) {
            String messageKey = OLEKeyConstants.WARNING_DV_PAYMENT_REASON_VALID_FOR_MULTIPLE_PAYEE_TYPES;
            messageList.add(messageKey, descriptivePaymentReason, descriptivePayeeTypes);
        }
        else if (payeeTypeCodes.size() == 1) {
            String messageKey = OLEKeyConstants.WARNING_DV_PAYMENT_REASON_VALID_FOR_SINGEL_PAYEE_TYPE;
            messageList.add(messageKey, descriptivePaymentReason, descriptivePayeeTypes);
        }
      //Commented for the jira issue OLE-3415
        /*if (this.isResearchPaymentReason(paymentReasonCode)) {
            String payLimit = this.getReserchNonVendorPayLimit();
            String messageKey = OLEKeyConstants.WARNING_DV_REASERCH_PAYMENT_REASON;
        ...
        if (this.isMovingPaymentReason(paymentReasonCode)) {
            ...
            String messageKey = OLEKeyConstants.WARNING_DV_MOVING_PAYMENT_REASON;
            messageList.add(messageKey, ownerShipTypeAsString);
        }

        if (this.isPrepaidTravelPaymentReason(paymentReasonCode)) {
            String messageKey = OLEKeyConstants.WARNING_DV_PREPAID_TRAVEL_PAYMENT_REASON;
            messageList.add(messageKey, descriptivePaymentReason, descriptivePayeeTypes);
        }*/
    }
    ...
    protected String convertListToString(List<String> list) {
        ...
        for (int index = 0; index < list.size(); index++) {
            ...
            if (index == 0) {
                ...
                listAsString.append(OLEConstants.COMMA).append(oneSpace).append(emlement);
            }
            else if (index == list.size() - 1) {
                listAsString.append(oneSpace).append(OLEConstants.AND).append(oneSpace).append(emlement);
            }
        }
