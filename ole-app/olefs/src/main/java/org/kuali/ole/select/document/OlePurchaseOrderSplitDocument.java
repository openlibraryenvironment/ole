...
public class OlePurchaseOrderSplitDocument extends PurchaseOrderSplitDocument {
    ...
    private static org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(OlePurchaseOrderSplitDocument.class);
    ...
    public void populatePurchaseOrderFromRequisition(RequisitionDocument requisitionDocument) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("Inside populatePurchaseOrderFromRequisition of OlePurchaseOrderSplitDocument");
        }
    ...
    public void prepareForSave(KualiDocumentEvent event) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("Inside prepareForSave of OlePurchaseOrderSplitDocument");
        }
    ...
    public void processAfterRetrieve() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("Inside processAfterRetrieve of OlePurchaseOrderSplitDocument");
        }
    ...
    public List getItemsActiveOnly() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("Inside getItemsActiveOnly of OlePurchaseOrderSplitDocument");
        }
    ...
    public List getItemsActiveOnlySetupAlternateAmount() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("Inside getItemsActiveOnlySetupAlternateAmount of OlePurchaseOrderSplitDocument");
        }
    ...
    public boolean getAdditionalChargesExist() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("Inside getAdditionalChargesExist of OlePurchaseOrderSplitDocument");
        }
    ...
    public boolean getIsFinalReqs() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("Inside getIsFinalReqs of OlePurchaseOrderSplitDocument");
        }
    ...
    public boolean getIsSplitPO() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("Inside getIsSplitPO of OlePurchaseOrderSplitDocument");
        }
    ...
    public boolean getIsReOpenPO() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("Inside getIsReOpenPO of OlePurchaseOrderSplitDocument");
        }
    ...
    public String getBibeditorCreateURL() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("Inside getBibeditorCreateURL of OlePurchaseOrderSplitDocument");
        }
    ...
    public String getBibSearchURL() {
        LOG.debug("Inside getBibSearchURL of OlePurchaseOrderSplitDocument");
    ...
    public String getBibeditorEditURL() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("Inside getBibeditorEditURL of OlePurchaseOrderSplitDocument");
        }
    ...
    public String getMarcXMLFileDirLocation() throws Exception {
        if (LOG.isDebugEnabled()) {
            LOG.debug("Inside getMarcXMLFileDirLocation of OlePurchaseOrderSplitDocument");
        }
