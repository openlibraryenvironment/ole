...
public class ObjectCodeFiscalYearMakerImpl extends FiscalYearMakerImpl {
    ...
    /**
     * @see org.kuali.ole.coa.batch.dataaccess.impl.FiscalYearMakerHelperImpl#createSelectionCriteria(java.lang.Integer)
     */
    @Override
    public Criteria createSelectionCriteria(Integer baseFiscalYear) {
        ...
        criteriaBdg.addEqualTo(OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR, baseFiscalYear);
        // REMOVE: THIS IS REALLY, REALLY BAD!  We should not be hard-coding object code values ANYWHERE!
        criteriaBdg.addEqualTo(OLEPropertyConstants.FINANCIAL_OBJECT_CODE, OLEConstants.BudgetConstructionConstants.OBJECT_CODE_2PLG);
