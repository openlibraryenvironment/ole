...
public class DataDictionaryRemoteFieldBuilder {
    ...
    public RemotableAttributeField buildRemotableFieldFromAttributeDefinition(String componentClassName, String attributeName) {
        ...
        WorkflowAttributePropertyResolutionService propertyResolutionService = (WorkflowAttributePropertyResolutionService)SpringContext.getBean("workflowAttributesPropertyResolutionService");
