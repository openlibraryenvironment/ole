 ...
 */
package org.kuali.ole.fp.identity;
 ...
 * users which belong to OLE-SYS User but NOT OLE-FP Cash Manager.
 */
public class CashReceiptInitiatorDerivedRoleTypeServiceImpl extends DerivedRoleTypeServiceBase {
    ...
    protected static final String SYS_USER_ROLE_NAMESPACE = "OLE-SYS";
    protected static final String SYS_USER_ROLE_NAME = "User";
    protected static final String CASH_MANAGER_ROLE_NAMESPACE = "OLE-FP";
    protected static final String CASH_MANAGER_ROLE_NAME = "Cash Manager";

    /**
     * Overridden to check principal id is in OLE-SYS User and not in OLE-FP Cash Manager
    ...
    /**
     * Determines if the given principal with the given qualification is a member of OLE-SYS User
     ...
     * @return true if the said shmoe is indeed a member of OLE-SYS User; false otherwise
     */
    ...
    /**
     * Determines if the given principal with the given qualification is a member of OLE-FP Cash Manager
     ...
     * @return true if principal is a member of OLE-FP Cash Manager, false otherwise
     */
