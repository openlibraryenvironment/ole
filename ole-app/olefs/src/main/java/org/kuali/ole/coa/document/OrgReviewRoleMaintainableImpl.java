...
//    }
    ...
    public List getSections(MaintenanceDocument document, Maintainable oldMaintainable) {
        ...
        boolean isFSTransDoc = StringUtils.equals( orr.getFinancialSystemDocumentTypeCode(), OLEConstants.COAConstants.FINANCIAL_SYSTEM_TRANSACTIONAL_DOCUMENT)
                || StringUtils.equals( OLEConstants.COAConstants.FINANCIAL_SYSTEM_TRANSACTIONAL_DOCUMENT, closestOrgReviewRoleParentDocumentTypeName);
        ...
        boolean shouldReviewTypesFieldBeReadOnly = isFSTransDoc
                ...
                || (StringUtils.isNotBlank(closestOrgReviewRoleParentDocumentTypeName)
                        && StringUtils.equals(closestOrgReviewRoleParentDocumentTypeName, OLEConstants.COAConstants.FINANCIAL_SYSTEM_COMPLEX_MAINTENANCE_DOCUMENT));
    ...
    public void refresh(String refreshCaller, Map fieldValues, MaintenanceDocument document) {
        ...
        if(StringUtils.isNotBlank(docTypeName) &&
           !getOrgReviewRoleService().isValidDocumentTypeForOrgReview(docTypeName) ){
            ...
            GlobalVariables.getMessageMap().putErrorWithoutFullErrorPath(OLEConstants.MAINTENANCE_NEW_MAINTAINABLE + OrgReviewRole.DOC_TYPE_NAME_FIELD_NAME, OLEKeyConstants.ERROR_DOCUMENT_ORGREVIEW_INVALID_DOCUMENT_TYPE, docTypeName);
