...
public class OrderImportFieldValuesUtil {
    ...
    public Map<String, String> getMaintenanceDataByField(String fieldName) {
        ...
        } else if (fieldName.equalsIgnoreCase("Contract Manager")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Order Type")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Funding Source")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Delivery Campus Code")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Building Code")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Building Room Number")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Vendor Choice")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Cost Source")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Default Location")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Vendor Number")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Vendor Alias Name")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Acquisition Unit's Vendor account / Vendor Info Customer #")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Requestor Name")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Item Status")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Account Number")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Object Code")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Request Source")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Assign To User")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Method Of PO Transmission")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Recurring Payment Type")) {
        ...
        } else if (fieldName.equalsIgnoreCase("Fund Code")) {
