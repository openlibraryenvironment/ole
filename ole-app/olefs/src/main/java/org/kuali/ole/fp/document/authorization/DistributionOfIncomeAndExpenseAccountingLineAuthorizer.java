...
public class DistributionOfIncomeAndExpenseAccountingLineAuthorizer extends FinancialProcessingAccountingLineAuthorizer {
     ...
     * 
     * @see org.kuali.ole.sys.document.authorization.AccountingLineAuthorizerBase#determineFieldModifyability(org.kuali.ole.sys.document.AccountingDocument,
     *      org.kuali.ole.sys.businessobject.AccountingLine, org.kuali.ole.sys.document.web.AccountingLineViewField, java.util.Map)
     */
    @Override
     ...
     * @see org.kuali.ole.sys.document.authorization.AccountingLineAuthorizerBase#determineEditPermissionOnLine(org.kuali.ole.sys.document.AccountingDocument, org.kuali.ole.sys.businessobject.AccountingLine, java.lang.String)
     */
    @Override
    ...
    protected boolean hasElectronicPaymentClaims(AccountingDocument accountingDocument) {
        ...
        if (epcs == null) {
            diDoc.refreshReferenceObject(OLEPropertyConstants.ELECTRONIC_PAYMENT_CLAIMS);
