...
public class PersistingTagRenderer extends StringRenderer {
    ...
    /**
     * @see org.kuali.ole.sys.document.web.renderers.StringRenderer#clear()
     */
    @Override
    public void clear() {
        super.clear();
    ...
    /**
     * @see org.kuali.ole.sys.document.web.renderers.StringRenderer#render(javax.servlet.jsp.PageContext, javax.servlet.jsp.tagext.Tag)
     */
    @Override
