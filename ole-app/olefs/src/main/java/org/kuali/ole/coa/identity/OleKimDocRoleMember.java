...
public class OleKimDocRoleMember extends PersistableBusinessObjectBase implements RoleMemberContract {
    ...
    protected List<OleKimRoleResponsibilityAction> roleRspActions = new ArrayList<OleKimRoleResponsibilityAction>();

    public OleKimDocRoleMember() {}

    public OleKimDocRoleMember( RoleMemberContract b ) {
        id = b.getId();
        roleId = b.getRoleId();
        ...
        if (!CollectionUtils.isEmpty(b.getRoleRspActions())) {
            for (RoleResponsibilityActionContract rra : b.getRoleRspActions()) {
                roleRspActions.add( new OleKimRoleResponsibilityAction(rra) );
            }
        }
    ...
    public OleKimDocRoleMember( String roleId, MemberType type) {
        this();
        this.roleId = roleId;
        this.type = type;
    }

    public OleKimDocRoleMember(String roleId, MemberType type, String memberId) {
        this( roleId, type );
    ...
    @Override
    public List<OleKimRoleResponsibilityAction> getRoleRspActions() {
        return roleRspActions;
    }
    public void setRoleRspActions(List<OleKimRoleResponsibilityAction> roleRspActions) {
