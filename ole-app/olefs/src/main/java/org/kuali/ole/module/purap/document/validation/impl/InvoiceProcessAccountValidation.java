...
public class InvoiceProcessAccountValidation extends GenericValidation {
    ...
    private InvoiceAccountTotalValidation accountTotalValidation;
    ...
    public InvoiceAccountTotalValidation getAccountTotalValidation() {
        return accountTotalValidation;
    }

    public void setAccountTotalValidation(InvoiceAccountTotalValidation accountTotalValidation) {
