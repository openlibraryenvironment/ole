...
public interface FinancialSystemUserService {
     ...
     * If the specified person does not have the OLE-SYS User role for the specified namespace but does with a blank namespace, this will return the organization associated with that assignment.
     * If the person does not have the OLE-SYS User role at all, this method will derive the organization from the Person Record.
     */
