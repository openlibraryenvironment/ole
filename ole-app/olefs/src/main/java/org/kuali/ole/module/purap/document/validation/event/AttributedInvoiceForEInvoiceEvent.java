...
public final class AttributedInvoiceForEInvoiceEvent extends AttributedDocumentEventBase {

    public AttributedInvoiceForEInvoiceEvent(Document document) {
        this(OLEConstants.EMPTY_STRING, document);
    }

    public AttributedInvoiceForEInvoiceEvent(String errorPathPrefix, Document document) {
