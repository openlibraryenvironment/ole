...
import org.kuali.ole.sys.batch.FiscalYearMakerStep;
import org.kuali.ole.sys.batch.dataaccess.FiscalYearMaker;
import org.kuali.ole.sys.batch.dataaccess.FiscalYearMakersDao;
import org.kuali.ole.sys.batch.service.FiscalYearMakerService;
...
/**
 * @see org.kuali.ole.coa.batch.service.FiscalYearMakerService
 */
@Transactional
public class FiscalYearMakerServiceImpl implements FiscalYearMakerService {
    ...
    /**
     * @see org.kuali.ole.coa.batch.service.FiscalYearMakerService#runProcess()
     */
    public void runProcess() {
        String parmBaseYear = parameterService.getParameterValueAsString(FiscalYearMakerStep.class, OLEConstants.ChartApcParms.FISCAL_YEAR_MAKER_SOURCE_FISCAL_YEAR);
        if (StringUtils.isBlank(parmBaseYear)) {
            throw new RuntimeException("Required fiscal year parameter " + OLEConstants.ChartApcParms.FISCAL_YEAR_MAKER_SOURCE_FISCAL_YEAR + " has not been set.");
        }

        Integer baseYear = Integer.parseInt(parmBaseYear);
        boolean replaceMode = parameterService.getParameterValueAsBoolean(FiscalYearMakerStep.class, OLEConstants.ChartApcParms.FISCAL_YEAR_MAKER_REPLACE_MODE);
