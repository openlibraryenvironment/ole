 ...
 */
public class PatronExpiredRuleFormulator extends  RuleFormulatorUtil implements RuleFormulator {
    @Override
    ...
    protected String getTemplateFileName() {
        return "general-checks/patron-expiration-date.txt";
    }
    ...
    public boolean isInterested(String value) {
        return value.equals(DroolsConstants.GENERAL_CHECK_RULE_TYPE.IS_PATRON_EXPIRED);
    }
