...
public class PosterOutputSummaryBalanceTypeFiscalYearTotal extends PosterOutputSummaryBalanceTypeTotal {
    ...
    /**
     * @see org.kuali.ole.gl.businessobject.PosterOutputSummaryBalanceTypeTotal#getSummaryMessageName()
     */
    
    protected String getSummaryMessageName() {
        return OLEKeyConstants.MESSAGE_REPORT_POSTER_OUTPUT_SUMMARY_BALANCE_TYPE_FISCAL_YEAR_TOTAL;
    }

    /**
     * @see org.kuali.ole.gl.businessobject.PosterOutputSummaryBalanceTypeTotal#getSummaryMessageParameters()
     */
    @Override
