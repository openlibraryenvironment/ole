 ...
 */
public class PatronActivationDateRuleFormulator extends RuleFormulatorUtil implements RuleFormulator {
    @Override
    ...
    protected String getTemplateFileName() {
        return "general-checks/patron-activation-date.txt";
    }
    ...
    public boolean isInterested(String value) {
        return value.equals(DroolsConstants.GENERAL_CHECK_RULE_TYPE.ACTIVATION_DATE);
    }
