...
public class NonCheckDisbursementBankValidation extends GenericValidation {
    ...
    public boolean validate(AttributedDocumentEvent event) {
        ...
        boolean isValid = BankCodeValidation.validate(nonCheckDisbursement, nonCheckDisbursement.getFinancialDocumentBankCode(), OLEPropertyConstants.FINANCIAL_DOCUMENT_BANK_CODE, false, true);
