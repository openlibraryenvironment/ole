 ...
 * <code>{@link org.kuali.ole.module.ld.document.SalaryExpenseTransferDocument}</code> which creates source lines from a labor
 ...
 *
 * @see org.kuali.ole.module.ld.document.SalaryExpenseTransferDocument
 * @see org.kuali.ole.module.ld.document.web.struts.SalaryExpenseTransferAction;
 * @see org.kuali.ole.module.ld.document.web.struts.SalaryExpenseTransferForm;
 */
public class BalanceInquiryLookupAction extends KualiMultipleValueLookupAction {
    ...
    public ActionForward search(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (lookupable.isSearchUsingOnlyPrimaryKeyValues()) {
            ...
            lookupForm.setPrimaryKeyFieldLabels(OLEConstants.EMPTY_STRING);
        }
    ...
    public ActionForward prepareToReturnNone(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        parameters.put(OLEConstants.DOC_FORM_KEY, multipleValueLookupForm.getFormKey());
        parameters.put(OLEConstants.DISPATCH_REQUEST_PARAMETER, OLEConstants.RETURN_METHOD_TO_CALL);
        parameters.put(OLEConstants.REFRESH_CALLER, OLEConstants.MULTIPLE_VALUE);
        parameters.put(OLEConstants.ANCHOR, multipleValueLookupForm.getLookupAnchor());
    ...
    public ActionForward prepareToReturnSelectedResults(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        // build the parameters for the refresh url
        Properties parameters = new Properties();
        parameters.put(OLEConstants.LOOKUP_RESULTS_BO_CLASS_NAME, multipleValueLookupForm.getBusinessObjectClassName());
        parameters.put(OLEConstants.LOOKUP_RESULTS_SEQUENCE_NUMBER, multipleValueLookupForm.getLookupResultsSequenceNumber());
        parameters.put(OLEConstants.DOC_FORM_KEY, multipleValueLookupForm.getFormKey());
        parameters.put(OLEConstants.DISPATCH_REQUEST_PARAMETER, OLEConstants.RETURN_METHOD_TO_CALL);
        parameters.put(OLEConstants.REFRESH_CALLER, OLEConstants.MULTIPLE_VALUE);
        parameters.put(OLEConstants.ANCHOR, multipleValueLookupForm.getLookupAnchor());
    ...
    private Map<String, String> getSelectedObjectIds(MultipleValueLookupForm multipleValueLookupForm, List<ResultRow> resultTable) {
        ...
        // try {
        // segmentedBusinessObject = (SegmentedBusinessObject)
        // Class.forName(multipleValueLookupForm.getBusinessObjectClassName()).newInstance();
        // }
        // catch (Exception e) {
