...
public class OriginEntryServiceImpl implements OriginEntryService {
     ...
     * @see org.kuali.ole.gl.service.OriginEntryService#getSummaryByGroupId(Collection)
     */
    ...
    public static LedgerEntryForReporting buildLedgerEntry(Object[] entrySummary) {
        ...
        else if (OLEConstants.GL_DEBIT_CODE.equals(debitCreditCode)) {
     ...
     * @see org.kuali.ole.gl.service.OriginEntryService#flatFile(java.util.Iterator, java.io.BufferedOutputStream)
     */
     ...
     * @see org.kuali.ole.gl.service.OriginEntryService#getPosterOutputSummaryByGroupId(java.util.Collection)
     */
