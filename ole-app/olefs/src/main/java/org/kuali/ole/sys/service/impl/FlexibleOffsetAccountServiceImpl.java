...
public class FlexibleOffsetAccountServiceImpl implements FlexibleOffsetAccountService {
    ...
    public boolean getEnabled() {
        ...
        return parameterService.getParameterValueAsBoolean(OffsetDefinition.class, OLEConstants.SystemGroupParameterNames.FLEXIBLE_OFFSET_ENABLED_FLAG);
    }
     ...
     * 
     * @see org.kuali.ole.sys.service.FlexibleOffsetAccountService#updateOffset(org.kuali.ole.gl.businessobject.OriginEntryFull)
     */
    public boolean updateOffset(FlexibleAccountUpdateable transaction) {
        ...
        transaction.setSubAccountNumber(OLEConstants.getDashSubAccountNumber());
        transaction.setFinancialSubObjectCode(OLEConstants.getDashFinancialSubObjectCode());
        return true;
    }
