...
public interface DisbursementVoucherConstants {
    ...
    public static final String DV_PAYEE_TYPE_EMPLOYEE_DESC = "Employee";
    ...
    public enum TabByReasonCode{
        NON_EMPLOYEE_TRAVEL_TAB(NONEMPLOYEE_TRAVEL_PAY_REASONS_PARM_NM, TabKey.NON_EMPLOYEE_TRAVEL_EXPENSE, OLEPropertyConstants.DV_NON_EMPLOYEE_TRAVEL, 
                OLEPropertyConstants.DISB_VCHR_NON_EMP_TRAVELER_NAME,OLEKeyConstants.WARNING_DV_NON_EMPLOYEE_TRAVEL_TAB),
        PREPAID_TRAVEL_TAB(PREPAID_TRAVEL_PAYMENT_REASONS_PARM_NM, TabKey.PRE_PAID_TRAVEL_EXPENSES, OLEPropertyConstants.DV_PRE_CONFERENCE_DETAIL, 
                OLEPropertyConstants.DV_CONFERENCE_DESTINATION_NAME,OLEKeyConstants.WARNING_DV_PREPAID_TRAVEL_TAB);
        ...
        public String getDocumentPropertyKey() {
            return OLEPropertyConstants.DOCUMENT + PropertyUtils.NESTED_DELIM + this.propertyName + PropertyUtils.NESTED_DELIM + this.reprentingFieldName;
        }
    }
    ...
    public static final String DOCUMENT_TYPE_CHECKACH = "OLE_DVCA";
    public static final String DOCUMENT_TYPE_WTFD = "OLE_DVWF";
