...
import org.kuali.ole.pdp.businessobject.lookup.PaymentDetailLookupableHelperService;
import org.kuali.ole.pdp.service.PaymentMaintenanceService;
import org.kuali.ole.pdp.util.PdpPaymentDetailQuestionCallback;
...
public class PaymentDetailAction extends KualiAction {
    ...
    private ActionForward askQuestionWithInput(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response, String confirmationQuestion, String confirmationText, String successMessage, String caller, PdpPaymentDetailQuestionCallback callback) throws Exception {
        ...
        String noteText = OLEConstants.EMPTY_STRING;
        Person person = GlobalVariables.getUserSession().getPerson();
        boolean actionStatus;
        String message = OLEConstants.EMPTY_STRING;
            ...
            if ((confirmationQuestion.equals(question)) && ConfirmationQuestion.NO.equals(buttonClicked)) {
                ...
                if (StringUtils.isBlank(reason)) {
                    ...
                    if (reason == null) {
                        ...
                        reason = OLEConstants.EMPTY_STRING;
                    }
                    return this.performQuestionWithInputAgainBecauseOfErrors(mapping, form, request, response, confirmationQuestion, confirmationText, KRADConstants.CONFIRMATION_QUESTION, OLEConstants.MAPPING_BASIC, paymentDetailId, reason, PdpKeyConstants.BatchConstants.ErrorMessages.ERROR_NOTE_EMPTY, KRADConstants.QUESTION_REASON_ATTRIBUTE_NAME, "");
                }
    ...
    private String buildUrl(String paymentDetailId, boolean success, String message, String errorList) {
        ...
        if (lookupUrl != null) {
            ...
            if (message != null && !message.equalsIgnoreCase(OLEConstants.EMPTY_STRING)) {
            ...
            lookupUrl = UrlFactory.parameterizeUrl(basePath + "/" + OLEConstants.LOOKUP_ACTION, parameters);
        }
        return lookupUrl;
    }
