...
import org.kuali.ole.module.purap.dataaccess.PurApAccountingDao;
...
public class PurapAccountingServiceImpl implements PurapAccountingService {
    ...
    private OlePaymentRequestDocument olePaymentRequestDocument;
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#generateAccountDistributionForProrationWithZeroTotal(java.util.List,
     *      java.lang.Integer)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#generateSummary(java.util.List)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#generateSummaryAccounts(org.kuali.ole.module.purap.document.PurchasingAccountsPayableDocument)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#generateSummaryAccountsWithNoZeroTotals(org.kuali.ole.module.purap.document.PurchasingAccountsPayableDocument)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#generateSummaryWithNoZeroTotals(java.util.List)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#generateSummaryWithNoZeroTotalsUsingAlternateAmount(java.util.List)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#generateSummaryExcludeItemTypes(java.util.List, java.util.Set)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#generateSummaryIncludeItemTypesAndNoZeroTotals(java.util.List,
     *      java.util.Set)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#generateSummaryIncludeItemTypes(java.util.List, java.util.Set)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#generateSummaryExcludeItemTypesAndNoZeroTotals(java.util.List,
     *      java.util.Set)
     */
    @Override
            ...
            if(currentItem instanceof OleInvoiceItem) {
                ...
                if(invoiceItem.getItemForeignListPrice() != null ) {
                    if(invoiceItem.getItemForeignDiscount() != null) {
                        ...
                        totalForeignAmount = new KualiDecimal(totalForeignAmount.add(invoiceItem.getItemForeignListPrice().bigDecimalValue().subtract(discountAmount))).bigDecimalValue();
                    }
                    else {
                        totalForeignAmount = new KualiDecimal(totalForeignAmount.add(invoiceItem.getItemForeignListPrice().bigDecimalValue())).bigDecimalValue();
                    }
                    ...
                    if (invoiceItem.getItemForeignDiscount() != null) {
                        ...
                        totalForeignAmount = new KualiDecimal(totalForeignAmount.add(invoiceItem.getItemForeignUnitCost().bigDecimalValue().subtract(discountAmount))).bigDecimalValue();
                    }
                    else {
                        totalForeignAmount = new KualiDecimal(totalForeignAmount.add(invoiceItem.getItemForeignUnitCost().bigDecimalValue())).bigDecimalValue();
                    }
                }
            }
     ...
     * @param itemTypeCodes            - list of {@link org.kuali.ole.module.purap.businessobject.ItemType} codes used in conjunction with
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#updateAccountAmounts(org.kuali.ole.module.purap.document.PurchasingAccountsPayableDocument)
     */
    @Override
    public void updateAccountAmounts(PurchasingAccountsPayableDocument document) {
        ...
        // olePaymentRequestDocument = (OlePaymentRequestDocument)document;
        ...
        if ((document instanceof OleInvoiceDocument) && purapService.isFullDocumentEntryCompleted(document)) {
            // update the percent but don't update the amounts if preq and past full entry
            convertMoneyToPercent((OleInvoiceDocument) document);
            return;
        }
        document.fixItemReferences();

        // OLE-3405 : disabling KFS Proportional/sequential distribution methods
        //if distribution method is sequential and document is PREQ or VCM then...
//          if (((document instanceof PaymentRequestDocument)
//                  || (document instanceof VendorCreditMemoDocument))
//                  && PurapConstants.AccountDistributionMethodCodes.SEQUENTIAL_CODE.equalsIgnoreCase(accountDistributionMethod)) {
...
//                      updatePreqProportionalItemAccountAmounts(item);
            ...
            if (item instanceof OlePaymentRequestItem) {
                updateItemAccountAmountsForAdditionalCharge(item, (OlePaymentRequestDocument) document);
            } else if (item instanceof OleCreditMemoItem) {
                updateItemAccountAmountsForAdditionalCharge(item, (OleVendorCreditMemoDocument) document);
            } else if (item instanceof OleInvoiceItem) {
                updateItemAccountAmountsForAdditionalCharge(item, (OleInvoiceDocument) document);
            } else {
                updateItemAccountAmounts(item);
//                          updatePreqProportionalItemAccountAmounts(item);
            }
...
//          }
    ...
    public void updateItemAccountAmountsForAdditionalCharge(PurApItem item, OlePaymentRequestDocument document) {
        List<PurApAccountingLine> sourceAccountingLines = item.getSourceAccountingLines();
        OlePaymentRequestItem olePaymentRequestItem = (OlePaymentRequestItem) item;
        KualiDecimal prorateSurcharge = new KualiDecimal();
        KualiDecimal qty = KualiDecimal.ZERO;
        if (olePaymentRequestItem.getItemSurcharge() == null) {
            prorateSurcharge = KualiDecimal.ZERO;
        } else {
            qty = olePaymentRequestItem.getItemQuantity();
            prorateSurcharge = new KualiDecimal(olePaymentRequestItem.getItemSurcharge());
        }
        KualiDecimal totalAmount = item.getTotalAmount();
        totalAmount = totalAmount.subtract(prorateSurcharge.multiply(qty));
    ...
    public void updateItemAccountAmountsForAdditionalCharge(PurApItem item, OleInvoiceDocument document) {
        ...
        KualiDecimal prorateSurcharge = new KualiDecimal();
        KualiDecimal qty = KualiDecimal.ZERO;
        if (oleInvoiceItem.getItemSurcharge() == null) {
            prorateSurcharge = KualiDecimal.ZERO;
        } else {
            qty = oleInvoiceItem.getItemQuantity();
            prorateSurcharge = new KualiDecimal(oleInvoiceItem.getItemSurcharge());
        }
        KualiDecimal totalAmount = item.getTotalAmount();
        totalAmount = totalAmount.subtract(prorateSurcharge.multiply(qty));
        updateAccountAmountsWithTotal(sourceAccountingLines, totalAmount);
    ...
    private void updateItemAccountAmountsForAdditionalCharge(PurApItem item, OleVendorCreditMemoDocument document) {

        List<PurApAccountingLine> sourceAccountingLines = item.getSourceAccountingLines();
        OleCreditMemoItem oleCreditMemoItem = (OleCreditMemoItem) item;
        KualiDecimal prorateSurcharge = new KualiDecimal();
        KualiDecimal qty = KualiDecimal.ZERO;
        if (oleCreditMemoItem.getItemSurcharge() == null) {
            prorateSurcharge = KualiDecimal.ZERO;
        } else {
            qty = oleCreditMemoItem.getItemQuantity();
            prorateSurcharge = new KualiDecimal(oleCreditMemoItem.getItemSurcharge());
        }
        KualiDecimal totalAmount = item.getTotalAmount();
        totalAmount = totalAmount.subtract(prorateSurcharge.multiply(qty));
        updateAccountAmountsWithTotal(sourceAccountingLines, totalAmount);
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#updateItemAccountAmounts(org.kuali.ole.module.purap.businessobject.PurApItem)
     */
    @Override
    public void updateItemAccountAmounts(PurApItem item) {
        ...
        if (item.getItemType().isAdditionalChargeIndicator()) {
            updateAccountAmountsWithTotalForAdditionalCharge(sourceAccountingLines, totalAmount);
        } else {
            updateAccountAmountsWithTotal(sourceAccountingLines, totalAmount);
        }
    }

    /*public void updateItemAccountAmountsForAdditionalCharge(PurApItem item) {
        List<PurApAccountingLine> sourceAccountingLines = item.getSourceAccountingLines();
        KualiDecimal totalAmount = item.getTotalAmount();
            updateAccountAmountsWithTotal(sourceAccountingLines, totalAmount);
    }*/
    ...
    public <T extends PurApAccountingLine> void updateAccountAmountsWithTotalForAdditionalCharge(List<T> sourceAccountingLines, KualiDecimal totalAmount) {
    ...
    public <T extends PurApAccountingLine> void updateAccountAmountsWithTotal2(List<T> sourceAccountingLines, KualiDecimal totalAmount) {
        if ((totalAmount != null) && KualiDecimal.ZERO.compareTo(totalAmount) != 0) {
                ...
                if (ObjectUtils.isNotNull(account.getAccountLinePercent()) || ObjectUtils.isNotNull(account.getAmount())) {
                    ...
                    if (ObjectUtils.isNotNull(account.getAccountLinePercent())) {
                        ...
                        if (noDiscount) {
                            ...
                            account.setAmount(new KualiDecimal(pct.multiply(new BigDecimal(discountAmount.toString()))
                                    .setScale(KualiDecimal.SCALE, KualiDecimal.ROUND_BEHAVIOR)));
                        }
                    }
                }
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#updatePreqProportionalItemAccountAmounts(org.kuali.ole.module.purap.businessobject.PurApItem)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#updatePreqItemAccountAmounts(org.kuali.ole.module.purap.businessobject.PurApItem)
     */
    @Override
            ...
            if (PurApItemUtils.checkItemActive(currentItem)) {
                for (PurApAccountingLine account : currentItem.getSourceAccountingLines()) {
                    ...
                    for (Object element : accounts) {
                        PurApAccountingLine alreadyAddedAccount = (PurApAccountingLine) element;
        ...
        for (Iterator<PaymentRequestItem> iter = pr.getItems().iterator(); iter.hasNext(); ) {
            ...
            if (item.getTotalAmount() != null && item.getTotalAmount().isNonZero()) {
               ...
               /* KualiDecimal prorateSurcharge = KualiDecimal.ZERO;
                ...
                if (ObjectUtils.isNotNull(lastAccount.getAccountLinePercent())) {
                    KualiDecimal differencePercent = (((new KualiDecimal(accountTotalPercent)).subtract(new KualiDecimal(100))).abs());
                    if((differencePercent.abs()).isLessEqual(new KualiDecimal(1).multiply((new KualiDecimal(item.getSourceAccountingLines().size()).divide(new KualiDecimal(2)))))) {
                        lastAccount.setAccountLinePercent(lastAccount.getAccountLinePercent().add(percentDifference));
                    }
                    else {
                        lastAccount.setAccountLinePercent(lastAccount.getAccountLinePercent());
            ...
            if (item.getTotalAmount() != null && item.getTotalAmount().isNonZero()) {
                ...
                if (item.getItemType().isQuantityBasedGeneralLedgerIndicator() && item.getExtendedPrice() != null && item.getExtendedPrice().compareTo(KualiDecimal.ZERO) != 0) {
                    if (((OleInvoiceItem) item).getItemSurcharge() != null) {
                        prorateSurcharge = new KualiDecimal(((OleInvoiceItem) item).getItemSurcharge()).multiply(item.getItemQuantity());
                    }
                }
                PurApAccountingLine lastAccount = null;
                BigDecimal accountTotalPercent = BigDecimal.ZERO;
                ...
                BigDecimal percentDifference = new BigDecimal(100).subtract(accountTotalPercent).setScale(BIG_DECIMAL_SCALE,BigDecimal.ROUND_CEILING);
                if (ObjectUtils.isNotNull(lastAccount) && ObjectUtils.isNotNull(lastAccount.getAccountLinePercent())) {
                    KualiDecimal differencePercent = (((new KualiDecimal(accountTotalPercent)).subtract(new KualiDecimal(100))).abs());
                    if((differencePercent.abs()).isLessEqual(new KualiDecimal(1).multiply((new KualiDecimal(item.getSourceAccountingLines().size()).divide(new KualiDecimal(2)))))) {
                        lastAccount.setAccountLinePercent(lastAccount.getAccountLinePercent().add(percentDifference));
                    }
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#deleteSummaryAccounts(java.lang.Integer, java.lang.String)
     */
    @Override
    public void deleteSummaryAccounts(Integer purapDocumentIdentifier, String docType) {
        if (PurapDocTypeCodes.PAYMENT_REQUEST_DOCUMENT.equals(docType)) {
            ...
            purApAccountingDao.deleteSummaryAccountsbyInvoiceIdentifier(purapDocumentIdentifier);
        }
    }
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#generateUseTaxAccount(org.kuali.ole.module.purap.document.PurchasingAccountsPayableDocument)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#isTaxAccount(org.kuali.ole.module.purap.document.PurchasingAccountsPayableDocument,
     *      org.kuali.ole.sys.businessobject.SourceAccountingLine)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#getSummaryAccountsbyPaymentRequestIdentifier(java.lang.Integer)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#getSummaryAccountsbyInvoiceIdentifier(java.lang.Integer)
     */
    @Override
    public List getSummaryAccountsbyInvoiceIdentifier(Integer invoiceIdentifier) {
        if (invoiceIdentifier != null) {
            Map fieldValues = new HashMap();
            fieldValues.put(PurapPropertyConstants.INVOICE_ID, invoiceIdentifier);
            return new ArrayList(businessObjectService.findMatching(OleInvoiceAccountsPayableSummaryAccount.class, fieldValues));
        }
        return null;
    }

    /**
     * @see org.kuali.ole.module.purap.service.PurapAccountingService#getSummaryAccountsbyCreditMemoIdentifier(java.lang.Integer)
     */
    @Override
