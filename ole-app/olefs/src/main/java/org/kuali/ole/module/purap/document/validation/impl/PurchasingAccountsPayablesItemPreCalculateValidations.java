...
public class PurchasingAccountsPayablesItemPreCalculateValidations extends GenericValidation {
    ...
    public boolean validate(AttributedDocumentEvent event) {
        ...
        // JHK : In this case, we are going to ensure that the amounts and percents add up
        // since that matches the OLE behavior where they both should be populated after a calculate.
