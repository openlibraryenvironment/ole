 ...
 */
package org.kuali.ole.vnd.service.impl;
...
public class TaxNumberServiceImpl implements TaxNumberService {
    ...
    public String formatToDefaultFormat(String taxNbr) throws FormatException {
        ...
        if (digits.length() < defaultTaxNumberDigits) {
            throw new FormatException("Tax number has fewer than " + defaultTaxNumberDigits + " digits.", OLEKeyConstants.ERROR_CUSTOM, taxNbr);
        }
        else if (digits.length() > defaultTaxNumberDigits) {
            throw new FormatException("Tax number has more than " + defaultTaxNumberDigits + " digits.", OLEKeyConstants.ERROR_CUSTOM, taxNbr);
        }
        else {
            return digits;
        }
