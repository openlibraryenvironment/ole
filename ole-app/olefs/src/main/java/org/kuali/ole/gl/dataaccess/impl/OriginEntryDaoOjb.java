...
import org.kuali.ole.gl.businessobject.OriginEntryGroup;
import org.kuali.ole.gl.businessobject.OriginEntryInformation;
import org.kuali.ole.gl.dataaccess.OriginEntryDao;
...
public class OriginEntryDaoOjb extends PlatformAwareDaoBaseOjb implements OriginEntryDao {
     ...
     * @see org.kuali.ole.gl.dataaccess.OriginEntryDao#getGroupTotal(java.lang.Integer, boolean)
     */
    @Override
    public KualiDecimal getGroupTotal(Integer groupId, boolean isCredit) {
        ...
        if (isCredit) {
            crit.addEqualTo(OriginEntryDaoOjb.TRANSACTION_DEBIT_CREDIT_CODE, OLEConstants.GL_CREDIT_CODE);
        }
        else {
            crit.addNotEqualTo(OriginEntryDaoOjb.TRANSACTION_DEBIT_CREDIT_CODE, OLEConstants.GL_CREDIT_CODE);
        }
     ...
     * @see org.kuali.ole.gl.dataaccess.OriginEntryDao#getGroupCount(java.lang.Integer)
     */
    @Override
     ...
     * @see org.kuali.ole.gl.dataaccess.OriginEntryDao#getGroupCounts()
     */
    @Override
     ...
     * @see org.kuali.ole.gl.dataaccess.OriginEntryDao#deleteEntry(org.kuali.ole.gl.businessobject.OriginEntryInformation)
     */
    @Override
     ...
     * @see org.kuali.ole.gl.dataaccess.OriginEntryDao#getDocumentsByGroup(org.kuali.ole.gl.businessobject.OriginEntryGroup)
     */
    @Override
    public Iterator getDocumentsByGroup(OriginEntryGroup oeg) {
        ...
        q.setAttributes(new String[] { OLEPropertyConstants.DOCUMENT_NUMBER, "financialDocumentTypeCode", "financialSystemOriginationCode" });
     ...
     * @see org.kuali.ole.gl.dataaccess.OriginEntryDao#getMatchingEntries(java.util.Map)
     */
    @Override
     ...
     * @see org.kuali.ole.gl.dataaccess.OriginEntryDao#getBadBalanceEntries(java.util.Collection)
     */
    @Override
     ...
     * @see org.kuali.ole.gl.dataaccess.OriginEntryDao#deleteGroups(java.util.Collection)
     */
    @Override
     ...
     * @param searchCriteria Map of field, value pairs
     * @return collection of entries
     * @see org.kuali.ole.gl.dataaccess.OriginEntryDao#getMatchingEntriesByCollection(java.util.Map)
     */
    @Override
     ...
     * @see org.kuali.ole.gl.dataaccess.OriginEntryDao#getSummaryByGroupId(java.util.List)
     */
    @Override
    public Iterator getSummaryByGroupId(Collection groupIdList) {
        ...
        Criteria criteria = new Criteria();
        criteria.addIn(OLEPropertyConstants.ENTRY_GROUP_ID, ids);
        ...
        String groupList[] = { OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR, OLEPropertyConstants.UNIVERSITY_FISCAL_PERIOD_CODE, OLEPropertyConstants.FINANCIAL_BALANCE_TYPE_CODE, OLEPropertyConstants.FINANCIAL_SYSTEM_ORIGINATION_CODE, OLEPropertyConstants.TRANSACTION_DEBIT_CREDIT_CODE };
     ...
     * @see org.kuali.ole.gl.dataaccess.OriginEntryDao#getExactMatchingEntry(java.lang.Integer)
     */
    @Override
     ...
     * @see org.kuali.ole.gl.dataaccess.OriginEntryDao#getPosterOutputSummaryByGroupId(java.util.Collection)
     */
    @Override
    public Iterator getPosterOutputSummaryByGroupId(Collection groups) {
        ...
        Criteria criteria = new Criteria();
        criteria.addIn(OLEPropertyConstants.ENTRY_GROUP_ID, ids);
        String fundGroupCode = OLEPropertyConstants.ACCOUNT + "." + OLEPropertyConstants.SUB_FUND_GROUP + "." + OLEPropertyConstants.FUND_GROUP_CODE;

        ReportQueryByCriteria query = QueryFactory.newReportQuery(entryClass, criteria);

        String attributeList[] = { OLEPropertyConstants.FINANCIAL_BALANCE_TYPE_CODE, OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR, OLEPropertyConstants.UNIVERSITY_FISCAL_PERIOD_CODE, fundGroupCode, OLEPropertyConstants.FINANCIAL_OBJECT_TYPE_CODE, OLEPropertyConstants.TRANSACTION_DEBIT_CREDIT_CODE, "sum(" + OLEPropertyConstants.TRANSACTION_LEDGER_ENTRY_AMOUNT + ")" };

        String groupList[] = { OLEPropertyConstants.FINANCIAL_BALANCE_TYPE_CODE, OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR, OLEPropertyConstants.UNIVERSITY_FISCAL_PERIOD_CODE, fundGroupCode, OLEPropertyConstants.FINANCIAL_OBJECT_TYPE_CODE, OLEPropertyConstants.TRANSACTION_DEBIT_CREDIT_CODE };
