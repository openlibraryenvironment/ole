...
import org.kuali.ole.sys.batch.service.LockModuleService;
...
public class LockModuleServiceImpl implements LockModuleService {
    ...
    public void lockModule(String namespaceCode , boolean lockModule) {
        Parameter parameter  = parameterService.getParameter(namespaceCode, OleParameterConstants.PARAMETER_ALL_DETAIL_TYPE, KRADConstants.SystemGroupParameterNames.OLTP_LOCKOUT_ACTIVE_IND);
