...
public class DisbursementVoucherAccountingLineAmountPositiveValidation extends AccountingLineAmountPositiveValidation {
    ...
    /**
     * @see org.kuali.ole.sys.document.validation.impl.AccountingLineAmountPositiveValidation#validate(org.kuali.ole.sys.document.validation.event.AttributedDocumentEvent)
     */
    @Override
