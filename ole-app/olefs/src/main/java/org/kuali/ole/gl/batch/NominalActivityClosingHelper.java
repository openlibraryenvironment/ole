...
public class NominalActivityClosingHelper {
    ...
    public NominalActivityClosingHelper(Integer fiscalYear, Date transactionDate, ParameterService parameterService, ConfigurationService configurationService) {
        ...
        varFundBalanceObjectCode = parameterService.getParameterValueAsString(OleParameterConstants.GENERAL_LEDGER_BATCH.class, GeneralLedgerConstants.ANNUAL_CLOSING_FUND_BALANCE_OBJECT_CODE_PARM);
        varFundBalanceObjectTypeCode = parameterService.getParameterValueAsString(OleParameterConstants.GENERAL_LEDGER_BATCH.class, GeneralLedgerConstants.ANNUAL_CLOSING_FUND_BALANCE_OBJECT_TYPE_PARM);
    ...
    public OriginEntryFull generateActivityEntry(Balance balance, Integer sequenceNumber) throws FatalErrorException {
        ...
        activityEntry.setFinancialSubObjectCode(OLEConstants.getDashFinancialSubObjectCode());
        ...
        activityEntry.setUniversityFiscalPeriodCode(OLEConstants.MONTH13);

        // 915 005960 MOVE 'ACLO'
        // 916 005970 TO FDOC-TYP-CD OF GLEN-RECORD.

        activityEntry.setFinancialDocumentTypeCode(parameterService.getParameterValueAsString(OleParameterConstants.GENERAL_LEDGER_BATCH.class, OLEConstants.SystemGroupParameterNames.GL_ANNUAL_CLOSING_DOC_TYPE));

        // 917 005980 MOVE 'MF'
        // 918 005990 TO FS-ORIGIN-CD OF GLEN-RECORD.

        activityEntry.setFinancialSystemOriginationCode(parameterService.getParameterValueAsString(OleParameterConstants.GENERAL_LEDGER_BATCH.class, OLEConstants.SystemGroupParameterNames.GL_ORIGINATION_CODE));
        ...
        if (ObjectHelper.isOneOf(balance.getObjectTypeCode(), expenseObjectCodeTypes)) {
            ...
            activityEntry.setTransactionLedgerEntryDescription(this.createTransactionLedgerEntryDescription(configurationService.getPropertyValueAsString(OLEKeyConstants.MSG_CLOSE_ENTRY_TO_NOMINAL_EXPENSE), balance));
            ...
            activityEntry.setTransactionLedgerEntryDescription(this.createTransactionLedgerEntryDescription(configurationService.getPropertyValueAsString(OLEKeyConstants.MSG_CLOSE_ENTRY_TO_NOMINAL_REVENUE), balance));
        ...
        if (null != balance.getObjectType()) {
            ...
            if (ObjectHelper.isOneOf(balance.getObjectType().getFinObjectTypeDebitcreditCd(), new String[] { OLEConstants.GL_CREDIT_CODE, OLEConstants.GL_DEBIT_CODE })) {
            ...
            if (balance.getAccountLineAnnualBalanceAmount().isNegative()) {
                ...
                if (ObjectHelper.isOneOf(balance.getObjectType().getFinObjectTypeDebitcreditCd(), new String[] { OLEConstants.GL_CREDIT_CODE, OLEConstants.GL_DEBIT_CODE })) {
                    ...
                    activityEntry.setTransactionDebitCreditCode(OLEConstants.GL_CREDIT_CODE);
                ...
                if (OLEConstants.GL_CREDIT_CODE.equals(balance.getObjectType().getFinObjectTypeDebitcreditCd())) {

                    // 991 006690 MOVE 'D' TO TRN-DEBIT-CRDT-CD OF GLEN-RECORD

                    activityEntry.setTransactionDebitCreditCode(OLEConstants.GL_DEBIT_CODE);
                    ...
                    if (OLEConstants.GL_DEBIT_CODE.equals(balance.getObjectType().getFinObjectTypeDebitcreditCd())) {
        ...
        activityEntry.setProjectCode(OLEConstants.getDashProjectCode());
    ...
    public OriginEntryFull generateOffset(Balance balance, Integer sequenceNumber) throws FatalErrorException {
        ...
        offsetEntry.setUniversityFiscalPeriodCode(OLEConstants.MONTH13);

        // 1088 007630 MOVE 'ACLO'
        // 1089 007640 TO FDOC-TYP-CD OF GLEN-RECORD.

        offsetEntry.setFinancialDocumentTypeCode(parameterService.getParameterValueAsString(OleParameterConstants.GENERAL_LEDGER_BATCH.class, OLEConstants.SystemGroupParameterNames.GL_ANNUAL_CLOSING_DOC_TYPE));

        // 1090 007650 MOVE 'MF'
        // 1091 007660 TO FS-ORIGIN-CD OF GLEN-RECORD.

        offsetEntry.setFinancialSystemOriginationCode(parameterService.getParameterValueAsString(OleParameterConstants.GENERAL_LEDGER_BATCH.class, OLEConstants.SystemGroupParameterNames.GL_ORIGINATION_CODE));
        ...
        offsetEntry.setTransactionLedgerEntryDescription(this.createTransactionLedgerEntryDescription(configurationService.getPropertyValueAsString(OLEKeyConstants.MSG_CLOSE_ENTRY_TO_FUND_BALANCE), balance));
        ...
        if (balance.getAccountLineAnnualBalanceAmount().isNegative()) {
            ...
            if (OLEConstants.GL_CREDIT_CODE.equals(debitCreditCode)) {
