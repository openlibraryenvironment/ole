 ...
 */
public class InvoiceAccountRevision extends InvoiceAccount {
     ...
     * Constructor.
     *
     * @param ia - invoice account
     */
    public InvoiceAccountRevision(InvoiceAccount ia, Integer postingYear, String postingPeriodCode) {
        // copy base attributes
        PurApObjectUtils.populateFromBaseWithSuper(ia, this, new HashMap<String, Class<?>>(), new HashSet<Class>());
