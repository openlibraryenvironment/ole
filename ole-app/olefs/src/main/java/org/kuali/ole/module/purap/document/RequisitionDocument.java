...
public class RequisitionDocument extends PurchasingDocumentBase implements Copyable {
    ...
    public void toCopy() throws WorkflowException, ValidationException {
        ...
        //for app doc status
        updateAndSaveAppDocStatus(PurapConstants.RequisitionStatuses.APPDOC_IN_PROCESS);
        /*this.setLicensingRequirementCode(PurapConstants.LicenseRequestStatus.NO_LICENSE_REQUIRED);*/
        /*this.setLicensingRequirementIndicator(false);*/
...
/*
  FIXME: Remove this code
    ...
    public String getUrl() {
        return SpringContext.getBean(ConfigurationService.class).getPropertyValueAsString(OLEConstants.WORKFLOW_URL_KEY) + "/DocHandler.do?docId=" + getDocumentNumber() + "&command=displayDocSearchView";
    }

    /**
     * This is a "do nothing" version of the method - it just won't create GLPEs
     *
     * @see org.kuali.ole.sys.document.AccountingDocumentBase#generateGeneralLedgerPendingEntries(org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntrySourceDetail, org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntrySequenceHelper)
     */
    @Override
    ...
    public void setupAccountDistributionMethod() {
        ...
        String defaultDistributionMethodCode = "P";//PurapConstants.AccountDistributionMethodCodes.PROPORTIONAL_CODE;
