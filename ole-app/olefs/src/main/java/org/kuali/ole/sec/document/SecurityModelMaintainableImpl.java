...
import org.kuali.ole.sec.businessobject.SecurityModel;
import org.kuali.ole.sec.businessobject.SecurityModelDefinition;
import org.kuali.ole.sec.businessobject.SecurityModelMember;
import org.kuali.ole.sec.businessobject.SecurityPrincipal;
...
public class SecurityModelMaintainableImpl extends AbstractSecurityModuleMaintainable {
    ...
    protected Role createOrUpdateModelRole(SecurityModel newSecurityModel) {
        ...
        Role modelRole = roleService.getRoleByNamespaceCodeAndName(OLEConstants.CoreModuleNamespaces.ACCESS_SECURITY, newSecurityModel.getName());
        ...
        // the appropriate value
            ...
            String roleId = OLEConstants.CoreModuleNamespaces.ACCESS_SECURITY+"-"+newSecurityModel.getId();
