...
public class Balance extends PersistableBusinessObjectBase {
    ...
    protected LinkedHashMap toStringMapper_RICE20_REFACTORME() {
        ...
        map.put(OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR, getUniversityFiscalYear());
        map.put(OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, getChartOfAccountsCode());
        map.put(OLEPropertyConstants.ACCOUNT_NUMBER, getAccountNumber());
        map.put(OLEPropertyConstants.SUB_ACCOUNT_NUMBER, getSubAccountNumber());
        map.put(OLEPropertyConstants.OBJECT_CODE, getObjectCode());
        map.put(OLEPropertyConstants.SUB_OBJECT_CODE, getSubObjectCode());
        map.put(OLEPropertyConstants.BALANCE_TYPE_CODE, getBalanceTypeCode());
        map.put(OLEPropertyConstants.OBJECT_TYPE_CODE, getObjectTypeCode());
        return map;
    }
    ...
    public KualiDecimal getAmount(String period) {
        if (OLEConstants.PERIOD_CODE_ANNUAL_BALANCE.equals(period)) {
            return getAccountLineAnnualBalanceAmount();
        }
        else if (OLEConstants.PERIOD_CODE_BEGINNING_BALANCE.equals(period)) {
            return getBeginningBalanceLineAmount();
        }
        else if (OLEConstants.PERIOD_CODE_CG_BEGINNING_BALANCE.equals(period)) {
            return getContractsGrantsBeginningBalanceAmount();
        }
        else if (OLEConstants.MONTH1.equals(period)) {
            return getMonth1Amount();
        }
        else if (OLEConstants.MONTH2.equals(period)) {
            return getMonth2Amount();
        }
        else if (OLEConstants.MONTH3.equals(period)) {
            return getMonth3Amount();
        }
        else if (OLEConstants.MONTH4.equals(period)) {
            return getMonth4Amount();
        }
        else if (OLEConstants.MONTH5.equals(period)) {
            return getMonth5Amount();
        }
        else if (OLEConstants.MONTH6.equals(period)) {
            return getMonth6Amount();
        }
        else if (OLEConstants.MONTH7.equals(period)) {
            return getMonth7Amount();
        }
        else if (OLEConstants.MONTH8.equals(period)) {
            return getMonth8Amount();
        }
        else if (OLEConstants.MONTH9.equals(period)) {
            return getMonth9Amount();
        }
        else if (OLEConstants.MONTH10.equals(period)) {
            return getMonth10Amount();
        }
        else if (OLEConstants.MONTH11.equals(period)) {
            return getMonth11Amount();
        }
        else if (OLEConstants.MONTH12.equals(period)) {
            return getMonth12Amount();
        }
        else if (OLEConstants.MONTH13.equals(period)) {
