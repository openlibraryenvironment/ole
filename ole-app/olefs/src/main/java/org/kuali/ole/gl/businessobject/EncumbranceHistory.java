...
public class EncumbranceHistory extends Encumbrance {
    ...
    public void addAmount(OriginEntryInformation originEntry) {
        ...
        if (OLEConstants.ENCUMB_UPDT_REFERENCE_DOCUMENT_CD.equals(originEntry.getTransactionEncumbranceUpdateCode()) 
            ...
            if (OLEConstants.GL_DEBIT_CODE.equals(originEntry.getTransactionDebitCreditCode())) {
            ...
            // encumbrance amount
            if (OLEConstants.GL_DEBIT_CODE.equals(originEntry.getTransactionDebitCreditCode()) || OLEConstants.GL_BUDGET_CODE.equals(originEntry.getTransactionDebitCreditCode())) {
     ...
     * @see org.kuali.ole.gl.businessobject.Balance#getTimestamp()
     */
    @Override
