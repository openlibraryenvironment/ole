...
public class PurApWorkflowIntegrationServiceImpl implements PurApWorkflowIntegrationService {
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurApWorkflowIntegrationService#takeAllActionsForGivenCriteria(org.kuali.rice.krad.document.Document,
    ...
    public boolean willDocumentStopAtGivenFutureRouteNode(PurchasingAccountsPayableDocument document, String givenNodeName) {
        ...
        try {
            ...
            String[] nodeNames = document.getDocumentHeader().getWorkflowDocument().getCurrentNodeNames().toArray(new String[0]);
