...
public class OLEPropertyConstants {
    ...
    // below field used by OLE specifically
    ...
    public static final String BUSINESS_OBJECT_PROPERTY_LABEL = "businessObjectProperty." + OLEPropertyConstants.PROPERTY_LABEL;
