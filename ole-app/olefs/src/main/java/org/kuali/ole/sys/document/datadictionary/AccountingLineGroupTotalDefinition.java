...
public class AccountingLineGroupTotalDefinition extends TotalDefinition{
     ...
     * @see org.kuali.ole.sys.document.datadictionary.TotalDefinition#getTotalRenderer()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.document.datadictionary.TotalDefinition#isNestedProperty()
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.web.NestedFieldTotaling#setContainingPropertyName(java.lang.String)
     */
