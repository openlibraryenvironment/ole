...
import org.kuali.ole.coa.dataaccess.A21SubAccountDao;
...
public class A21SubAccountServiceImpl implements A21SubAccountService {
    ...
    /**
     * @see org.kuali.ole.coa.service.A21SubAccountService#getByPrimaryKey(java.lang.String, java.lang.String, java.lang.String)
     */
    public A21SubAccount getByPrimaryKey(String chartOfAccountsCode, String accountNumber, String subAccountNumber) {
        ...
        keys.put(OLEPropertyConstants.SUB_ACCOUNT_NUMBER, subAccountNumber);
        return (A21SubAccount) SpringContext.getBean(BusinessObjectService.class).findByPrimaryKey(A21SubAccount.class, keys);
    }

    /**
     * @see org.kuali.ole.coa.service.A21SubAccountService#buildCgIcrAccount(java.lang.String, java.lang.String, java.lang.String,
     *      java.lang.String)
     */
    public A21SubAccount buildCgIcrAccount(String chartOfAccountsCode, String accountNumber, String subAccountNumber, String subAccountTypeCode) {
        if (StringUtils.isEmpty(chartOfAccountsCode) || StringUtils.isEmpty(accountNumber) || StringUtils.equals(subAccountTypeCode, OLEConstants.SubAccountType.COST_SHARE)) {
            return null;
        }
    ...
    /**
     * @see org.kuali.ole.coa.service.A21SubAccountService#populateCgIcrAccount(org.kuali.ole.coa.businessobject.A21SubAccount,
    ...
    public void populateCgIcrAccount(A21SubAccount a21SubAccount, String chartOfAccountsCode, String accountNumber) {
        ...
        if (ObjectUtils.isNotNull(account) && ObjectUtils.isNotNull(a21SubAccount) && !StringUtils.equals(a21SubAccount.getSubAccountTypeCode(), OLEConstants.SubAccountType.COST_SHARE)) {
