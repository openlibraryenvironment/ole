 ...
 */
public class OLEBatchProcessBatchExportProfileValueFinder extends KeyValuesBase {

    private static final Logger LOG = Logger.getLogger(OLEBatchProcessBatchExportProfileValueFinder.class);
    ...
    public List<KeyValue> getKeyValues() {
        ...
        List<KeyValue> options = initProfileDetailsForBatchExport();
        return options;
    }

    public static List<KeyValue> initProfileDetailsForBatchExport() {

        List<KeyValue> keyValues = new ArrayList<KeyValue>();
        BusinessObjectService businessObjectService = KRADServiceLocator.getBusinessObjectService();
        Map parentCriteria1 = new HashMap();
        parentCriteria1.put("batchProcessProfileType", "Batch Export");
    ...
    public static List<String> retrieveBatchProfileNamesForBatchExport(String locationVal) {
        List<KeyValue> locationKeyValues = retrieveProfileDetailsForBatchExport();
    ...
    private static List<KeyValue> retrieveProfileDetailsForBatchExport() {
        long currentTime = System.currentTimeMillis() / 1000;
        if (locationKeyValues == null) {
            locationKeyValues = initProfileDetailsForBatchExport();
    ...
    public  static String getValue(String batchVal){
        String value="";
        locationKeyValues=retrieveProfileDetailsForBatchExport();
        for (KeyValue keyValue : locationKeyValues) {
