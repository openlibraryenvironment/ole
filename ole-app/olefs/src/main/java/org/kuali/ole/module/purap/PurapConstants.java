...
import org.kuali.ole.module.purap.businessobject.AvailabilityMatrix;
...
public class PurapConstants {
    ...
    public static final KualiDecimal DOCUMENT_MAX_TOTAL = new KualiDecimal(1000);

    public static final String ORDER_TYPE_FIRM = "Firm, Fixed";

    public static final String ORDER_TYPE_FIRM_MULTIPART = "Firm (multi part)";

    public static final String ORDER_TYPE_APPROVAL = "Approval";

    public static final String ORDER_TYPE_SUBSCRIPTION = "Subscription";

    public static final String ORDER_TYPE_STANDING = "Standing";

    public static final String ORDER_TYPE_BLANKET = "Blanket";
    public static final String ORDER_TYPE_INTEGRATING_RESOURCE = "Integrating resource";
    public static final String ORDER_TYPE_CONTINUING = "Continuing";
    ...
    public static class RequisitionStatuses {
        ...
        public static final String APPDOC_AWAIT_LICENSE_REVIEW = "Awaiting License Review";
        ...
        public static final String APPDOC_DAPRVD_LICENSE = "Disapproved License";
        public static final String AWAIT_BUDGET_REVIEW = "Awaiting Budget Approval";
        public static final String APPDOC_DAPRVD_BUDGET = "Disapproved Budget";
        public static final String APPDOC_DAPRVD_NO_VENDOR = "Disapproved No Vendor";
        ...
        public static HashMap<String, String> getAllAppDocStatuses() {
            ...
            /*appDocStatusMap.put(APPDOC_AWAIT_LICENSE_REVIEW, APPDOC_AWAIT_LICENSE_REVIEW);*/
            appDocStatusMap.put(AWAIT_BUDGET_REVIEW, AWAIT_BUDGET_REVIEW);
            ...
            appDocStatusMap.put(APPDOC_DAPRVD_LICENSE, APPDOC_DAPRVD_LICENSE);
            appDocStatusMap.put(APPDOC_DAPRVD_BUDGET, APPDOC_DAPRVD_BUDGET);
            appDocStatusMap.put(APPDOC_DAPRVD_NO_VENDOR,APPDOC_DAPRVD_NO_VENDOR);
        ...
        public static final String NODE_LICENSE_REVIEW = "LicenseRequest";
        public static final String NODE_BUDGET_OFFICE_REVIEW = "Budget";
        public static final String NODE_NO_VENDOR = "NoVendor";
        ...
        public static HashMap<String, String> getRequistionAppDocStatuses() {
            ...
            reqAppDocStatusMap.put(NODE_LICENSE_REVIEW, APPDOC_DAPRVD_LICENSE);
            reqAppDocStatusMap.put(AWAIT_BUDGET_REVIEW, RequisitionStatuses.NODE_BUDGET_OFFICE_REVIEW);
            ...
            reqAppDocStatusMap.put(NODE_BUDGET_OFFICE_REVIEW, RequisitionStatuses.APPDOC_DAPRVD_BUDGET);
            reqAppDocStatusMap.put(NODE_NO_VENDOR, APPDOC_DAPRVD_NO_VENDOR);
    ...
    public static class RequisitionSources {
        ...
        public static final String MANUAL_INGEST = "MAN";
    }
    ...
    public static final String PRQS_DISCOUNT_MULT = "-0.01";

    public static final String REQUISITION_DOCUMENT_TYPE = "OLE_REQS";
    public static final String RECEIVING_LINE_ITEM_DOCUMENT_TYPE = "OLE_RCVL";
    public static final String RECEIVING_THRESHOLD_DOCUMENT_TYPE = "OLE_THLD";

    public static class PurchaseOrderDocTypes {
        public static final String PURCHASE_ORDER_REOPEN_DOCUMENT = "OLE_POR";
        public static final String PURCHASE_ORDER_CLOSE_DOCUMENT = "OLE_POC";
        public static final String PURCHASE_ORDER_DOCUMENT = "OLE_PO";
        public static final String PURCHASE_ORDER_RETRANSMIT_DOCUMENT = "OLE_PORT";
        public static final String PURCHASE_ORDER_PRINT_DOCUMENT = "OLEPurchaseOrderPrintDocument";
        public static final String PURCHASE_ORDER_VOID_DOCUMENT = "OLE_POV";
        public static final String PURCHASE_ORDER_PAYMENT_HOLD_DOCUMENT = "OLE_POPH";
        public static final String PURCHASE_ORDER_REMOVE_HOLD_DOCUMENT = "OLE_PORH";
        public static final String PURCHASE_ORDER_AMENDMENT_DOCUMENT = "OLE_POA";
        public static final String PURCHASE_ORDER_SPLIT_DOCUMENT = "OLE_POSP";
    }
    ...
    // INVOICE
    public static final String INVOICE_ACTION_NAME = "Invoice";
    public static final String PRQS_PAY_DATE_DAYS = "days";
    public static final String PRQS_PAY_DATE_DATE = "date";
    public static final int PRQS_PAY_DATE_EMPTY_TERMS_DEFAULT_DAYS = 28;
    public static final int PRQS_PAY_DATE_DAYS_BEFORE_WARNING = 60;
    ...
    public static final class InvoiceIndicatorText {
        public static final String HOLD = "HOLD";
        public static final String REQUEST_CANCEL = "REQUEST CANCEL";
    }
    ...
    public static final class PaymentRequestStatuses {
        ...
        public static final String APPDOC_EXTRACTED = "Extracted";
        public static final String APPDOC_DO_NOT_EXTRACT = "Do Not Extract";
        ...
        public static final String APPDOC_AWAITING_PAYMENT_REVIEW = "Awaiting Payment Method Approval";
        ...
        public static HashMap<String, String> getAllAppDocStatuses() {
            ...
            appDocStatusMap.put(APPDOC_EXTRACTED, APPDOC_EXTRACTED);
            appDocStatusMap.put(APPDOC_DO_NOT_EXTRACT, APPDOC_DO_NOT_EXTRACT);
            ...
            appDocStatusMap.put(APPDOC_AWAITING_PAYMENT_REVIEW, APPDOC_AWAITING_PAYMENT_REVIEW);
        ...
        public enum STATUS_ORDER {
            ...
            AWAIT_BUDGET_REVIEW(
                    PurapConstants.PaymentRequestStatuses.AWAIT_BUDGET_REVIEW, false),
            ...
            AWAITING_PAYMENT_REVIEW(
                    PurapConstants.PaymentRequestStatuses.APPDOC_AWAITING_PAYMENT_REVIEW, false),
            ...
            EXTRACTED(PurapConstants.PaymentRequestStatuses.APPDOC_EXTRACTED, false),
            DO_NOT_EXTRACT(PurapConstants.PaymentRequestStatuses.APPDOC_DO_NOT_EXTRACT, false),
            ;
        ...
        static {
            ...
            STATUSES_DISALLOWING_REQUEST_CANCEL.add(APPDOC_EXTRACTED);
            STATUSES_DISALLOWING_REQUEST_CANCEL.add(APPDOC_DO_NOT_EXTRACT);
            ...
            STATUSES_ENROUTE.add(APPDOC_AWAITING_PAYMENT_REVIEW);

            STATUSES_POSTROUTE.add(APPDOC_DEPARTMENT_APPROVED);
            STATUSES_POSTROUTE.add(APPDOC_AUTO_APPROVED);
            STATUSES_POSTROUTE.add(APPDOC_EXTRACTED);
            STATUSES_POSTROUTE.add(APPDOC_DO_NOT_EXTRACT);
        }
    ...
    public static final class InvoiceStatuses {
      ...
      //  public static final String APPDOC_CANCELLED_IN_PROCESS = "Cancelled In Process";
        ...
        public static final String APPDOC_AUTO_APPROVED = "Auto-Approved";
        public static final String APPDOC_EXTRACTED = "Extracted";
        public static final String APPDOC_DO_NOT_EXTRACT = "Do Not Extracted";
        public static final String APPDOC_AWAITING_ACCOUNTS_PAYABLE_REVIEW = "Awaiting AP Review"; // Waiting for Accounts Payable approval
        public static final String APPDOC_AWAITING_RECEIVING_REVIEW = "Awaiting Receiving"; // Waiting for Receiving approval
        public static final String APPDOC_AWAITING_SUB_ACCT_MGR_REVIEW = "Awaiting Sub-Account Manager Approval"; // Waiting for Sub Acct Manager approval
        public static final String APPDOC_AWAITING_FISCAL_REVIEW = "Awaiting Fiscal Officer Approval"; // Waiting for Fiscal Officer approval
       ...
       // public static final String DAPRVD_BUDGET = "DBUD";
        public static final String APPDOC_AWAITING_PAYMENT_REVIEW = "Awaiting Payment Method Approval";
        public static final String APPDOC_DAPRVD_BUDGET = "Disapproved Budget";
        public static final String APPDOC_DAPRVD_PAYMENT = "Disapproved Payment";
        ...
        //    appDocStatusMap.put(APPDOC_CANCELLED_IN_PROCESS, APPDOC_CANCELLED_IN_PROCESS);
            ...
            appDocStatusMap.put(APPDOC_PENDING_E_INVOICE, APPDOC_PENDING_E_INVOICE);
            appDocStatusMap.put(APPDOC_DAPRVD_BUDGET, APPDOC_DAPRVD_BUDGET);
            appDocStatusMap.put(APPDOC_DAPRVD_PAYMENT, APPDOC_DAPRVD_PAYMENT);
        ...
        public enum STATUS_ORDER {
         //   CANCELLED_IN_PROCESS(PurapConstants.InvoiceStatuses.APPDOC_CANCELLED_IN_PROCESS, false),
            ...
            INITIATE(PurapConstants.InvoiceStatuses.APPDOC_INITIATE, true),
            IN_PROCESS(PurapConstants.InvoiceStatuses.APPDOC_IN_PROCESS, true),
            AWAITING_ACCOUNTS_PAYABLE_REVIEW(PurapConstants.InvoiceStatuses.APPDOC_AWAITING_ACCOUNTS_PAYABLE_REVIEW, false),
            AWAITING_RECEIVING_REVIEW(PurapConstants.InvoiceStatuses.APPDOC_AWAITING_RECEIVING_REVIEW, false),
            AWAITING_SUB_ACCT_MGR_REVIEW(PurapConstants.InvoiceStatuses.APPDOC_AWAITING_SUB_ACCT_MGR_REVIEW, false),
            AWAIT_BUDGET_REVIEW(
                    PurapConstants.InvoiceStatuses.AWAIT_BUDGET_REVIEW, false),
            AWAITING_FISCAL_REVIEW(PurapConstants.InvoiceStatuses.APPDOC_AWAITING_FISCAL_REVIEW, false),
            AWAITING_ORG_REVIEW(PurapConstants.InvoiceStatuses.APPDOC_AWAITING_ORG_REVIEW, false),
            AWAITING_TAX_REVIEW(PurapConstants.InvoiceStatuses.APPDOC_AWAITING_TAX_REVIEW, false),
            AWAITING_PAYMENT_REVIEW(
                    PurapConstants.InvoiceStatuses.APPDOC_AWAITING_PAYMENT_REVIEW, false),
            DEPARTMENT_APPROVED(PurapConstants.InvoiceStatuses.APPDOC_DEPARTMENT_APPROVED, false),
            AUTO_APPROVED(PurapConstants.InvoiceStatuses.APPDOC_AUTO_APPROVED, false),
            EXTRACTED(PurapConstants.InvoiceStatuses.APPDOC_EXTRACTED, false),
            DO_NOT_EXTRACT(PurapConstants.InvoiceStatuses.APPDOC_DO_NOT_EXTRACT, false),;
        ...
        public static final String[] PRQS_STATUSES_FOR_AUTO_APPROVE = {
                APPDOC_AWAITING_SUB_ACCT_MGR_REVIEW,
                AWAIT_BUDGET_REVIEW,
                APPDOC_AWAITING_FISCAL_REVIEW,
                APPDOC_AWAITING_ORG_REVIEW,
        ...
        public static final HashMap<String, String> getInvoiceAppDocDisapproveStatuses() {
            ...
            appDocStatusMap.put(NODE_ORG_REVIEW, InvoiceStatuses.APPDOC_CANCELLED_POST_AP_APPROVE);
        ...
        static {
            INCOMPLETE_STATUSES.add(AWAIT_BUDGET_REVIEW);
            COMPLETE_STATUSES.add(APPDOC_DAPRVD_BUDGET);
            INCOMPLETE_STATUSES.add(APPDOC_AWAITING_PAYMENT_REVIEW);
            COMPLETE_STATUSES.add(APPDOC_DAPRVD_PAYMENT);
        }
    ...
    public static class PRQSDocumentsStrings {
        public static final String DUPLICATE_INVOICE_QUESTION = "PRQSDuplicateInvoice";
        public static final String HOLD_PRQS_QUESTION = "HoldPRQS";
        public static final String CONFIRM_HOLD_QUESTION = "ConfirmHold";
        public static final String HOLD_NOTE_PREFIX = "Note entered while placing Payment Request on hold : ";
        public static final String REMOVE_HOLD_PRQS_QUESTION = "RemoveHoldPRQS";
        public static final String CONFIRM_REMOVE_HOLD_QUESTION = "ConfirmRemoveHold";
        public static final String REMOVE_HOLD_NOTE_PREFIX = "Note entered while removing a hold on Payment Request : ";
        public static final String CANCEL_PRQS_QUESTION = "CancelPRQS";
        public static final String CONFIRM_CANCEL_QUESTION = "ConfirmCancel";
        public static final String CANCEL_NOTE_PREFIX = "Note entered while requesting cancel on Payment Request : ";
        public static final String REMOVE_CANCEL_PRQS_QUESTION = "RemoveCancelPRQS";
        public static final String CONFIRM_REMOVE_CANCEL_QUESTION = "ConfirmRemoveCancel";
        public static final String REMOVE_CANCEL_NOTE_PREFIX = "Note entered while removing a request cancel on Payment Request : ";
        public static final String PURCHASE_ORDER_ID = "Purchase Order Identifier";
        public static final String INVOICE_DATE = "Invoice Date";
        public static final String OFFSET_ACCT_LINE = "Offset Accounting Line";
        public static final String INVOICE_NUMBER = "Invoice Number";
        public static final String IN_PROCESS = "In Process";
        public static final String THRESHOLD_DAYS_OVERRIDE_QUESTION = "Threshold Days Override Question";
        public static final String UNUSED_TRADE_IN_QUESTION = "There is an unused trade in amount from PO that you could apply to line item; are you sure you want to proceed ?";
        ...
        public static final String INV_ID = "invoiceIdentifier";
        public static final String PUR_ID = "purapDocumentIdentifier";
        public static final String PRORATION_TYPE = "Proration Type";
    ...
    public static class CreditMemoStatuses {
        ...
        public static final String[] STATUSES_POTENTIALLY_ACTIVE = {APPDOC_IN_PROCESS, APPDOC_AWAITING_ACCOUNTS_PAYABLE_REVIEW,APPDOC_EXTRACTED};
    ...
    private static final HashMap<String, Class> uncopyableFields() {
        ...
        fields.put(OLEConstants.VERSION_NUMBER, null);
        fields.put("LOG", null);
        fields.put(OLEPropertyConstants.GENERAL_LEDGER_PENDING_ENTRIES, null);
    ...
    public static final Map<String, Class> uncopyableFieldsForPurchaseOrder() {
        ...
        returnMap.put(OLEPropertyConstants.DOCUMENT_NUMBER, null);
    ...
    public static final Map<String, Class<?>> uncopyableFieldsForSplitPurchaseOrder() {
        Map<String, Class<?>> returnMap = new HashMap<String, Class<?>>();
        returnMap.put(OLEPropertyConstants.DOCUMENT_HEADER, null);
    ...
    @Deprecated // this should be removed - use the central definition in OLEConstants
    ...
    public static final class PurapDocTypeCodes {
        public static final String PAYMENT_REQUEST_DOCUMENT = "OLE_PREQ";
        public static final String INVOICE_DOCUMENT = "OLE_PRQS";
        public static final String CREDIT_MEMO_DOCUMENT = "OLE_CM";
        public static final String PO_DOCUMENT = "OLE_PO";
        public static final String PO_AMENDMENT_DOCUMENT = "OLE_POA";
        public static final String PO_CLOSE_DOCUMENT = "OLE_POC";
        public static final String PO_REOPEN_DOCUMENT = "OLE_POR";
        public static final String PO_VOID_DOCUMENT = "OLE_POV";
    }
    ...
    private static HashMap<String, String> getPurapParameterDetailTypeCodes() {
        ...
        map.put("OLE_REQS", RequisitionDocument.class.getName());
        map.put("OLE_PO", PurchaseOrderDocument.class.getName());
        map.put("OLE_POC", PurchaseOrderDocument.class.getName());
        map.put("OLE_POR", PurchaseOrderDocument.class.getName());
        map.put("OLE_POA", PurchaseOrderDocument.class.getName());
        map.put("OLE_POPH", PurchaseOrderDocument.class.getName());
        map.put("OLE_PORH", PurchaseOrderDocument.class.getName());
        map.put("OLE_PORT", PurchaseOrderDocument.class.getName());
        map.put("OLE_POV", PurchaseOrderDocument.class.getName());
        map.put("OLE_POSP", PurchaseOrderDocument.class.getName());
        map.put("OLE_PREQ", PaymentRequestDocument.class.getName());
        map.put("OLE_PRQS", InvoiceDocument.class.getName());
        map.put("OLE_CM", VendorCreditMemoDocument.class.getName());
        return map;
    }
    ...
    public static class LicenseRequestStatus {
        public static final String INITIATE_LICENSE_REQUEST = "ILR";
        public static final String NO_LICENSE_REQUIRED = "NLR";
        public static final String LICENSE_REQUEST_COMPLETE = "LRC";
        public static final String NEGOTIATION_FAILED = "NF";
...
//    }
    ...
    public static final String APO_LIMIT = "REQ_GT_PO";
    public static final String REQ_TOT = "REQ_GT_ZE";
    public static final String VEN_NOT_SEL = "VEN_NOT_SEL_DB";
    public static final String ERR_RTV_VENDOR = "ERR_RTV_VEN_DB";
    public static final String VENDOR_RESTRICTED = "VEN_REST";
    public static final String REQ_WITH_NO_CONTRACT = "REQ_NO_CONT";
    public static final String ITM_RESTRICTED = "ITM_REST";
    public static final String REQ_CON_TRADEIN = "REQ_TRAD_IN";
    public static final String REQ_CON_ACC_LINE = "REQ_CON_ACC_LN";
    public static final String REQ_CON_CAP_ASSET_ITM = "REQ_CPT_ASST_ITM";
    public static final String RECUR_REQ_TYPE = "REQ_PAY_RECUR";
    public static final String PO_TOT_NOT_EXCEED = "PO_TOT_NOT_EXC";
    public static final String RECUR_PAY_TYPE = "REQ_PAY_RECUR";
    public static final String ALT_VEN_NAME_EXISTS = "ALT_VEN_NAM";


    public static class PaymentRequestDocumentStrings {
        public static final String CUSTOMER_INVOICE_DETAIL_UOM_DEFAULT = "EA"; //TODO: System parameter?
    }

    public static class InvoiceDocumentStrings {
        public static final String CUSTOMER_INVOICE_DETAIL_UOM_DEFAULT = "EA"; //TODO: System parameter?
    }
    ...
    public static final class PlatformStatuses {
        public static final String APPDOC_INITIATE = "Initiated";
    }
}
