...
public class DisbursementVoucherPayeeServiceImpl implements DisbursementVoucherPayeeService {
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPayeeService#getPayeeTypeDescription(java.lang.String)
     */
    @Override
...
//            payeeTypeDescription = parameterService.getParameterValueAsString(DisbursementVoucherDocument.class, DisbursementVoucherConstants.NON_VENDOR_EMPLOYEE_PAYEE_TYPE_LABEL_PARM_NM);
            payeeTypeDescription = DisbursementVoucherConstants.DV_PAYEE_TYPE_EMPLOYEE_DESC;
        }
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPayeeService#isEmployee(org.kuali.ole.fp.businessobject.DisbursementVoucherPayeeDetail)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPayeeService#isEmployee(org.kuali.ole.fp.businessobject.DisbursementPayee)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPayeeService#isVendor(org.kuali.ole.fp.businessobject.DisbursementVoucherPayeeDetail)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPayeeService#isVendor(org.kuali.ole.fp.businessobject.DisbursementPayee)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPayeeService#isPayeeIndividualVendor(org.kuali.ole.fp.businessobject.DisbursementVoucherPayeeDetail)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPayeeService#isPayeeIndividualVendor(org.kuali.ole.fp.businessobject.DisbursementPayee)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPayeeService#getVendorOwnershipTypeCode(org.kuali.ole.fp.businessobject.DisbursementPayee)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPayeeService#checkPayeeAddressForChanges(org.kuali.ole.fp.document.DisbursementVoucherDocument)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPayeeService#getFieldConversionBetweenPayeeAndVendor()
     */
    @Override
    public Map<String, String> getFieldConversionBetweenPayeeAndVendor() {
        ...
        fieldConversionMap.put(OLEPropertyConstants.TAX_NUMBER, VendorPropertyConstants.VENDOR_TAX_NUMBER);
        fieldConversionMap.put(OLEPropertyConstants.PAYEE_NAME, VendorPropertyConstants.VENDOR_NAME);

        fieldConversionMap.put(OLEPropertyConstants.VENDOR_NAME, VendorPropertyConstants.VENDOR_NAME);
        fieldConversionMap.put(OLEPropertyConstants.VENDOR_NUMBER, VendorPropertyConstants.VENDOR_NUMBER);

        fieldConversionMap.put(OLEPropertyConstants.PERSON_FIRST_NAME, VendorPropertyConstants.VENDOR_FIRST_NAME);
        fieldConversionMap.put(OLEPropertyConstants.PERSON_LAST_NAME, VendorPropertyConstants.VENDOR_LAST_NAME);

        fieldConversionMap.put(OLEPropertyConstants.ACTIVE, OLEPropertyConstants.ACTIVE_INDICATOR);

        return fieldConversionMap;
    }

    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPayeeService#getFieldConversionBetweenPayeeAndPerson()
     */
    @Override
    public Map<String, String> getFieldConversionBetweenPayeeAndPerson() {
        Map<String, String> fieldConversionMap = new HashMap<String, String>();

        //fieldConversionMap.put(OLEPropertyConstants.TAX_NUMBER, KIMPropertyConstants.Person.EXTERNAL_ID);

        fieldConversionMap.put(OLEPropertyConstants.PAYEE_NAME, KIMPropertyConstants.Person.NAME);
        fieldConversionMap.put(OLEPropertyConstants.PERSON_FIRST_NAME, KIMPropertyConstants.Person.FIRST_NAME);
        fieldConversionMap.put(OLEPropertyConstants.PERSON_LAST_NAME, KIMPropertyConstants.Person.LAST_NAME);

        fieldConversionMap.put(OLEPropertyConstants.EMPLOYEE_ID, KIMPropertyConstants.Person.EMPLOYEE_ID);
        fieldConversionMap.put(OLEPropertyConstants.ACTIVE, KIMPropertyConstants.Person.ACTIVE);

        return fieldConversionMap;
    }

    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPayeeService#getPayeeFromVendor(org.kuali.ole.vnd.businessobject.VendorDetail)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.fp.document.service.DisbursementVoucherPayeeService#getPayeeFromPerson(org.kuali.rice.kim.api.identity.Person)
     */
    @Override
    public DisbursementPayee getPayeeFromPerson(Person person) {
        ...
        disbursementPayee.setTaxNumber(OLEConstants.BLANK_SPACE);
    ...
    protected String buildPayeeChangedNoteText(DisbursementVoucherPayeeDetail newPayeeDetail, DisbursementVoucherPayeeDetail oldPayeeDetail) {
        ...
        try {
            ...
            valueLabel = dataDictionaryService.getAttributeLabel(DisbursementVoucherPayeeDetail.class, OLEPropertyConstants.DISB_VCHR_PAYEE_LINE1_ADDR);
            ...
            valueLabel = dataDictionaryService.getAttributeLabel(DisbursementVoucherPayeeDetail.class, OLEPropertyConstants.DISB_VCHR_PAYEE_LINE2_ADDR);
            ...
            valueLabel = dataDictionaryService.getAttributeLabel(DisbursementVoucherPayeeDetail.class, OLEPropertyConstants.DISB_VCHR_PAYEE_CITY_NAME);
            ...
            valueLabel = dataDictionaryService.getAttributeLabel(DisbursementVoucherPayeeDetail.class, OLEPropertyConstants.DISB_VCHR_PAYEE_STATE_CODE);
            ...
            valueLabel = dataDictionaryService.getAttributeLabel(DisbursementVoucherPayeeDetail.class, OLEPropertyConstants.DISB_VCHR_PAYEE_ZIP_CODE);
            ...
            valueLabel = dataDictionaryService.getAttributeLabel(DisbursementVoucherPayeeDetail.class, OLEPropertyConstants.DISB_VCHR_PAYEE_COUNTRY_CODE);
    ...
    protected String getVendorTypeDescription(String vendorTypeCode) {
        ...
        primaryKeys.put(OLEPropertyConstants.VENDOR_TYPE_CODE, vendorTypeCode);
