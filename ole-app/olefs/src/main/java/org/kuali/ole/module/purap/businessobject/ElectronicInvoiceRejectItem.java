...
public class ElectronicInvoiceRejectItem extends PersistableBusinessObjectBase {
    ...
    /**
     * @param electronicInvoiceRejectDocument
     *         The electronicInvoiceRejectDocument to set.
     */
     ...
     *         The invoiceItemUnitPriceCurrencyCode to set.
     */
    ...
    /**
     * @param invoiceReferenceItemCountryCode
     *         The invoiceReferenceItemCountryCode to set.
     */
    ...
    /**
     * @param invoiceReferenceItemCountryName
     *         The invoiceReferenceItemCountryName to set.
     */
    ...
    /**
     * @param invoiceReferenceItemDescription
     *         The invoiceReferenceItemDescription to set.
     */
    ...
    /**
     * @param invoiceReferenceItemManufacturerName
     *         The invoiceReferenceItemManufacturerName to set.
     */
    ...
    /**
     * @param invoiceReferenceItemManufacturerPartIdentifier
     *         The invoiceReferenceItemManufacturerPartIdentifier to set.
     */
    ...
    /**
     * @param invoiceReferenceItemSerialNumber
     *         The invoiceReferenceItemSerialNumber to set.
     */
     ...
     *         The invoiceReferenceItemSupplierPartAuxiliaryIdentifier to set.
     */
    ...
    /**
     * @param invoiceReferenceItemSupplierPartIdentifier
     *         The invoiceReferenceItemSupplierPartIdentifier to set.
     */
