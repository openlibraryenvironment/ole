...
public interface OleInvoiceItemService {
    ...
    public List<OlePurchaseOrderLineForInvoice> getOlePurchaseOrderLineForInvoiceForAddItem(OlePurchaseOrderDocument oleInvoiceDocument);

    public List<OlePurchaseOrderTotal> getOlePurchaseOrderTotalForAddItem(OlePurchaseOrderDocument oleInvoiceDocument);
}
