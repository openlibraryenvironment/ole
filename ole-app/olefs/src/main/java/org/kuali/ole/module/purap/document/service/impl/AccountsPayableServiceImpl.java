...
import org.kuali.ole.module.purap.document.service.AccountsPayableDocumentSpecificService;
...
public class AccountsPayableServiceImpl implements AccountsPayableService {
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.AccountsPayableService#getExpiredOrClosedAccountList(org.kuali.ole.module.purap.document.AccountsPayableDocument)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.AccountsPayableService#generateExpiredOrClosedAccountNote(org.kuali.ole.module.purap.document.AccountsPayableDocument,
     *      java.util.HashMap)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.AccountsPayableService#generateExpiredOrClosedAccountWarning(org.kuali.ole.module.purap.document.AccountsPayableDocument)
     */
    @Override
    public void generateExpiredOrClosedAccountWarning(AccountsPayableDocument document) {
        ...
        String showContinuationAccountWaringFO = parameterService.getParameterValueAsString(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapConstants.PURAP_AP_SHOW_CONTINUATION_ACCOUNT_WARNING_FISCAL_OFFICERS);

        // get parameter to see if ap users may see the continuation account warning
        String showContinuationAccountWaringAP = parameterService.getParameterValueAsString(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapConstants.PURAP_AP_SHOW_CONTINUATION_ACCOUNT_WARNING_AP_USERS);
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.AccountsPayableService#processExpiredOrClosedAccount(org.kuali.ole.module.purap.businessobject.PurApAccountingLineBase,
     *      java.util.HashMap)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.AccountsPayableService#cancelAccountsPayableDocument(org.kuali.ole.module.purap.document.AccountsPayableDocument, java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.AccountsPayableService#updateItemList(org.kuali.ole.module.purap.document.AccountsPayableDocument)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.AccountsPayableService#purchaseOrderItemEligibleForPayment(org.kuali.ole.module.purap.businessobject.PurchaseOrderItem)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.AccountsPayableService#canCopyAccountingLinesWithZeroAmount()
     */
    @Override
    public boolean canCopyAccountingLinesWithZeroAmount() {
        ...
        String copyZeroAmountLine = parameterService.getParameterValueAsString(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapParameterConstants.COPY_ACCOUNTING_LINES_WITH_ZERO_AMOUNT_FROM_PO_TO_PREQ_IND);
