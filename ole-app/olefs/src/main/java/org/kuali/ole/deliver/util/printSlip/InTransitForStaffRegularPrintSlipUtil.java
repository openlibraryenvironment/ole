 ...
 */
public class InTransitForStaffRegularPrintSlipUtil extends OleRegularPrintSlipUtil {
    ...
    protected void populateHeader(Paragraph paraGraph) {
        paraGraph.add(new Chunk("Routing Slip In-Transit Per Staff Request", getPdfFormatUtil().getBoldFont()));
    }
    ...
    protected void populateBody(PdfPTable pdfTable) {
        ...
        pdfTable.addCell(getPdfFormatUtil().getPdfPCellInJustified("Requested By"));
        pdfTable.addCell(getPdfFormatUtil().getPdfPCellInLeft(":"));
