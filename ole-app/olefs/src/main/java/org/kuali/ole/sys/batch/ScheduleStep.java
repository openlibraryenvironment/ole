...
public class ScheduleStep extends AbstractStep {
    ...
    public boolean execute(String jobName, Date jobRunDate) {
        ...
        while (schedulerService.hasIncompleteJob() && !isPastScheduleCutoffTime) {
            ...
            try {
                Thread.sleep(Integer.parseInt(getParameterService().getParameterValueAsString(getClass(), OLEConstants.SystemGroupParameterNames.BATCH_SCHEDULE_STATUS_CHECK_INTERVAL)));
            }
