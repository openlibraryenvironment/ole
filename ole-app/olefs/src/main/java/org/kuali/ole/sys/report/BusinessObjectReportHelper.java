 ...
 * configurability
 * 
 * @see org.kuali.ole.sys.service.impl.ReportWriterTextServiceImpl
 */
public class BusinessObjectReportHelper {
    ...
    public Map<String, String> getTableDefinition() {       
        ...
        tableDefinition.put(OLEConstants.ReportConstants.TABLE_HEADER_LINE_KEY, tableHeaderLine);
        tableDefinition.put(OLEConstants.ReportConstants.SEPARATOR_LINE_KEY, separatorLine);
        tableDefinition.put(OLEConstants.ReportConstants.TABLE_CELL_FORMAT_KEY, tableCellFormat);
    ...
    public String getSepartorLine(List<Integer> cellWidthList) {
        ...
        for (int index = 0; index < this.columnCount; index++) {
            ...
            separatorLine = separatorLine.append(StringUtils.rightPad(StringUtils.EMPTY, cellWidth, OLEConstants.DASH)).append(" ");
        }
