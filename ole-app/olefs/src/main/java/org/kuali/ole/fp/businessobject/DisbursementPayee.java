...
public class DisbursementPayee extends TransientBusinessObjectBase implements MutableInactivatable {
    ...
    protected LinkedHashMap toStringMapper_RICE20_REFACTORME() {
        ...
        map.put(OLEPropertyConstants.PAYEE_ID_NUMBER, this.payeeIdNumber);
        map.put(OLEPropertyConstants.PAYEE_TYPE_CODE, this.payeeTypeCode);
        map.put(OLEPropertyConstants.PAYEE_NAME, this.payeeName);
     ...
     * 
     * @param persvendorDetailon The vendorDetail to set.
     */
