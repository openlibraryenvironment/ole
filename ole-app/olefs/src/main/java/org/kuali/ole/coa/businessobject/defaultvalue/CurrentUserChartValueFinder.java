...
public class CurrentUserChartValueFinder implements ValueFinder {
    ...
    public String getValue() {
        ...
        if (currentUser != null) {
            return SpringContext.getBean(FinancialSystemUserService.class).getPrimaryOrganization(currentUser, OLEConstants.ParameterNamespaces.CHART).getChartOfAccountsCode();
        }
        else {
