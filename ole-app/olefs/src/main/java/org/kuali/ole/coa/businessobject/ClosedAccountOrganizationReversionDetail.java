...
public class ClosedAccountOrganizationReversionDetail implements OrganizationReversionCategoryInfo {
    ...
    /**
     * Always returns R2
     * @see org.kuali.ole.coa.businessobject.OrganizationReversionCategoryInfo#getOrganizationReversionCode()
     */
    public String getOrganizationReversionCode() {
        return OLEConstants.RULE_CODE_R2;
    }

    /**
     * 
     * @see org.kuali.ole.coa.businessobject.OrganizationReversionCategoryInfo#getOrganizationReversionObjectCode()
     */
