...
public class YearEndPendingEntryServiceImpl implements YearEndPendingEntryService {
    ...
    protected static final String FINAL_ACCOUNTING_PERIOD = OLEConstants.MONTH13;
    ...
    /**
     * @see org.kuali.ole.fp.document.service.YearEndPendingEntryService#customizeExplicitGeneralLedgerPendingEntry(org.kuali.rice.krad.document.TransactionalDocument, org.kuali.ole.sys.businessobject.AccountingLine, org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntry)
     */
    @Override
    ...
    public boolean customizeOffsetGeneralLedgerPendingEntry(TransactionalDocument transactionalDocument, GeneralLedgerPendingEntrySourceDetail accountingLine, GeneralLedgerPendingEntry explicitEntry, GeneralLedgerPendingEntry offsetEntry) {
        ...
        if (!ObjectUtils.isNull(offsetDefinition)) {
            ...
            if (offsetObjectCode.equals(AccountingDocumentRuleBaseConstants.GENERAL_LEDGER_PENDING_ENTRY_CODE.getBlankFinancialObjectCode())) {
                ...
                offsetDefinition.refreshReferenceObject(OLEPropertyConstants.FINANCIAL_OBJECT);
    ...
    /**
     * @see org.kuali.ole.fp.document.service.YearEndPendingEntryService#getFinalAccountingPeriod()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.fp.document.service.YearEndPendingEntryService#getPreviousFiscalYear()
     */
    @Override
