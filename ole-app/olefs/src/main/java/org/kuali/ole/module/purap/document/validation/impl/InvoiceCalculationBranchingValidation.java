...
public class InvoiceCalculationBranchingValidation extends BranchingValidation {

    @Override
    protected String determineBranch(AttributedDocumentEvent event) {
        InvoiceDocument prqs = (InvoiceDocument) event.getDocument();
        if (InvoiceStatuses.APPDOC_AWAITING_TAX_REVIEW.equals(prqs.getApplicationDocumentStatus())) {
