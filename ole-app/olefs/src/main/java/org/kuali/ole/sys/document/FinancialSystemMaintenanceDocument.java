...
public class FinancialSystemMaintenanceDocument extends MaintenanceDocumentBase implements FinancialSystemDocument {
    ...
    public boolean answerSplitNodeQuestion(String nodeName) {
        ...
        if (getNewMaintainableObject() instanceof FinancialSystemMaintainable) {
            ...
            throw new UnsupportedOperationException("Maintainable for "+getNewMaintainableObject().getBoClass().getName()+" does not extend org.kuali.ole.sys.document.FinancialSystemMaintainable nor org.kuali.ole.sys.document.FinancialSystemGlobalMaintainable and therefore cannot answer split node question");
        }
    }
