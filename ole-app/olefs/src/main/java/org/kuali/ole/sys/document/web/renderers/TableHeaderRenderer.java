...
public class TableHeaderRenderer extends TableCellRenderer {
     ...
     * @see org.kuali.ole.sys.document.web.renderers.TableCellRenderer#getTagName()
     */
    @Override
     ...
     * @see org.kuali.ole.sys.document.web.renderers.TableCellRenderer#verticallyAlignTowardsTop()
     */
    @Override
