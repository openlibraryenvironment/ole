 ...
 */
public class OleStatisticalSearchingCodesLookupableImpl extends LookupableImpl {
    ...
    protected String getActionUrlHref(LookupForm lookupForm, Object dataObject, String methodToCall,
        ...
        String maintenanceMapping = "statisticalSearchingCodesMaintenance";
    ...
    protected List<?> getSearchResults(LookupForm form, Map<String, String> searchCriteria, boolean unbounded) {
        List<?> searchResults;
        List<OleStatisticalSearchingCodes> finalSearchResult = new ArrayList<OleStatisticalSearchingCodes>();
        List<OleStatisticalSearchingCodes> oleStatisticalSearchingCodes = new ArrayList<OleStatisticalSearchingCodes>();


        oleStatisticalSearchingCodes = (List<OleStatisticalSearchingCodes>) super.getSearchResults(form, searchCriteria, unbounded);
        finalSearchResult.addAll(oleStatisticalSearchingCodes);
