...
public class CopiesRequisitionEvent extends KualiDocumentEventBase {


    protected CopiesRequisitionEvent(String errorPathPrefix, Document document) {
        super("Creating Copies Tag" + getDocumentId(document), errorPathPrefix, document);
    }

    public CopiesRequisitionEvent(Document document, OleRequisitionItem reqItem) {
    ...
    public boolean invokeRuleMethod(BusinessRule rule) {
        return ((OleValidationRule) rule).processCustomAddCopiesRequisitionBusinessRules(document, reqItem);
    }
