...
public class ProcurementCardDocument extends CapitalAccountingLinesDocumentBase implements AmountTotaling, CapitalAssetEditable {
    ...
    /**
     * @see org.kuali.ole.sys.document.AccountingDocumentBase#getTargetAccountingLineClass()
     */
    @Override
     ...
     * @see org.kuali.ole.sys.document.validation.impl.AccountingDocumentRuleBase.IsDebitUtils#isDebitConsideringSection(AccountingDocumentRuleBase,
