 ...
 *
 * @see org.kuali.ole.vnd.businessobject.VendorHeader
 */
public class VendorDetail extends PersistableBusinessObjectBase implements VendorRoutingComparable {
  ...
  //  private String currencyType;
    ...
    private boolean linkedToEHoldings;

    private List<VendorTransmissionFormatDetail> vendorTransmissionFormat;
   ...
   // private Account accountNumber;
    ...
    private OlePaymentMethod vendorPaymentMethod;
    ...
    // jira OLE-3081
    private String vendorLinkingNumber;
    ...
    public VendorDetail() {
        ...
        vendorTransmissionFormat = new ArrayList<VendorTransmissionFormatDetail>();
   ...
   /* public Account getAccountNumber() {
    ...
    /**
     * @see org.kuali.ole.vnd.document.routing.VendorRoutingComparable#isEqualForRouting(java.lang.Object)
     */
    @Override
    public boolean isEqualForRouting(Object toCompare) {
        ...
        if ((ObjectUtils.isNull(toCompare)) || !(toCompare instanceof VendorDetail)) {
            ...
            return new EqualsBuilder().append(
                    ...
                    //MSU Contribution OLEMI-8580 DTT-3367 OLECNTRB-952
                    ...
                    this.getVendorPaymentTermsCode(), detail.getVendorPaymentTermsCode()).append(
                            this.getPaymentMethodId(), detail.getPaymentMethodId()).append(
    ...
    public List<VendorTransmissionFormatDetail> getVendorTransmissionFormat() {
        return vendorTransmissionFormat;
    }

    public void setVendorTransmissionFormat(List<VendorTransmissionFormatDetail> vendorTransmissionFormat) {
    ...
    public OlePaymentMethod getVendorPaymentMethod() {
        return vendorPaymentMethod;
    }

    public void setVendorPaymentMethod(OlePaymentMethod vendorPaymentMethod) {
        this.vendorPaymentMethod = vendorPaymentMethod;
    }

    public String getVendorLinkingNumber() {
        return vendorLinkingNumber;
    }

    public void setVendorLinkingNumber(String vendorLinkingNumber) {
        this.vendorLinkingNumber = vendorLinkingNumber;
    }

    private String claimInterval;

    public String getClaimInterval() {
        return claimInterval;
    }

    public void setClaimInterval(String claimInterval) {
    ...
    public List<VendorEventLog> getEventLogs() {
        return eventLogs;
    }

    public void setEventLogs(List<VendorEventLog> eventLogs) {
        this.eventLogs = eventLogs;
    }

    public String getGokbOrganizationStatus() {
        return gokbOrganizationStatus;
    }

    public void setGokbOrganizationStatus(String gokbOrganizationStatus) {
        this.gokbOrganizationStatus = gokbOrganizationStatus;
    }

    public Timestamp getGokbLastUpdated() {
        return gokbLastUpdated;
    }

    public void setGokbLastUpdated(Timestamp gokbLastUpdated) {
        this.gokbLastUpdated = gokbLastUpdated;
    }

    public boolean isLinkedToEHoldings() {
        return linkedToEHoldings;
    }
