...
import org.kuali.ole.coa.businessobject.OrganizationReversionGlobal;
import org.kuali.ole.coa.businessobject.OrganizationReversionGlobalDetail;
import org.kuali.ole.coa.businessobject.OrganizationReversionGlobalOrganization;
import org.kuali.ole.coa.businessobject.options.OrganizationReversionCodeValuesFinder;
import org.kuali.ole.coa.document.OrganizationReversionGlobalMaintainableImpl;
...
public class OrganizationReversionGlobalRule extends GlobalDocumentRuleBase {
    ...
    public boolean processCustomAddCollectionLineBusinessRules(MaintenanceDocument document, String collectionName, PersistableBusinessObject line) {
        ...
        if (line instanceof OrganizationReversionGlobalDetail) {
            ...
            if (!checkEmptyValue(org.getChartOfAccountsCode())) {
                GlobalVariables.getMessageMap().putError("chartOfAccountsCode", OLEKeyConstants.ERROR_REQUIRED, "Chart of Accounts Code");
            }
            if (!checkEmptyValue(org.getOrganizationCode())) {
                GlobalVariables.getMessageMap().putError("organizationCode", OLEKeyConstants.ERROR_REQUIRED, "Organization Code");
            }
            if (success) {
    ...
    public boolean checkBudgetReversionAccountPair(OrganizationReversionGlobal globalOrgRev) {
        ...
        if ((!StringUtils.isBlank(globalOrgRev.getBudgetReversionChartOfAccountsCode()) && StringUtils.isBlank(globalOrgRev.getBudgetReversionAccountNumber())) || (StringUtils.isBlank(globalOrgRev.getBudgetReversionChartOfAccountsCode()) && !StringUtils.isBlank(globalOrgRev.getBudgetReversionAccountNumber()))) {
            success = false;
            GlobalVariables.getMessageMap().putError(MAINTAINABLE_ERROR_PREFIX + "budgetReversionChartOfAccountsCode", OLEKeyConstants.ERROR_DOCUMENT_GLOBAL_ORG_REVERSION_BUDGET_REVERSION_INCOMPLETE, new String[] {});
        }
        return success;
    }
    ...
    public boolean checkCashReversionAccountPair(OrganizationReversionGlobal globalOrgRev) {
        ...
        if ((!StringUtils.isBlank(globalOrgRev.getCashReversionFinancialChartOfAccountsCode()) && StringUtils.isBlank(globalOrgRev.getCashReversionAccountNumber())) || (StringUtils.isBlank(globalOrgRev.getCashReversionFinancialChartOfAccountsCode()) && !StringUtils.isBlank(globalOrgRev.getCashReversionAccountNumber()))) {
            success = false;
            GlobalVariables.getMessageMap().putError(MAINTAINABLE_ERROR_PREFIX + "cashReversionFinancialChartOfAccountsCode", OLEKeyConstants.ERROR_DOCUMENT_GLOBAL_ORG_REVERSION_CASH_REVERSION_INCOMPLETE, new String[] {});
        }
        return success;
    }
    ...
    public boolean checkDetailOrgReversionCategoryValidity(OrganizationReversionGlobalDetail detail) {
        ...
        if (StringUtils.isBlank(detail.getOrganizationReversionCategoryCode())) {
            success = false;
            GlobalVariables.getMessageMap().putError("organizationReversionCategoryCode", OLEKeyConstants.ERROR_REQUIRED, new String[] {});
        }
        else {
            ...
            if (detail.getOrganizationReversionCategory() == null || !detail.getOrganizationReversionCategory().isActive()) {
                success = false;
                GlobalVariables.getMessageMap().putError("organizationReversionCategoryCode", OLEKeyConstants.ERROR_DOCUMENT_GLOBAL_ORG_REVERSION_INVALID_ORG_REVERSION_CATEGORY, new String[] { detail.getOrganizationReversionCategoryCode() });
            }
        }
        return success;
    }
    ...
    public boolean checkDetailObjectCodeValidity(OrganizationReversionGlobal globalOrgRev, OrganizationReversionGlobalDetail detail) {
        ...
        for (OrganizationReversionGlobalOrganization org : globalOrgRev.getOrganizationReversionGlobalOrganizations()) {
            if (!validObjectCode(globalOrgRev.getUniversityFiscalYear(), org.getChartOfAccountsCode(), detail.getOrganizationReversionObjectCode())) {
                success = false;
                GlobalVariables.getMessageMap().putError("organizationReversionObjectCode", OLEKeyConstants.ERROR_DOCUMENT_GLOBAL_ORG_REVERSION_OBJECT_CODE_INVALID, new String[] { globalOrgRev.getUniversityFiscalYear().toString(), org.getChartOfAccountsCode(), detail.getOrganizationReversionObjectCode(), org.getChartOfAccountsCode(), org.getOrganizationCode() });
            }
        }
        return success;
    }
    ...
    public boolean checkAllObjectCodesForValidity(OrganizationReversionGlobal globalOrgRev, OrganizationReversionGlobalOrganization org) {
        ...
        for (OrganizationReversionGlobalDetail detail : globalOrgRev.getOrganizationReversionGlobalDetails()) {
            if (!validObjectCode(globalOrgRev.getUniversityFiscalYear(), org.getChartOfAccountsCode(), detail.getOrganizationReversionObjectCode())) {
                success = false;
                GlobalVariables.getMessageMap().putError("organizationCode", OLEKeyConstants.ERROR_DOCUMENT_GLOBAL_ORG_REVERSION_OBJECT_CODE_INVALID, new String[] { globalOrgRev.getUniversityFiscalYear().toString(), org.getChartOfAccountsCode(), detail.getOrganizationReversionObjectCode(), org.getChartOfAccountsCode(), org.getOrganizationCode() });
            }
        }
        return success;
    }
    ...
    public boolean checkDetailObjectReversionCodeValidity(OrganizationReversionGlobalDetail detail) {
        ...
        if (!StringUtils.isBlank(detail.getOrganizationReversionCode())) {
            ...
            if (!foundInList) {
                ...
                GlobalVariables.getMessageMap().putError("organizationReversionCode", OLEKeyConstants.ERROR_DOCUMENT_GLOBAL_ORG_REVERSION_INVALID_ORG_REVERSION_CODE, new String[] { detail.getOrganizationReversionCode() });
            }
        }
        return success;
    }
    ...
    public boolean areAllOrganizationsValid(OrganizationReversionGlobal globalOrgRev) {
        ...
        if (globalOrgRev.getOrganizationReversionGlobalOrganizations().size() == 0) {
            putFieldError(OLEConstants.MAINTENANCE_ADD_PREFIX + "organizationReversionGlobalOrganizations.organizationCode", OLEKeyConstants.ERROR_DOCUMENT_GLOBAL_ORG_REVERSION_NO_ORGANIZATIONS);
        }
        else {
    ...
    public boolean checkOrganizationChartValidity(OrganizationReversionGlobalOrganization org) {
        ...
        if (StringUtils.isBlank(org.getChartOfAccountsCode())) {
            if (!StringUtils.isBlank(org.getOrganizationCode())) {
                success = false;
                GlobalVariables.getMessageMap().putError("chartOfAccountsCode", OLEKeyConstants.ERROR_REQUIRED, new String[] {});
            }
        }
        else {
            ...
            if (org.getChartOfAccounts() == null) {
                success = false;
                GlobalVariables.getMessageMap().putError("chartOfAccountsCode", OLEKeyConstants.ERROR_DOCUMENT_GLOBAL_ORG_REVERSION_INVALID_CHART, new String[] { org.getChartOfAccountsCode() });
            }
        }
        return success;
    }
    ...
    public boolean checkOrganizationValidity(OrganizationReversionGlobalOrganization org) {
        ...
        if (StringUtils.isBlank(org.getOrganizationCode())) {
            if (!StringUtils.isBlank(org.getChartOfAccountsCode())) {
                success = false;
                GlobalVariables.getMessageMap().putError("organizationCode", OLEKeyConstants.ERROR_REQUIRED, new String[] {});
            }
        }
            ...
            if (org.getOrganization() == null) {
                success = false;
                GlobalVariables.getMessageMap().putError("organizationCode", OLEKeyConstants.ERROR_DOCUMENT_GLOBAL_ORG_REVERSION_INVALID_ORGANIZATION, new String[] { org.getChartOfAccountsCode(), org.getOrganizationCode() });
            }
        }
        return success;
    }
    ...
    public boolean checkOrganizationReversionForOrganizationExists(OrganizationReversionGlobal globalOrgRev, OrganizationReversionGlobalOrganization org) {
        ...
        if (globalOrgRev.getUniversityFiscalYear() != null) {
            if (organizationReversionService.getByPrimaryId(globalOrgRev.getUniversityFiscalYear(), org.getChartOfAccountsCode(), org.getOrganizationCode()) == null) {
                success = false;
                GlobalVariables.getMessageMap().putError("organizationCode", OLEKeyConstants.ERROR_DOCUMENT_GLOBAL_ORG_REVERSION_NO_ORG_REVERSION, new String[] { globalOrgRev.getUniversityFiscalYear().toString(), org.getChartOfAccountsCode(), org.getOrganizationCode() });
            }
        }
        return success;
    }
    ...
    public boolean checkOrganizationIsNotAmongOrgRevOrganizations(OrganizationReversionGlobal globalOrgRev, OrganizationReversionGlobalOrganization orgRevOrg) {
        ...
        while (iter.hasNext() && success) {
            ...
            if (areContainingSameOrganizations(currOrg, orgRevOrg)) {
                success = false;
                GlobalVariables.getMessageMap().putError("organizationCode", OLEKeyConstants.ERROR_DOCUMENT_GLOBAL_ORG_REVERSION_DUPLICATE_ORGS, new String[] { orgRevOrg.getChartOfAccountsCode(), orgRevOrg.getOrganizationCode() });
            }
        }
        return success;
    }
