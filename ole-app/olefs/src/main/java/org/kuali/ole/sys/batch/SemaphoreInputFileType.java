...
import org.kuali.ole.sys.context.BatchStepFileDescriptor;
...
public class SemaphoreInputFileType extends BatchInputFileTypeBase {
	 ...
	 *
	 * @see org.kuali.ole.sys.batch.BatchInputFileType#getFileName(String, Object, String)
	 */
	@Override
    ...
    public String getTitleKey() {
    	return OLEKeyConstants.Semaphore.MESSAGE_BATCH_UPLOAD_TITLE_PREFIX +"."+ getFileExtension();
    }
     ...
     *
     * @see org.kuali.ole.sys.batch.BatchInputFileType#process(String, Object)
     */
	@Override
    public void process(String fileName, Object parsedFileContents) {
		...
		if (doneFile.exists()) {
			...
			if (!doneFile.delete()) {
		    	...
		    	errors.putError(OLEConstants.GLOBAL_ERRORS, OLEKeyConstants.Semaphore.ERROR_BATCH_UPLOAD_DELETE_DONE_FILE);
	 ...
	 *
	 * @see org.kuali.ole.sys.batch.BatchInputFileType#validate(Object)
	 */
	@Override
    public boolean validate(Object parsedFileContents) {
		...
		if (content.size() <= 0) {
	    	MessageMap errors = new MessageMap();
	    	errors.putError(OLEConstants.GLOBAL_ERRORS, OLEKeyConstants.Semaphore.ERROR_BATCH_UPLOAD_INVALID_STEP);
	    	GlobalVariables.mergeErrorMap(errors);
	    	return false;
		}
	 ...
	 *
	 * @see org.kuali.ole.sys.batch.BatchInputFileType#getAuthorPrincipalName(File)
	 */
	@Override
