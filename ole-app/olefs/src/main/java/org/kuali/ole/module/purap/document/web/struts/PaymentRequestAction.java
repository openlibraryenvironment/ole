...
public class PaymentRequestAction extends AccountsPayableActionBase {
    ...
    public ActionForward continuePREQ(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (ObjectUtils.isNotNull(paymentRequestDocument.getInvoiceNumber())) {
    ...
    protected ActionForward performDuplicatePaymentRequestAndEncumberFiscalYearCheck(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response, PaymentRequestDocument paymentRequestDocument) throws Exception {
        ...
        if (question == null) {
            ...
            if (isEncumberNextFiscalYear(paymentRequestDocument)) {
                ...
                return this.performQuestionWithoutInput(mapping, form, request, response, PREQDocumentsStrings.ENCUMBER_NEXT_FISCAL_YEAR_QUESTION, questionText, OLEConstants.CONFIRMATION_QUESTION, OLEConstants.ROUTE_METHOD, "");
            } else {
                ...
                if (!duplicateMessages.isEmpty()) {
                    return this.performQuestionWithoutInput(mapping, form, request, response, PREQDocumentsStrings.DUPLICATE_INVOICE_QUESTION, duplicateMessages.get(PREQDocumentsStrings.DUPLICATE_INVOICE_QUESTION), OLEConstants.CONFIRMATION_QUESTION, OLEConstants.ROUTE_METHOD, "");
                }
            }
        } else {
...
//    }
    ...
    /**
     * @see org.kuali.ole.module.purap.document.web.struts.AccountsPayableActionBase#getActionName()
     */
    @Override
