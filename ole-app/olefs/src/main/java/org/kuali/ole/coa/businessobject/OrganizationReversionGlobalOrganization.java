...
public class OrganizationReversionGlobalOrganization extends GlobalBusinessObjectDetailBase {
    ...
    protected LinkedHashMap toStringMapper_RICE20_REFACTORME() {
        ...
        stringMapper.put(OLEPropertyConstants.DOCUMENT_NUMBER, this.documentNumber);
        stringMapper.put(OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, this.chartOfAccountsCode);
        stringMapper.put(OLEPropertyConstants.ORGANIZATION_CODE, this.organizationCode);
        return stringMapper;
    }
    ...
    private String convertKeyToLockingRepresentation(String keyName) {
        ...
        sb.append(keyName);
        sb.append(OLEConstants.Maintenance.AFTER_FIELDNAME_DELIM);
        String keyValue = "";
        try {
        ...
        sb.append(OLEConstants.Maintenance.AFTER_VALUE_DELIM);
        return sb.toString();
    }
