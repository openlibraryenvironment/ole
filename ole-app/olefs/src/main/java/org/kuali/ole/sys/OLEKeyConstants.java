...
public class OLEKeyConstants {
    ...
    public static final String ERROR_ACCOUNT_INFORMATION_FILTER_VALIDATION= "error.account.information.filter.validation";
    public static final String ERROR_FILTER_VALIDATION = "error.filter.validation";
    public static final String ERROR_CHART_FILTER_VALIDATION = "error.chart.filter.validation";
    public static final String ERROR_VENDOR_DEPOSIT_ACCOUNT="error.vendor.deposit.account";
    public static final String ERROR_SUBFUND_GROUP_CODE="error.subfund.group.code";
    ...
    public static final String ERROR_DOCUMENT_ACCOUNT_IS_TEMPORARY_RESTRICTED = "error.document.account.is.temporary.restricted";
    public static final String ERROR_DOCUMENT_ACCOUNT_IS_RESTRICTED = "error.document.account.is.restricted";
    ...
    public static final String ERROR_DOCUMENT_ACCMAINT_INVALID_SUBFUNDGROUP_WITH_VENDOR_NAME = "error.document.accountMaintenance.invalidSubFundGroupWithVendorName";
    public static final String ERROR_DOCUMENT_ACCMAINT_VENDOR_NAME_NEEDED_FOR_SELECTED_SUBFUNDGROUP = "error.document.accountMaintenance.vendorName.needed";
    ...
    public static final String ERROR_DOCUMENT_ACCMAINT_ACCOUNT_TEMPORARY_RESTRICTED_STATUS_DATE_GREATERTHAN_CURRENTDATE = "error.document.accmaint.temporary.restricted.status.date.greaterthan.currentdate";
    public static final String ERROR_DOCUMENT_ACCMAINT_ACCOUNT_TEMPORARY_RESTRICTED_STATUS_DATE_NOTNULL = "error.document.accmaint.temporary.restricted.status.date.notnull";
    ...
    // Vendor errors
    public static final String ERROR_DUPLICATE_PREFERRED_FORMAT = "error.document.vendor.duplicatePreferredFormat";
    ...
    public static final String ERROR_ACC_LINE_TOTAL = "error.document.checktotal.accline";
    ...
    public static final String MESSAGE_BATCH_UPLOAD_TITLE_REQUISITION = "message.batchUpload.title.requisition";
    public static final String MESSAGE_BATCH_UPLOAD_TITLE_MARC = "message.batchUpload.title.marc";
    ...
    public static final String MESSAGE_BATCH_UPLOAD_TITLE_ORD = "message.batchUpload.title.ord";
    ...
    public static final String ERROR_BATCH_UPLOAD_NO_FILE_PATH_SELECTED_SAVE = "error.batchUpload.save.destinationPath";
    ...
    public static final String ERROR_BATCH_UPLOAD_FILE_SIZE = "error.batchUpload.fileSize";
    public static final String ERROR_BATCH_LOAD_PROFILE = "error.batchUpload.batchLoadProfile";
    public static final String ERROR_BATCH_LOAD_SCHEMA= "error.batchUpload.schema";

    // Requisition Error Messages
    public static final String ERROR_REQUISITION_APPROVE_WFE = "error.requisition.approve.wfe";
    public static final String ERROR_REQUISITION_CANCELED_WFE = "error.requisition.canceled.wfe";
    ...
    // Order Queue Page errors
    public static final String ERROR_ORDERQUEUE_REQUISITIONS_APPROVE = "error.orderqueue.requisitions.approve";
    public static final String ERROR_ORDERQUEUE_REQUISITIONS_NOAPPROVALS_REQD = "error.orderqueue.requisitions.noapprovals.reqd";
    public static final String ERROR_ORDERQUEUE_REQUISITIONS_ASSIGN = "error.orderqueue.requisitions.assign";
    public static final String ERROR_ORDERQUEUE_REQUISITIONS_CANCELED = "error.orderqueue.requisitions.canceled";
    public static final String ERROR_ORDERQUEUE_INVALID_SELECTOR = "error.orderqueue.invalid.selector";
    public static final String ERROR_ORDERQUEUE_INVALID_PRINCIPAL_NAME = "error.orderqueue.invalid.principalname";
    public static final String ERROR_ORDERQUEUE_REQUISITIONS_APPROVE_WFE = "error.orderqueue.requisitions.approve.wfe";
    public static final String ERROR_ORDERQUEUE_REQUISITIONS_CANCELED_WFE = "error.orderqueue.requisitions.canceled.wfe";
    public static final String ERROR_ORDERQUEUE_REQUISITIONS_SUBMIT_WFE = "error.orderqueue.requisitions.submit.wfe";
    public static final String MESSAGE_ORDERQUEUE_REQUISITIONS_APPROVED = "message.orderqueue.requisitions.approved";
    public static final String MESSAGE_ORDERQUEUE_REQUISITIONS_ASSIGNED = "message.orderqueue.requisitions.assigned";
    public static final String MESSAGE_ORDERQUEUE_REQUISITIONS_CANCELED = "message.orderqueue.requisitions.canceled";
    public static final String MESSAGE_ORDERQUEUE_REQUISITIONS_SELECT = "message.orderqueue.requisitions.select";
    public static final String ERROR_NO_REQUISITIONS_FOUND = "error.no.requisitions.found";
    public static final String MESSAGE_ORDERQUEUE_REQUISITIONS_HAS_NO_PRICE = "message.orderqueue.requisitions.has.noprice";
    public static final String WORKFLOWSTATUSCHANGEDATETO_NOT_LESSER_THAN_WORKFLOWSTATUSCHANGEDATEFROM = "workflowStatusChangeDateTo.not.lesserthan.workflowStatusChangeDateFrom";
    public static final String ERROR_ORDERQUEUE_REQUISITIONS_APPROVE_NOT_INITIATOR = "error.orderqueue.requisitions.approve.not.initiator";

    // Ole Receiving Line
    public static final String ERROR_RECEIVING_LINE_PRTRETURNED_GT_PRTRECEIVED = "error.receivingLine.partsReturnedGreaterThanPartsReceived";
    public static final String ERROR_RECEIVING_LINE_PRTDAMAGED_GT_PRTRECEIVED = "error.receivingLine.partsDamagedGreaterThanPartsReceived";
    public static final String ERROR_RECEIVING_LINE_EXCEPTION_NOTE_MANDATORY = "error.receivingLine.exceptionNote.mandatory";
    public static final String ERROR_RECEIVING_LINE_NOTACKNOWLEDGED = "error.receivingLine.notAcknowledged";
    public static final String ERROR_RECEIVING_LINE_RECEIVED_TOTAL_QUANTITY_NON_ZERO_UNORDERED = "error.receivingLine.receivedQuantity.nonZero.unOrdered";
    public static final String ERROR_RECEIVING_LINE_RECEIVED_TOTAL_PARTS_NON_ZERO_UNORDERED  = "error.receivingLine.receivedParts.nonZero.unOrdered";
    public static final String ERROR_RECEIVING_LINE_RECEIVED_TOTAL_QUANTITY_NON_ZERO_ORDERED = "error.receivingLine.receivedQuantity.nonZero.ordered";
    public static final String ERROR_RECEIVING_LINE_ITEM_RECEIVED_TOTAL_QUANTITY = "error.received.total.quantity";
    public static final String ERROR_RECEIVING_LINE_RECEIVED_TOTAL_PARTS_NON_ZERO_ORDERED = "error.receivingLine.receivedParts.nonZero.ordered";
    public static final String ERROR_RECEIVING_LINE_TOTAL_COPIES_NOT_EQUAL_QUANITY                                                        = "error.receivingLine.copies.notEqual.quantity";
    public static final String ERROR_TOTAL_COPIES_TOTAL_PARTS_SHOULDBE_LESSTHAN_OR_EQUALTO_QUANTITY_TOBE_RECEIVED_AND_PARTS_TOBE_RECEIVED = "error.total.copies.and.parts.should.be.lesserThan.or.equalTo.quantity.and.parts.tobe.received";
    public static final String ERROR_ATLEAST_ONE_COPY_SHOULD_ADD_WHEN_TOTAL_RECEIVED_COPY_IS_GREATERTHAN_ZERO                             = "error.atleast.one.copy.should.add.when.total.received.copy.is.greaterThan.zero";

    // Ole Receiving Queue Search Page
    public static final String ERROR_RECEIVING_LINE_PO_NOT_EXIST = "error.receiving.line.po.not.exist";
    public static final String ERROR_RECEIVING_LINE_PONOTACTIVE = "error.receiving.ine.poNotActive";
    public static final String ERROR_RECEIVING_LINE_DOCUMENT_ACTIVE_FOR_PO = "error.receiving.line.document.active.forpo";
    public static final String ERROR_PO_HAS_SPECIAL_HANDLING_NOTES = "error.po.has.special.handling.notes";
    public static final String ERROR_RECEIVING_LINE_SAVE_OR_SUBMIT = "error.receiving.line.save.or.submit";
    public static final String MESSAGE_RECEIVING_LINE_SUBMITTED = "message.receiving.line.submitted";
    ...
    //Ole Payment Request
    public static final String ERROR_PAYMENT_REQUEST_TOTAL_MISMATCH = "error.payment.request.total.mismatch";
    //Ole AcquiisitionsSearch
    public static final String ERROR_NO_DOC_TYPE_FOUND = "error.no.doc.type.found";
    public static final String ERROR_NO_RESULTS_FOUND = "error.no.results.found";
    public static final String ERROR_NO_TRANSACTION_FOUND = "error.no.transaction.found";

    public static final String ERROR_DOCSTORE_SERVER_UNAVAILABLE = "error.docstore.server.unavailable";

    // Added by Aditya for Jira OLE-2563
    public static final String ERROR_DATE_TO_NOT_LESSER_THAN_DATE_FROM = "error.date.to.not.lesser.than.date.from";


    // Added by Aditya for Jira OLE-3402
    public static final String ERROR_DUP_FOUND_STWRD_TYP_NAME = "error.duplicate.type.name";
    public static final String STWRDSHIP_TYPE_NAME = "stewardshipTypeName";
    ...
    public static final String ERROR_NO_VENDOR = "error.no.vendor";
    public static final String ERROR_NO_PO_EXIST = "error.no.po.exist";
    public static final String ERROR_NO_MATCHING_PO_VND = "error.no.matching.po.vnd";
    public static final String ERROR_NO_PO_SELECTED = "error.no.po.selected";
    public static final String ERROR_NO_INVOICE_DATE = "error.no.invoice.date";
    public static final String ERROR_NO_INVOICE_AMOUNT = "error.no.invoice.amount";
    public static final String ERROR_VALID_INVOICE_AMOUNT = "error.valid.invoice.amount";
    public static final String ERROR_NO_PAYMENT_MTHD = "error.no.payment.mthd";
    public static final String ERROR_PRORATE_DOLLAR_ZERO_ITEM_TOTAL = "error.prorate.dollar.zero.item.total";
    public static final String LOAD_DUPLICATE_INVOICE = "url.load.duplicate.invoice";
