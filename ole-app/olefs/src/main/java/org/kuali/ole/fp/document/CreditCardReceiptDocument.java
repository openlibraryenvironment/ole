    ...
    public boolean generateDocumentGeneralLedgerPendingEntries(GeneralLedgerPendingEntrySequenceHelper sequenceHelper) {
        ...
        if (SpringContext.getBean(BankService.class).isBankSpecificationEnabled()) {
            ...
            if (ObjectUtils.isNull(offsetBank)) {
                ...
                success &= glpeService.populateBankOffsetGeneralLedgerPendingEntry(offsetBank, bankOffsetAmount, this, getPostingYear(), sequenceHelper, bankOffsetEntry, OLEConstants.CREDIT_CARD_RECEIPTS_LINE_ERRORS);
