...
public class ProcurementCardObjectCodeValidation extends GenericValidation {
    ...
    public boolean validate(AttributedDocumentEvent event) {
        ...
        String errorKey = OLEPropertyConstants.FINANCIAL_OBJECT_CODE;
        ...
        if (!accountingLine.getObjectCode().isFinancialObjectActiveCode()) {
            errors.putError(errorKey, OLEKeyConstants.ERROR_INACTIVE, "object code");
        ...
        if (objectCodeAllowed) {
            ...
            objectCodeAllowed = evaluator.evaluateAndAddError(SourceAccountingLine.class, OLEPropertyConstants.FINANCIAL_OBJECT_CODE);
        }
        ...
        if (objectCodeAllowed) {
            ...
            objectCodeAllowed = evaluator.evaluateAndAddError(SourceAccountingLine.class, "objectCode.financialObjectSubTypeCode", OLEPropertyConstants.FINANCIAL_OBJECT_CODE);
        }
        return objectCodeAllowed;
    }
