...
public class PurapMassRequisitionStep extends AbstractStep implements TestingStep {
    ...
    private void setInitiatedRunParameter() {
        ...
        if (runIndicatorParameter == null) {
            Parameter.Builder newParameter = Builder.create(OLEConstants.APPLICATION_NAMESPACE_CODE, PurapConstants.PURAP_NAMESPACE, RUN_INDICATOR_PARAMETER_NAMESPACE_STEP, Job.STEP_RUN_PARM_NM, ParameterType.Builder.create("CONFG"));
    ...
    private class ChangeWaiter {
        ...
        public boolean valueChanged() throws Exception {
            ...
            String currentStatus = d.getDocumentHeader().getWorkflowDocument().getStatus().toString();

            for (String desiredWorkflowState : desiredWorkflowStates) {
