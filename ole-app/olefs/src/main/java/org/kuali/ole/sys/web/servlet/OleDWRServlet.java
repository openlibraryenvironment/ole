 ...
 */
package org.kuali.ole.sys.web.servlet;
...
import org.kuali.rice.core.framework.util.spring.NamedOrderedListBean;
import org.kuali.rice.krad.service.KRADServiceLocator;
import org.kuali.rice.krad.service.KualiModuleService;
import org.kuali.rice.krad.service.ModuleService;
import org.springframework.core.io.DefaultResourceLoader;

public class OleDWRServlet extends DwrServlet {
    /**
     * 
     */
    ...
    protected void configureContainer(Container container, ServletConfig servletConfig) throws ServletException, IOException {       
      ...
      ConfigurationService  configurationService=GlobalResourceLoader.getService("kualiConfigurationService");
        ...
        for (NamedOrderedListBean namedOrderedListBean : this.getDwrNamedOrderedListBeans(OLEConstants.SCRIPT_CONFIGURATION_FILES_LIST_NAME)) {
