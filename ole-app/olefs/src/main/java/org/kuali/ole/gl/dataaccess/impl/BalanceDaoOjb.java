...
import org.kuali.ole.gl.dataaccess.BalanceDao;
...
public class BalanceDaoOjb extends PlatformAwareDaoBaseOjb implements BalanceDao, LedgerBalanceBalancingDao {
     ...
     * @see org.kuali.ole.gl.dataaccess.BalanceDao#findBalancesForFiscalYear(java.lang.Integer)
     */
     ...
     * @see org.kuali.ole.gl.dataaccess.BalanceDao#findBalances(org.kuali.ole.coa.businessobject.Account, java.lang.Integer,
    ...
    public Iterator<Balance> findBalances(Account account, Integer fiscalYear, Collection includedObjectCodes, Collection excludedObjectCodes, Collection objectTypeCodes, Collection balanceTypeCodes) {
        ...
        criteria.addEqualTo(OLEPropertyConstants.ACCOUNT_NUMBER, account.getAccountNumber());
        criteria.addEqualTo(OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, account.getChartOfAccountsCode());
     ...
     * @see org.kuali.ole.gl.dataaccess.BalanceDao#lookupCashBalance(Map, boolean, List)
     */
     ...
     * @see org.kuali.ole.gl.dataaccess.BalanceDao#getDetailedCashBalanceRecordCount(Map, List)
     */
     ...
     * @param fieldValues the input fields and values
     * @return the size collection of cash balance entry groups
     * @see org.kuali.ole.gl.dataaccess.BalanceDao#getConsolidatedCashBalanceRecordCount(Map, List)
     */
     ...
     * @return an Iterator of Balances
     * @see org.kuali.ole.gl.dataaccess.BalanceDao#findBalance(java.util.Map, boolean)
     */
     ...
     * @see org.kuali.ole.gl.dataaccess.BalanceDao#getConsolidatedBalanceRecordCount(Map, List)
     */
    ...
    protected ReportQueryByCriteria getCashBalanceCountQuery(Map fieldValues, Collection<String> encumbranceBalanceTypes) {
        ...
        criteria.addEqualTo(OLEPropertyConstants.BALANCE_TYPE_CODE, OLEConstants.BALANCE_TYPE_ACTUAL);
        criteria.addEqualToField("chart.financialCashObjectCode", OLEPropertyConstants.OBJECT_CODE);

        ReportQueryByCriteria query = QueryFactory.newReportQuery(CashBalance.class, criteria);

        List groupByList = buildGroupByList();
        groupByList.remove(OLEPropertyConstants.SUB_ACCOUNT_NUMBER);
        groupByList.remove(OLEPropertyConstants.SUB_OBJECT_CODE);
        groupByList.remove(OLEPropertyConstants.OBJECT_TYPE_CODE);
    ...
    protected Query getCashBalanceQuery(Map fieldValues, boolean isConsolidated, Collection<String> encumbranceBalanceTypes) {
        ...
        if (isConsolidated) {
            attributeList.remove(OLEPropertyConstants.SUB_ACCOUNT_NUMBER);
            groupByList.remove(OLEPropertyConstants.SUB_ACCOUNT_NUMBER);
            attributeList.remove(OLEPropertyConstants.SUB_OBJECT_CODE);
            groupByList.remove(OLEPropertyConstants.SUB_OBJECT_CODE);
            attributeList.remove(OLEPropertyConstants.OBJECT_TYPE_CODE);
            groupByList.remove(OLEPropertyConstants.OBJECT_TYPE_CODE);
        }
    ...
    protected Criteria buildCriteriaFromMap(Map fieldValues, Balance balance, Collection<String> encumbranceBalanceTypes) {
        ...
        String propertyName = OLEPropertyConstants.BALANCE_TYPE_CODE;
        if (localFieldValues.containsKey(propertyName)) {
            ...
            if (OLEConstants.AGGREGATE_ENCUMBRANCE_BALANCE_TYPE_CODE.equals(propertyValue)) {
                localFieldValues.remove(OLEPropertyConstants.BALANCE_TYPE_CODE);

                criteria.addIn(OLEPropertyConstants.BALANCE_TYPE_CODE, encumbranceBalanceTypes);
            }
        }
    ...
    protected List<String> buildGroupByList() {
        ...
        attributeList.add(OLEPropertyConstants.OBJECT_TYPE_CODE);
     ...
     * @see org.kuali.ole.gl.dataaccess.BalanceDao#getCurrentBudgetForObjectCode(java.lang.Integer, java.lang.String,
    ...
    public Balance getCurrentBudgetForObjectCode(Integer universityFiscalYear, String chartOfAccountsCode, String accountNumber, String objectCode) {
        ...
        Criteria crit = new Criteria();
        crit.addEqualTo(OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR, universityFiscalYear);
        crit.addEqualTo(OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, chartOfAccountsCode);
        crit.addEqualTo(OLEPropertyConstants.ACCOUNT_NUMBER, accountNumber);
        crit.addEqualTo(OLEPropertyConstants.OBJECT_CODE, objectCode);
        crit.addEqualTo(OLEPropertyConstants.BALANCE_TYPE_CODE, OLEConstants.BALANCE_TYPE_CURRENT_BUDGET);
    ...
    public Iterator<Balance> findAccountBalances(Integer universityFiscalYear, String chartOfAccountsCode, String accountNumber) {
        ...
        return this.findAccountBalances(universityFiscalYear, chartOfAccountsCode, accountNumber, OLEConstants.SF_TYPE_OBJECT);
    }
    ...
    public Iterator<Balance> findAccountBalances(Integer universityFiscalYear, String chartOfAccountsCode, String accountNumber, String sfCode) {
        ...
        QueryByCriteria qbc = QueryFactory.newQuery(Balance.class, crit);
        if (OLEConstants.SF_TYPE_OBJECT.equals(sfCode)) {
            qbc.addOrderByAscending(OLEPropertyConstants.OBJECT_CODE);
        }
        else if (OLEConstants.SF_TYPE_LEVEL.equals(sfCode)) {
            qbc.addOrderByAscending(GeneralLedgerConstants.BalanceInquiryDrillDowns.OBJECT_LEVEL_CODE);
        }
        else if (OLEConstants.SF_TYPE_CONSOLIDATION.equals(sfCode)) {
     ...
     * @see org.kuali.ole.gl.dataaccess.BalanceDao#countBalancesForFiscalYear(java.lang.Integer)
     */
     ...
     * @see org.kuali.ole.gl.dataaccess.BalanceDao#findNominalActivityBalancesForFiscalYear(Integer, List, SystemOptions)
     */
    public Iterator<Balance> findNominalActivityBalancesForFiscalYear(Integer year, Collection<String> nominalActivityObjectTypeCodes, SystemOptions currentYearOptions) {
        ...
        Criteria c = new Criteria();
        c.addEqualTo(OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR, year);
        c.addEqualTo(OLEPropertyConstants.BALANCE_TYPE_CODE, currentYearOptions.getActualFinancialBalanceTypeCd());
        c.addIn(OLEPropertyConstants.OBJECT_TYPE_CODE, nominalActivityObjectTypeCodes);
    ...
    /**
     * @see org.kuali.ole.gl.dataaccess.BalanceDao#findCumulativeBalancesToForwardForFiscalYear(java.lang.Integer, java.util.List,
    ...
    public Iterator<Balance> findCumulativeBalancesToForwardForFiscalYear(Integer year, Collection<String> cumulativeForwardBalanceObjectTypes, Collection<String> contractsAndGrantsDenotingValues, Collection<String> subFundGroupsForCumulativeBalanceForwarding, Collection<String> cumulativeBalanceForwardBalanceTypes, boolean fundGroupDenotesCGInd) {
        Criteria c = new Criteria();
        c.addEqualTo(OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR, year);
        c.addIn(OLEPropertyConstants.BALANCE_TYPE_CODE, cumulativeBalanceForwardBalanceTypes);
        c.addIn(OLEPropertyConstants.OBJECT_TYPE_CODE, cumulativeForwardBalanceObjectTypes);
    ...
    /**
     * @see org.kuali.ole.gl.dataaccess.BalancingDao#findCountGreaterOrEqualThan(java.lang.Integer)
     */
