...
public class LoadDefaultLocationsListener implements ServletContextListener,
        HttpSessionListener, HttpSessionAttributeListener {

    private static final Logger LOG = Logger.getLogger(LoadDefaultLocationsListener.class);

    // Public constructor is required by servlet spec
    public LoadDefaultLocationsListener() {
    }
