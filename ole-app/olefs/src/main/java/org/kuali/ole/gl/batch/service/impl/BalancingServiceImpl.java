...
import org.kuali.ole.gl.batch.PosterBalancingStep;
import org.kuali.ole.gl.batch.service.BalancingService;
import org.kuali.ole.gl.businessobject.AccountBalance;
import org.kuali.ole.gl.businessobject.AccountBalanceHistory;
import org.kuali.ole.gl.businessobject.Balance;
import org.kuali.ole.gl.businessobject.BalanceHistory;
import org.kuali.ole.gl.businessobject.Encumbrance;
import org.kuali.ole.gl.businessobject.EncumbranceHistory;
import org.kuali.ole.gl.businessobject.Entry;
import org.kuali.ole.gl.businessobject.EntryHistory;
import org.kuali.ole.gl.businessobject.LedgerBalanceHistory;
import org.kuali.ole.gl.businessobject.OriginEntryFull;
import org.kuali.ole.gl.businessobject.OriginEntryInformation;
import org.kuali.ole.gl.dataaccess.AccountBalanceDao;
import org.kuali.ole.gl.dataaccess.BalancingDao;
...
public class BalancingServiceImpl extends BalancingServiceBaseImpl<EntryHistory, BalanceHistory> implements BalancingService {
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.BalancingService#getPosterInputFile()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.BalancingService#getPosterErrorOutputFile()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.BalancingService#getReversalInputFile()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.BalancingService#getReversalErrorOutputFile()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.BalancingService#getICRInputFile()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.BalancingService#getICRErrorOutputFile()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.BalancingService#getPastFiscalYearsToConsider()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.BalancingService#getComparisonFailuresToPrintPerReport()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.BalancingService#getShortTableLabel(java.lang.String)
     */
    @Override
    public String getShortTableLabel(String businessObjectName) {
        Map<String, String> names = new HashMap<String, String>();
        names.put((Entry.class).getSimpleName(), kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.REPORT_ENTRY_LABEL));
        names.put((EntryHistory.class).getSimpleName(), kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.REPORT_ENTRY_LABEL));
        names.put((Balance.class).getSimpleName(), kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.REPORT_BALANCE_LABEL));
        names.put((BalanceHistory.class).getSimpleName(), kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.REPORT_BALANCE_LABEL));
        names.put((AccountBalance.class).getSimpleName(), kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.REPORT_ACCOUNT_BALANCE_LABEL));
        names.put((AccountBalanceHistory.class).getSimpleName(), kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.REPORT_ACCOUNT_BALANCE_LABEL));
        names.put((Encumbrance.class).getSimpleName(), kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.REPORT_ENCUMBRANCE_LABEL));
        names.put((EncumbranceHistory.class).getSimpleName(), kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.REPORT_ENCUMBRANCE_LABEL));

        return names.get(businessObjectName) == null ? kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.REPORT_UNKNOWN_LABEL) : names.get(businessObjectName);
    }

    /**
     * @see org.kuali.ole.gl.batch.service.BalancingService#getOriginEntry(java.lang.String, int)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.BalancingService#updateEntryHistory(org.kuali.ole.gl.businessobject.OriginEntryInformation)
     * @see org.kuali.ole.gl.batch.service.impl.PostEntry#post(org.kuali.ole.gl.businessobject.Transaction, int, java.util.Date)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.BalancingService#getBalance(org.kuali.ole.gl.businessobject.LedgerBalanceHistory)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.BalancingService#clearPosterFileCache()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.impl.BalancingServiceBaseImpl#customPopulateHistoryTables(java.lang.Integer)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.impl.BalancingServiceBaseImpl#doesCustomHistoryExist(java.lang.Integer)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.impl.BalancingServiceBaseImpl#deleteCustomHistory(java.lang.Integer)
     */
    @Override
    protected void deleteCustomHistory(Integer fiscalYear) {
        ...
        reportWriterService.writeFormattedMessageLine(kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.MESSAGE_BATCH_BALANCING_OBSOLETE_FISCAL_YEAR_DATA_DELETED), (AccountBalanceHistory.class).getSimpleName(), (EncumbranceHistory.class).getSimpleName(), fiscalYear);
        reportWriterService.writeNewLines(1);
    }

    /**
     * @see org.kuali.ole.gl.batch.service.impl.BalancingServiceBaseImpl#updateCustomHistory(org.kuali.ole.gl.businessobject.OriginEntryInformation)
     */
    @Override
     ...
     * @see org.kuali.ole.gl.batch.service.impl.PostAccountBalance#post(org.kuali.ole.gl.businessobject.Transaction, int, java.util.Date)
     */
    protected void updateAccountBalanceHistory(OriginEntryInformation originEntry) {
        ...
        originEntryFull.refreshReferenceObject(OLEPropertyConstants.OPTION);
    ...
    /**
     *
     * @see org.kuali.ole.gl.batch.service.BalancingService#clearBalanceHistory()
     */
    ...
    public void clearHistories() {
        ...
        reportWriterService.writeFormattedMessageLine(kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.MESSAGE_BATCH_BALANCING_HISTORY_PURGED));
    }

    /**
     * @see org.kuali.ole.gl.batch.service.BalancingService#getFilenames()
     */
    @Override
        ...
        if (!data.isEmpty()) {
            for (Iterator<Balance> itr = data.iterator(); itr.hasNext();) {
                ...
                if (countComparisionFailures <= this.getComparisonFailuresToPrintPerReport()) {
                    reportWriterService.writeError(balance, new Message(kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.MESSAGE_BATCH_BALANCING_RECORD_FAILED_BALANCING), Message.TYPE_WARNING, balance.getClass().getSimpleName()));
                }
            }
        }
    ...
    protected Integer compareEntryHistory() {
        ...
        if (!data.isEmpty()) {
            for (Iterator<Entry> itr = data.iterator(); itr.hasNext();) {
                ...
                countComparisionFailures++;
                if (countComparisionFailures <= this.getComparisonFailuresToPrintPerReport()) {
                    reportWriterService.writeError(entry, new Message(kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.MESSAGE_BATCH_BALANCING_RECORD_FAILED_BALANCING), Message.TYPE_WARNING, entry.getClass().getSimpleName()));
                }
     ...
     * @param originEntry representing the update details
     * @see org.kuali.ole.gl.batch.service.impl.PostEncumbrance#post(org.kuali.ole.gl.businessobject.Transaction, int, java.util.Date)
     */
    protected void updateEncumbranceHistory(OriginEntryInformation originEntry) {
        ...
        if (OLEConstants.ENCUMB_UPDT_REFERENCE_DOCUMENT_CD.equals(originEntryFull.getTransactionEncumbranceUpdateCode())) {
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.impl.BalancingServiceBaseImpl#customCompareHistory()
     */
    @Override
    ...
    protected Integer accountBalanceCompareHistory() {
        ...
        if (!data.isEmpty()) {
            for (Iterator<AccountBalance> itr = data.iterator(); itr.hasNext();) {
                ...
                countComparisionFailures++;
                if (countComparisionFailures <= this.getComparisonFailuresToPrintPerReport()) {
                    reportWriterService.writeError(accountBalanceHistory, new Message(kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.MESSAGE_BATCH_BALANCING_RECORD_FAILED_BALANCING), Message.TYPE_WARNING, accountBalanceHistory.getClass().getSimpleName()));
                }
            }
            ...
            reportWriterService.writeNewLines(1);
            reportWriterService.writeFormattedMessageLine(kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.MESSAGE_BATCH_BALANCING_FAILURE_COUNT), (AccountBalanceHistory.class).getSimpleName(), countComparisionFailures, this.getComparisonFailuresToPrintPerReport());
        }
        return countComparisionFailures;
    }
    ...
    protected Integer encumbranceCompareHistory() {
        ...
        if (!data.isEmpty()) {
            for (Iterator<Encumbrance> itr = data.iterator(); itr.hasNext();) {
                ...
                countComparisionFailures++;
                if (countComparisionFailures <= this.getComparisonFailuresToPrintPerReport()) {
                    reportWriterService.writeError(encumbranceHistory, new Message(kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.MESSAGE_BATCH_BALANCING_RECORD_FAILED_BALANCING), Message.TYPE_WARNING, encumbranceHistory.getClass().getSimpleName()));
                }
            }
            ...
            reportWriterService.writeNewLines(1);
            reportWriterService.writeFormattedMessageLine(kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.MESSAGE_BATCH_BALANCING_FAILURE_COUNT), (EncumbranceHistory.class).getSimpleName(), countComparisionFailures, this.getComparisonFailuresToPrintPerReport());
        }
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.impl.BalancingServiceBaseImpl#customPrintRowCountHistory()
     */
    @Override
    protected void customPrintRowCountHistory(Integer fiscalYear) {
        ...
        reportWriterService.writeStatisticLine(kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.REPORT_ACCOUNT_BALANCE_ROW_COUNT_HISTORY), this.getShortTableLabel((AccountBalanceHistory.class).getSimpleName()), "(" + (AccountBalanceHistory.class).getSimpleName() + ")", this.getHistoryCount(null, AccountBalanceHistory.class));
        reportWriterService.writeStatisticLine(kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.REPORT_ACCOUNT_BALANCE_ROW_COUNT_PRODUCTION), this.getShortTableLabel((AccountBalance.class).getSimpleName()), accountBalanceDao.findCountGreaterOrEqualThan(fiscalYear));
        reportWriterService.writeStatisticLine(kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.REPORT_ENCUMBRANCE_ROW_COUNT_HISTORY), this.getShortTableLabel((EncumbranceHistory.class).getSimpleName()), "(" + (EncumbranceHistory.class).getSimpleName() + ")", this.getHistoryCount(null, EncumbranceHistory.class));
        reportWriterService.writeStatisticLine(kualiConfigurationService.getPropertyValueAsString(OLEKeyConstants.Balancing.REPORT_ENCUMBRANCE_ROW_COUNT_PRODUCTION), this.getShortTableLabel((Encumbrance.class).getSimpleName()), encumbranceDao.findCountGreaterOrEqualThan(fiscalYear));
    }
