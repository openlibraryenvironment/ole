...
public interface FiscalYearMaker {
     ...
     * @param currentRecord business object of type (@see org.kuali.ole.coa.dataaccess.FiscalYearMakerDao.getBusinessObjectClass())
     *        populated with the current year record data
     * @return business object of type (@see org.kuali.ole.coa.dataaccess.FiscalYearMakerDao.getBusinessObjectClass()) populated
