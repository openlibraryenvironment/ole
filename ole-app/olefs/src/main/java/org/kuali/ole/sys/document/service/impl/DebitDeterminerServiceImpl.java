...
public class DebitDeterminerServiceImpl implements DebitDeterminerService {
    ...
    /**
     * @see org.kuali.ole.sys.document.service.DebitDeterminerService#disallowErrorCorrectionDocumentCheck(org.kuali.ole.sys.document.GeneralLedgerPendingEntrySource)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.service.DebitDeterminerService#isAsset(org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntrySourceDetail)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.service.DebitDeterminerService#isAssetTypeCode(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.service.DebitDeterminerService#isDebitCode(java.lang.String)
     */
    public boolean isDebitCode(String debitCreditCode) {
        LOG.debug("isDebitCode(String) - start");

        boolean returnboolean = StringUtils.equals(OLEConstants.GL_DEBIT_CODE, debitCreditCode);
        LOG.debug("isDebitCode(String) - end");
        return returnboolean;
    }

    /**
     * @see org.kuali.ole.sys.document.service.DebitDeterminerService#isDebitConsideringNothingPositiveOnly(org.kuali.ole.sys.document.GeneralLedgerPendingEntrySource, org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntrySourceDetail)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.service.DebitDeterminerService#isDebitConsideringSection(org.kuali.ole.sys.document.AccountingDocument, org.kuali.ole.sys.businessobject.AccountingLine)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.service.DebitDeterminerService#isDebitConsideringType(org.kuali.ole.sys.document.GeneralLedgerPendingEntrySource, org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntrySourceDetail)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.service.DebitDeterminerService#isErrorCorrection(org.kuali.ole.sys.document.GeneralLedgerPendingEntrySource)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.service.DebitDeterminerService#isExpense(org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntrySourceDetail)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.service.DebitDeterminerService#isExpenseOrAsset(org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntrySourceDetail)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.service.DebitDeterminerService#isIncome(org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntrySourceDetail)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.service.DebitDeterminerService#isIncomeOrLiability(org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntrySourceDetail)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.service.DebitDeterminerService#isLiability(org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntrySourceDetail)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.service.DebitDeterminerService#isLiabilityTypeCode(java.lang.String)
     */
    ...
    public String getConvertedAmount(String objectType , String debitCreditCode , String amount ) {
        ...
        if(systemOption.getFinancialObjectTypeAssetsCd().equals(objectType)
            ...
            if (OLEConstants.GL_DEBIT_CODE.equals(debitCreditCode)) {
              amount = "-" + amount;
            }
...
/**
     * @see org.kuali.ole.sys.document.service.DebitDeterminerService#isRevenue(org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntrySourceDetail)
     */
