...
public class ChartDerivedRoleTypeServiceImpl extends DerivedRoleTypeServiceBase {
     ...
     *     Chart Code
     * Requirements:
     *     - OLE-SYS University Chart Manger:
     *     OLE-SYS Chart Manager where for the chart that matches the one on CA_ORG_T where CA_ORG_T.ORG_TYP_CD = U
     *
    ...
    public Map<String,String> convertQualificationForMemberRoles( String namespaceCode, String roleName, String memberRoleNamespaceCode, String memberRoleName, Map<String,String> qualification){
        ...
        if(chartOrg != null){
            ...
            processingChartQualification.put(OleKimAttributes.CHART_OF_ACCOUNTS_CODE, rootChartOfAccountCode);
    ...
    protected boolean performMatch(Map<String,String> inputAttributeSet, Map<String,String> storedAttributeSet) {
        // don't perform any matching - really just a pass-thru role for the embedded OLE-SYS User role
        return true;
    }
