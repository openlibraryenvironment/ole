 ...
 */
public class IsAddressVerifiedRuleFormulator extends RuleFormulatorUtil implements RuleFormulator {
    @Override
    ...
    protected String getTemplateFileName() {
        return "general-checks/address-verified.txt";
    }
    ...
    public boolean isInterested(String value) {
        return value.equals(DroolsConstants.GENERAL_CHECK_RULE_TYPE.ADDRESS_VERIFIED);
    }
