...
public class CorrectionForm extends KualiDocumentFormBase implements CorrectionDocumentEntryMetadata {
     ...
     * {@link org.kuali.ole.gl.service.OriginEntryGroupService} for the group id last saved in the doc would turn up no results.
     */
    ...
    public void populate(HttpServletRequest request) {
        ...
        if (OLEConstants.TableRenderConstants.SWITCH_TO_PAGE_METHOD.equals(getMethodToCall())) {
        ...
        if (OLEConstants.TableRenderConstants.SORT_METHOD.equals(getMethodToCall())) {
        ...
        if (StringUtils.isNotBlank(request.getParameter("processInBatch" + OLEConstants.CHECKBOX_PRESENT_ON_FORM_ANNOTATION)) && StringUtils.isBlank(request.getParameter("processInBatch"))) {
            setProcessInBatch(false);
        }
        
        if (StringUtils.isNotBlank(request.getParameter("matchCriteriaOnly" + OLEConstants.CHECKBOX_PRESENT_ON_FORM_ANNOTATION)) && StringUtils.isBlank(request.getParameter("matchCriteriaOnly"))) {
    ...
    protected void customInitMaxUploadSizes() {
        ...
        addMaxUploadSize(SpringContext.getBean(ParameterService.class).getParameterValueAsString(GeneralLedgerCorrectionProcessDocument.class, OLEConstants.ORIGIN_ENTRY_IMPORT_MAX_FILE_SIZE_PARM_NM));
    }
