...
public class SecTransactionalDocumentAuthorizer implements TransactionalDocumentAuthorizer {
    ...
    public boolean canViewNoteAttachment(Document document, String attachmentTypeCode, Person user) {
        ...
        if (canView) {
            ...
            if (!canView) {
                GlobalVariables.getMessageMap().putInfo(OLEConstants.GLOBAL_ERRORS, SecKeyConstants.MESSAGE_DOCUMENT_NOTES_RESTRICTED, (String) null);
            }
        }
        ...
        if (alwaysAllowInitiatorAccess) {
            ...
            if (hasViewRestrictions) {
                if (documentActionsToReturn.contains(KRADConstants.KUALI_ACTION_CAN_COPY)) {
                    ...
                    GlobalVariables.getMessageMap().putInfo(OLEConstants.GLOBAL_ERRORS, SecKeyConstants.MESSAGE_DOCUMENT_COPY_RESTRICTED, (String) null);
                }
                ...
                if (documentActionsToReturn.contains(OLEConstants.KFS_ACTION_CAN_ERROR_CORRECT)) {
                    ...
                    GlobalVariables.getMessageMap().putInfo(OLEConstants.GLOBAL_ERRORS, SecKeyConstants.MESSAGE_DOCUMENT_ERROR_CORRECT_RESTRICTED, (String) null);
                }
            }
        }
