 ...
 */
public class OleAgreementDocTypeKeyValues extends KeyValuesBase {
    ...
    public List getKeyValues() {
        ...
        Collection<OleAgreementDocType> oleAgreementDocTypes = KRADServiceLocator.getBusinessObjectService().findAll(OleAgreementDocType.class);
        keyValues.add(new ConcreteKeyValue("", "-- --"));
        for (OleAgreementDocType oleAgreementDocType : oleAgreementDocTypes) {
            keyValues.add(new ConcreteKeyValue(oleAgreementDocType.getAgreementDocTypeId(), oleAgreementDocType.getAgreementDocTypeName()));
        }
        return keyValues;
    }
