...
import org.kuali.ole.module.purap.PurapAuthorizationConstants.PurchaseOrderEditMode;
...
public class PurchaseOrderDocumentPresentationController extends PurchasingAccountsPayableDocumentPresentationController {
    ...
    public boolean canEdit(Document document) {
        ...
        //Check whether the document is created from a requisition.
        //if not make it editable

        if (!poDocument.isCreatedFromRequisition()) {
            return true;
        }
    ...
    public Set<String> getEditModes(Document document) {
        ...
        if (poDocument.isCreatedFromRequisition()) {
            editModes.add(PurchaseOrderEditMode.EDITABLE_FUNDING_SOURCE);
        }
