...
public class TaxRegionMaintainableImpl extends FinancialSystemMaintainable {
    ...
    protected String getSectionIdToDisplay(String taxRegionTypeCode) {
        if (OLEConstants.TaxRegionConstants.TAX_REGION_TYPE_CODE_STATE.equals(taxRegionTypeCode)) {
            return OLEConstants.TaxRegionConstants.TAX_REGION_STATES_SECTION_ID;
        }
        else if (OLEConstants.TaxRegionConstants.TAX_REGION_TYPE_CODE_COUNTY.equals(taxRegionTypeCode)) {
            return OLEConstants.TaxRegionConstants.TAX_REGION_COUNTIES_SECTION_ID;
        }
        else if (OLEConstants.TaxRegionConstants.TAX_REGION_TYPE_CODE_POSTAL_CODE.equals(taxRegionTypeCode)) {
            return OLEConstants.TaxRegionConstants.TAX_REGION_POSTAL_CODES_SECTION_ID;
        }
        else {
    ...
    protected boolean isMainOrRateSection(String sectionId) {
        return OLEConstants.TaxRegionConstants.TAX_REGION_RATES_SECTION_ID.equals(sectionId) || OLEConstants.TaxRegionConstants.TAX_REGION_CREATE_SECTION_ID.equals(sectionId);
    }
}
