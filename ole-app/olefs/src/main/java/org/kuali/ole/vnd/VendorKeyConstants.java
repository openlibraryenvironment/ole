...
public class VendorKeyConstants {
    ...
    public static final String ERROR_INACTIVE_REFERENCE = "error.vendorMaint.inactiveReason.reference";
    ...
    public static final String ERROR_PHONE_NUMBER = "error.vendorMaint.vendorAddress.phoneNumber";
    public static final String ERROR_FORIEGN_VENDOR_FAX_NUMBER = "error.vendorMaint.vendorAddress.foreignVendor.faxNumber";
    public static final String ERROR_FORIEGN_VENDOR_PHONE_NUMBER = "error.vendorMaint.vendorAddress.foreignVendor.phoneNumber";
    ...
    public static final String OLE_VENDOR_REQUISITION_LINKED = "error.vendor.requisition.linked";
    public static final String OLE_VENDOR_PURCHSEORDER_LINKED = "error.vendor.purchaseOrder.linked";
    public static final String OLE_VENDOR_GOKB_EXISTS = "error.gokbid.exists";
