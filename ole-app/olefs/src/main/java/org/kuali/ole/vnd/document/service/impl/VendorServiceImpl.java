 ...
 */
package org.kuali.ole.vnd.document.service.impl;
...
import org.kuali.ole.vnd.businessobject.VendorRoutingComparable;
import org.kuali.ole.vnd.dataaccess.VendorDao;
...
public class VendorServiceImpl implements VendorService {
    ...
    /**
     * @see org.kuali.ole.vnd.document.service.VendorService#saveVendorHeader(org.kuali.ole.vnd.businessobject.VendorDetail)
     */
    @Override
    public void saveVendorHeader(VendorDetail vendorDetail) {
        getBusinessObjectService().save(vendorDetail.getVendorHeader());
    }

    /**
     * @see org.kuali.ole.vnd.document.service.getByVendorNumber(String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.vnd.document.service.VendorService#getVendorDetail(String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.vnd.document.service.VendorService#getVendorDetail(java.lang.Integer, java.lang.Integer)
     */
    @Override
    public VendorDetail getVendorDetail(Integer headerId, Integer detailId) {
        ...
        return getBusinessObjectService().findByPrimaryKey(VendorDetail.class, keys);
    }

    /**
     * @see org.kuali.ole.vnd.document.service.VendorService#getApoLimitFromContract(Integer, String, String)
     */
    @Override
    public KualiDecimal getApoLimitFromContract(Integer contractId, String chart, String org) {
        ...
        if (ObjectUtils.isNotNull(contractId) && ObjectUtils.isNotNull(chart) && ObjectUtils.isNotNull(org)) {
            ...
            VendorContractOrganization contractOrg = getBusinessObjectService().findByPrimaryKey(VendorContractOrganization.class, pkFields);
        ...
        // contract
        if ( contractId != null ) {
            VendorContract contract = getBusinessObjectService().findBySinglePrimaryKey(VendorContract.class, contractId);
            if (contract != null) {
    ...
    /**
     * @see org.kuali.ole.vnd.document.service.VendorService#getParentVendor(java.lang.Integer)
     */
    @Override
    public VendorDetail getParentVendor(Integer vendorHeaderGeneratedIdentifier) {
        ...
        Collection<VendorDetail> vendors = getBusinessObjectService().findMatching(VendorDetail.class,
    ...
    /**
     * @see org.kuali.ole.vnd.document.service.VendorService#getVendorByDunsNumber(String)
     */
    @Override
    public VendorDetail getVendorByDunsNumber(String vendorDunsNumber) {
        ...
        Collection<VendorDetail> vds = getBusinessObjectService().findMatching(VendorDetail.class, criteria);
    ...
    /**
     * @see org.kuali.ole.vnd.document.service.VendorService#getVendorDefaultAddress(Integer, Integer, String, String)
     */
    @Override
    public VendorAddress getVendorDefaultAddress(Integer vendorHeaderId, Integer vendorDetailId, String addressType, String campus) {
        ...
        Collection<VendorAddress> addresses = getBusinessObjectService().findMatching(VendorAddress.class, criteria);
        LOG.debug("Exiting getVendorDefaultAddress.");
        return getVendorDefaultAddress(addresses, addressType, campus);
    }

    /**
     * @see org.kuali.ole.vnd.document.service.VendorService#getVendorDefaultAddress(List, String, String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.vnd.document.service.VendorService#noRouteSignificantChangeOccurred(org.kuali.ole.vnd.businessobject.VendorDetail,
    ...
    /**
     * @see org.kuali.ole.vnd.document.service.VendorService#equalMemberLists(java.util.List, java.util.List)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.vnd.document.service.VendorService#isVendorInstitutionEmployee(java.lang.Integer)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.vnd.document.service.VendorService#isVendorNonResidentAlien(java.lang.Integer)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.vnd.document.service.VendorService#isSubjectPaymentVendor(java.lang.Integer)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.vnd.document.service.VendorService#isRevolvingFundCodeVendor(java.lang.Integer)
     */
    @Override
    ...
    public Building getBuildingDetails(String campusCode, String buildingCode) {
      //  LOG.debug("Entering getVendorDetail for headerId:" + headerId + ", detailId:" + detailId);
        ...
        return getBusinessObjectService().findByPrimaryKey(Building.class, keys);
    }
    ...
    public VendorContract getVendorB2BContract(VendorDetail vendorDetail, String campus) {
        return SpringContext.getBean(org.kuali.ole.vnd.dataaccess.VendorDao.class).getVendorB2BContract(vendorDetail, campus, dateTimeService.getCurrentSqlDate());
    }
