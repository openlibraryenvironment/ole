...
public class AccountDelegateGlobalDetail extends GlobalBusinessObjectDetailBase {
    ...
    @Override
    public int hashCode() {
        return ObjectUtil.generateHashCode(this, Arrays.asList(OLEPropertyConstants.DOCUMENT_NUMBER,"financialDocumentTypeCode", "accountDelegatePrimaryRoutingIndicator", "accountDelegateUniversalId" ));
    }
