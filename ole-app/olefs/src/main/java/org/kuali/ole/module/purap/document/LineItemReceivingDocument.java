...
public class LineItemReceivingDocument extends ReceivingDocumentBase {
    ...
    protected void populateDocumentDescription(PurchaseOrderDocument poDocument) {
        String description =  getOlePurapService().getParameter(OLEConstants.LINE_ITEM_RCV_DESC);
        Map<String,String> descMap = new HashMap<>();
        descMap.put(OLEConstants.PO_DOC_ID,poDocument.getPurapDocumentIdentifier().toString());
        descMap.put(OLEConstants.VENDOR_NAME,poDocument.getVendorName());
    ...
    public boolean answerSplitNodeQuestion(String nodeName) throws UnsupportedOperationException {
        if (nodeName.equals(PurapWorkflowConstants.RELATES_TO_OUTSTANDING_TRANSACTIONS))
