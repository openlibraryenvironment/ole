 ...
 */
package org.kuali.ole.fp.document.dataaccess;
...
public class OJBTravelExpenseQueryCustomizer implements QueryCustomizer {
    ...
    private static final String prepaidIndicatorField = OLEPropertyConstants.DISB_VCHR_EXPENSE + "." + OLEPropertyConstants.PREPAID_EXPENSE;
    ...
    public Query customizeQuery(Object arg0, PersistenceBroker arg1, CollectionDescriptor arg2, QueryByCriteria arg3) {
        if ("TRUE".equals(getAttribute(prepaidAttributeName))) {
            arg3.getCriteria().addEqualTo(prepaidIndicatorField, OLEConstants.ACTIVE_INDICATOR);
        }
        else {
            arg3.getCriteria().addEqualTo(prepaidIndicatorField, OLEConstants.NON_ACTIVE_INDICATOR);
        }
        return arg3;
    }
