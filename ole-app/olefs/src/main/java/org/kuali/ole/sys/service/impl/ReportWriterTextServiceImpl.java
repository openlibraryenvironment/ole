...
import org.kuali.ole.sys.report.BusinessObjectReportHelper;
 ...
 * 
 * @see org.kuali.ole.sys.report.BusinessObjectReportHelper
 */
public class ReportWriterTextServiceImpl implements ReportWriterService, WrappingBatchService {
    ...
    /**
     * @see org.kuali.ole.sys.batch.service.WrappingBatchService#initialize()
     */
    ...
    /**
     * @see org.kuali.ole.sys.batch.service.WrappingBatchService#destroy()
     */
    public void destroy() {
        if(printStream != null) {        
            printStream.close();
    ...
    /**
     * @see org.kuali.ole.sys.service.ReportWriterService#writeSubTitle(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.sys.service.ReportWriterService#writeError(java.lang.Class, org.kuali.ole.sys.Message)
     */
    ...
    /**
     * @see org.kuali.ole.sys.service.ReportWriterService#writeError(java.lang.Class, java.util.List)
     */
    ...
    /**
     * @see org.kuali.ole.sys.service.ReportWriterService#writeNewLines(int)
     */
    ...
    /**
     * @see org.kuali.ole.sys.service.ReportWriterService#writeStatisticLine(java.lang.String, java.lang.Object[])
     */
    ...
    /**
     * @see org.kuali.ole.sys.service.ReportWriterService#writeParameterLine(java.lang.String, java.lang.Object[])
     */
    ...
    /**
     * @see org.kuali.ole.sys.service.ReportWriterService#writeFormattedMessageLine(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.sys.service.ReportWriterService#writeFormattedMessageLine(java.lang.String, java.lang.Object[])
     */
    ...
    /**
     * @see org.kuali.ole.sys.service.ReportWriterService#pageBreak()
     */
    ...
    protected void writeHeader(String title) {
        ...
        if (aggregationModeOn) {
            this.writeFormattedMessageLine("%s%s%s", headerText, pageLabel, OLEConstants.REPORT_WRITER_SERVICE_PAGE_NUMBER_PLACEHOLDER);
        }
        else {
    ...
    /**
     * @see org.kuali.ole.sys.service.ReportWriterService#writeTableHeader(org.kuali.rice.krad.bo.BusinessObject)
     */
    public void writeTableHeader(BusinessObject businessObject) {
        ...
        String tableHeaderFormat = tableDefinition.get(OLEConstants.ReportConstants.TABLE_HEADER_LINE_KEY);
    ...
    /**
     * @see org.kuali.ole.sys.service.ReportWriterService#writeTableRow(org.kuali.rice.krad.bo.BusinessObject)
     */
    public void writeTableRowSeparationLine(BusinessObject businessObject) {
        BusinessObjectReportHelper businessObjectReportHelper = getBusinessObjectReportHelper(businessObject);
        Map<String, String> tableDefinition = businessObjectReportHelper.getTableDefinition();

        String separationLine = tableDefinition.get(OLEConstants.ReportConstants.SEPARATOR_LINE_KEY);
    ...
    public void writeTableRow(BusinessObject businessObject) {
        ...
        String tableCellFormat = tableDefinition.get(OLEConstants.ReportConstants.TABLE_CELL_FORMAT_KEY);
    ...
    /**
     * @see org.kuali.ole.sys.service.ReportWriterService#writeTableRowWithColspan(org.kuali.rice.krad.bo.BusinessObject)
     */
    ...
    /**
     * @see org.kuali.ole.sys.service.ReportWriterService#writeTable(java.util.List, boolean, boolean)
     */
     ...
     * @see OLEConstants.ReportConstants.FORMAT_ESCAPE_CHARACTERS
     */
    protected String escapeFormatCharacters(String replacementString) {
        String escapedString = replacementString;
        for (int i = 0; i < OLEConstants.ReportConstants.FORMAT_ESCAPE_CHARACTERS.length; i++) {
            String characterToEscape = OLEConstants.ReportConstants.FORMAT_ESCAPE_CHARACTERS[i];
