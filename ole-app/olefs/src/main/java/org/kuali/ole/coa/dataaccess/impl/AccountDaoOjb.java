 ...
 */
package org.kuali.ole.coa.dataaccess.impl;
...
import org.kuali.ole.coa.dataaccess.AccountDao;
import org.kuali.ole.sys.OLEConstants;
import org.kuali.ole.sys.OLEPropertyConstants;
import org.kuali.ole.sys.businessobject.AccountResponsibility;
...
public class AccountDaoOjb extends PlatformAwareDaoBaseOjb implements AccountDao {
    ...
    /**
     * @see org.kuali.ole.coa.dataaccess.AccountDao#determineUserResponsibilityOnAccount(org.kuali.rice.kim.api.identity.Person,
     *      org.kuali.ole.coa.businessobject.Account, java.sql.Date)
     */
     ...
     * Code and for a Document Type Code of "OLE", the delegate for the specific document type code is returned;
     * 
     * @see org.kuali.ole.coa.dataaccess.AccountDao#getPrimaryDelegationByExample(org.kuali.ole.coa.businessobject.AccountDelegate,
     *      java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.coa.dataaccess.AccountDao#getSecondaryDelegationsByExample(org.kuali.ole.coa.businessobject.AccountDelegate,
     *      java.lang.String)
     */
    ...
    protected Criteria getDelegateByExampleCriteria(AccountDelegate delegateExample, Date currentSqlDate, String totalDollarAmount, String accountsDelegatePrmrtIndicator) {
        Criteria criteria = new Criteria();
        criteria.addEqualTo(OLEConstants.CHART_OF_ACCOUNTS_CODE_PROPERTY_NAME, delegateExample.getChartOfAccountsCode());
        criteria.addEqualTo(OLEConstants.ACCOUNT_NUMBER_PROPERTY_NAME, delegateExample.getAccountNumber());
        ...
        if (totalDollarAmount != null) {
            ...
            toAmountIsNullish.addIsNull(OLEPropertyConstants.FIN_DOC_APPROVAL_TO_THIS_AMOUNT);
            Criteria toAmountIsZero1 = new Criteria();
            toAmountIsZero1.addEqualTo(OLEPropertyConstants.FIN_DOC_APPROVAL_TO_THIS_AMOUNT, "0");
            toAmountIsNullish.addOrCriteria(toAmountIsZero1);

            Criteria fromMatchesClause = new Criteria();
            fromMatchesClause.addIsNull(OLEPropertyConstants.FIN_DOC_APPROVAL_FROM_THIS_AMT);
            Criteria fromAmountIsLessThanTotal = new Criteria();
            fromAmountIsLessThanTotal.addLessOrEqualThan(OLEPropertyConstants.FIN_DOC_APPROVAL_FROM_THIS_AMT, totalDollarAmount);
            ...
            toMatchesClause.addIsNull(OLEPropertyConstants.FIN_DOC_APPROVAL_TO_THIS_AMOUNT);
            Criteria toAmountIsZero2 = new Criteria();
            toAmountIsZero2.addEqualTo(OLEPropertyConstants.FIN_DOC_APPROVAL_TO_THIS_AMOUNT, "0");
            toMatchesClause.addOrCriteria(toAmountIsZero2);
            Criteria toAmountIsGreaterThanTotal = new Criteria();
            toAmountIsGreaterThanTotal.addGreaterOrEqualThan(OLEPropertyConstants.FIN_DOC_APPROVAL_TO_THIS_AMOUNT, totalDollarAmount);
            toMatchesClause.addOrCriteria(toAmountIsGreaterThanTotal);

            Criteria fromIsNullClause = new Criteria();
            fromIsNullClause.addIsNull(OLEPropertyConstants.FIN_DOC_APPROVAL_FROM_THIS_AMT);
            Criteria fromIsZeroClause = new Criteria();
            fromIsZeroClause.addEqualTo(OLEPropertyConstants.FIN_DOC_APPROVAL_FROM_THIS_AMT, "0");
            ...
            bothActive.addLessOrEqualThan(OLEPropertyConstants.FIN_DOC_APPROVAL_FROM_THIS_AMT, totalDollarAmount);
            bothActive.addGreaterOrEqualThan(OLEPropertyConstants.FIN_DOC_APPROVAL_TO_THIS_AMOUNT, totalDollarAmount);
    ...
    /**
     * @see org.kuali.ole.coa.dataaccess.AccountDao#getAllAccounts()
    ...
    /**
     * @see org.kuali.ole.coa.dataaccess.AccountDao#getActiveAccountsForAccountSupervisor(java.lang.String, java.sql.Date)
     */
    ...
    /**
     * @see org.kuali.ole.coa.dataaccess.AccountDao#getActiveAccountsForFiscalOfficer(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.coa.dataaccess.AccountDao#getExpiredAccountsForAccountSupervisor(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.coa.dataaccess.AccountDao#getExpiredAccountsForFiscalOfficer(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.coa.dataaccess.AccountDao#isPrincipalInAnyWayShapeOrFormAccountManager(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.coa.dataaccess.AccountDao#isPrincipalInAnyWayShapeOrFormAccountSupervisor(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.coa.dataaccess.AccountDao#isPrincipalInAnyWayShapeOrFormFiscalOfficer(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.coa.dataaccess.AccountDao#getAccountsForAccountNumber(java.lang.String)
     */
