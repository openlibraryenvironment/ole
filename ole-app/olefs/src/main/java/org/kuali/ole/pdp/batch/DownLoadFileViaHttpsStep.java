...
import org.kuali.ole.pdp.util.HttpsTrustManager;
...
public class DownLoadFileViaHttpsStep extends AbstractStep {
    ...
    public boolean execute(String jobName, Date jobRunDate) throws InterruptedException {
        ...
        String sourceFileUrl = getParameterService().getParameterValueAsString(OleParameterConstants.PRE_DISBURSEMENT_BATCH.class, PdpParameterConstants.FEDERAL_ACH_BANK_FILE_URL);
        String targetFileName = getParameterService().getParameterValueAsString(OleParameterConstants.PRE_DISBURSEMENT_BATCH.class, PdpParameterConstants.ACH_BANK_INPUT_FILE);
