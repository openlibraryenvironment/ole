...
import org.kuali.ole.coa.businessobject.ReportingCode;
    ...
    protected boolean checkReportsToReportingCode() {
        ...
        if (doExistenceTest) {
            ...
            if (!ObjectUtils.isNotNull(referenceBo)) {
                putFieldError("financialReportsToReportingCode", OLEKeyConstants.ERROR_EXISTENCE, "Reports To Reporting Code");
                success &= false;
            }
        }
        return success;
