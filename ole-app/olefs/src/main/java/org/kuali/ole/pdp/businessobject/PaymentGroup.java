...
import org.kuali.ole.sys.businessobject.TimestampedBusinessObjectBase;
...
public class PaymentGroup extends TimestampedBusinessObjectBase {
    ...
    protected LinkedHashMap toStringMapper_RICE20_REFACTORME() {
        ...
        m.put(OLEPropertyConstants.ID, this.id);
    ...
    public String getStreet() {
        ...
        street.append(StringUtils.isNotBlank(line1Address) ? (line1Address + OLEConstants.NEWLINE) : OLEConstants.EMPTY_STRING);
        street.append(StringUtils.isNotBlank(line2Address) ? (line2Address + OLEConstants.NEWLINE) : OLEConstants.EMPTY_STRING);
        street.append(StringUtils.isNotBlank(line3Address) ? (line3Address + OLEConstants.NEWLINE) : OLEConstants.EMPTY_STRING);
        street.append(StringUtils.isNotBlank(line4Address) ? (line4Address + OLEConstants.NEWLINE) : OLEConstants.EMPTY_STRING);
