 ...
 */
public class OLEBatchProcessPatronImportProfileValueFinder extends KeyValuesBase {

    private static final Logger LOG = Logger.getLogger(OLEBatchProcessPatronImportProfileValueFinder.class);
    ...
    public List<KeyValue> getKeyValues() {
        ...
        List<KeyValue> options = initProfileDetailsForPatronImport();
        return options;
    }

    public static List<KeyValue> initProfileDetailsForPatronImport() {

        List<KeyValue> keyValues = new ArrayList<KeyValue>();
        BusinessObjectService businessObjectService = KRADServiceLocator.getBusinessObjectService();
        Map parentCriteria1 = new HashMap();
        parentCriteria1.put("batchProcessProfileType", "Patron Import");
    ...
    public static List<String> retrieveBatchProfileNamesForPatronImport(String locationVal) {
        List<KeyValue> locationKeyValues = retrieveProfileDetailsForPatronImport();
    ...
    private static List<KeyValue> retrieveProfileDetailsForPatronImport() {
        long currentTime = System.currentTimeMillis() / 1000;
        if (locationKeyValues == null) {
            locationKeyValues = initProfileDetailsForPatronImport();
    ...
    public  static String getValue(String batchVal){
        String value="";
        locationKeyValues=retrieveProfileDetailsForPatronImport();
