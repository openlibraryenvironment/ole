...
public interface BatchInputFileSetType extends BatchInputType {
     ...
     * 
     * If validation fails, the implementation is responsible for adding error messages to the {@link OLEConstants#GLOBAL_ERRORS} property
     ...
     * 
     * @param typeToFiles a map consisting of file type Strings (see {@link #getFileTypes()}) to file mappings
     *        Note that the map may contain the file handle for {@link OLEConstants#DONE_FILE_TYPE} for the done file,
     *        if it was created 
     */
