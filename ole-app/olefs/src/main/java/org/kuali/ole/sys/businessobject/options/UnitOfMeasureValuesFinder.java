...
public class UnitOfMeasureValuesFinder extends KeyValuesBase {
    ...
    public List getKeyValues() {
        Collection<UnitOfMeasure> results = SpringContext.getBean(KeyValuesService.class).findAllOrderBy(UnitOfMeasure.class, OLEPropertyConstants.ITEM_UNIT_OF_MEASURE_DESCRIPTION, true);
