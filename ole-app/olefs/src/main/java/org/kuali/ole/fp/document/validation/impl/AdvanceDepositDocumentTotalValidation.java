...
public class AdvanceDepositDocumentTotalValidation extends GenericValidation {
    ...
    public boolean validate(AttributedDocumentEvent event) {
        ...
        if (!isValid) {
            GlobalVariables.getMessageMap().putError(OLEPropertyConstants.NEW_ADVANCE_DEPOSIT, OLEKeyConstants.AdvanceDeposit.ERROR_DOCUMENT_ADVANCE_DEPOSIT_OUT_OF_BALANCE);
        }
