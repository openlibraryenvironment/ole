...
public class LoadDefaultCirculationPoliciesListener implements ServletContextListener,
        HttpSessionListener, HttpSessionAttributeListener {
    private static final Logger LOG = Logger.getLogger(LoadDefaultCirculationPoliciesListener.class);

    // Public constructor is required by servlet spec
    public LoadDefaultCirculationPoliciesListener() {
    }
