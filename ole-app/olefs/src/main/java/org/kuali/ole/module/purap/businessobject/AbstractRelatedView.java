...
public abstract class AbstractRelatedView extends PersistableBusinessObjectBase {
    ...
    public List<Note> getNotes() {
        ...
        String document = findDocument(this.documentNumber).getDocumentHeader().getObjectId();
        List<Note> tmpNotes = null;
        if (document != null)
            tmpNotes = noteService.getByRemoteObjectId(document);
        notes.clear();
    ...
    public String getUrl() {
        ...
        if (handler.equals("OLEInvoice"))
            return docHandlerUrl + "&" + KRADConstants.PARAMETER_DOC_ID + "=" + this.getDocumentNumber() + "&" + KRADConstants.PARAMETER_COMMAND + "=" + KewApiConstants.DOCSEARCH_COMMAND;
        else
