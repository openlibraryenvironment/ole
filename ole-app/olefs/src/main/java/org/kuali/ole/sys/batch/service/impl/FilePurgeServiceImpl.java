...
import org.kuali.ole.sys.batch.FilePurgeCustomAge;
import org.kuali.ole.sys.batch.FilePurgeDirectoryWalker;
import org.kuali.ole.sys.batch.FilePurgeStep;
import org.kuali.ole.sys.batch.MaxAgePurgeFileFilter;
import org.kuali.ole.sys.batch.NotAmongDirectoriesFileFilter;
import org.kuali.ole.sys.batch.service.FilePurgeService;
...
public class FilePurgeServiceImpl implements FilePurgeService {
     ...
     * @see org.kuali.ole.gl.batch.service.FilePurgeService#purgeFiles(java.lang.String, java.util.List)
     */
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.FilePurgeService#getAgeInDaysForCustomAge(org.kuali.ole.sys.batch.FilePurgeCustomAge)
     */
    ...
    /**
     * @see org.kuali.ole.gl.batch.service.FilePurgeService#getStandardDaysBeforePurge()
     */
