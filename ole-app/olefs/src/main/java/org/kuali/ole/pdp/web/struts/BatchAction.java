...
import org.kuali.ole.pdp.service.BatchMaintenanceService;
import org.kuali.ole.pdp.util.PdpBatchQuestionCallback;
...
public class BatchAction extends KualiAction {
        ...
        if (question == null) {
            ...
            if ((confirmationQuestion.equals(question)) && ConfirmationQuestion.NO.equals(buttonClicked)) {
                ...
                if (StringUtils.isBlank(reason)) {
                    ...
                    return this.performQuestionWithInputAgainBecauseOfErrors(mapping, form, request, response, confirmationQuestion, confirmationText, KRADConstants.CONFIRMATION_QUESTION, OLEConstants.MAPPING_BASIC, batchId, reason, PdpKeyConstants.BatchConstants.ErrorMessages.ERROR_NOTE_EMPTY, KRADConstants.QUESTION_REASON_ATTRIBUTE_NAME, "");
                }
    ...
    private String buildUrl(String batchId, boolean success, String message, String errorList) {
        ...
        parameters.put(OLEConstants.BUSINESS_OBJECT_CLASS_ATTRIBUTE, Batch.class.getName());
