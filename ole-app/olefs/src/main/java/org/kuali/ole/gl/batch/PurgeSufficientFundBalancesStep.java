...
public class PurgeSufficientFundBalancesStep extends AbstractStep {
    ...
    public boolean execute(String jobName, Date jobRunDate) {
        String yearStr = getParameterService().getParameterValueAsString(PurgeSufficientFundBalancesStep.class, OLEConstants.SystemGroupParameterNames.PURGE_GL_SF_BALANCES_T_BEFORE_YEAR);
     ...
     * @see org.kuali.ole.gl.service.SufficientFundsService
     */
