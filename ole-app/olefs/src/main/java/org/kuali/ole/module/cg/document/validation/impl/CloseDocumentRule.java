...
public class CloseDocumentRule extends TransactionalDocumentRuleBase {
    ...
    public boolean processCustomRouteDocumentBusinessRules(Document document) {
        ...
        if (closeDate == null) {
            ...
            GlobalVariables.getMessageMap().putError("userInitiatedCloseDate", OLEKeyConstants.ContractsAndGrants.USER_INITIATED_DATE_TOO_EARLY, closeDateLabel);
        }
        if (closeOnOrBeforeDate == null) {
            ...
            GlobalVariables.getMessageMap().putError("closeOnOrBeforeDate", OLEKeyConstants.ContractsAndGrants.CLOSE_ON_OR_BEFORE_DATE_TOO_EARLY, closeOnOrBeforeDateLabel);
        } else if (closeOnOrBeforeDate.getTime() > closeDate.getTime()) {
            closeOnOrBeforeDateIsCloseDateOrEarlier = false;
            GlobalVariables.getMessageMap().putError("closeOnOrBeforeDate", OLEKeyConstants.ContractsAndGrants.CLOSE_ON_OR_BEFORE_DATE_TOO_LATE, closeOnOrBeforeDateLabel, closeDateLabel);
        }
