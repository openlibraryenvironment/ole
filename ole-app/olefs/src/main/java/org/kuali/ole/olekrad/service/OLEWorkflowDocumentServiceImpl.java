package org.kuali.ole.olekrad.service;
...
import org.kuali.rice.krad.workflow.service.impl.WorkflowDocumentServiceImpl;
...
public class OLEWorkflowDocumentServiceImpl extends WorkflowDocumentServiceImpl {
    ...
    private static org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(OLEWorkflowDocumentServiceImpl.class);
...
//        return KEWServiceLocator.getRouteHeaderService().getRouteHeader(workflowDocument.getDocumentId()).getCurrentRouteLevelName();
            ...
            for (AdHocRouteRecipient recipient : adHocRecipients) {
                if (StringUtils.isNotEmpty(recipient.getId())) {
                    ...
                    if (AdHocRouteRecipient.PERSON_TYPE.equals(recipient.getType())) {
                        ...
                        Principal principal = KimApiServiceLocator.getIdentityService().getPrincipalByPrincipalName(recipient.getName());
                        if (principal == null) {
     ...
     *
     * @see org.kuali.rice.krad.workflow.service.WorkflowDocumentService#complete(org.kuali.rice.kew.api.WorkflowDocument, String, java.util.List)
     */
