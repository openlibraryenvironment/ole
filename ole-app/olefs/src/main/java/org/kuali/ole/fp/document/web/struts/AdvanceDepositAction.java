...
import org.kuali.ole.fp.document.validation.impl.AdvanceDepositDocumentRuleUtil;
...
public class AdvanceDepositAction extends CapitalAccountingLinesActionBase {
    ...
    */
    ...
    protected boolean validateNewAdvanceDeposit(AdvanceDepositDetail advanceDeposit) {
        GlobalVariables.getMessageMap().addToErrorPath(OLEPropertyConstants.NEW_ADVANCE_DEPOSIT);
        boolean isValid = AdvanceDepositDocumentRuleUtil.validateAdvanceDeposit(advanceDeposit);
        GlobalVariables.getMessageMap().removeFromErrorPath(OLEPropertyConstants.NEW_ADVANCE_DEPOSIT);
        return isValid;
    }
