        ...
        if (jsonObject != null) {
            ...
            if (oleShelvingSchemeBo != null && validObject) {
                ...
                if (oleShelvingScheme != null) {
                    ...
                    String details = getOleShelvingSchemeLoaderHelperService().formOleShelvingSchemeExportResponse(oleShelvingScheme, OLELoaderConstants.OLELoaderContext.SHELVING_SCHEME,
