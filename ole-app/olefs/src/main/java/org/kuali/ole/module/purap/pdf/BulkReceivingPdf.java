...
public class BulkReceivingPdf extends PurapPdf {
    ...
    private String getFormattedVendorAddress() {
        ...
        if (blkRecDoc.getGoodsDeliveredVendorNumber() == null ||
            ...
            if (!OLEConstants.COUNTRY_CODE_UNITED_STATES.equalsIgnoreCase(blkRecDoc.getVendorCountryCode()) && blkRecDoc.getVendorCountry() != null) {
            ...
            if (!OLEConstants.COUNTRY_CODE_UNITED_STATES.equalsIgnoreCase(blkRecDoc.getAlternateVendorDetail().getDefaultAddressCountryCode()) && blkRecDoc.getAlternateVendorDetail().getDefaultAddressCountryCode() != null) {
