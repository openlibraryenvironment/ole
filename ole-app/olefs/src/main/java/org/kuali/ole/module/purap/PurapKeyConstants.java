...
public class PurapKeyConstants {
    ...
    public static final String AP_QUESTION_CONFIRM_INVOICE_MISMATCH = "ole.ap.question.confirm.invoice.mismatch";
    public static final String AP_QUESTION_CONFIRM_INVOICE_SUBSCRIPTION_DATE_OVERLAP = "ole.ap.question.confirm.invoice.subscription.date.overlap";
    ...
    public static final String ERROR_PURCHASE_ORDER_NOT_FOUND = "error.invoice.purchaseOrder.notFound";
    ...
    public static final String ERROR_PURCHASE_ORDER_PENDING_ACTION = "error.invoice.purchase.order.pending.action";
    ...
    public static final String ERROR_PO_ADD = "error.invoice.purchaseOrder.add";
    public static final String ERROR_INVALID_DEPOSIT_ACCT = "error.invalid.deposit.account";
    ...
    public static final String ERROR_SELECT_ERESOURCE = "error.select.eresource";
    public static final String ERROR_ERESOURCE_ONLY_ONE_PARENT = "error.eresource.only.one.parent";
    public static final String ERROR_ERESOURCE_ALREADY_HAS_PARENT = "error.eresource.already.has.parent";
