...
import org.kuali.ole.module.purap.pdf.*;
...
public class PrintServiceImpl implements PrintService {
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PrintService#generatePurchaseOrderQuoteRequestsListPdf(org.kuali.ole.module.purap.document.PurchaseOrderDocument, java.io.ByteArrayOutputStream)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PrintService#savePurchaseOrderQuoteRequestsListPdf(org.kuali.ole.module.purap.document.PurchaseOrderDocument)
     */
    @Override
    ...
    /*protected PurchaseOrderPdfFaxParameters getPurchaseOrderQuotePdfParameters(PurchaseOrderDocument po) {
        ...
        if (parameterService.parameterExists(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapConstants.PDF_IMAGES_AVAILABLE_INDICATOR)) {
            useImage = parameterService.getParameterValueAsBoolean(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapConstants.PDF_IMAGES_AVAILABLE_INDICATOR);
        }
        ...
        if (useImage) {
            imageTempLocation = kualiConfigurationService.getPropertyValueAsString(OLEConstants.TEMP_DIRECTORY_KEY) + "/";
        ...
        criteria.put(OLEPropertyConstants.CAMPUS_CODE, po.getDeliveryCampusCode());
        ...
        String pdfFileLocation = parameterService.getParameterValueAsString(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapConstants.PDF_DIRECTORY);
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PrintService#generatePurchaseOrderQuotePdf(org.kuali.ole.module.purap.document.PurchaseOrderDocument, org.kuali.ole.module.purap.businessobject.PurchaseOrderVendorQuote, java.io.ByteArrayOutputStream, java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PrintService#savePurchaseOrderQuotePdf(org.kuali.ole.module.purap.document.PurchaseOrderDocument, org.kuali.ole.module.purap.businessobject.PurchaseOrderVendorQuote, java.lang.String)
     */
    @Override
   ...
   /* protected PurchaseOrderPdfFaxParameters getPurchaseOrderPdfParameters(PurchaseOrderDocument po) {
        ...
        String statusInquiryUrl = parameterService.getParameterValueAsString(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapConstants.STATUS_INQUIRY_URL);
        ...
        criteria.put(OLEPropertyConstants.ACTIVE, true);
    ...
    protected Collection generatePurchaseOrderPdf(PurchaseOrderDocument po, ByteArrayOutputStream byteArrayOutputStream, boolean isRetransmit, String environment, List<PurchaseOrderItem> retransmitItems) {
        ...
        try {
            ...
            if (LOG.isInfoEnabled()) {
                LOG.info("PDF Parameters in PrintServiceImpl" + "pdfParameters:" + pdfParameters + "isRetransmit:"
                        + isRetransmit + "retransmitItems:" + retransmitItems);
            }
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PrintService#generatePurchaseOrderPdf(org.kuali.ole.module.purap.document.PurchaseOrderDocument,
    ...
    public Collection generatePurchaseOrderPdf(PurchaseOrderDocument po, ByteArrayOutputStream byteArrayOutputStream, String environment, List<PurchaseOrderItem> retransmitItems) {
        if (LOG.isInfoEnabled()) {
            LOG.info("Inside the PrintServiceImpl class" + "PO:" + po + "ByteArrayOutputStream:"
                    + byteArrayOutputStream + "environment:" + environment + "retransmitItems:" + retransmitItems);
        }
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PrintService#savePurchaseOrderPdf(org.kuali.ole.module.purap.document.PurchaseOrderDocument,
     *      java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PrintService#savePurchaseOrderPdfForRetransmission(org.kuali.ole.module.purap.document.PurchaseOrderDocument,
     *      java.lang.String)
     */
    @Override
