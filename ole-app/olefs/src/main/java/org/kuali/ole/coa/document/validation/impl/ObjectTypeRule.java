...
public class ObjectTypeRule extends MaintenanceDocumentRuleBase {
    ...
    protected boolean checkAccountingCategory(MaintenanceDocument document) {
        ...
        if (basicAccountingCategory == null) {
            result = false;
            putFieldError("basicAccountingCategoryCode", OLEKeyConstants.ERROR_DOCUMENT_OBJTYPE_INVALID_ACCT_CTGRY, new String[] { objectType.getBasicAccountingCategoryCode() });
        }
        return result;
    }
}
