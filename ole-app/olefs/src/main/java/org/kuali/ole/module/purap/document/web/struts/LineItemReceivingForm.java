...
public class LineItemReceivingForm extends ReceivingFormBase {
    ...
    protected boolean canCreateCorrection() {
        ...
        DocumentAuthorizer documentAuthorizer = SpringContext.getBean(DocumentHelperService.class).getDocumentAuthorizer(OLEConstants.FinancialDocumentTypeCodes.CORRECTION_RECEIVING);
        boolean isUserAuthorized = documentAuthorizer.canInitiate(OLEConstants.FinancialDocumentTypeCodes.CORRECTION_RECEIVING, user);
    ...
    protected Map<String, ExtraButton> createButtonsMap() {
        ...
        clearButton.setExtraButtonSource("${" + OLEConstants.RICE_EXTERNALIZABLE_IMAGES_URL_KEY + "}buttonsmall_clear.gif");
        ...
        correctionButton.setExtraButtonSource("${" + OLEConstants.EXTERNALIZABLE_IMAGES_URL_KEY + "}buttonsmall_correction.gif");
