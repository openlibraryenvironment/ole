...
import org.kuali.ole.pdp.batch.service.ExtractPaymentService;
import org.kuali.ole.pdp.businessobject.AchAccountNumber;
import org.kuali.ole.pdp.businessobject.CustomerBank;
import org.kuali.ole.pdp.businessobject.CustomerProfile;
import org.kuali.ole.pdp.businessobject.DisbursementNumberRange;
import org.kuali.ole.pdp.businessobject.DisbursementType;
import org.kuali.ole.pdp.businessobject.FormatProcess;
...
import org.kuali.ole.pdp.dataaccess.FormatPaymentDao;
import org.kuali.ole.pdp.dataaccess.PaymentDetailDao;
import org.kuali.ole.pdp.dataaccess.PaymentGroupDao;
import org.kuali.ole.pdp.dataaccess.ProcessDao;
import org.kuali.ole.pdp.service.AchService;
...
public class FormatServiceImpl implements FormatService {
    ...
    /**
     * @see org.kuali.ole.pdp.service.FormatProcessService#getDataForFormat(org.kuali.rice.kim.api.identity.Person)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.pdp.service.FormatService#getFormatProcessStartDate(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.pdp.service.FormatService#startFormatProcess(org.kuali.rice.kim.api.identity.Person, java.lang.String,
    ...
    /**
     * @see org.kuali.ole.pdp.service.FormatService#performFormat(java.lang.Integer)
     */
    @Override
    ...
    protected boolean validateAndUpdatePaymentGroupBankCode(PaymentGroup paymentGroup, DisbursementType disbursementType, CustomerProfile customer) {
        ...
        if (ObjectUtils.isNull(paymentGroup.getBank())) {
            ...
            GlobalVariables.getMessageMap().putError(OLEConstants.GLOBAL_ERRORS, PdpKeyConstants.Format.ErrorMessages.ERROR_FORMAT_BANK_MISSING, customer.getCustomerShortName());
            bankValid = false;
    ...
    protected boolean assignDisbursementNumbersAndCombineChecks(PaymentProcess paymentProcess, FormatProcessSummary postFormatProcessSummary) {
        ...
        while (paymentGroupIterator.hasNext()) {
            ...
            if (range == null) {
                GlobalVariables.getMessageMap().putError(OLEConstants.GLOBAL_ERRORS, PdpKeyConstants.Format.ErrorMessages.ERROR_FORMAT_DISBURSEMENT_MISSING, campus, paymentGroup.getBank().getBankCode(), paymentGroup.getDisbursementType().getCode());
                successful = false;
                return successful;
            }
    ...
    protected KualiInteger assignDisbursementNumber(String campus, DisbursementNumberRange range, PaymentGroup paymentGroup, FormatProcessSummary postFormatProcessSummary) {
        ...
        if (disbursementNumber.isGreaterThan(range.getEndDisbursementNbr())) {
            GlobalVariables.getMessageMap().putError(OLEConstants.GLOBAL_ERRORS, PdpKeyConstants.Format.ErrorMessages.ERROR_FORMAT_DISBURSEMENT_EXHAUSTED, campus, paymentGroup.getBank().getBankCode(), paymentGroup.getDisbursementType().getCode());
    ...
    /**
     * @see org.kuali.ole.pdp.service.FormatService#clearUnfinishedFormat(java.lang.Integer)
     */
    @Override
    @SuppressWarnings("rawtypes")
    ...
    /**
     * @see org.kuali.ole.pdp.service.FormatService#resetFormatPayments(java.lang.Integer)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.pdp.service.FormatService#endFormatProcess(java.lang.String)
     */
    @Override
    @SuppressWarnings("rawtypes")
    ...
    /**
     * @see org.kuali.ole.pdp.service.FormatService#getAllCustomerProfiles()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.pdp.service.FormatService#getAllDisbursementNumberRanges()
     */
    @Override
