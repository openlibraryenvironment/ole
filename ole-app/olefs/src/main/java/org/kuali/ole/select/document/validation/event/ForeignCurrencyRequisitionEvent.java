...
public class ForeignCurrencyRequisitionEvent extends KualiDocumentEventBase {
    ...
    protected ForeignCurrencyRequisitionEvent(String errorPathPrefix, Document document) {
        super("Creating Note Tag" + getDocumentId(document), errorPathPrefix, document);
    }

    public ForeignCurrencyRequisitionEvent(Document document, OleRequisitionItem reqItem) {
        this("", document);
    ...
    public boolean invokeRuleMethod(BusinessRule rule) {
        return ((OleValidationRule) rule).processCustomForeignCurrencyRequisitionBusinessRules(document, reqItem);
    }
