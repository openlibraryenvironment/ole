...
import org.kuali.ole.module.purap.PurapParameterConstants.TaxParameters;
...
import org.kuali.ole.sys.businessobject.TaxDetail;
...
import org.kuali.ole.sys.service.TaxService;
...
public class PurapServiceImpl implements PurapService {
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService# updateStatus(org.kuali.ole.module.purap.document.PurchasingAccountsPayableDocument, String)
     */
  ...
  /*  @Override
    public boolean updateStatus(PurchasingAccountsPayableDocument document, String newStatus) {
        ...
        if (ObjectUtils.isNotNull(document) || ObjectUtils.isNotNull(newStatus)) {
            String oldStatus = document.getApplicationDocumentStatus();
            document.setApplicationDocumentStatus(newStatus);
    ...
    public void saveRoutingDataForRelatedDocuments(Integer accountsPayablePurchasingDocumentLinkIdentifier) {
        ...
        try {
            ...
            //save Invoice routing data
            List<InvoiceView> invViews = getRelatedViews(InvoiceView.class, accountsPayablePurchasingDocumentLinkIdentifier);
            for (InvoiceView invView : invViews) {
                Document doc = documentService.getByDocumentHeaderId(invView.getDocumentNumber());
                doc.getDocumentHeader().getWorkflowDocument().saveDocumentData();
            }
            ...
            throw new IllegalArgumentException("unable to save routing data for related docs", e);
        }

    }

    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#getRelatedDocumentIds(Integer)
     */
    @Override
    public List<String> getRelatedDocumentIds(Integer accountsPayablePurchasingDocumentLinkIdentifier) {
        ...
        List<InvoiceView> invViews = getRelatedViews(InvoiceView.class, accountsPayablePurchasingDocumentLinkIdentifier);
        for (InvoiceView invView : invViews) {
            documentIdList.add(invView.getDocumentNumber());
        }
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#getRelatedViews(Class, Integer)
     */
    @Override
    ...
    public List getRelatedViews(Class clazz, Integer accountsPayablePurchasingDocumentLinkIdentifier) {
        ...
        String st = clazz.getSimpleName();

        //if (st.equals("InvoiceView") || st.equals("CreditMemoView") || st.equals("PaymentRequestView")) {
        if (st.equals("InvoiceView")) {
            Map criteriaMap = new HashMap();
            criteriaMap.put("accountsPayablePurchasingDocumentLinkIdentifier", accountsPayablePurchasingDocumentLinkIdentifier);
            List<OleInvoiceItem> boInvoiceItemList = (List<OleInvoiceItem>) businessObjectService.findMatching(OleInvoiceItem.class, criteriaMap);
            List boList = new ArrayList();
            if (boInvoiceItemList.size() > 0) {
                for (OleInvoiceItem item : boInvoiceItemList) {
                    accountsPayablePurchasingDocumentLinkIdentifier =item.getInvoiceDocument().getAccountsPayablePurchasingDocumentLinkIdentifier();
                    criteria.put("accountsPayablePurchasingDocumentLinkIdentifier", accountsPayablePurchasingDocumentLinkIdentifier);
                    boList.addAll((List) businessObjectService.findMatchingOrderBy(clazz, criteria, OLEPropertyConstants.DOCUMENT_NUMBER, false));
        ...
        List boList = (List) businessObjectService.findMatchingOrderBy(clazz, criteria, OLEPropertyConstants.DOCUMENT_NUMBER, false);
        return boList;
    }

    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#addBelowLineItems(org.kuali.ole.module.purap.document.PurchasingAccountsPayableDocument)
     */
    @Override
    @SuppressWarnings("unchecked")
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#sortBelowTheLine(String[], java.util.List, java.util.List)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#getBelowTheLineForDocument(org.kuali.ole.module.purap.document.PurchasingAccountsPayableDocument)
     */
    @Override
...
//        }
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#getBelowTheLineByType(org.kuali.ole.module.purap.document.PurchasingAccountsPayableDocument,
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#getDateFromOffsetFromToday(int)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#isDateInPast(java.sql.Date)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#isDateMoreThanANumberOfDaysAway(java.sql.Date, int)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#isDateAYearAfterToday(java.sql.Date)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#getApoLimit(Integer, String, String)
     */
    @Override
    @SuppressWarnings("unchecked")
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#isFullDocumentEntryCompleted(org.kuali.ole.module.purap.document.PurchasingAccountsPayableDocument)
     */
    @Override
    public boolean isFullDocumentEntryCompleted(PurchasingAccountsPayableDocument purapDocument) {
        ...
        } else if (purapDocument instanceof OleInvoiceDocument) {
            value = PurapConstants.InvoiceStatuses.STATUS_ORDER.isFullDocumentEntryCompleted(purapDocument.getApplicationDocumentStatus());
        }
        return value;
    }

    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#isPaymentRequestFullDocumentEntryCompleted(String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#isVendorCreditMemoFullDocumentEntryCompleted(String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#isInvoiceFullDocumentEntryCompleted(String)
     */
    @Override
    public boolean isInvoiceFullDocumentEntryCompleted(String purapDocumentStatus) {
        LOG.debug("isInvoiceFullDocumentEntryCompleted() started");
        return PurapConstants.InvoiceStatuses.STATUS_ORDER.isFullDocumentEntryCompleted(purapDocumentStatus);
    }

    /**
     * Main hook point for close/Reopen PO.
     *
     * @see org.kuali.ole.module.purap.document.service.PurapService#performLogicForCloseReopenPO(org.kuali.ole.module.purap.document.PurchasingAccountsPayableDocument)
     */
    @Override
    public void performLogicForCloseReopenPO(PurchasingAccountsPayableDocument purapDocument) {
        ...
        if (purapDocument instanceof PaymentRequestDocument) {
            ...
            if (paymentRequest.isClosePurchaseOrderIndicator() && PurchaseOrderStatuses.APPDOC_OPEN.equals(paymentRequest.getPurchaseOrderDocument().getApplicationDocumentStatus())) {
            ...
            if (creditMemo.isReopenPurchaseOrderIndicator() && PurchaseOrderStatuses.APPDOC_CLOSED.equals(creditMemo.getPurchaseOrderDocument().getApplicationDocumentStatus())) {
                // get the po id and get the current PO
    ...
    protected String assemblePurchaseOrderNote(AccountsPayableDocumentBase apDocument, String docType, String action) {
        ...
        closeReopenNote.append(dataDictionaryService.getDocumentLabelByTypeName(OLEConstants.FinancialDocumentTypeCodes.PURCHASE_ORDER));
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#performLogicWithFakedUserSession(String, org.kuali.ole.module.purap.document.service.LogicContainer, Object[])
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurchaseOrderService#saveDocumentNoValidation(org.kuali.ole.module.purap.document.PurchaseOrderDocument)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#isDocumentStoppedInRouteNode(org.kuali.ole.module.purap.document.PurchasingAccountsPayableDocument, String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#allowEncumberNextFiscalYear()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#getAllowedFiscalYears()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#isTodayWithinApoAllowedRange()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#clearTax(org.kuali.ole.module.purap.document.PurchasingAccountsPayableDocument)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#calculateTax(org.kuali.ole.module.purap.document.PurchasingAccountsPayableDocument)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#isTaxableForSummary(boolean, String, org.kuali.ole.module.purap.businessobject.PurApItem)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#isDeliveryStateTaxable(String)
     */
    @Override
    public boolean isDeliveryStateTaxable(String deliveryState) {
        ParameterEvaluator parmEval = /*REFACTORME*/SpringContext.getBean(ParameterEvaluatorService.class).getParameterEvaluator(OleParameterConstants.PURCHASING_DOCUMENT.class, TaxParameters.TAXABLE_DELIVERY_STATES, deliveryState);
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.PurapService#isAccountingLineTaxable(org.kuali.ole.module.purap.businessobject.PurApAccountingLine, boolean)
     */
    @Override
    ...
    protected boolean isAccountTaxable(String parameterSuffix, PurApAccountingLine acctLine) {
        ...
        fundParamEval = SpringContext.getBean(ParameterEvaluatorService.class).getParameterEvaluator(OleParameterConstants.PURCHASING_DOCUMENT.class, fundParam, acctLine.getAccount().getSubFundGroup().getFundGroupCode());
        subFundParamEval = SpringContext.getBean(ParameterEvaluatorService.class).getParameterEvaluator(OleParameterConstants.PURCHASING_DOCUMENT.class, subFundParam, acctLine.getAccount().getSubFundGroupCode());
    ...
    protected boolean isObjectCodeTaxable(String parameterSuffix, PurApAccountingLine acctLine) {
        ...
        levelParamEval = SpringContext.getBean(ParameterEvaluatorService.class).getParameterEvaluator(OleParameterConstants.PURCHASING_DOCUMENT.class, levelParam, acctLine.getObjectCode().getFinancialObjectLevelCode());
        consolidationParamEval = SpringContext.getBean(ParameterEvaluatorService.class).getParameterEvaluator(OleParameterConstants.PURCHASING_DOCUMENT.class, consolidationParam, acctLine.getObjectCode().getFinancialObjectLevel().getFinancialConsolidationObjectCode());
    ...
    public void prorateForTradeInAndFullOrderDiscount(PurchasingAccountsPayableDocument purDoc) {
        ...
        if (tradeIn != null && tradeIn.getExtendedPrice() != null && tradeIn.getExtendedPrice().isNonZero()) {
            ...
            Collection<String> objectSubTypesRequiringQty = SpringContext.getBean(ParameterService.class).getParameterValuesAsString(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapParameterConstants.OBJECT_SUB_TYPES_REQUIRING_QUANTITY);
            Collection<String> purchasingObjectSubTypes = SpringContext.getBean(ParameterService.class).getParameterValuesAsString(OleParameterConstants.CAPITAL_ASSET_BUILDER_DOCUMENT.class, PurapParameterConstants.PURCHASING_OBJECT_SUB_TYPES);
     ...
     * @return true if tax is disabled, false if it is not - in foundation OLE, tax is never disabled
     */
