...
public class RequisitionAccountingLineAuthorizer extends PurapAccountingLineAuthorizer {
    ...
    public boolean renderNewLine(AccountingDocument accountingDocument, String accountingGroupProperty) {
        ...
        if (workflowDocument.getCurrentNodeNames().contains(RequisitionAccountingLineAuthorizer.INITIATOR_NODE) || workflowDocument.getCurrentNodeNames().contains(RequisitionAccountingLineAuthorizer.CONTENT_REVIEW_NODE))
            return true;
