 ...
 */
public class OleBorrowerTypeLookupableImpl extends LookupableImpl {

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(OleBorrowerTypeLookupableImpl.class);
    ...
    protected String getActionUrlHref(LookupForm lookupForm, Object dataObject, String methodToCall,
        ...
        String maintenanceMapping = "borrowerTypeMaintenance";
    ...
    protected List<?> getSearchResults(LookupForm form, Map<String, String> searchCriteria, boolean unbounded) {
        List<?> searchResults;
        List<OleBorrowerType> finalSearchResult = new ArrayList<OleBorrowerType>();
        List<OleBorrowerType> oleBorrowerType = new ArrayList<OleBorrowerType>();
        oleBorrowerType = (List<OleBorrowerType>) super.getSearchResults(form, searchCriteria, unbounded);
        finalSearchResult.addAll(oleBorrowerType);
