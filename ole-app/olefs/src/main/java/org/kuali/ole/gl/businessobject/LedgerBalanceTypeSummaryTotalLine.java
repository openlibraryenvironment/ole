...
public class LedgerBalanceTypeSummaryTotalLine extends LedgerSummaryTotalLine {
    ...
    public String getSummary() {
        final String message = SpringContext.getBean(ConfigurationService.class).getPropertyValueAsString(OLEKeyConstants.MESSAGE_REPORT_NIGHTLY_OUT_LEDGER_BALANCE_TYPE_TOTAL);
