 ...
 */
package org.kuali.ole.gl.document;
...
public class CorrectionDocumentUtils {
    ...
    public static int getRecordCountFunctionalityLimit() {
        String limitString = SpringContext.getBean(ParameterService.class).getParameterValueAsString(GeneralLedgerCorrectionProcessDocument.class, OLEConstants.GeneralLedgerCorrectionProcessApplicationParameterKeys.RECORD_COUNT_FUNCTIONALITY_LIMIT);
        if (limitString != null) {
    ...
    public static int getRecordsPerPage() {
        String limitString = SpringContext.getBean(ParameterService.class).getParameterValueAsString(GeneralLedgerCorrectionProcessDocument.class, OLEConstants.GeneralLedgerCorrectionProcessApplicationParameterKeys.RECORDS_PER_PAGE);
        if (limitString != null) {
            return Integer.valueOf(limitString);
        }
    ...
    public static boolean isDebit(OriginEntryFull oe) {
        return (OLEConstants.GL_DEBIT_CODE.equals(oe.getTransactionDebitCreditCode()));
    }
    ...
    public static boolean isBudget(OriginEntryFull oe) {
        return OLEConstants.GL_BUDGET_CODE.equals(oe.getTransactionDebitCreditCode());
    }
    ...
    public static boolean isCredit(OriginEntryFull oe) {
        return OLEConstants.GL_CREDIT_CODE.equals(oe.getTransactionDebitCreditCode());
    }
