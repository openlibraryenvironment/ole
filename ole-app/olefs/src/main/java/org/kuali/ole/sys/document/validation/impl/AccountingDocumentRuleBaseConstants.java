...
public interface AccountingDocumentRuleBaseConstants {
    ...
    public static final class GENERAL_LEDGER_PENDING_ENTRY_CODE {
        ...
        public static String getBlankProjectCode() {
            if (BLANK_PROJECT_STRING == null) {
                BLANK_PROJECT_STRING = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(GeneralLedgerPendingEntry.class, OLEPropertyConstants.PROJECT_CODE), '-');
            }
        ...
        public static String getBlankFinancialSubObjectCode() {
            if (BLANK_SUB_OBJECT_CODE == null) {
                BLANK_SUB_OBJECT_CODE = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(GeneralLedgerPendingEntry.class, OLEPropertyConstants.FINANCIAL_SUB_OBJECT_CODE), '-');
            }
        ...
        public static String getBlankSubAccountNumber() {
            if (BLANK_SUB_ACCOUNT_NUMBER == null) {
                BLANK_SUB_ACCOUNT_NUMBER = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(GeneralLedgerPendingEntry.class, OLEPropertyConstants.SUB_ACCOUNT_NUMBER), '-');
            }
        ...
        public static String getBlankFinancialObjectCode() {
            if (BLANK_OBJECT_CODE == null) {
                BLANK_OBJECT_CODE = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(GeneralLedgerPendingEntry.class, OLEPropertyConstants.FINANCIAL_OBJECT_CODE), '-');
            }
        ...
        public static String getBlankFinancialObjectType() {
            if (BLANK_OBJECT_TYPE_CODE == null) {
                BLANK_OBJECT_TYPE_CODE = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(GeneralLedgerPendingEntry.class, OLEPropertyConstants.FINANCIAL_OBJECT_TYPE_CODE), '-');
            }
            return BLANK_OBJECT_TYPE_CODE;
        }
    }

    // Object Type Code OLEConstants
    public static final class OBJECT_TYPE_CODE {
        public static final String DOCUMENT_TYPE_INTERNAL_BILLING = "OLE_IB";
        public static final String DOCUMENT_TYPE_DISTRIBUTION_OF_INCOME_AND_EXPENSE = "OLE_DI";
        public static final String DOCUMENT_TYPE_SERVICE_BILLING = "OLE_SB";
        public static final String DOCUMENT_TYPE_NON_CHECK_DISBURSEMENT = "OLE_NC";
        public static final String DOCUMENT_TYPE_INDIRECT_COST_ADJUSTMENT = "OLE_ICA";
    }

    // Object Sub-Type Code OLEConstants
    ...
    // Object Level Code OLEConstants
    ...
    // Consolidated Object Code OLEConstants
