...
import org.kuali.ole.module.purap.businessobject.AccountsPayableSummaryAccount;
...
public class PurApAccountingDaoOjb extends PlatformAwareDaoBaseOjb implements PurApAccountingDao {
    ...
    /**
     * @see org.kuali.ole.module.purap.dataaccess.PurApAccountingDao#getAccountingLinesForItem(org.kuali.ole.module.purap.businessobject.PurApItem)
     */
    ...
    /**
     * @see org.kuali.ole.module.purap.dataaccess.PurApAccountingDao#deleteSummaryAccountsbyPaymentRequestIdentifier(java.lang.Integer)
     */
    ...
    public void deleteSummaryAccountsbyInvoiceIdentifier(Integer invoiceIdentifier) {
        if (invoiceIdentifier != null) {
            Criteria criteria = new Criteria();
            criteria.addEqualTo(PurapPropertyConstants.INVOICE_ID, invoiceIdentifier);

            getPersistenceBrokerTemplate().deleteByQuery(QueryFactory.newQuery(OleInvoiceAccountsPayableSummaryAccount.class, criteria));
            getPersistenceBrokerTemplate().clearCache();
        }
    }

    /**
     * @see org.kuali.ole.module.purap.dataaccess.PurApAccountingDao#deleteSummaryAccountsbyCreditMemoIdentifier(java.lang.Integer)
     */
