...
import org.kuali.ole.sys.document.web.renderers.ActionsRenderer;
...
public class AccountingLineViewActionsField extends FieldTableJoiningWithHeader {
    private String name = OLEConstants.AccountingLineViewStandardBlockNames.ACTION_BLOCK;
     ...
     * @see org.kuali.ole.sys.document.web.FieldTableJoining#isActionBlock()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.document.web.FieldTableJoiningWithHeader#joinTable(java.util.List)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.document.web.RenderableElement#renderElement(javax.servlet.jsp.PageContext, javax.servlet.jsp.tagext.Tag)
     */
    ...
    public HeaderLabel createHeaderLabel() {
        return new LiteralHeaderLabel(SpringContext.getBean(ConfigurationService.class).getPropertyValueAsString(OLEKeyConstants.AccountingLineViewRendering.ACCOUNTING_LINE_ACTIONS_LABEL));
    }
