...
public class SubContractor extends PersistableBusinessObjectBase implements MutableInactivatable {
    ...
    public static final String CACHE_NAME = OLEConstants.APPLICATION_NAMESPACE_CODE + "/" + "SubContractor";
    /**
    ...
    public StateEbo getSubcontractorState() {
        if ( StringUtils.isBlank(subcontractorCountryCode) || StringUtils.isBlank(OLEConstants.COUNTRY_CODE_UNITED_STATES ) ) {
            subcontractorState = null;
        } else {
            if ( subcontractorState == null || !StringUtils.equals( subcontractorState.getCode(),subcontractorCountryCode) || !StringUtils.equals(subcontractorState.getCountryCode(), OLEConstants.COUNTRY_CODE_UNITED_STATES ) ) {
