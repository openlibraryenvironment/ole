 ...
 */
package org.kuali.ole.sys.batch.service;
...
public interface BatchInputFileService {
     ...
     * @param fileContents - contents of the uploaded file
     * @param parsedObject - object parsed from the input file
     * @param destinationFilePath - destination path selected by user for storing the ole format xml.
     * @param extension - extension of the file selected through marc file upload screen 
     * @return String - name of file that was saved, or null if errors were enountered
     * @throws FileStorageException - if errors were encountered while attempting to write the file
     */
    public String save(Person user, BatchInputFileType inputType, String fileUserIdentifier, InputStream fileContents, Object parsedObject,String destinationFilePath,String extension) throws AuthorizationException, FileStorageException;
