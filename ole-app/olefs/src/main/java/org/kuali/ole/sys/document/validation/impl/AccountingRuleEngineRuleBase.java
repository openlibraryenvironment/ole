...
import org.kuali.ole.sys.document.validation.AccountingRuleEngineRule;
import org.kuali.ole.sys.document.validation.Validation;
import org.kuali.ole.sys.document.validation.event.AttributedAddAdHocRoutePersonEvent;
import org.kuali.ole.sys.document.validation.event.AttributedAddAdHocRouteWorkgroupEvent;
import org.kuali.ole.sys.document.validation.event.AttributedAddNoteEvent;
import org.kuali.ole.sys.document.validation.event.AttributedApproveDocumentEvent;
...
public class AccountingRuleEngineRuleBase extends DocumentRuleBase implements AccountingRuleEngineRule {
    ...
    /**
     * @see org.kuali.ole.sys.document.validation.AccountingRuleEngineRule#validateForEvent(org.kuali.rice.krad.rule.event.KualiDocumentEvent)
     */
    ...
    public boolean isDocumentAttributesValid(Document document, boolean validateRequired) {
        ...
        if (document instanceof GeneralLedgerPostingDocumentBase) {
            ...
            for (GeneralLedgerPendingEntry glpe : glpeDocument.getGeneralLedgerPendingEntries()) {
                glpe.refreshReferenceObject(OLEPropertyConstants.FINANCIAL_OBJECT);
            }
        }
