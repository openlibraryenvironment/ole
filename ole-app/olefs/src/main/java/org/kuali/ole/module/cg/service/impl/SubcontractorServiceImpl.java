...
import org.kuali.ole.module.cg.businessobject.SubContractor;
import org.kuali.ole.module.cg.service.SubcontractorService;
...
public class SubcontractorServiceImpl implements SubcontractorService {
    ...
    /**
     * @see org.kuali.ole.module.cg.service.SubcontractorService#getByPrimaryId(String)
     */
    @Override
    ...
    protected Map<String, Object> mapPrimaryKeys(String subcontractorNumber) {
        ...
        primaryKeys.put(OLEPropertyConstants.SUBCONTRACTOR_NUMBER, subcontractorNumber.trim());
        return primaryKeys;
    }
