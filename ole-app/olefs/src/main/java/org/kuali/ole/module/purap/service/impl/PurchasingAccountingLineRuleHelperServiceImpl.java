...
public class PurchasingAccountingLineRuleHelperServiceImpl extends PurapAccountingLineRuleHelperServiceImpl {
    ...
    /**
     * @see org.kuali.ole.module.purap.service.impl.PurapAccountingLineRuleHelperServiceImpl#hasRequiredOverrides(org.kuali.ole.sys.businessobject.AccountingLine, java.lang.String)
    ...
    public boolean hasRequiredOverrides(AccountingLine line, String overrideCode) {
        ...
        if (!ObjectUtils.isNull(account) && account.isExpired()) {
            GlobalVariables.getMessageMap().putError(OLEConstants.ACCOUNT_NUMBER_PROPERTY_NAME, PurapKeyConstants.ERROR_ITEM_ACCOUNT_EXPIRED, account.getAccountNumber());
            retVal = false;
        }
        return retVal;
    }
