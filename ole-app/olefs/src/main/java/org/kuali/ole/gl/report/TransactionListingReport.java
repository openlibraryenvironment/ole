...
public class TransactionListingReport {
    ...
    public void generateReport(ReportWriterService reportWriterService, Transaction transaction) {
        ...
        if (transaction != null) {
            ...
            if (OLEConstants.GL_DEBIT_CODE.equals(transaction.getTransactionDebitCreditCode())) {
                debitTotal = debitTotal.add(transaction.getTransactionLedgerEntryAmount());
            }
            if (OLEConstants.GL_CREDIT_CODE.equals(transaction.getTransactionDebitCreditCode())) {
                creditTotal = creditTotal.add(transaction.getTransactionLedgerEntryAmount());
            }
            if (!OLEConstants.GL_CREDIT_CODE.equals(transaction.getTransactionDebitCreditCode()) && !OLEConstants.GL_DEBIT_CODE.equals(transaction.getTransactionDebitCreditCode())) {
