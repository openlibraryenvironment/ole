...
public class AccountingDocumentRuleHelperServiceImpl implements AccountingDocumentRuleHelperService {
    ...
    /**
     * @see org.kuali.ole.sys.document.service.AccountingDocumentRuleHelperService#isExpense(org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntrySourceDetail)
     */
    public boolean isExpense(GeneralLedgerPendingEntrySourceDetail postable) {
        // return SpringContext.getBean(ConfigurationService.class).succeedsRule(OLEConstants.FINANCIAL_NAMESPACE,
    ...
    /**
     * @see org.kuali.ole.sys.document.service.AccountingDocumentRuleHelperService#isIncome(org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntrySourceDetail)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.service.AccountingDocumentRuleHelperService#isValidBalanceType(org.kuali.ole.coa.businessobject.BalanceTyp,
     *      java.lang.String)
     */
    ...
    public boolean isValidBalanceType(BalanceType balanceType, Class entryClass, String attributeName, String errorPropertyName) {
        ...
        if (ObjectUtils.isNull(balanceType)) {
            GlobalVariables.getMessageMap().putError(errorPropertyName, OLEKeyConstants.ERROR_EXISTENCE, label);
            return false;
        }
        // make sure it's active for usage
        if (!balanceType.isActive()) {
            GlobalVariables.getMessageMap().putError(errorPropertyName, OLEKeyConstants.ERROR_INACTIVE, label);
            return false;
        }
        return true;
    }
    ...
    /**
     * @see org.kuali.ole.sys.document.service.AccountingDocumentRuleHelperService#isValidOpenAccountingPeriod(org.kuali.ole.coa.businessobject.AccountingPeriod,
     *      java.lang.Class, java.lang.String, java.lang.String)
     */
    public boolean isValidOpenAccountingPeriod(AccountingPeriod accountingPeriod, Class entryClass, String attribueName, String errorPropertyName) {
        ...
        if (!accountingPeriod.isActive()) {
            GlobalVariables.getMessageMap().putError(errorPropertyName, OLEKeyConstants.ERROR_DOCUMENT_ACCOUNTING_PERIOD_CLOSED);
            return false;
        }
    ...
    /**
     * @see org.kuali.ole.sys.document.service.AccountingDocumentRuleHelperService#isValidReversalDate(java.sql.Date,
     *      java.lang.String)
     */
    public boolean isValidReversalDate(Date reversalDate, String errorPropertyName) {
        ...
        if (null != reversalDate && reversalDate.before(today)) {
            GlobalVariables.getMessageMap().putError(errorPropertyName, OLEKeyConstants.ERROR_DOCUMENT_INCORRECT_REVERSAL_DATE);
            return false;
        }
        else {
            return true;
