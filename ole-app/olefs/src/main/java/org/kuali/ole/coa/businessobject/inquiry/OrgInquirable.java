...
public class OrgInquirable extends KfsInquirableImpl {
    ...
    public void addAdditionalSections(List sections, BusinessObject bo) {
        if (bo instanceof Organization) {
            ...
            parameters.put(OleKimAttributes.CHART_OF_ACCOUNTS_CODE, org.getChartOfAccountsCode());
            parameters.put(OleKimAttributes.ORGANIZATION_CODE, org.getOrganizationCode());
