...
import org.kuali.ole.sys.service.ElectronicPaymentClaimingDocumentGenerationStrategy;
import org.kuali.ole.sys.service.ElectronicPaymentClaimingService;
...
public class ElectronicPaymentClaimingServiceImpl implements ElectronicPaymentClaimingService {
    ...
    /**
     * @see org.kuali.ole.sys.service.ElectronicPaymentClaimingService#constructNotesForClaims(java.util.List)
     */
    @Override
    public List<String> constructNoteTextsForClaims(List<ElectronicPaymentClaim> claims) {
        ...
        try {
            ...
            throw new RuntimeException("The OLE-SYS / ElectronicPaymentClaim / " + ELECTRONIC_FUNDS_CLAIM_SUMMARIES_PER_NOTE_PARAMETER + " should have a value that can be parsed into an integer.", nfe);
        }
        return noteTexts;
    }
    ...
    /**
     * @see org.kuali.ole.sys.service.ElectronicPaymentClaimingService#createPaymentClaimingDocument(java.util.List,
     *      org.kuali.ole.sys.service.ElectronicPaymentClaimingDocumentGenerationStrategy)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.service.ElectronicPaymentClaimingService#getClaimingDocumentChoices(org.kuali.rice.kim.api.identity.Person)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.service.ElectronicPaymentClaimingService#declaimElectronicPaymentClaimsForDocument(org.kuali.rice.krad.document.Document)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.service.ElectronicPaymentClaimingService#isAuthorizedForClaimingElectronicPayment(org.kuali.rice.kim.api.identity.Person,
     *      java.lang.String, java.lang.String)
     */
    @Override
    public boolean isAuthorizedForClaimingElectronicPayment(Person user, String workflowDocumentTypeName) {
        String principalId = user.getPrincipalId();
        String namespaceCode = OLEConstants.ParameterNamespaces.OLE;
        String permissionTemplateName = OLEConstants.PermissionTemplate.CLAIM_ELECTRONIC_PAYMENT.name;
    ...
    /**
     * @see org.kuali.ole.sys.service.ElectronicPaymentClaimingService#generateElectronicPaymentClaimRecords(org.kuali.ole.fp.document.AdvanceDepositDocument)
     */
    @Override
