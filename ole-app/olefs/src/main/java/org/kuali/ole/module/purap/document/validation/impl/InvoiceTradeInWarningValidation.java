...
public class InvoiceTradeInWarningValidation extends GenericValidation {
    ...
    public boolean validate(AttributedDocumentEvent event) {
        ...
        if (itemForValidation.getItemType().isLineItemIndicator() && itemForValidation.getItemAssignedToTradeInIndicator()) {
            InvoiceItem tradeInItem = (InvoiceItem) ((InvoiceDocument) event.getDocument()).getTradeInItem();
