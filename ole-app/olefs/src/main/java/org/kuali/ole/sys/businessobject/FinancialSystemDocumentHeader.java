...
/**
 * This class is a custom {@link DocumentHeader} class used by OLE to facilitate custom data fields and a few UI fields
 */
public class FinancialSystemDocumentHeader extends DocumentHeader {
    ...
    public FinancialSystemDocumentHeader() {
        super();
        financialDocumentStatusCode = OLEConstants.DocumentStatusCodes.INITIATED;
    }
