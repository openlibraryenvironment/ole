...
import org.kuali.ole.sys.batch.BatchJobStatus;
...
import org.kuali.ole.sys.batch.JobListener;
import org.kuali.ole.sys.batch.ScheduleStep;
import org.kuali.ole.sys.batch.SimpleTriggerDescriptor;
...
public class SchedulerServiceImpl implements SchedulerService {
    ...
    /**
     * @see org.kuali.ole.sys.batch.service.SchedulerService#initialize()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.batch.service.SchedulerService#initializeJob(java.lang.String,org.kuali.ole.sys.batch.Job)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.batch.service.SchedulerService#hasIncompleteJob()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.batch.service.SchedulerService#isPastScheduleCutoffTime()
     */
    @Override
    ...
    protected boolean isPastScheduleCutoffTime(Calendar dateTime, boolean log) {
        try {
            ...
            String cutoffParameter = parameterService.getParameterValueAsString(ScheduleStep.class, OLEConstants.SystemGroupParameterNames.BATCH_SCHEDULE_CUTOFF_TIME);
            ...
            if ( scheduleStepCutoffTime.length != 3 && scheduleStepCutoffTime.length != 4 ) {
                throw new IllegalArgumentException( "Error! The " + OLEConstants.SystemGroupParameterNames.BATCH_SCHEDULE_CUTOFF_TIME + " parameter had an invalid value: " + cutoffParameter );
            }
            ...
            if (parameterService.getParameterValueAsBoolean(ScheduleStep.class, OLEConstants.SystemGroupParameterNames.BATCH_SCHEDULE_CUTOFF_TIME_IS_NEXT_DAY)) {
    ...
    /**
     * @see org.kuali.ole.sys.batch.service.SchedulerService#processWaitingJobs()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.batch.service.SchedulerService#logScheduleResults()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.batch.service.SchedulerService#shouldNotRun(org.quartz.JobDetail)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.batch.service.SchedulerService#updateStatus(org.quartz.JobDetail,java.lang.String jobStatus)
     */
    @Override
    ...
    protected Map<String, String> getJobDependencies(String jobName) {
        ...
        if (BatchSpringContext.getJobDescriptor(jobName) != null && BatchSpringContext.getJobDescriptor(jobName).getDependencies() != null) {
    ...
    public String getStatus(JobDetail jobDetail) {
        ...
        OleModuleServiceImpl moduleService = (OleModuleServiceImpl)
