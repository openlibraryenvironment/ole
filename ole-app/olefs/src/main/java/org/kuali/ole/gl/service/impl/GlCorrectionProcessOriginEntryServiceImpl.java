 ...
 * org.kuali.ole.sys.batch.PurgeOldLookupResultsStep class may cause the purging of origin entries persisted with this implementation.
 * 
...
public class GlCorrectionProcessOriginEntryServiceImpl implements GlCorrectionProcessOriginEntryService {
     ...
     * @see org.kuali.ole.gl.service.GlCorrectionProcessOriginEntryService#persistAllEntries(java.lang.String, java.util.List)
     */
     ...
     * @see org.kuali.ole.gl.service.GlCorrectionProcessOriginEntryService#retrieveAllEntries(java.lang.String)
     */
    ...
    protected LookupResults retrieveGlcpAllOriginEntries(String glcpSearchResuiltsSequenceNumber) {
        ...
        criteria.put(OLEConstants.LOOKUP_RESULTS_SEQUENCE_NUMBER, glcpSearchResuiltsSequenceNumber);
