...
public class SourceAccountingLine extends AccountingLineBase {
    ...
    /**
     * This Non Persistable field is used to calculate charges in account summary based on proration.
     */
    @Transient
    private KualiDecimal sourceAccountQty;

    public KualiDecimal getSourceAccountQty() {
        return sourceAccountQty;
    }

    public void setSourceAccountQty(KualiDecimal sourceAccountQty) {
        this.sourceAccountQty = sourceAccountQty;
    }
