...
import org.kuali.ole.gl.batch.NominalActivityClosingHelper;
import org.kuali.ole.gl.batch.dataaccess.YearEndDao;
...
public class YearEndServiceImpl implements YearEndService {
     ...
     * @see org.kuali.ole.gl.batch.service.YearEndService#closeNominalActivity()
     */
    public void closeNominalActivity(String nominalClosingFileName, Map nominalClosingJobParameters) {
        ...
        getNominalActivityClosingReportWriterService().writeSubTitle(configurationService.getPropertyValueAsString(OLEKeyConstants.MESSAGE_REPORT_YEAR_END_NOMINAL_ACTIVITY_CLOSING_LEDGER_TITLE_LINE));
    ...
    public void forwardBalances(String balanceForwardsUnclosedFileName, String balanceForwardsclosedFileName, BalanceForwardRuleHelper balanceForwardRuleHelper) {
        ...
        getBalanceForwardReportWriterService().writeParameterLine("%32s %10s", OLEConstants.SystemGroupParameterNames.GL_ANNUAL_CLOSING_DOC_TYPE, balanceForwardRuleHelper.getAnnualClosingDocType());
        getBalanceForwardReportWriterService().writeParameterLine("%32s %10s", OLEConstants.SystemGroupParameterNames.GL_ORIGINATION_CODE, balanceForwardRuleHelper.getGlOriginationCode());
        ...
        getBalanceForwardReportWriterService().writeSubTitle(configurationService.getPropertyValueAsString(OLEKeyConstants.MESSAGE_REPORT_YEAR_END_BALANCE_FORWARD_OPEN_ACCOUNT_LEDGER_TITLE_LINE));
        ...
        getBalanceForwardReportWriterService().writeSubTitle(configurationService.getPropertyValueAsString(OLEKeyConstants.MESSAGE_REPORT_YEAR_END_BALANCE_FORWARD_CLOSED_ACCOUNT_LEDGER_TITLE_LINE));
     ...
     * @see org.kuali.ole.gl.batch.service.YearEndService#logAllMissingPriorYearAccounts(java.lang.Integer)
     */
    ...
    /**
     * @param balanceFiscalYear the fiscal year to find balances encumbrances for
     * @see org.kuali.ole.gl.batch.service.YearEndService#logAllMissingSubFundGroups(java.lang.Integer)
     */
     ...
     * @see org.kuali.ole.gl.dataaccess.EncumbranceDao
     */
     ...
     * @see org.kuali.ole.gl.service.OriginEntryService
     */
