...
import org.kuali.ole.gl.businessobject.CollectorDetailFieldUtil;
...
public class GeneralLedgerConstants {
    ...
    public static String getSpaceUniversityFiscalPeriodCode() {
        if (SPACE_UNIVERSITY_FISCAL_PERIOD_CODE == null) {
            SPACE_UNIVERSITY_FISCAL_PERIOD_CODE = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(OriginEntryFull.class, OLEPropertyConstants.UNIVERSITY_FISCAL_PERIOD_CODE), ' ');
        }
    ...
    public static String getSpaceBalanceTypeCode() {
        if (SPACE_BALANCE_TYPE_CODE == null) {
            SPACE_BALANCE_TYPE_CODE = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(BalanceType.class, OLEPropertyConstants.CODE), ' ');
        }
    ...
    public static String getSpaceFinancialSystemOriginationCode() {
        if (SPACE_FINANCIAL_SYSTEM_ORIGINATION_CODE == null) {
            SPACE_FINANCIAL_SYSTEM_ORIGINATION_CODE = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(OriginationCode.class, OLEPropertyConstants.FINANCIAL_SYSTEM_ORIGINATION_CODE), ' ');
        }
    ...
    public static String getSpaceDebitCreditCode() {
        if (SPACE_DEBIT_CREDIT_CODE == null) {
            SPACE_DEBIT_CREDIT_CODE = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(OriginEntryFull.class, OLEPropertyConstants.TRANSACTION_DEBIT_CREDIT_CODE), ' ');
        }
    ...
    public static String getSpaceFinancialObjectCode() {
        if (SPACE_FINANCIAL_OBJECT_CODE == null) {
            SPACE_FINANCIAL_OBJECT_CODE = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(ObjectCode.class, OLEPropertyConstants.FINANCIAL_OBJECT_CODE), ' ');
        }
    ...
    public static String getSpaceTransactionDate() {
        if (SPACE_TRANSACTION_DATE == null) {
            SPACE_TRANSACTION_DATE = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(OriginEntryFull.class, OLEPropertyConstants.TRANSACTION_DATE), ' ');
        }
    ...
    public static String getSpaceUniversityFiscalYear() {
        if (SPACE_UNIVERSITY_FISCAL_YEAR == null) {
            SPACE_UNIVERSITY_FISCAL_YEAR = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(OriginEntryFull.class, OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR), ' ');
        }
    ...
    public static String getSpaceTransactionEntrySequenceNumber() {
        if (SPACE_TRANSACTION_ENTRY_SEQUENCE_NUMBER == null) {
            SPACE_TRANSACTION_ENTRY_SEQUENCE_NUMBER = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(OriginEntryFull.class, OLEPropertyConstants.TRANSACTION_ENTRY_SEQUENCE_NUMBER), ' ');
        }
    ...
    public static String getSpaceTransactionLedgetEntryDescription() {
        if (SPACE_TRANSACTION_LEDGER_ENTRY_DESCRIPTION == null) {
            SPACE_TRANSACTION_LEDGER_ENTRY_DESCRIPTION = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(OriginEntryFull.class, OLEPropertyConstants.TRANSACTION_LEDGER_ENTRY_DESC), ' ');
        }
    ...
    public static String getSpaceSubAccountTypeCode() {
        if (SPACE_SUB_ACCOUNT_TYPE_CODE == null) {
            SPACE_SUB_ACCOUNT_TYPE_CODE = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(A21SubAccount.class, OLEPropertyConstants.SUB_ACCOUNT_TYPE_CODE), ' ');
        }
    ...
    public static String getSpaceAllOriginEntryFields() {
        if (SPACE_ALL_ORIGIN_ENTRY_FIELDS == null) {
            ...
            for ( AttributeDefinition attributeDefinition : attributes ) {
                ...
                if (!(OLEPropertyConstants.ENTRY_GROUP_ID.equals(attributeDefinition.getName()) || OLEPropertyConstants.ENTRY_ID.equals(attributeDefinition.getName()))) {
        ...
        if (SPACE_ALL_COLLECTOR_BATCH_HEADER_FIELDS == null) {
            ...
            for ( AttributeDefinition attributeDefinition : attributes ) {
                if (!(OLEPropertyConstants.TRAILER_RECORD_FIRST_EMPTY_FIELD.equals(attributeDefinition.getName()) ||
                    ...
                    OLEPropertyConstants.TRAILER_RECORD_SECOND_EMPTY_FIELD.equals(attributeDefinition.getName()) ||
        ...
        if (SPACE_ALL_COLLECTOR_BATCH_TRAILER_FIELDS == null) {
            ...
            for ( AttributeDefinition attributeDefinition : attributes ) {
                if ((OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR.equals(attributeDefinition.getName()) ||
                     ...
                     OLEPropertyConstants.TRAILER_RECORD_FIRST_EMPTY_FIELD.equals(attributeDefinition.getName()) ||
                     OLEPropertyConstants.TOTAL_RECORDS.equals(attributeDefinition.getName()) ||
                     OLEPropertyConstants.TRAILER_RECORD_SECOND_EMPTY_FIELD.equals(attributeDefinition.getName()) ||
                     OLEPropertyConstants.TOTAL_AMOUNT.equals(attributeDefinition.getName()))) {
                     totalLength += attributeDefinition.getMaxLength();
    ...
    public static String getZeroTransactionEntrySequenceNumber() {
        if (ZERO_TRANSACTION_ENTRY_SEQUENCE_NUMBER == null) {
            ZERO_TRANSACTION_ENTRY_SEQUENCE_NUMBER = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(OriginEntryFull.class, OLEPropertyConstants.TRANSACTION_ENTRY_SEQUENCE_NUMBER), '0');
        }
    ...
    public static String getDashOrganizationReferenceId() {
        if (DASH_ORGANIZATION_REFERENCE_ID == null) {
            DASH_ORGANIZATION_REFERENCE_ID = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(OriginEntryFull.class, OLEPropertyConstants.ORGANIZATION_REFERENCE_ID), '-');
        }
    ...
    public static String getSpaceChartOfAccountsCode() {
        if (SPACE_CHART_OF_ACCOUNTS_CODE == null) {
            SPACE_CHART_OF_ACCOUNTS_CODE = StringUtils.rightPad("", SpringContext.getBean(DataDictionaryService.class).getAttributeMaxLength(OriginEntryFull.class, OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE), ' ');
        }
