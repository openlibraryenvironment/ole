 ...
 */
package org.kuali.ole.sys.document.dataaccess.impl;
...
/**
 * This class is the OLE specific document dao implementation
 */
public class FinancialSystemDocumentDaoOjb extends PlatformAwareDaoBaseOjb implements FinancialSystemDocumentDao {
    ...
    public <T extends Document> Collection<T> findByDocumentHeaderStatusCode(Class<T> clazz, String statusCode) {
        ...
        criteria.addEqualTo(KRADPropertyConstants.DOCUMENT_HEADER + "." + OLEPropertyConstants.FINANCIAL_DOCUMENT_STATUS_CODE, statusCode);
