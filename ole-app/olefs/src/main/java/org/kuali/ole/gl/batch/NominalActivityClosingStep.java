...
public class NominalActivityClosingStep extends AbstractWrappedBatchStep {
    ...
    protected CustomBatchExecutor getCustomBatchExecutor() {
        return new CustomBatchExecutor() {
             ...
             * @see org.kuali.ole.sys.batch.Step#performStep()
             */
            public boolean execute() {
                ...
                try {
                    ...
                    varTransactionDate = new Date(transactionDateFormat.parse(getParameterService().getParameterValueAsString(OleParameterConstants.GENERAL_LEDGER_BATCH.class, GeneralLedgerConstants.ANNUAL_CLOSING_TRANSACTION_DATE_PARM)).getTime());
                }
                ...
                Integer varFiscalYear = new Integer(getParameterService().getParameterValueAsString(OleParameterConstants.GENERAL_LEDGER_BATCH.class, GeneralLedgerConstants.ANNUAL_CLOSING_FISCAL_YEAR_PARM));
