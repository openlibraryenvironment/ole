...
import org.kuali.ole.pdp.dataaccess.PaymentGroupHistoryDao;
...
public class ExtractPaymentServiceImpl extends InitiateDirectoryBase implements ExtractPaymentService {
    ...
    /**
     * @see org.kuali.ole.pdp.batch.service.ExtractPaymentService#extractCancelledChecks()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.pdp.batch.service.ExtractPaymentService#extractAchPayments()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.pdp.batch.service.ExtractPaymentService#extractChecks()
     */
    @Override
