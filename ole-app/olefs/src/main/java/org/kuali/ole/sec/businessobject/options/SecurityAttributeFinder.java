...
import org.kuali.ole.sec.businessobject.SecurityAttribute;
...
public class SecurityAttributeFinder extends KeyValuesBase {
    ...
    public List getKeyValues() {
        ...
        Collection securityAttributes = SpringContext.getBean(KeyValuesService.class).findAllOrderBy(SecurityAttribute.class, OLEPropertyConstants.ID, true);
