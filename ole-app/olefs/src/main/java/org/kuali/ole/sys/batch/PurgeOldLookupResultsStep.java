...
public class PurgeOldLookupResultsStep extends AbstractStep {
    ...
    public boolean execute(String jobName, Date jobRunDate) {
        try {
            ...
            String maxAgeInSecondsStr = getParameterService().getParameterValueAsString(OleParameterConstants.NERVOUS_SYSTEM_LOOKUP.class, OLEConstants.SystemGroupParameterNames.MULTIPLE_VALUE_LOOKUP_RESULTS_EXPIRATION_AGE);
