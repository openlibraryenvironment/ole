...
public abstract class PurchasingFormBase extends PurchasingAccountsPayableFormBase {
    ...
    /**
     * @see org.kuali.ole.sys.web.struts.KualiAccountingDocumentFormBase#repopulateOverrides(org.kuali.ole.sys.businessobject.AccountingLine, java.lang.String, java.util.Map)
     */
    @Override
    ...
    public String getLineItemImportInstructionsUrl() {
        return SpringContext.getBean(ConfigurationService.class).getPropertyValueAsString(OLEConstants.EXTERNALIZABLE_HELP_URL_KEY) + SpringContext.getBean(ParameterService.class).getParameterValueAsString(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapParameterConstants.LINE_ITEM_IMPORT);
    }
}
