...
public class PosterSortComparator implements Comparator<String> {
    ...
    Range[] compareRanges;
    {
        ...
        compareRanges[0] = new Range(pMap.get(OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR),             pMap.get(OLEPropertyConstants.TRANSACTION_ENTRY_SEQUENCE_NUMBER));
        compareRanges[1] = new Range(pMap.get(OLEPropertyConstants.PROJECT_CODE),                       pMap.get(OLEPropertyConstants.REFERENCE_FIN_DOCUMENT_TYPE_CODE));
    }
