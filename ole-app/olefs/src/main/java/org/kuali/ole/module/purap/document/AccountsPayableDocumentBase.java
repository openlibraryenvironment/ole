...
public abstract class AccountsPayableDocumentBase extends PurchasingAccountsPayableDocumentBase implements AccountsPayableDocument {
     ...
     *
     * @see org.kuali.ole.sys.document.GeneralLedgerPostingDocumentBase#removeGeneralLedgerPendingEntries()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.AccountsPayableDocument#requiresAccountsPayableReviewRouting()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.AccountsPayableDocument#approvalAtAccountsPayableReviewAllowed()
     */
    @Override
    ...
    public void populateDocumentForRouting() {
        if (ObjectUtils.isNotNull(getPurchaseOrderDocument())) {
            ...
            if (ObjectUtils.isNull(this.getPurchaseOrderDocument().getDocumentHeader().getDocumentNumber())) {
                this.getPurchaseOrderDocument().refreshReferenceObject(OLEPropertyConstants.DOCUMENT_HEADER);
            }
        }
    ...
    /**
     * @see org.kuali.ole.module.purap.document.AccountsPayableDocument#getGrandTotal()
     */
    @Override
    public abstract KualiDecimal getGrandTotal();

    /**
     * @see org.kuali.ole.module.purap.document.AccountsPayableDocument#getInitialAmount()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.AccountsPayableDocument#getTotalRemitAmount()
     */
    @Override
    ...
    public boolean customizeOffsetGeneralLedgerPendingEntry(GeneralLedgerPendingEntrySourceDetail accountingLine, GeneralLedgerPendingEntry explicitEntry, GeneralLedgerPendingEntry offsetEntry) {
        ...
        if (offsetEntry != null && this.offsetUseTax != null) {
            ...
            offsetEntry.refreshReferenceObject(OLEPropertyConstants.CHART);
