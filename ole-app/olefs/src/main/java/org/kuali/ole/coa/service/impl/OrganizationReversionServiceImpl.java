...
import org.kuali.ole.gl.batch.service.impl.GenericOrganizationReversionCategory;
...
public class OrganizationReversionServiceImpl implements OrganizationReversionService {
    ...
    /**
     * @see org.kuali.ole.coa.service.OrganizationReversionService#getByPrimaryId(java.lang.Integer, java.lang.String,
     *      java.lang.String)
     */
    @Override
    public OrganizationReversion getByPrimaryId(Integer fiscalYear, String chartCode, String orgCode) {
        ...
        keys.put(OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, chartCode);
        keys.put(OLEPropertyConstants.ORGANIZATION_CODE, orgCode);
        return SpringContext.getBean(BusinessObjectService.class).findByPrimaryKey(OrganizationReversion.class, keys);
    }

    /**
     * @see org.kuali.ole.coa.service.OrganizationReversionService#getCategories()
     */
    @Override
    ...
    /**
     * 
     * @see org.kuali.ole.coa.service.OrganizationReversionService#getCategoryList()
     */
    @Override
    public List<OrganizationReversionCategory> getCategoryList() {
        return new ArrayList<OrganizationReversionCategory>(
                businessObjectService.findMatchingOrderBy(OrganizationReversionCategory.class, Collections.singletonMap(OLEPropertyConstants.ACTIVE, true), "organizationReversionSortCode", true)
                );
    }

    
    /**
     * @see org.kuali.ole.coa.service.OrganizationReversionService#getOrganizationReversionDetaiFromSystemParameters()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.coa.service.OrganizationReversionService#isCategoryActive(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.coa.service.OrganizationReversionService#isCategoryActiveByName(java.lang.String)
     */
    @Override
