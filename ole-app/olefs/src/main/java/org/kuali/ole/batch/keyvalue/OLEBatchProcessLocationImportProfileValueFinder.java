 ...
 */
public class OLEBatchProcessLocationImportProfileValueFinder extends KeyValuesBase {

    private static final Logger LOG = Logger.getLogger(OLEBatchProcessLocationImportProfileValueFinder.class);
    ...
    public List<KeyValue> getKeyValues() {
        ...
        List<KeyValue> options = initProfileDetailsForLocationImport();
        return options;
    }

    public static List<KeyValue> initProfileDetailsForLocationImport() {

        List<KeyValue> keyValues = new ArrayList<KeyValue>();
        BusinessObjectService businessObjectService = KRADServiceLocator.getBusinessObjectService();
        Map parentCriteria1 = new HashMap();
        parentCriteria1.put("batchProcessProfileType", "Location Import");
    ...
    public static List<String> retrieveBatchProfileNamesForLocationImport(String locationVal) {
        List<KeyValue> locationKeyValues = retrieveProfileDetailsForLocationImport();
    ...
    private static List<KeyValue> retrieveProfileDetailsForLocationImport() {
        long currentTime = System.currentTimeMillis() / 1000;
        if (locationKeyValues == null) {
            locationKeyValues = initProfileDetailsForLocationImport();
    ...
    public  static String getValue(String batchVal){
        String value="";
        locationKeyValues=retrieveProfileDetailsForLocationImport();
