...
public class PurgeEntryStep extends AbstractStep {
    ...
    public boolean execute(String jobName, Date jobRunDate) {
        String yearStr = getParameterService().getParameterValueAsString(PurgeEntryStep.class, OLEConstants.SystemGroupParameterNames.PURGE_GL_ENTRY_T_BEFORE_YEAR);
     ...
     * @see org.kuali.ole.gl.service.EntryService
     */
