...
public class CapitalAssetInformationDetail extends PersistableBusinessObjectBase {
    ...
    public Map<String, Object> getValuesMap() {
        ...
        simpleValues.put(OLEPropertyConstants.ITEM_LINE_NUMBER, this.getItemLineNumber());
        simpleValues.put(OLEPropertyConstants.CAMPUS_CODE, this.getCampusCode());
        simpleValues.put(OLEPropertyConstants.BUILDING_CODE, this.getBuildingCode());
        simpleValues.put(OLEPropertyConstants.BUILDING_ROOM_NUMBER, this.getBuildingRoomNumber());
