...
import org.kuali.ole.sys.context.BatchContainerDirectory;
import org.kuali.ole.sys.context.BatchLogger;
import org.kuali.ole.sys.context.BatchStepExecutor;
import org.kuali.ole.sys.context.BatchStepFileDescriptor;
import org.kuali.ole.sys.context.ContainerStepListener;
...
public class BatchContainerStep extends AbstractStep implements ContainerStepListener {
	...
	protected long getSemaphoreProcessingInterval() {
		return Long.parseLong(getParameterService().getParameterValueAsString(BatchContainerStep.class, OLEConstants.SystemGroupParameterNames.BATCH_CONTAINER_SEMAPHORE_PROCESSING_INTERVAL));
	}
