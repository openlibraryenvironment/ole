...
import org.kuali.ole.module.purap.exception.FaxServerUnavailableError;
import org.kuali.ole.module.purap.exception.FaxSubmissionError;
...
import org.kuali.ole.module.purap.pdf.PurchaseOrderQuotePdf;
...
public class FaxServiceImpl implements FaxService {
    ...
    public void faxPurchaseOrderPdf(PurchaseOrderDocument po, boolean isRetransmit) {
        ...
        String imageTempLocation = kualiConfigurationService.getPropertyValueAsString(OLEConstants.TEMP_DIRECTORY_KEY) + "/";
    ...
    public String getPdfFileLocation() {
        return parameterService.getParameterValueAsString(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapConstants.PDF_DIRECTORY);
    }
