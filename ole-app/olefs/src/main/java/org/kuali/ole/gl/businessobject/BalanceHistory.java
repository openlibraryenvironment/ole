...
public class BalanceHistory extends Balance implements LedgerBalanceHistory {
     ...
     * 
     * @param balance
     * @see org.kuali.ole.gl.businessobject.Balance#addAmount(java.lang.String, org.kuali.rice.core.api.util.type.KualiDecimal)
     */
    ...
    /**
     * History does not track this field.
     * @see org.kuali.ole.gl.businessobject.Balance#setTimestamp(java.sql.Date)
     */
    @Override
