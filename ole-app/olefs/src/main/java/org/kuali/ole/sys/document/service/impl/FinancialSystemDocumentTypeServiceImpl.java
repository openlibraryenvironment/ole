...
import org.kuali.ole.sys.document.LedgerPostingMaintainable;
...
public class FinancialSystemDocumentTypeServiceImpl implements FinancialSystemDocumentTypeService {
     ...
     * root doc type for the application (in the distribution, this is "OLE").
     * @see org.kuali.ole.coa.service.AccountDelegateService#isFinancialSystemDocumentType(java.lang.String)
     */
    public boolean isFinancialSystemDocumentType(String documentTypeCode) {
        ...
        final DocumentType rootDocumentType = documentTypeService.getDocumentTypeByName(OLEConstants.ROOT_DOCUMENT_TYPE);
    ...
    /**
     * @see org.kuali.ole.sys.document.service.FinancialSystemDocumentService#isAccountingDocumentType(java.lang.String)
     */
    ...
    protected boolean isFinancialSystemLedgerOnlyDocumentType(String documentTypeCode) {
        final DocumentType documentType = documentTypeService.getDocumentTypeByName(documentTypeCode);
        final DocumentType rootDocumentType = documentTypeService.getDocumentTypeByName(OLEConstants.FINANCIAL_SYSTEM_LEDGER_ONLY_ROOT_DOCUMENT_TYPE);
