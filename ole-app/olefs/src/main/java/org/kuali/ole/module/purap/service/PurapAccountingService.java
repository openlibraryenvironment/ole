...
public interface PurapAccountingService {
    ...
    /**
     * Retrieves the summary accounts by Invoice document id.
     *
     * @param invoicetIdentifier - payment request document id
     * @return List of SummaryAccounts
     */
    public List getSummaryAccountsbyInvoiceIdentifier(Integer invoicetIdentifier);
