...
import org.kuali.ole.gl.batch.PosterEntriesStep;
import org.kuali.ole.gl.batch.service.AccountingCycleCachingService;
import org.kuali.ole.gl.batch.service.EncumbranceCalculator;
...
public class PostEncumbrance implements PostTransaction, EncumbranceCalculator {
    ...
    public String post(Transaction t, int mode, Date postDate, ReportWriterService posterReportWriterService) {
        ...
        if ((StringUtils.isBlank(t.getTransactionEncumbranceUpdateCode())) || " ".equals(t.getTransactionEncumbranceUpdateCode()) || OLEConstants.ENCUMB_UPDT_NO_ENCUMBRANCE_CD.equals(t.getTransactionEncumbranceUpdateCode()) || t.getOption().getFinObjectTypeFundBalanceCd().equals(t.getFinancialObjectTypeCode())) {
        ...
        if (OLEConstants.ENCUMB_UPDT_REFERENCE_DOCUMENT_CD.equals(t.getTransactionEncumbranceUpdateCode())) {
     ...
     * @see org.kuali.ole.gl.batch.service.EncumbranceCalculator#findEncumbrance(java.util.Collection, org.kuali.ole.gl.businessobject.Transaction)
     */
    public Encumbrance findEncumbrance(Collection encumbranceList, Transaction t) {
        ...
        if ((!OLEConstants.ENCUMB_UPDT_DOCUMENT_CD.equals(t.getTransactionEncumbranceUpdateCode())) && (!OLEConstants.ENCUMB_UPDT_REFERENCE_DOCUMENT_CD.equals(t.getTransactionEncumbranceUpdateCode()))) {
            return null;
        }
    ...
    public void updateEncumbrance(Transaction t, Encumbrance enc) {
        ...
        if (OLEConstants.ENCUMB_UPDT_REFERENCE_DOCUMENT_CD.equals(t.getTransactionEncumbranceUpdateCode()) && !ArrayUtils.contains(encumbranceOpenAmountOeverridingDocTypes, t.getFinancialDocumentTypeCode())) {
            // If using referring doc number, add or subtract transaction amount from
            // encumbrance closed amount
            if (OLEConstants.GL_DEBIT_CODE.equals(t.getTransactionDebitCreditCode())) {
