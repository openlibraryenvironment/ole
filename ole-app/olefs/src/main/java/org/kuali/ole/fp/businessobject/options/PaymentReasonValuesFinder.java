...
public class PaymentReasonValuesFinder extends KeyValuesBase {
    ...
    public List getKeyValues() {
        ...
        List<PaymentReasonCode> boList = (List<PaymentReasonCode>) SpringContext.getBean(KeyValuesService.class).findAllOrderBy(PaymentReasonCode.class, OLEPropertyConstants.NAME, true);
