...
public abstract class EnterpriseFeederStatusBase implements EnterpriseFeederStatus {
     ...
     * @see org.kuali.ole.gl.batch.service.impl.EnterpriseFeederStatus#getStatusDescription()
     */
    public String getStatusDescription() {
        try {
            String description = SpringContext.getBean(ConfigurationService.class).getPropertyValueAsString(OLEConstants.ENTERPRISE_FEEDER_STATUS_DESCRIPTION_PREFIX + getClass().getName());
            if (description == null) {
