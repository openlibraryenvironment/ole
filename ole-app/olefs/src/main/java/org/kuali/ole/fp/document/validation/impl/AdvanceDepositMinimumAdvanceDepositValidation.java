...
public class AdvanceDepositMinimumAdvanceDepositValidation extends GenericValidation {
    ...
    public boolean validate(AttributedDocumentEvent event) {
        ...
        if (ad.getAdvanceDeposits().size() < requiredMinimumCount) {
            GlobalVariables.getMessageMap().putError(DOCUMENT_ERROR_PREFIX, OLEKeyConstants.AdvanceDeposit.ERROR_DOCUMENT_ADVANCE_DEPOSIT_REQ_NUMBER_DEPOSITS_NOT_MET);
            return false;
        }
        return true;
    }
