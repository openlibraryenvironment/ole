...
public class PurgeSessionDocumentsStep extends AbstractStep {
    ...
    public boolean execute(String jobName, Date jobRunDate) {
        try {
            ...
            String maxAgeInDaysStr = parameterService.getParameterValueAsString(PurgeSessionDocumentsStep.class, OLEConstants.SystemGroupParameterNames.NUMBER_OF_DAYS_SINCE_LAST_UPDATE);
