...
public class OleVendorCreditMemoItemExtendedPriceValidation extends GenericValidation {
    ...
    public boolean validate(AttributedDocumentEvent event) {
        ...
        if (itemForValidation.getExtendedPrice() != null) {
            if (itemForValidation.getExtendedPrice().isNegative() && cmDocument.getInvoiceIdentifier() == null) {
                String label = dataDictionaryService.getAttributeErrorLabel(OleCreditMemoItem.class, PurapPropertyConstants.EXTENDED_PRICE);
           ...
           /* if (!cmDocument.isSourceVendor()) {
                ...
                if (itemForValidation.getTotalAmount().isGreaterThan(invoicedAmount) && (itemForValidation.getItemSurcharge() == null)) {
