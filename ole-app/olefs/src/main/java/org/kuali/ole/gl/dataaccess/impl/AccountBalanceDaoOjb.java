...
import org.kuali.ole.gl.dataaccess.AccountBalanceConsolidationDao;
import org.kuali.ole.gl.dataaccess.AccountBalanceDao;
import org.kuali.ole.gl.dataaccess.AccountBalanceLevelDao;
import org.kuali.ole.gl.dataaccess.AccountBalanceObjectDao;
...
public class AccountBalanceDaoOjb extends PlatformAwareDaoBaseOjb implements AccountBalanceDao {
     ...
     * @see org.kuali.ole.gl.dataaccess.AccountBalanceDao#getByTransaction(org.kuali.ole.gl.businessobject.Transaction)
     */
     ...
     * @see org.kuali.ole.gl.dataaccess.AccountBalanceDao#findAvailableAccountBalance(java.util.Map, boolean)
     */
    public Iterator findConsolidatedAvailableAccountBalance(Map fieldValues) {
        ...
        String[] attributes = new String[] { OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR, OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, OLEPropertyConstants.ACCOUNT_NUMBER, OLEPropertyConstants.OBJECT_CODE, OBJ_TYP_CD, "sum(currentBudgetLineBalanceAmount)", "sum(accountLineActualsBalanceAmount)", "sum(accountLineEncumbranceBalanceAmount)" };

        String[] groupBy = new String[] { OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR, OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, OLEPropertyConstants.ACCOUNT_NUMBER, OLEPropertyConstants.OBJECT_CODE, OBJ_TYP_CD };
     ...
     * @see org.kuali.ole.gl.dataaccess.AccountBalanceDao#findAvailableAccountBalance(java.util.Map)
     */
     ...
     * @see org.kuali.ole.gl.dataaccess.AccountBalanceDao#findAccountBalanceByConsolidationByObjectTypes(java.lang.String[],
    ...
    /**
     * @see org.kuali.ole.gl.dataaccess.AccountBalanceDao#findAccountBalanceByLevel(java.lang.Integer, java.lang.String,
    ...
    /**
     * @see org.kuali.ole.gl.dataaccess.AccountBalanceDao#findAccountBalanceByObject(java.lang.Integer, java.lang.String,
    ...
    /**
     * @see org.kuali.ole.gl.dataaccess.AccountBalanceDao#findCountGreaterOrEqualThan(java.lang.Integer)
     */
