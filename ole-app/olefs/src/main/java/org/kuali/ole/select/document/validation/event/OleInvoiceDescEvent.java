...
public class OleInvoiceDescEvent extends KualiDocumentEventBase {

    private OleInvoiceItem payItem;


    protected OleInvoiceDescEvent(String errorPathPrefix, Document document) {
        super("Creating Note Tag" + getDocumentId(document), errorPathPrefix, document);
    }

    public OleInvoiceDescEvent(Document document, OleInvoiceItem payItem) {
        this("", document);
    ...
    public boolean invokeRuleMethod(BusinessRule rule) {
        return ((OleValidationRule) rule).processCustomInvoiceDescriptionBusinessRules(document, payItem);
    }
