...
import org.kuali.ole.sys.document.web.renderers.DynamicNameLabelRenderer;
...
public class AccountingLineViewField extends FieldTableJoiningWithHeader implements HeaderLabelPopulating, ReadOnlyable {
     ...
     * 
     * @see org.kuali.ole.sys.document.web.AccountingLineViewRenderableElementField#isHidden()
     */
     ...
     * determination)
     * 
     * @see org.kuali.ole.sys.document.web.AccountingLineViewRenderableElementField#isReadOnly()
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.web.TableJoining#readOnlyize()
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.web.TableJoiningWithHeader#getHeaderLabelProperty()
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.web.RenderableElement#renderElement(javax.servlet.jsp.PageContext,
    ...
    protected void renderField(PageContext pageContext, Tag parentTag, AccountingLineRenderingContext renderingContext) throws JspException {
        ...
        boolean chartSetByAccount = getName().equals(OLEConstants.CHART_OF_ACCOUNTS_CODE_PROPERTY_NAME) && !SpringContext.getBean(AccountService.class).accountsCanCrossCharts();
        ...
        if (renderer != null) {
            ...
            if (!this.isReadOnly()) {
                ...
                if (renderingContext.isNewLine()) {
                    String format = SpringContext.getBean(ConfigurationService.class).getPropertyValueAsString(OLEKeyConstants.LABEL_NEW_ACCOUNTING_LINE_FIELD);
                    ...
                    String format = SpringContext.getBean(ConfigurationService.class).getPropertyValueAsString(OLEKeyConstants.LABEL_ACCOUNTING_LINE_FIELD);
    ...
    /**
     * @see org.kuali.ole.sys.document.web.TableJoining#performFieldTransformation(org.kuali.ole.sys.document.service.AccountingLineFieldRenderingTransformation,
     ...
     * 
     * @see org.kuali.ole.sys.document.web.FieldTableJoiningWithHeader#createHeaderLabelTableCell()
     */
    @Override
     ...
     * Overridden to allow for colspan override
     * 
     * @see org.kuali.ole.sys.document.web.FieldTableJoining#createTableCell()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.document.web.HeaderLabelPopulating#populateHeaderLabel(org.kuali.ole.sys.document.web.HeaderLabel,
    ...
    /**
     * @see org.kuali.ole.sys.document.web.ReadOnlyable#setEditable()
     */
