 ...
 *
 * @see org.kuali.ole.fp.service.BankService
 */
public class BankServiceImpl implements BankService {
    ...
    /**
     * @see org.kuali.ole.fp.service.BankService#getByPrimaryId(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.service.BankService#getDefaultBankByDocType(java.lang.String)
     */
    @Override
    @Cacheable(value=Bank.CACHE_NAME, key="'DefaultByDocType-'+#p0")
    public Bank getDefaultBankByDocType(String documentTypeCode) {
        if (parameterService.parameterExists(Bank.class, OLEParameterKeyConstants.DEFAULT_BANK_BY_DOCUMENT_TYPE)) {
            List<String> parmValues = new ArrayList<String>( parameterService.getSubParameterValuesAsString(Bank.class, OLEParameterKeyConstants.DEFAULT_BANK_BY_DOCUMENT_TYPE, documentTypeCode) );
    ...
    /**
     * @see org.kuali.ole.sys.service.BankService#getDefaultBankByDocType(java.lang.Class)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.service.BankService#isBankSpecificationEnabled()
     */
    @Override
    @Cacheable(value=Bank.CACHE_NAME, key="'isBankSpecificationEnabled'")
    public boolean isBankSpecificationEnabled() {
        return parameterService.getParameterValueAsBoolean(Bank.class, OLEParameterKeyConstants.ENABLE_BANK_SPECIFICATION_IND);
    }

    /**
     * @see org.kuali.ole.sys.service.BankService#isBankSpecificationEnabledForDocument(java.lang.Class)
     */
    @Override
    ...
    public boolean isBankSpecificationEnabledForDocument(Class<?> documentClass) {
        ...
        ParameterEvaluator evaluator = SpringContext.getBean(ParameterEvaluatorService.class).getParameterEvaluator(Bank.class, OLEParameterKeyConstants.BANK_CODE_DOCUMENT_TYPES, documentTypeCode);
