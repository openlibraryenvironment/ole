...
public class AccountBalanceByObjectInquirableImpl extends AbstractGeneralLedgerInquirableImpl {
    ...
    protected Map getUserDefinedAttributeMap() {
        ...
        userDefinedAttributeMap.put(OLEPropertyConstants.FINANCIAL_OBJECT_CODE, "");
    ...
    protected String getAttributeName(String attributeName) {
        if (attributeName.equals(GeneralLedgerConstants.DummyBusinessObject.LINK_BUTTON_OPTION)) {
            attributeName = OLEPropertyConstants.GENERAL_LEDGER_PENDING_ENTRY;
        }
    ...
    protected Class getInquiryBusinessObjectClass(String attributeName) {
        if (OLEPropertyConstants.GENERAL_LEDGER_PENDING_ENTRY.equals(attributeName)) {
