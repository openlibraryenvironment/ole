...
public class EntryInquirableImpl extends AbstractGeneralLedgerInquirableImpl {
     ...
     * @see org.kuali.ole.gl.businessobject.inquiry.AbstractGeneralLedgerInquirableImpl#getInquiryBusinessObjectClass(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.gl.businessobject.inquiry.AbstractGeneralLedgerInquirableImpl#getInquiryUrl(org.kuali.rice.krad.bo.BusinessObject,
     *      java.lang.String)
     */
    @Override
    public HtmlData getInquiryUrl(BusinessObject businessObject, String attributeName) {
        if (OLEPropertyConstants.FINANCIAL_DOCUMENT_TYPE_CODE.equals(attributeName)) {
        ...
        else if (OLEPropertyConstants.REFERENCE_FIN_DOCUMENT_TYPE_CODE.equals(attributeName)) {
            if (businessObject instanceof Transaction) {
                Transaction transaction = (Transaction) businessObject;
