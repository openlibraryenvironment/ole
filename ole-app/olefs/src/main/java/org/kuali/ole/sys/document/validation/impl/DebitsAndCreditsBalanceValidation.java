...
public class DebitsAndCreditsBalanceValidation extends GenericValidation {
    ...
    public boolean validate(AttributedDocumentEvent event) {
        ...
        for(GeneralLedgerPendingEntry entry : pendingEntries) {
            ...
            if (OLEConstants.GL_CREDIT_CODE.equals(entry.getTransactionDebitCreditCode())) {
        ...
        if (!isValid) {
            GlobalVariables.getMessageMap().putError(OLEConstants.ACCOUNTING_LINE_ERRORS, OLEKeyConstants.ERROR_DOCUMENT_BALANCE);
        }
