...
public class CashReceiptDepositTypeFormatter extends Formatter {
    ...
    public CashReceiptDepositTypeFormatter() {
        INTERIM_CD = OLEConstants.DepositConstants.DEPOSIT_TYPE_INTERIM;
        INTERIM_MSG = SpringContext.getBean(ConfigurationService.class).getPropertyValueAsString(OLEKeyConstants.Deposit.DEPOSIT_TYPE_INTERIM);

        FINAL_CD = OLEConstants.DepositConstants.DEPOSIT_TYPE_FINAL;
        FINAL_MSG = SpringContext.getBean(ConfigurationService.class).getPropertyValueAsString(OLEKeyConstants.Deposit.DEPOSIT_TYPE_FINAL);
    }
