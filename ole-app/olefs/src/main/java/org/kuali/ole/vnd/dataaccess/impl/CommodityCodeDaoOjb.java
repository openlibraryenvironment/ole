 ...
 */
package org.kuali.ole.vnd.dataaccess.impl;
...
import org.kuali.ole.vnd.dataaccess.CommodityCodeDao;
...
public class CommodityCodeDaoOjb extends PlatformAwareDaoBaseOjb implements CommodityCodeDao {
    ...
    /**
     * @see org.kuali.ole.vnd.dataaccess.CommodityCodeDao#wildCardCommodityCodeExists(java.lang.String)
     */
    public boolean wildCardCommodityCodeExists(String wildCardCommodityCode) {
        String commodityCodeString = StringUtils.replace(wildCardCommodityCode, OLEConstants.WILDCARD_CHARACTER, OLEConstants.PERCENTAGE_SIGN);
