 ...
 */
package org.kuali.ole.sys.spring.datadictionary;
...
public class AttributeBeanDefinitionParser extends KualiBeanDefinitionParserBase {
    ...
    protected BeanDefinition processUserControlElement( Element ele ) {
        ...
        if ( StringUtils.hasText(userObjectAttribute) ) {
            controlBean.addPropertyValue("userIdAttributeName", userObjectAttribute + "." + OLEPropertyConstants.PERSON_USER_ID );
            controlBean.addPropertyValue("personNameAttributeName", userObjectAttribute + "." + OLEPropertyConstants.PERSON_NAME );
        }
        parseEmbeddedPropertyElements(ele, controlBean);
