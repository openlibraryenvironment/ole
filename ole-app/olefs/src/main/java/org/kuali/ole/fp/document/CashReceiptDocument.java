...
import org.kuali.ole.fp.service.CheckService;
...
public class CashReceiptDocument extends CashReceiptFamilyBase implements Copyable, AmountTotaling, CapitalAssetEditable {
    ...
    public static final String DOCUMENT_TYPE = "OLE_CR";
    ...
    /**
     * @see org.kuali.ole.sys.document.AccountingDocumentBase#checkSufficientFunds()
     */
    @Override
    ...
    public KualiDecimal getTotalDollarAmount() {
        if(getFinancialSystemDocumentHeader().getFinancialDocumentStatusCode().equals(OLEConstants.DocumentStatusCodes.CashReceipt.VERIFIED)) {
    ...
    public void doRouteStatusChange(DocumentRouteStatusChange statusChangeEvent) {
        ...
        if (workflowDocument.isProcessed()) {
            this.getFinancialSystemDocumentHeader().setFinancialDocumentStatusCode(OLEConstants.DocumentStatusCodes.CashReceipt.VERIFIED);
    ...
    public void postProcessSave(KualiDocumentEvent event) {
        ...
        if (retrieveCurrencyDetail() == null) {
            ...
            getCurrencyDetail().setCashieringStatus(OLEConstants.CurrencyCoinSources.CASH_RECEIPTS);
        }
        ...
        if (retrieveCoinDetail() == null) {
            ...
            getCoinDetail().setCashieringStatus(OLEConstants.CurrencyCoinSources.CASH_RECEIPTS); 
        }
        ...
        if(cM_veifies) {
            ...
            getConfirmedCurrencyDetail().setCashieringStatus(OLEConstants.CurrencyCoinSources.CASH_MANAGEMENT_IN);
            ...
            getConfirmedCoinDetail().setCashieringStatus(OLEConstants.CurrencyCoinSources.CASH_MANAGEMENT_IN);
        ...
        if(!(getTotalChangeAmount().compareTo(KualiDecimal.ZERO) == 0)) {
            ...
            if (cM_veifies) {
                getChangeCurrencyDetail().setCashieringStatus(OLEConstants.CurrencyCoinSources.CASH_CHANGE_GRANTED);
                getChangeCoinDetail().setCashieringStatus(OLEConstants.CurrencyCoinSources.CASH_CHANGE_GRANTED);
            } else {
                getChangeCurrencyDetail().setCashieringStatus(OLEConstants.CurrencyCoinSources.CASH_CHANGE_REQUEST);
                getChangeCoinDetail().setCashieringStatus(OLEConstants.CurrencyCoinSources.CASH_CHANGE_REQUEST);
            }
    ...
    protected Map getCashDetailPrimaryKey() {
        ...
        pk.put("cashieringStatus", OLEConstants.CurrencyCoinSources.CASH_RECEIPTS); 
        return pk;
    }
    ...
    protected Map getConfirmedCashDetailPrimaryKey() {
        ...
        pk.put("documentNumber", this.getDocumentNumber());
        pk.put("financialDocumentTypeCode", CashReceiptDocument.DOCUMENT_TYPE);
        pk.put("cashieringStatus", OLEConstants.CurrencyCoinSources.CASH_MANAGEMENT_IN); 
        return pk;
    }
    ...
    protected Map getChangeCashDetailPrimaryKey() {
        ...
        pk.put("documentNumber", this.getDocumentNumber());
        pk.put("financialDocumentTypeCode", CashReceiptDocument.DOCUMENT_TYPE);
        pk.put("cashieringStatus", OLEConstants.CurrencyCoinSources.CASH_CHANGE_REQUEST); 
        return pk;
    }
    ...
    public List generateSaveEvents() {
        ...
        List events = generateEvents(persistedChecks, currentChecks, OLEConstants.EXISTING_CHECK_PROPERTY_NAME, this);
    ...
    public Check createNewCheck() {
        ...
        newCheck.setCashieringStatus(OLEConstants.CheckSources.CASH_RECEIPTS);
        return newCheck;
    }
    ...
    public Check createNewConfirmedCheck() {
        Check newCheck = new CheckBase();
        newCheck.setFinancialDocumentTypeCode(DOCUMENT_TYPE);
        newCheck.setCashieringStatus(OLEConstants.CheckSources.CASH_MANAGEMENT);
        return newCheck;
    }
