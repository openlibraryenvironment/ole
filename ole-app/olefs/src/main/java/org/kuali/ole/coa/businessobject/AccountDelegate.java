...
public class AccountDelegate extends PersistableBusinessObjectBase implements MutableInactivatable {
    ...
    @Override
    public int hashCode() {
        return ObjectUtil.generateHashCode(this, Arrays.asList(OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, OLEPropertyConstants.ACCOUNT_NUMBER,"financialDocumentTypeCode", "accountDelegateSystemId" ));
    }
