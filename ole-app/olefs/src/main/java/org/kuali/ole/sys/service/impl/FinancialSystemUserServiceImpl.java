...
import org.kuali.ole.coa.identity.FinancialSystemUserRoleTypeServiceImpl;
...
public class FinancialSystemUserServiceImpl implements FinancialSystemUserService {
    ...
    protected String getUserRoleId() {
        if (userRoleId == null) {
            userRoleId = roleService.getRoleIdByNamespaceCodeAndName(OLEConstants.CoreModuleNamespaces.OLE, OLEConstants.SysKimApiConstants.KFS_USER_ROLE_NAME);
        }
        return userRoleId;
    }
    ...
    /**
     * @see org.kuali.ole.sys.service.FinancialSystemUserService#isActiveFinancialSystemUser(org.kuali.rice.kim.api.identity.Person)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.service.FinancialSystemUserService#isActiveFinancialSystemUser(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.service.FinancialSystemUserService#getPrimaryOrganization(org.kuali.rice.kim.api.identity.Person,
     *      java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.service.FinancialSystemUserService#getOrganizationByNamespaceCode(org.kuali.rice.kim.api.identity.Person,
     *      java.lang.String)
     */
    @Override
    ...
    protected ChartOrgHolder getOrganizationForFinancialSystemUser(String principalId, String namespaceCode) {
        ...
        if ((roleQualifiers != null) && !roleQualifiers.isEmpty()) {
            return new ChartOrgHolderImpl(roleQualifiers.get(0).get(OleKimAttributes.CHART_OF_ACCOUNTS_CODE), roleQualifiers.get(0).get(OleKimAttributes.ORGANIZATION_CODE));
        }
        return null;
    }
    ...
    public Collection<String> getPrincipalIdsForFinancialSystemOrganizationUsers( String namespaceCode, ChartOrgHolder chartOrg) {
        ...
        qualification.put(FinancialSystemUserRoleTypeServiceImpl.PERFORM_QUALIFIER_MATCH, "true");
        qualification.put(KimConstants.AttributeConstants.NAMESPACE_CODE, namespaceCode);
        qualification.put(OleKimAttributes.CHART_OF_ACCOUNTS_CODE, chartOrg.getChartOfAccountsCode());
        qualification.put(OleKimAttributes.ORGANIZATION_CODE, chartOrg.getOrganizationCode());
