 ...
 */
public class OlePurchaseOrderRetransmitDocument extends PurchaseOrderRetransmitDocument {

    private static org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(OlePurchaseOrderRetransmitDocument.class);
    /**
     * This method is overridden to populate newly added ole fields from requisition into Ole Purchase Order Retransmit Document.
     *
    ...
    public String getBibSearchURL() {
        LOG.debug("Inside getBibSearchURL of OlePurchaseOrderRetransmitDocument");
