...
import org.kuali.ole.module.purap.businessobject.DeliveryRequiredDateReason;
...
public interface ReceivingDocument extends TransactionalDocument, PurapItemOperations {
    ...
    /**
     * Gets the License request Doc Number for the given requisition document number
