 ...
 */
public class OleCirculationDeskMapping extends TransientBusinessObjectBase {
    ...
    public OleCirculationDeskMapping( Principal principal, String personEntityTypeCode ) {
        this( principal, null, personEntityTypeCode );
    }

    public OleCirculationDeskMapping( Principal principal, EntityDefault entity, String personEntityTypeCode ) {
    ...
    public OleCirculationDeskMapping( EntityDefaultInfoCacheBo p ) {
     ...
     * This overridden method ...
     *
     * @see org.kuali.rice.kim.api.identity.Person#hasAffiliationOfType(String)
     */
    ...
    /**
     * @see org.kuali.rice.kim.api.identity.Person#getExternalId(String)
     */
