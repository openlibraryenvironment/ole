...
public class LoadDefaultLicensesListener implements ServletContextListener,
        HttpSessionListener, HttpSessionAttributeListener {
    private static final Logger LOG = Logger.getLogger(LoadDefaultLicensesListener.class);

    // Public constructor is required by servlet spec
    public LoadDefaultLicensesListener() {
    }
