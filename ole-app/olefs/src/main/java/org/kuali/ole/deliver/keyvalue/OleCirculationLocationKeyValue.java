 ...
 */
public class OleCirculationLocationKeyValue extends KeyValuesBase {
    /**
    ...
    public List getKeyValues() {
        ...
        for (OleLocation oleLocation : oleLocations) {
            if ("LIBRARY".equalsIgnoreCase(oleLocation.getLevelCode()))
                keyValues.add(new ConcreteKeyValue(oleLocation.getLocationCode(), oleLocation.getLocationName()));
