...
public class PurchaseOrderTransmitParameters implements PurchaseOrderParameters {
    ...
    public void setPurchaseOrderPdfParameters(PurchaseOrderDocument po, PurchaseOrderVendorQuote povq) {
        ...
        if (SpringContext.getBean(ParameterService.class).parameterExists(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapConstants.PDF_IMAGES_AVAILABLE_INDICATOR)) {
            useImage = SpringContext.getBean(ParameterService.class).getParameterValueAsBoolean(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapConstants.PDF_IMAGES_AVAILABLE_INDICATOR);
        }
    ...
    public void setPurchaseOrderFaxParameters(PurchaseOrderDocument po, PurchaseOrderVendorQuote povq) {
        ...
        String productionEnvironmentCode = SpringContext.getBean(ConfigurationService.class).getPropertyValueAsString(OLEConstants.PROD_ENVIRONMENT_CODE_KEY);
        String environmentCode = SpringContext.getBean(ConfigurationService.class).getPropertyValueAsString(OLEConstants.ENVIRONMENT_KEY);
    ...
    public String getPdfFileLocation() {
        if (pdfFileLocation == null) {
            pdfFileLocation = SpringContext.getBean(ParameterService.class).getParameterValueAsString(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapConstants.PDF_DIRECTORY);
        }
    ...
    public String getImageTempLocation() {
        if (imageTempLocation == null) {
            imageTempLocation = SpringContext.getBean(ConfigurationService.class).getPropertyValueAsString(OLEConstants.TEMP_DIRECTORY_KEY) + "/";
        }
    ...
    public String getStatusInquiryUrl() {
        if (statusInquiryUrl == null) {
            statusInquiryUrl = SpringContext.getBean(ParameterService.class).getParameterValueAsString(OleParameterConstants.PURCHASING_DOCUMENT.class, PurapConstants.STATUS_INQUIRY_URL);
        }
