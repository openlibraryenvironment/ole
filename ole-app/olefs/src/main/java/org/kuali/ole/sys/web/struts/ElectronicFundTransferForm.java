...
public class ElectronicFundTransferForm extends KualiForm {
    ...
    public String getDocumentationMessageKey() {
        return OLEKeyConstants.ElectronicPaymentClaim.MESSAGE_EFT_CLAIMING_DOCUMENTATION;
    }
    ...
    public String getDocumentChoiceMessageKey() {
        return OLEKeyConstants.ElectronicPaymentClaim.MESSAGE_EFT_DOCUMENT_CHOICE;
    }
    ...
    public String getPreviouslyClaimedHeaderKey() {
        return OLEKeyConstants.ElectronicPaymentClaim.MESSAGE_EFT_PREVIOUSLY_CLAIMED_HEADER;
    }
    ...
    public String getClaimingDocumentNumberHeaderKey() {
        return OLEKeyConstants.ElectronicPaymentClaim.MESSAGE_EFT_CLAIMING_DOCUMENT_NUMBER_HEADER;
    }
