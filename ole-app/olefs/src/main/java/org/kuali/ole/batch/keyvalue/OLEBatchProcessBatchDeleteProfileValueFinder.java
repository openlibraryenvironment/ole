 ...
 */
public class OLEBatchProcessBatchDeleteProfileValueFinder extends KeyValuesBase {

    private static final Logger LOG = Logger.getLogger(OLEBatchProcessBatchDeleteProfileValueFinder.class);
    ...
    public List<KeyValue> getKeyValues() {
        ...
        List<KeyValue> options = initProfileDetailsForBatchDelete();
        return options;
    }
    ...
    private static List<KeyValue> retrieveProfileDetailsForBatchDelete() {
        long currentTime = System.currentTimeMillis() / 1000;
        if (locationKeyValues == null) {
            locationKeyValues = initProfileDetailsForBatchDelete();
