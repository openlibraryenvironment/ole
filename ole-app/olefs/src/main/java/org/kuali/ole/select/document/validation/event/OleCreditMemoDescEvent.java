...
public class OleCreditMemoDescEvent extends KualiDocumentEventBase {

    private OleCreditMemoItem creditMemoItem;


    protected OleCreditMemoDescEvent(String errorPathPrefix, Document document) {
        super("Creating Note Tag" + getDocumentId(document), errorPathPrefix, document);
    }

    public OleCreditMemoDescEvent(Document document, OleCreditMemoItem creditMemoItem) {
        this("", document);
    ...
    public boolean invokeRuleMethod(BusinessRule rule) {
        return ((OleValidationRule) rule).processCustomCreditMemoDescriptionBusinessRules(document, creditMemoItem);
    }
