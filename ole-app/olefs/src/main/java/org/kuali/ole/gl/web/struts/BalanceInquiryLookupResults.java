...
public class BalanceInquiryLookupResults extends LookupForm implements LookupResultsSelectable {
    ...
    protected String getMethodToCall(HttpServletRequest request) {
        return request.getParameter(OLEConstants.DISPATCH_REQUEST_PARAMETER);
    }
    ...
    public void populate(HttpServletRequest request) {
        ...
        if (StringUtils.isNotBlank(request.getParameter(OLEConstants.TableRenderConstants.VIEWED_PAGE_NUMBER))) {
            setViewedPageNumber(Integer.parseInt(request.getParameter(OLEConstants.TableRenderConstants.VIEWED_PAGE_NUMBER)));
        }
        else {
            setViewedPageNumber(0); // first page is page 0
        }

        if (OLEConstants.TableRenderConstants.SWITCH_TO_PAGE_METHOD.equals(getMethodToCall(request))) {
            ...
            String paramPrefix = OLEConstants.DISPATCH_REQUEST_PARAMETER + "." + OLEConstants.TableRenderConstants.SWITCH_TO_PAGE_METHOD + ".";
        ...
        if (OLEConstants.TableRenderConstants.SORT_METHOD.equals(getMethodToCall(request))) {
            setColumnToSortIndex(-1);

            // the param we're looking for looks like: methodToCall.sort.1.x , where 1 is the column to sort on
            String paramPrefix = OLEConstants.DISPATCH_REQUEST_PARAMETER + "." + OLEConstants.TableRenderConstants.SORT_METHOD + ".";
            for (Enumeration i = request.getParameterNames(); i.hasMoreElements();) {
                String parameterName = (String) i.nextElement();
                if (parameterName.startsWith(paramPrefix) && parameterName.endsWith(".x")) {
    ...
    protected Set<String> parsePreviouslySelectedObjectIds(HttpServletRequest request) {
        String previouslySelectedObjectIds = request.getParameter(OLEConstants.MULTIPLE_VALUE_LOOKUP_PREVIOUSLY_SELECTED_OBJ_IDS_PARAM);
    ...
    protected Set<String> parseSelectedObjectIdSet(HttpServletRequest request) {
        ...
        while (paramNames.hasMoreElements()) {
            ...
            if (paramName.startsWith(OLEConstants.MULTIPLE_VALUE_LOOKUP_SELECTED_OBJ_ID_PARAM_PREFIX) && StringUtils.isNotBlank(request.getParameter(paramName))) {
                set.add(StringUtils.substringAfter(paramName, OLEConstants.MULTIPLE_VALUE_LOOKUP_SELECTED_OBJ_ID_PARAM_PREFIX));
            }
        }
        return set;
    }
    ...
    protected Set<String> parseDisplayedObjectIdSet(HttpServletRequest request) {
        ...
        while (paramNames.hasMoreElements()) {
            String paramName = (String) paramNames.nextElement();
            if (paramName.startsWith(OLEConstants.MULTIPLE_VALUE_LOOKUP_DISPLAYED_OBJ_ID_PARAM_PREFIX) && StringUtils.isNotBlank(request.getParameter(paramName))) {
                set.add(StringUtils.substringAfter(paramName, OLEConstants.MULTIPLE_VALUE_LOOKUP_DISPLAYED_OBJ_ID_PARAM_PREFIX));
            }
        }
        return set;
    }
    ...
    protected boolean parseSearchUsingOnlyPrimaryKeyValues(HttpServletRequest request) {
        ...
        String paramPrefix = OLEConstants.DISPATCH_REQUEST_PARAMETER + "." + getMethodToCall(request) + ".";
        for (Enumeration i = request.getParameterNames(); i.hasMoreElements();) {
            String parameterName = (String) i.nextElement();
            if (parameterName.startsWith(paramPrefix) && parameterName.endsWith(".x")) {
    ...
    protected boolean parseSearchUsingOnlyPrimaryKeyValues(String methodToCallParam) {
        String searchUsingOnlyPrimaryKeyValuesStr = StringUtils.substringBetween(methodToCallParam, OLEConstants.METHOD_TO_CALL_PARM12_LEFT_DEL, OLEConstants.METHOD_TO_CALL_PARM12_RIGHT_DEL);
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#getViewedPageNumber()
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#setViewedPageNumber(int)
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#getLookupResultsSequenceNumber()
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#setLookupResultsSequenceNumber(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#getTotalNumberOfPages()
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#setTotalNumberOfPages(int)
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#getFirstRowIndex()
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#setFirstRowIndex(int)
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#getLastRowIndex()
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#setLastRowIndex(int)
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#getSwitchToPageNumber()
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#getPreviouslySelectedObjectIdSet()
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#setPreviouslySelectedObjectIdSet(java.util.Set)
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#getSelectedObjectIdSet()
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#setSelectedObjectIdSet(java.util.Set)
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#getDisplayedObjectIdSet()
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#setDisplayedObjectIdSet(java.util.Set)
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#getCompositeObjectIdMap()
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#setCompositeObjectIdMap(java.util.Map)
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#getColumnToSortIndex()
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#setColumnToSortIndex(int)
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#getPreviouslySortedColumnIndex()
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#setPreviouslySortedColumnIndex(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#getResultsActualSize()
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#setResultsActualSize(int)
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#getResultsLimitedSize()
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#setResultsLimitedSize(int)
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#jumpToFirstPage(int, int)
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#jumpToLastPage(int, int)
     */
    ...
    /**
     * @see org.kuali.ole.gl.web.struts.LookupResultsSelectable#jumpToPage(int, int, int)
     */
