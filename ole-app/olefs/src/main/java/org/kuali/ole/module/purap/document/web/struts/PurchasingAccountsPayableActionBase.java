...
import org.kuali.ole.module.purap.businessobject.PurApAccountingLineParser;
...
public class PurchasingAccountsPayableActionBase extends KualiAccountingDocumentActionBase {
    ...
    public ActionForward copy(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        for (PurApItem item : items) {
            item.getNewSourceLine().setAccountLinePercent(new BigDecimal(0));
    ...
    /**
     * @see org.kuali.ole.sys.web.struts.KualiAccountingDocumentActionBase#getSourceAccountingLine(org.apache.struts.action.ActionForm,
