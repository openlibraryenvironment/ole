...
public class Summary implements Comparable {
    ...
    public static List<Summary> buildDefualtReportSummary(String destination, int startingOrder) {
        ...
        updateReportSummary(reportSummary, destination, OLEConstants.OperationType.INSERT, 0, startingOrder++);
        updateReportSummary(reportSummary, destination, OLEConstants.OperationType.UPDATE, 0, startingOrder++);
        updateReportSummary(reportSummary, destination, OLEConstants.OperationType.DELETE, 0, startingOrder++);
