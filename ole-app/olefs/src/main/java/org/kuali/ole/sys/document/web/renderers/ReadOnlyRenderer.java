...
public class ReadOnlyRenderer extends FieldRendererBase {
     ...
     * @see org.kuali.ole.sys.document.web.renderers.FieldRendererBase#clear()
     */
    @Override
    public void clear() {
        super.clear();
    ...
    protected String buildBeginInquiryLink() {
        ...
        if (getField().getInquiryURL() instanceof AnchorHtmlData) {
            ...
            beginInquiryLink.append("<a href=\"");
                beginInquiryLink.append(SpringContext.getBean(ConfigurationService.class).getPropertyValueAsString(OLEConstants.APPLICATION_URL_KEY));
     ...
     * @see org.kuali.ole.sys.document.web.renderers.FieldRenderer#renderQuickfinder()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.document.web.renderers.FieldRendererBase#closeNoWrapSpan(javax.servlet.jsp.PageContext, javax.servlet.jsp.tagext.Tag)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.document.web.renderers.FieldRendererBase#openNoWrapSpan(javax.servlet.jsp.PageContext, javax.servlet.jsp.tagext.Tag)
     */
    @Override
