 ...
 * Orders.
 *
 * @see org.kuali.ole.vnd.businessobject.VendorContract
 */
public class ContractManager extends PersistableBusinessObjectBase implements MutableInactivatable {
    ...
    public String getContractManagerUserIdentifier() {
        ...
        String roleId = roleService.getRoleIdByNamespaceCodeAndName(OleParameterConstants.PURCHASING_NAMESPACE, ContractManagerRoleTypeServiceImpl.CONTRACT_MANAGER_ROLE_NAME);

        qualification.put(OleKimAttributes.CONTRACT_MANAGER_CODE, String.valueOf(contractManagerCode));
