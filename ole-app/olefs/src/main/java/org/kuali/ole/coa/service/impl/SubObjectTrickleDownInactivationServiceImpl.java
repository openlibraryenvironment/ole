...
import org.kuali.ole.coa.service.SubObjectTrickleDownInactivationService;
...
public class SubObjectTrickleDownInactivationServiceImpl implements SubObjectTrickleDownInactivationService {
    ...
    //MSU Contribution DTT-3791 OLEMI-8645 OLECNTRB-976
    ...
    protected void addNotesToDocument(TrickleDownInactivationStatus trickleDownInactivationStatus, String documentNumber) {
        ...
        addNotes(documentNumber, trickleDownInactivationStatus.inactivatedSubObjCds, OLEKeyConstants.SUB_OBJECT_TRICKLE_DOWN_INACTIVATION, noteParent, newNote);
        addNotes(documentNumber, trickleDownInactivationStatus.errorPersistingSubObjCds, OLEKeyConstants.SUB_OBJECT_TRICKLE_DOWN_INACTIVATION_ERROR_DURING_PERSISTENCE, noteParent, newNote);
        addMaintenanceLockedNotes(documentNumber, trickleDownInactivationStatus.alreadyLockedSubObjCds, OLEKeyConstants.SUB_OBJECT_TRICKLE_DOWN_INACTIVATION_RECORD_ALREADY_MAINTENANCE_LOCKED, noteParent, newNote);
    }
    ...
    protected Collection<SubObjectCode> getAssociatedSubObjects(Account account) {
        ...
        fieldValues.put(OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR, universityDateService.getCurrentFiscalYear());
        fieldValues.put(OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, account.getChartOfAccountsCode());
        fieldValues.put(OLEPropertyConstants.ACCOUNT_NUMBER, account.getAccountNumber());
    ...
    protected Collection<SubObjectCode> getAssociatedSubObjects(ObjectCode objectCode) {
        Map<String, Object> fieldValues = new HashMap<String, Object>();
        fieldValues.put(OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR, objectCode.getUniversityFiscalYear());
        fieldValues.put(OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, objectCode.getChartOfAccountsCode());
        fieldValues.put(OLEPropertyConstants.FINANCIAL_OBJECT_CODE, objectCode.getFinancialObjectCode());
        return businessObjectService.findMatching(SubObjectCode.class, fieldValues);
    }
    ...
    protected int getNumSubObjectsPerNote() {
        //MSU Contribution DTT-3791 OLEMI-8645 OLECNTRB-976 - Account Document in Exception reduced the no of sub objects 
