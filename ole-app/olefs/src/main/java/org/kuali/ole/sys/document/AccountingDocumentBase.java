...
import org.kuali.ole.sys.document.validation.event.AccountingLineEvent;
...
import org.kuali.ole.sys.document.validation.event.ReviewAccountingLineEvent;
...
public abstract class AccountingDocumentBase extends GeneralLedgerPostingDocumentBase implements AccountingDocument, GeneralLedgerPendingEntrySource {
    ...
    /**
     * @see org.kuali.ole.sys.document.AccountingDocument#getTargetAccountingLines()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.document.AccountingDocument#setTargetAccountingLines(java.util.List)
     */
    @Override
     ...
     *
     * @see org.kuali.ole.sys.document.AccountingDocument#addSourceAccountingLine(SourceAccountingLine)
     */
    @Override
     ...
     *
     * @see org.kuali.ole.sys.document.AccountingDocument#addTargetAccountingLine(TargetAccountingLine)
     */
    @Override
     ...
     * if you add more than one item to the list.
     *
     * @see org.kuali.ole.sys.document.AccountingDocument#getTargetAccountingLine(int)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.document.AccountingDocument#getTargetTotal()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.document.AccountingDocument#getNextSourceLineNumber()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.document.AccountingDocument#setNextSourceLineNumber(java.lang.Integer)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.document.AccountingDocument#getNextTargetLineNumber()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.document.AccountingDocument#setNextTargetLineNumber(java.lang.Integer)
     */
    @Override
     ...
     *
     * @see org.kuali.ole.sys.document.AccountingDocument#getTargetAccountingLineClass()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.document.GeneralLedgerPostingDocumentBase#toCopy()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.document.GeneralLedgerPostingDocumentBase#toErrorCorrection()
     */
    @Override
    ...
    public List generateSaveEvents() {
        ...
        List sourceEvents = generateEvents(persistedSourceLines, currentSourceLines, OLEConstants.DOCUMENT_PROPERTY_NAME + "." + OLEConstants.SOURCE_ACCOUNTING_LINE_ERRORS, this);
        ...
        List targetEvents = generateEvents(persistedTargetLines, currentTargetLines, OLEConstants.DOCUMENT_PROPERTY_NAME + "." + OLEConstants.TARGET_ACCOUNTING_LINE_ERRORS, this);
    ...
    protected List generateEvents(List persistedLines, List currentLines, String errorPathPrefix, TransactionalDocument document) {
        ...
        for (Iterator i = persistedLineMap.entrySet().iterator(); i.hasNext();) {
            ...
            String groupErrorPathPrefix = errorPathPrefix + OLEConstants.ACCOUNTING_LINE_GROUP_SUFFIX;
    ...
    /**
     *
     * @see org.kuali.ole.sys.document.AccountingDocument#isDocumentFinalOrProcessed()
     */
    @Override
