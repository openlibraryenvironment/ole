...
/**
 * Special case <code>{@link SourceAccountingLine}</code> type for <code>{@link org.kuali.ole.fp.document.VoucherDocument}</code>
 */
public class VoucherSourceAccountingLine extends SourceAccountingLine {
    ...
    public VoucherSourceAccountingLine() {
        ...
        this.setDebitCreditCode(OLEConstants.GL_DEBIT_CODE);
    }
     ...
     * 
     * @see org.kuali.ole.sys.businessobject.AccountingLineBase#setFinancialObjectCode(java.lang.String)
     */
    @Override
