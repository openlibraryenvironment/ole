 ...
 */
public class OleItemAvailableStatusLookupableImpl extends LookupableImpl {
    ...
    protected String getActionUrlHref(LookupForm lookupForm, Object dataObject, String methodToCall,
        ...
        String maintenanceMapping = "itemAvailableStatusMaintenance";
    ...
    protected List<?> getSearchResults(LookupForm form, Map<String, String> searchCriteria, boolean unbounded) {
        ...
        List<?> searchResults;
        List<OleItemAvailableStatus> finalSearchResult = new ArrayList<OleItemAvailableStatus>();
        List<OleItemAvailableStatus> oleItemAvailableStatus = new ArrayList<OleItemAvailableStatus>();

        oleItemAvailableStatus = (List<OleItemAvailableStatus>) super.getSearchResults(form, searchCriteria, unbounded);
        finalSearchResult.addAll(oleItemAvailableStatus);
