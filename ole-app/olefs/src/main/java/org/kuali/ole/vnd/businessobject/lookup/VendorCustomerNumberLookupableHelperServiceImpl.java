...
public class VendorCustomerNumberLookupableHelperServiceImpl extends KualiLookupableHelperServiceImpl {
    ...
    protected List<? extends BusinessObject> getSearchResultsHelper(Map<String, String> fieldValues, boolean unbounded) {
        ...
        setBackLocation(fieldValues.get(OLEConstants.BACK_LOCATION));
        setDocFormKey(fieldValues.get(OLEConstants.DOC_FORM_KEY));
        setReferencesToRefresh(fieldValues.get(OLEConstants.REFERENCES_TO_REFRESH));
