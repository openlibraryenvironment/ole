...
public interface BankService {
    public static final String[] PERMANENT_BANK_SPECIFICATION_ENABLED_DOCUMENT_TYPES = {OLEConstants.FinancialDocumentTypeCodes.ADVANCE_DEPOSIT, OLEConstants.FinancialDocumentTypeCodes.CASH_MANAGEMENT, OLEConstants.FinancialDocumentTypeCodes.NON_CHECK_DISBURSEMENT};
