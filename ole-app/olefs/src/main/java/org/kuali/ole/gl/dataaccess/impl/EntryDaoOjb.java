...
import org.kuali.ole.gl.dataaccess.EntryDao;
...
public class EntryDaoOjb extends PlatformAwareDaoBaseOjb implements EntryDao, LedgerEntryBalancingDao {
    ...
    /**
     * @see org.kuali.ole.gl.dataaccess.LedgerEntryBalancingDao#findEntryByGroup(java.lang.Integer, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)
     */
    public Object[] findEntryByGroup(Integer universityFiscalYear, String chartOfAccountsCode, String financialObjectCode, String financialBalanceTypeCode, String universityFiscalPeriodCode, String transactionDebitCreditCode) {
        ...
        criteria.addEqualTo(OLEConstants.FINANCIAL_OBJECT_CODE_PROPERTY_NAME, financialObjectCode);
        criteria.addEqualTo(OLEConstants.FINANCIAL_BALANCE_TYPE_CODE_PROPERTY_NAME, financialBalanceTypeCode);
        criteria.addEqualTo(OLEConstants.UNIVERSITY_FISCAL_PERIOD_CODE_PROPERTY_NAME, universityFiscalPeriodCode);
        criteria.addEqualTo(OLEConstants.TRANSACTION_DEBIT_CREDIT_CODE, transactionDebitCreditCode);

        ReportQueryByCriteria reportQuery = QueryFactory.newReportQuery(Entry.class, criteria);
        reportQuery.setAttributes(new String[] { "count(*)", "sum(" + OLEConstants.TRANSACTION_LEDGER_ENTRY_AMOUNT + ")"});
        reportQuery.addGroupBy(new String[] { OLEConstants.UNIVERSITY_FISCAL_YEAR_PROPERTY_NAME, OLEConstants.CHART_OF_ACCOUNTS_CODE_PROPERTY_NAME, OLEConstants.FINANCIAL_OBJECT_CODE_PROPERTY_NAME, OLEConstants.FINANCIAL_BALANCE_TYPE_CODE_PROPERTY_NAME, OLEConstants.UNIVERSITY_FISCAL_PERIOD_CODE_PROPERTY_NAME, OLEConstants.TRANSACTION_DEBIT_CREDIT_CODE});
