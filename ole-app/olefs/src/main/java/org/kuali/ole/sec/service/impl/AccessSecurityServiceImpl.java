...
import org.kuali.ole.sec.SecConstants.SecurityTemplateNames;
import org.kuali.ole.sec.businessobject.AccessSecurityRestrictionInfo;
import org.kuali.ole.sec.datadictionary.AccessSecurityAttributeRestrictionEntry;
import org.kuali.ole.sec.identity.SecKimAttributes;
import org.kuali.ole.sec.service.AccessPermissionEvaluator;
...
import org.kuali.ole.sys.businessobject.datadictionary.FinancialSystemBusinessObjectEntry;
...
/**
 * @see org.kuali.ole.sec.service.AccessSecurityService
 */
public class AccessSecurityServiceImpl implements AccessSecurityService {
    ...
    /**
     * @see org.kuali.ole.sec.service.AccessSecurityService#applySecurityRestrictionsForGLInquiry(java.util.List, org.kuali.rice.kim.api.identity.Person)
     */
    @Override
    public void applySecurityRestrictionsForGLInquiry(List<? extends BusinessObject> results, Person person) {
        applySecurityRestrictions(results, person, getInquiryWithFieldValueTemplate(), Collections.singletonMap(KimConstants.AttributeConstants.NAMESPACE_CODE, OLEConstants.CoreModuleNamespaces.GL));
    }

    /**
     * @see org.kuali.ole.sec.service.AccessSecurityService#applySecurityRestrictionsForLookup(java.util.List, org.kuali.rice.kim.api.identity.Person)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sec.service.AccessSecurityService#canEditDocumentAccountingLine(org.kuali.ole.sys.document.AccountingDocument,
    ...
    /**
     * @see org.kuali.ole.sec.service.AccessSecurityService#canViewDocument(org.kuali.ole.sys.document.AccountingDocument,
    ...
    /**
     * @see org.kuali.ole.sec.service.AccessSecurityService#canViewDocumentAccountingLine(org.kuali.ole.sys.document.AccountingDocument,
     *      org.kuali.ole.sys.businessobject.AccountingLine, org.kuali.rice.kim.api.identity.Person)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sec.service.AccessSecurityService#canViewDocumentNotesAttachments(org.kuali.ole.sys.document.AccountingDocument,
     ...
     * @see org.kuali.ole.sec.service.AccessPermissionEvaluator
     */
    ...
    /**
     * @see org.kuali.ole.sec.service.AccessSecurityService#getEditAccountingLineWithFieldValueTemplateId()
     */
    @Override
    public Template getEditAccountingLineWithFieldValueTemplate() {
        Template templateInfo = getPermissionService().findPermTemplateByNamespaceCodeAndName(OLEConstants.CoreModuleNamespaces.ACCESS_SECURITY, SecurityTemplateNames.EDIT_ACCOUNTING_LINE_FIELD_VALUE);
    ...
    /**
     * @see org.kuali.ole.sec.service.AccessSecurityService#getEditDocumentWithFieldValueTemplateId()
     */
    @Override
    public Template getEditDocumentWithFieldValueTemplate() {
        Template templateInfo = getPermissionService().findPermTemplateByNamespaceCodeAndName(OLEConstants.CoreModuleNamespaces.ACCESS_SECURITY, SecurityTemplateNames.EDIT_DOCUMENT_FIELD_VALUE);
        if ( templateInfo != null ) {
            return templateInfo;
        } else {
    ...
    /**
     * @see org.kuali.ole.sec.service.AccessSecurityService#getInquiryWithFieldValueTemplateId()
     */
    @Override
    public Template getInquiryWithFieldValueTemplate() {
        Template templateInfo = getPermissionService().findPermTemplateByNamespaceCodeAndName(OLEConstants.CoreModuleNamespaces.ACCESS_SECURITY, SecurityTemplateNames.INQUIRY_FIELD_VALUE);
        if ( templateInfo != null ) {
            return templateInfo;
        } else {
    ...
    /**
     * @see org.kuali.ole.sec.service.AccessSecurityService#getLookupWithFieldValueTemplateId()
     */
    @Override
    public Template getLookupWithFieldValueTemplate() {
        Template templateInfo = getPermissionService().findPermTemplateByNamespaceCodeAndName(OLEConstants.CoreModuleNamespaces.ACCESS_SECURITY, SecurityTemplateNames.LOOKUP_FIELD_VALUE);
        if ( templateInfo != null ) {
            return templateInfo;
        } else {
    ...
    /**
     * @see org.kuali.ole.sec.service.AccessSecurityService#getViewAccountingLineWithFieldValueTemplateId()
     */
    @Override
    public Template getViewAccountingLineWithFieldValueTemplate() {
        Template templateInfo = getPermissionService().findPermTemplateByNamespaceCodeAndName(OLEConstants.CoreModuleNamespaces.ACCESS_SECURITY, SecurityTemplateNames.VIEW_ACCOUNTING_LINE_FIELD_VALUE);
        if ( templateInfo != null ) {
            return templateInfo;
        } else {
    ...
    /**
     * @see org.kuali.ole.sec.service.AccessSecurityService#getViewDocumentWithFieldValueTemplateId()
     */
    @Override
    public Template getViewDocumentWithFieldValueTemplate() {
        Template templateInfo = getPermissionService().findPermTemplateByNamespaceCodeAndName(OLEConstants.CoreModuleNamespaces.ACCESS_SECURITY, SecurityTemplateNames.VIEW_DOCUMENT_FIELD_VALUE);
        if ( templateInfo != null ) {
            return templateInfo;
        } else {
    ...
    /**
     * @see org.kuali.ole.sec.service.AccessSecurityService#getViewNotesAttachmentsWithFieldValueTemplateId()
     */
    @Override
    public Template getViewNotesAttachmentsWithFieldValueTemplate() {
        Template templateInfo = getPermissionService().findPermTemplateByNamespaceCodeAndName(OLEConstants.CoreModuleNamespaces.ACCESS_SECURITY, SecurityTemplateNames.VIEW_NOTES_ATTACHMENTS_FIELD_VALUE);
        if ( templateInfo != null ) {
            return templateInfo;
        } else {
    ...
    public void compareListSizeAndAddMessageIfChanged(int previousListSize, List<?> results, String messageKey) {
        ...
        if (previousListSize != currentListSize) {
            GlobalVariables.getMessageMap().putInfo(OLEConstants.GLOBAL_MESSAGES, messageKey, Integer.toString(previousListSize - currentListSize));
        }
    }
