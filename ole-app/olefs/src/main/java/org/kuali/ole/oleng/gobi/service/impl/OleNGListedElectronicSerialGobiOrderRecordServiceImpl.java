 ...
 */
public class OleNGListedElectronicSerialGobiOrderRecordServiceImpl extends OleNgGobiOrderImportServiceImpl {

    private PurchaseOrder.Order.ListedElectronicSerial.OrderDetail orderDetail;
    ...
    protected void preProcess() {
        orderDetail = getOrder().getOrder().getListedElectronicSerial().getOrderDetail();
    }
