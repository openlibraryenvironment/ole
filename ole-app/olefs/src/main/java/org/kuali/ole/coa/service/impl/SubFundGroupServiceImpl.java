...
import org.kuali.ole.coa.dataaccess.SubFundGroupDao;
...
public class SubFundGroupServiceImpl implements SubFundGroupService {
    ...
    /**
     * @see org.kuali.ole.coa.service.SubFundGroupService#isForContractsAndGrants(org.kuali.ole.coa.businessobject.SubFundGroup)
     */
    public boolean isForContractsAndGrants(SubFundGroup subFundGroup) {
        if (ObjectUtils.isNull(subFundGroup)) {
            ...
            return /*REFACTORME*/SpringContext.getBean(ParameterEvaluatorService.class).getParameterEvaluator(Account.class, OLEConstants.ChartApcParms.ACCOUNT_CG_DENOTING_VALUE, subFundGroup.getFundGroupCode()).evaluationSucceeds();
    //      return getContractsAndGrantsDenotingValue(subFundGroup.getFundGroupCode());
        }
        else {
            return /*REFACTORME*/SpringContext.getBean(ParameterEvaluatorService.class).getParameterEvaluator(Account.class, OLEConstants.ChartApcParms.ACCOUNT_CG_DENOTING_VALUE, subFundGroup.getSubFundGroupCode()).evaluationSucceeds();
    ...
    /**
     * @see org.kuali.ole.coa.service.SubFundGroupService#getContractsAndGrantsDenotingAttributeLabel()
     */
    public String getContractsAndGrantsDenotingAttributeLabel() {
        if (fundGroupDenotesContractsAndGrants()) {
            return dataDictionaryService.getAttributeLabel(FundGroup.class, OLEConstants.FUND_GROUP_CODE_PROPERTY_NAME);
        }
        else {
            return dataDictionaryService.getAttributeLabel(SubFundGroup.class, OLEConstants.SUB_FUND_GROUP_CODE_PROPERTY_NAME);
        }
    }

    /**
     * 
     * @see org.kuali.ole.coa.service.SubFundGroupService#getContractsAndGrantsDenotingValue(org.kuali.ole.coa.businessobject.SubFundGroup)
     */
    ...
    /**
     * @see org.kuali.ole.coa.service.SubFundGroupService#getContractsAndGrantsDenotingValues()
     */
    public Collection<String> getContractsAndGrantsDenotingValues() {
        return parameterService.getParameterValuesAsString(Account.class, OLEConstants.ChartApcParms.ACCOUNT_CG_DENOTING_VALUE);
    }
    
    
    /**
     * @see org.kuali.ole.coa.service.SubFundGroupService#getContractsAndGrantsDenotingValueForMessage()
     */
    public String getContractsAndGrantsDenotingValueForMessage() {
        return /*REFACTORME*/SpringContext.getBean(ParameterEvaluatorService.class).getParameterEvaluator(Account.class, OLEConstants.ChartApcParms.ACCOUNT_CG_DENOTING_VALUE).getParameterValuesForMessage();
    }
    ...
    protected boolean fundGroupDenotesContractsAndGrants() {
        return parameterService.getParameterValueAsBoolean(Account.class, OLEConstants.ChartApcParms.ACCOUNT_FUND_GROUP_DENOTES_CG);
    }

    /**
     * @see org.kuali.ole.coa.service.SubFundGroupService#getByPrimaryId(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.coa.service.SubFundGroupService#getByChartAndAccount(java.lang.String, java.lang.String)
     */
