...
import org.kuali.ole.sys.batch.service.AutoDisapproveDocumentsService;
...
public class AutoDisapproveDocumentsServiceImpl implements AutoDisapproveDocumentsService {
     ...
     * @see org.kuali.ole.sys.batch.service.autoDisapproveDocumentsInEnrouteStatus#autoDisapproveDocumentsInEnrouteStatus()
     */
    ...
    protected boolean checkIfRunDateParameterExists() {
        ...
        if (!getParameterService().parameterExists(AutoDisapproveDocumentsStep.class, OLEParameterKeyConstants.YearEndAutoDisapprovalConstants.YEAR_END_AUTO_DISAPPROVE_DOCUMENT_STEP_RUN_DATE)) {
    ...
    protected boolean checkIfParentDocumentTypeParameterExists() {
        ...
        if (!getParameterService().parameterExists(AutoDisapproveDocumentsStep.class, OLEParameterKeyConstants.YearEndAutoDisapprovalConstants.YEAR_END_AUTO_DISAPPROVE_PARENT_DOCUMENT_TYPE)) {
    ...
    protected boolean checkIfDocumentCompareCreateDateParameterExists() {
        ...
        if (!getParameterService().parameterExists(AutoDisapproveDocumentsStep.class, OLEParameterKeyConstants.YearEndAutoDisapprovalConstants.YEAR_END_AUTO_DISAPPROVE_DOCUMENT_CREATE_DATE)) {
    ...
    protected boolean checkIfDocumentTypesExceptionParameterExists() {
        ...
        if (!getParameterService().parameterExists(AutoDisapproveDocumentsStep.class, OLEParameterKeyConstants.YearEndAutoDisapprovalConstants.YEAR_END_AUTO_DISAPPROVE_DOCUMENT_TYPES)) {
    ...
    protected boolean checkIfAnnotationForDisapprovalParameterExists() {
        ...
        if (!getParameterService().parameterExists(AutoDisapproveDocumentsStep.class, OLEParameterKeyConstants.YearEndAutoDisapprovalConstants.YEAR_END_AUTO_DISAPPROVE_ANNOTATION)) {
    ...
    protected boolean canAutoDisapproveJobRun() {
      ...
      String yearEndAutoDisapproveRunDate = getParameterService().getParameterValueAsString(AutoDisapproveDocumentsStep.class, OLEParameterKeyConstants.YearEndAutoDisapprovalConstants.YEAR_END_AUTO_DISAPPROVE_DOCUMENT_STEP_RUN_DATE);
     ...
     * @param principalId The principal id which is OLE-SYS System user to run the process under.
    ...
    protected boolean checkIfDocumentEligibleForAutoDispproval(Document document) {
        ...
        String yearEndAutoDisapproveParentDocumentType = getParameterService().getParameterValueAsString(AutoDisapproveDocumentsStep.class, OLEParameterKeyConstants.YearEndAutoDisapprovalConstants.YEAR_END_AUTO_DISAPPROVE_PARENT_DOCUMENT_TYPE);
    ...
    protected Date getDocumentCompareDateParameter() {
        ...
        String yearEndAutoDisapproveDocumentDate = getParameterService().getParameterValueAsString(AutoDisapproveDocumentsStep.class, OLEParameterKeyConstants.YearEndAutoDisapprovalConstants.YEAR_END_AUTO_DISAPPROVE_DOCUMENT_CREATE_DATE);
    ...
    protected boolean exceptionsToAutoDisapproveProcess(Document document, Date documentCompareDate) {
        ...
        if (createDate.before(documentCompareDate) || createDate.equals(documentCompareDate)) {
            ...
            ParameterEvaluator evaluatorDocumentType = /*REFACTORME*/SpringContext.getBean(ParameterEvaluatorService.class).getParameterEvaluator(AutoDisapproveDocumentsStep.class, OLEParameterKeyConstants.YearEndAutoDisapprovalConstants.YEAR_END_AUTO_DISAPPROVE_DOCUMENT_TYPES, documentTypeName);
