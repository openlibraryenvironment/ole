 ...
 */
public class OLEBatchConstantsLocationLevel2KeyValues extends KeyValuesBase {
    @Override
    public List<KeyValue> getKeyValues() {
        List<KeyValue> keyValues = new ArrayList<KeyValue>();
        keyValues = getLocationsByLocationLevel(OLEConstants.OLEBatchProcess.LOCATION_LEVEL_CAMPUS);
        return keyValues;
    }
