...
public class KualiAccountMaintainableImpl extends FinancialSystemMaintainable {
    ...
    protected void populateChartOfAccountsCodeFields() {
        ...
        while (chartAccountPairs.hasNext()) {
            ...
            String coaCode = null;
            String coaCodePK = (String)ObjectUtils.getPropertyValue(bo, OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE);
            String accountNumberPK = (String)ObjectUtils.getPropertyValue(bo, OLEPropertyConstants.ACCOUNT_NUMBER);
