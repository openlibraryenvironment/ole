...
import org.kuali.ole.sys.batch.service.BatchInputFileSetService;
...
public class BatchInputFileSetServiceImpl extends InitiateDirectoryBase implements BatchInputFileSetService {
    ...
    /**
     * @see org.kuali.ole.sys.batch.service.BatchInputFileSetService#isBatchInputTypeActive(org.kuali.ole.sys.batch.BatchInputFileSetType)
     */
    ...
    /**
     * @see org.kuali.ole.sys.batch.service.BatchInputFileSetService#save(org.kuali.rice.kim.api.identity.Person,
     *      org.kuali.ole.sys.batch.BatchInputFileSetType, java.lang.String, java.util.Map)
     */
    public Map<String, String> save(Person user, BatchInputFileSetType inputType, String fileUserIdentifier, Map<String, InputStream> typeToStreamMap) throws AuthorizationException, FileStorageException {
        ...
        try {
            ...
            typeToFiles.put(OLEConstants.DONE_FILE_TYPE, doneFile);
        }
        catch (IOException e) {
    ...
    protected String getTempDirectoryName() {
        return kualiConfigurationService.getPropertyValueAsString(OLEConstants.TEMP_DIRECTORY_KEY);
    }

    /**
     * @see org.kuali.ole.sys.batch.service.BatchInputFileSetService#isFileUserIdentifierProperlyFormatted(java.lang.String)
     */
