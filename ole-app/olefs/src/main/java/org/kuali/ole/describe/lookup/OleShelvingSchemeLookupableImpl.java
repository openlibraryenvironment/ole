 ...
 */
public class OleShelvingSchemeLookupableImpl extends LookupableImpl {
    ...
    protected String getActionUrlHref(LookupForm lookupForm, Object dataObject, String methodToCall,
        ...
        String maintenanceMapping = "shelvingSchemeMaintenance";
    ...
    protected List<?> getSearchResults(LookupForm form, Map<String, String> searchCriteria, boolean unbounded) {
        List<?> searchResults;
        List<OleShelvingScheme> finalSearchResult = new ArrayList<OleShelvingScheme>();
        List<OleShelvingScheme> oleShelvingScheme = new ArrayList<OleShelvingScheme>();


        oleShelvingScheme = (List<OleShelvingScheme>) super.getSearchResults(form, searchCriteria, unbounded);
        finalSearchResult.addAll(oleShelvingScheme);
