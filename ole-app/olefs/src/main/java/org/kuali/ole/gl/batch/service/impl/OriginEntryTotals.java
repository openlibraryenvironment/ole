...
public class OriginEntryTotals {
    ...
    public void addToTotals(Iterator<OriginEntryFull> entries) {
        while (entries.hasNext()) {
            ...
            if (OLEConstants.GL_CREDIT_CODE.equals(originEntry.getTransactionDebitCreditCode())) {
                creditAmount = creditAmount.add(originEntry.getTransactionLedgerEntryAmount());
                numCreditEntries++;
            }
            else if (OLEConstants.GL_DEBIT_CODE.equals(originEntry.getTransactionDebitCreditCode())) {
