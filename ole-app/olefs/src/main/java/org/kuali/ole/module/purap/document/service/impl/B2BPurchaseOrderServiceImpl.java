...
import org.kuali.ole.module.purap.document.service.B2BPurchaseOrderService;
import org.kuali.ole.module.purap.document.service.RequisitionService;
import org.kuali.ole.module.purap.exception.B2BConnectionException;
import org.kuali.ole.module.purap.exception.CxmlParseError;
import org.kuali.ole.module.purap.util.PurApDateFormatUtils;
import org.kuali.ole.module.purap.util.cxml.B2BParserHelper;
import org.kuali.ole.module.purap.util.cxml.PurchaseOrderResponse;
...
public class B2BPurchaseOrderServiceImpl implements B2BPurchaseOrderService {
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.B2BPurchaseOrderService#sendPurchaseOrder(org.kuali.ole.module.purap.document.PurchaseOrderDocument)
     */
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.B2BPurchaseOrderService#getCxml(org.kuali.ole.module.purap.document.PurchaseOrderDocument,
    ...
    public String getCxml(PurchaseOrderDocument purchaseOrder, String requisitionInitiatorId, String password, ContractManager contractManager, String contractManagerEmail, String vendorDuns) {
        ...
        cxml.append("    <Sender>\n");
        cxml.append("      <Credential domain=\"NetworkUserId\">\n");
        cxml.append("        <Identity>OLE</Identity>\n");
    ...
    /**
     * @see org.kuali.ole.module.purap.document.service.B2BPurchaseOrderService#verifyCxmlPOData(org.kuali.ole.module.purap.document.PurchaseOrderDocument,
     *      org.kuali.rice.kim.api.identity.Person, java.lang.String, org.kuali.ole.vnd.businessobject.ContractManager,
     *      java.lang.String, java.lang.String)
     */
    ...
    protected boolean isProduction() {
        ...
        return StringUtils.equals(configService.getPropertyValueAsString(OLEConstants.PROD_ENVIRONMENT_CODE_KEY), b2bEnvironment);
    }
