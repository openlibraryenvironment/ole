...
import org.kuali.ole.integration.cam.CapitalAssetManagementAssetType;
...
public class CapitalAssetInformation extends PersistableBusinessObjectBase {
    ...
    protected LinkedHashMap toStringMapper_RICE20_REFACTORME() {
        ...
        m.put(OLEPropertyConstants.CAPITAL_ASSET_LINE_NUMBER, this.getCapitalAssetLineNumber());
    ...
    public CapitalAssetManagementAsset getCapitalAssetManagementAsset() {
        capitalAssetManagementAsset = SpringContext.getBean(KualiModuleService.class).getResponsibleModuleService(CapitalAssetManagementAsset.class).retrieveExternalizableBusinessObjectIfNecessary(this, capitalAssetManagementAsset, OLEPropertyConstants.CAPITAL_ASSET_MANAGEMENT_ASSET);
    ...
    public CapitalAssetManagementAssetType getCapitalAssetManagementAssetType() {
        capitalAssetManagementAssetType = SpringContext.getBean(KualiModuleService.class).getResponsibleModuleService(CapitalAssetManagementAssetType.class).retrieveExternalizableBusinessObjectIfNecessary(this, capitalAssetManagementAssetType, OLEPropertyConstants.CAPITAL_ASSET_MANAGEMENT_ASSET_TYPE);
    ...
    public Map<String, Object> getValuesMap() {
        ...
        simpleValues.put(OLEPropertyConstants.DOCUMENT_NUMBER, this.getDocumentNumber());
        simpleValues.put(OLEPropertyConstants.VENDOR_HEADER_GENERATED_ID, this.getVendorHeaderGeneratedIdentifier());
        simpleValues.put(OLEPropertyConstants.VENDOR_DETAIL_ASSIGNED_ID, this.getVendorDetailAssignedIdentifier());
        simpleValues.put(OLEPropertyConstants.VENDOR_NAME, this.getVendorName());
        simpleValues.put(OLEPropertyConstants.CAPITAL_ASSET_NUMBER, this.getCapitalAssetNumber());
        simpleValues.put(OLEPropertyConstants.CAPITAL_ASSET_TYPE_CODE, this.getCapitalAssetTypeCode());
        simpleValues.put(OLEPropertyConstants.CAPITAL_ASSET_LINE_AMOUNT, this.getCapitalAssetLineAmount());
        simpleValues.put(OLEPropertyConstants.CAPITAL_ASSET_LINE_NUMBER, this.getCapitalAssetLineNumber());
        simpleValues.put(OLEPropertyConstants.CAPITAL_ASSET_ACTION_INDICATOR, this.getCapitalAssetActionIndicator());
        simpleValues.put(OLEPropertyConstants.CAPITAL_ASSET_QUANTITY, this.getCapitalAssetQuantity());
        simpleValues.put(OLEPropertyConstants.CAPITAL_ASSET_PROCESSED_IND, this.isCapitalAssetProcessedIndicator());
        simpleValues.put(OLEPropertyConstants.CPTLAST_DST_AMT_CD, this.getDistributionAmountCode());
        return simpleValues;
    }
