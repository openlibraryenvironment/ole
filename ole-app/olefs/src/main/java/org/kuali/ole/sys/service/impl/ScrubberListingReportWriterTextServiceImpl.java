...
public class ScrubberListingReportWriterTextServiceImpl extends ReportWriterTextServiceImpl implements DocumentNumberAwareReportWriterService {
    ...
    /**
     * @see org.kuali.ole.sys.service.impl.ReportWriterTextServiceImpl#destroy()
     */
    @Override
    public void destroy() {
        super.destroy();
    ...
    /**
     * @see org.kuali.ole.sys.service.impl.ReportWriterTextServiceImpl#initialize()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.service.DocumentNumberAwareReportWriterService#setDocumentNumber(java.lang.String)
     */
