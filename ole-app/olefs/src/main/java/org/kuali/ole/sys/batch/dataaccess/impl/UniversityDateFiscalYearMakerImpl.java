...
public class UniversityDateFiscalYearMakerImpl extends FiscalYearMakerImpl {
    ...
    protected void deleteNewYearRows(Integer requestYear) {
        businessObjectService.deleteMatching(UniversityDate.class, Collections.singletonMap(OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR, requestYear));
    ...
    /**
     * @see org.kuali.ole.coa.batch.dataaccess.impl.FiscalYearMakerHelperImpl#doCustomProcessingOnly()
     */
    @Override
