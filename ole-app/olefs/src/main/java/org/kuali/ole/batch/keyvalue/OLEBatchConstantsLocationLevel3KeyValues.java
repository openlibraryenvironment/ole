 ...
 */
public class OLEBatchConstantsLocationLevel3KeyValues extends KeyValuesBase {
    @Override
    public List<KeyValue> getKeyValues() {
        List<KeyValue> keyValues = new ArrayList<KeyValue>();
        keyValues = getLocationsByLocationLevel(OLEConstants.OLEBatchProcess.LOCATION_LEVEL_LIBRARY);
        return keyValues;
    }
