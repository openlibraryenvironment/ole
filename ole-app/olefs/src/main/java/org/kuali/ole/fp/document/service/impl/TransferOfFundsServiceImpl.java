...
public class TransferOfFundsServiceImpl implements TransferOfFundsService {
    ...
    /**
     * @see org.kuali.ole.fp.document.service.TransferOfFundsService#isMandatoryTransfersSubType(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.fp.document.service.TransferOfFundsService#isNonMandatoryTransfersSubType(java.lang.String)
     */
    ...
    protected boolean checkMandatoryTransfersSubType(String objectSubTypeCode, String parameterName) {
        ...
        ParameterEvaluator evaluator = /*REFACTORME*/SpringContext.getBean(ParameterEvaluatorService.class).getParameterEvaluator(OleParameterConstants.FINANCIAL_PROCESSING_DOCUMENT.class, parameterName, objectSubTypeCode);
