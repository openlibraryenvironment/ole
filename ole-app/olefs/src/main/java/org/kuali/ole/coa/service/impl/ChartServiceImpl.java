...
public class ChartServiceImpl implements ChartService {
    ...
    /**
     * @see org.kuali.ole.coa.service.ChartService#getByPrimaryId(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.coa.service.ChartService#getUniversityChart()
     */
    @Override
    ...
    public Chart getUniversityChart() {
        ...
        String organizationReportsToSelfParameterValue = parameterService.getParameterValueAsString(Organization.class, OLEConstants.ChartApcParms.ORG_MUST_REPORT_TO_SELF_ORG_TYPES);

        Map<String,String> orgCriteria = new HashMap<String, String>(2);
        orgCriteria.put(OLEPropertyConstants.ORGANIZATION_TYPE_CODE, organizationReportsToSelfParameterValue);
        orgCriteria.put(OLEPropertyConstants.ACTIVE, OLEConstants.ACTIVE_INDICATOR);
    ...
    /**
     * @see org.kuali.ole.coa.service.ChartService#getAllChartCodes()
     */
    @Override
    @Cacheable(value=Chart.CACHE_NAME,key="'AllChartCodes'")
    public List<String> getAllChartCodes() {
        Collection<Chart> charts = businessObjectService.findAllOrderBy(Chart.class, OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, true);
    ...
    public Collection<Chart> getAllActiveCharts() {
        return businessObjectService.findMatchingOrderBy(Chart.class,
                Collections.singletonMap(OLEPropertyConstants.ACTIVE, true),
                OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, true);
    }
    ...
    /**
     * @see org.kuali.ole.coa.service.ChartService#getChartManager(java.lang.String)
     */
    @Override
    public Person getChartManager(String chartOfAccountsCode) {
        ...
        qualification.put(OleKimAttributes.CHART_OF_ACCOUNTS_CODE, chartOfAccountsCode);

        Collection<String> chartManagerList = getRoleService().getRoleMemberPrincipalIds(OLEConstants.CoreModuleNamespaces.OLE, OLEConstants.SysKimApiConstants.CHART_MANAGER_KIM_ROLE_NAME, qualification);
