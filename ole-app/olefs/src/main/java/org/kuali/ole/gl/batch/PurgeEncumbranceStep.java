...
public class PurgeEncumbranceStep extends AbstractStep {
    ...
    public boolean execute(String jobName, Date jobRunDate) {
        String yearStr = getParameterService().getParameterValueAsString(getClass(), OLEConstants.SystemGroupParameterNames.PURGE_GL_ENCUMBRANCE_T_BEFORE_YEAR);
     ...
     * @see org.kuali.ole.gl.service.EncumbranceService
     */
