...
public class OrganizationRoutingModelNameLookupableHelperServiceImpl extends KualiLookupableHelperServiceImpl {
    ...
    /**
     * Overrides the base implementation to always return to {@link OLEConstants.MAINTENANCE_ACTION}
     *
    ...
    public String getBackLocation() {
        ...
        return OLEConstants.MAINTENANCE_ACTION;
    }

    /**
     * Overrides the base implementation to add in new parameters to the return url
     * <ul>
     * <li>{@link OLEConstants.DISPATCH_REQUEST_PARAMETER}</li>
     * <li>{@link OLEConstants.BUSINESS_OBJECT_CLASS_ATTRIBUTE}</li>
     * <li>{@link OLEConstants.OVERRIDE_KEYS}</li>
     * </ul>
     * {@link OLEConstants.DISPATCH_REQUEST_PARAMETER}
     *
    ...
    public HtmlData getReturnUrl(BusinessObject businessObject, LookupForm lookupForm, List returnKeys, BusinessObjectRestrictions businessObjectRestrictions) {
        ...
        parameters.put(OLEConstants.BUSINESS_OBJECT_CLASS_ATTRIBUTE, AccountDelegateGlobal.class.getName());
        parameters.put(OLEConstants.OVERRIDE_KEYS, "modelName" + OLEConstants.FIELD_CONVERSIONS_SEPERATOR + "modelChartOfAccountsCode" + OLEConstants.FIELD_CONVERSIONS_SEPERATOR + "modelOrganizationCode");
        setBackLocation(OLEConstants.MAINTENANCE_ACTION);
