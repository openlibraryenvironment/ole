 ...
 */
package org.kuali.ole.sec.datadictionary;

import org.kuali.ole.sec.document.authorization.SecAccountingLineAuthorizer;
...
public class SecAccountingLineGroupDefinition extends AccountingLineGroupDefinition {
     ...
     * 
     * @see org.kuali.ole.sys.document.datadictionary.AccountingLineGroupDefinition#createAccountingLineAuthorizer()
     */
    @Override
