...
public abstract class FieldTableJoiningWithHeader extends FieldTableJoining implements TableJoiningWithHeader {
    ...
    /**
     * @see org.kuali.ole.sys.document.web.FieldTableJoining#joinTable(java.util.List)
     */
    @Override
     ...
     * @see org.kuali.ole.sys.document.web.FieldTableJoining#getRequestedRowCount()
     */
    @Override
