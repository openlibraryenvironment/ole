...
public interface OlePurapAccountingService extends PurapAccountingService {	
	 ...
	 public List<PurApAccountingLine> generateAccountDistributionForProrationByQty(List<SourceAccountingLine> accounts, KualiDecimal totalAmount, Integer percentScale, Class clazz) ;
