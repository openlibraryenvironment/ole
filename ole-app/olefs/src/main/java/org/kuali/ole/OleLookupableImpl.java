...
import org.kuali.rice.krad.lookup.*;
...
/**
 * Created by pvsubrah on 5/5/14.
 */

//TODO: This class will need to be retired once there is a permanent fix for the securefieldpaternmatching
//TODO: in KRADUtils thats used bu the LookupableImpl

public class OleLookupableImpl extends ViewHelperServiceImpl implements Lookupable {
    ...
    public void getReturnUrlForResults(Action returnLink, Object model) {
        ...
        Map<String, String> returnKeyValues = getPropertyKeyValuesFromDataObject(returnKeys, dataObject);
    ...
    public void getMaintenanceActionLink(Action actionLink, Object model, String maintenanceMethodToCall) {
        ...
        Map<String, String> primaryKeyValues = getPropertyKeyValuesFromDataObject(pkNames, dataObject);
