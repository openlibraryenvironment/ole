 ...
 */
public class EHoldingsSearchFieldKeyValuefinder extends UifKeyValuesFinderBase implements DocstoreConstants{
    ...
    public List<KeyValue> getKeyValues(ViewModel viewModel) {
        ...
        String docType = DocType.EHOLDINGS.getCode();
        ...
        for (DocTypeConfig docTypeConfig : documentSearchConfig.getDocTypeConfigs()) {
            if (docTypeConfig.getName().equals(docType)) {
                for (DocFormatConfig docFormatConfig : docTypeConfig.getDocFormatConfigList()) {
                    if (docFormatConfig.getName().equals("oleml") && DocType.EHOLDINGS.getCode().equals(docType)) {
