...
import org.kuali.ole.fp.businessobject.BudgetAdjustmentSourceAccountingLine;
import org.kuali.ole.fp.businessobject.BudgetAdjustmentTargetAccountingLine;
import org.kuali.ole.fp.businessobject.FiscalYearFunctionControl;
import org.kuali.ole.fp.document.validation.impl.BudgetAdjustmentDocumentRuleConstants;
import org.kuali.ole.fp.document.validation.impl.TransferOfFundsDocumentRuleConstants;
...
public class BudgetAdjustmentDocument extends AccountingDocumentBase implements Copyable, Correctable, AmountTotaling {
    ...
    public List<GeneralLedgerPendingEntry> getPendingLedgerEntriesForSufficientFundsChecking() {
        ...
        for (GeneralLedgerPendingEntry ple : copiedBa.getGeneralLedgerPendingEntries()) {
            if (!OLEConstants.BALANCE_TYPE_BASE_BUDGET.equals(ple.getFinancialBalanceTypeCode()) && !OLEConstants.BALANCE_TYPE_MONTHLY_BUDGET.equals(ple.getFinancialBalanceTypeCode())) {
     ...
     * @return KualiDecimal
     */
    public KualiDecimal getSourceBaseBudgetTotal() {
        KualiDecimal baseBudgetTotal = KualiDecimal.ZERO;
     ...
     * @return KualiDecimal
     */
    public KualiDecimal getSourceBaseBudgetIncomeTotal() {
        KualiDecimal total = KualiDecimal.ZERO;
     ...
     * @return KualiDecimal
     */
    public KualiDecimal getSourceBaseBudgetExpenseTotal() {
        KualiDecimal total = KualiDecimal.ZERO;
     ...
     * @return KualiDecimal
     */
    public KualiDecimal getTargetBaseBudgetTotal() {
        KualiDecimal baseBudgetTotal = KualiDecimal.ZERO;
     ...
     * @return KualiDecimal
     */
    public KualiDecimal getTargetBaseBudgetIncomeTotal() {
        KualiDecimal total = KualiDecimal.ZERO;
     ...
     * @return KualiDecimal
     */
    public KualiDecimal getTargetBaseBudgetExpenseTotal() {
        KualiDecimal total = KualiDecimal.ZERO;
     ...
     * 
     * @see org.kuali.ole.sys.document.AccountingDocumentBase#toErrorCorrection()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.sys.document.AccountingDocumentBase#getSourceAccountingLinesSectionTitle()
     */
    @Override
    public String getSourceAccountingLinesSectionTitle() {
        return OLEConstants.BudgetAdjustmentDocumentConstants.SOURCE_BA;
    }
    ...
    public String getTargetAccountingLinesSectionTitle() {
        return OLEConstants.BudgetAdjustmentDocumentConstants.TARGET_BA;
    }
    ...
    public boolean generateGeneralLedgerPendingEntries(GeneralLedgerPendingEntrySourceDetail glpeSourceDetail, GeneralLedgerPendingEntrySequenceHelper sequenceHelper) {
        ...
        if (budgetAccountingLine.getBaseBudgetAdjustmentAmount().isNonZero()) {
            ...
            explicitEntry.setFinancialBalanceTypeCode(OLEConstants.BALANCE_TYPE_BASE_BUDGET);
            explicitEntry.setTransactionLedgerEntryAmount(budgetAccountingLine.getBaseBudgetAdjustmentAmount().multiply(amountSign));
        ...
        if (budgetAccountingLine.getCurrentBudgetAdjustmentAmount().isNonZero()) {
            ...
            /* D/C code is empty for BA, set correct balance type, correct amount */
            explicitEntry.setTransactionDebitCreditCode("");
            explicitEntry.setFinancialBalanceTypeCode(OLEConstants.BALANCE_TYPE_CURRENT_BUDGET);
    ...
    protected void createMonthlyBudgetGLPE(AccountingLine accountingLine, GeneralLedgerPendingEntrySequenceHelper sequenceHelper, String fiscalPeriod, KualiDecimal monthAmount) {
        ...
        /* D/C code is empty for BA, set correct balance type, correct amount */
        explicitEntry.setTransactionDebitCreditCode("");
        explicitEntry.setFinancialBalanceTypeCode(OLEConstants.BALANCE_TYPE_MONTHLY_BUDGET);
    ...
    public Map buildIncomeStreamBalanceMapForTransferOfFundsGeneration() {
        ...
        for (BudgetAdjustmentAccountingLine budgetAccountingLine : accountingLines) {
            ...
            if(parameterEvaluatorService.getParameterEvaluator(BudgetAdjustmentDocument.class, OLEConstants.BudgetAdjustmentDocumentConstants.CROSS_INCOME_STREAM_GLPE_TRANSFER_GENERATING_FUND_GROUPS, baAccount.getSubFundGroup().getFundGroupCode()).evaluationSucceeds() &&
               parameterEvaluatorService.getParameterEvaluator(BudgetAdjustmentDocument.class, OLEConstants.BudgetAdjustmentDocumentConstants.CROSS_INCOME_STREAM_GLPE_TRANSFER_GENERATING_SUB_FUND_GROUPS, baAccount.getSubFundGroupCode()).evaluationSucceeds()) {
     ...
     */
    //MSU Contribution DTT-3059, DTT-3235 OLEMI-8689 OLECNTRB-941 - Re-implemented this method to execute the rules correctly
