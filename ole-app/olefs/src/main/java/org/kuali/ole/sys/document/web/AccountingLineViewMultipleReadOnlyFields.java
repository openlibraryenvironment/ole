...
import org.kuali.ole.sys.document.datadictionary.AccountingLineViewMultipleReadOnlyFieldsDefinition;
import org.kuali.ole.sys.document.web.renderers.MultipleReadOnlyFieldsRenderer;
...
public class AccountingLineViewMultipleReadOnlyFields extends FieldTableJoiningWithHeader {
    ...
    public HeaderLabel createHeaderLabel() {
        return new LiteralHeaderLabel(OLEConstants.BLANK_SPACE);
    }
