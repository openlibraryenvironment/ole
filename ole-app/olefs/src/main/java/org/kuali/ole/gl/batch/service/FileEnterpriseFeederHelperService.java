...
public interface FileEnterpriseFeederHelperService {
     ...
     *        {@link org.kuali.ole.gl.batch.service.ReconciliationParserService} to determine the format of the data in a file.
     ...
     * @param statusAndErrors a class with references to a {@link org.kuali.ole.gl.batch.service.impl.EnterpriseFeederStatus} object and a list
