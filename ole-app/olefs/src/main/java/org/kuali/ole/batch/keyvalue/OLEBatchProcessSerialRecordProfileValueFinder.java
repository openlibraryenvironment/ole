 ...
 */
public class OLEBatchProcessSerialRecordProfileValueFinder extends KeyValuesBase {

    private static final Logger LOG = Logger.getLogger(OLEBatchProcessSerialRecordProfileValueFinder.class);
    ...
    public List<KeyValue> getKeyValues() {
        ...
        List<KeyValue> options = initProfileDetailsForSerialRecordImport();
        return options;
    }

    public static List<KeyValue> initProfileDetailsForSerialRecordImport() {

        List<KeyValue> keyValues = new ArrayList<KeyValue>();
        BusinessObjectService businessObjectService = KRADServiceLocator.getBusinessObjectService();
        Map parentCriteria1 = new HashMap();
        parentCriteria1.put("batchProcessProfileType", "Serial Record Import");
    ...
    public static List<String> retrieveBatchProfileNamesForSerialRecordImport(String locationVal) {
        List<KeyValue> locationKeyValues = retrieveProfileDetailsForSerialRecordImport();
    ...
    private static List<KeyValue> retrieveProfileDetailsForSerialRecordImport() {
        long currentTime = System.currentTimeMillis() / 1000;
        if (locationKeyValues == null) {
            locationKeyValues = initProfileDetailsForSerialRecordImport();
    ...
    public  static String getValue(String batchVal){
        String value="";
        locationKeyValues=retrieveProfileDetailsForSerialRecordImport();
