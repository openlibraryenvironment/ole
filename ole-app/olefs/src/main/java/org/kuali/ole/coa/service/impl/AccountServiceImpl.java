...
public class AccountServiceImpl implements AccountService {
     ...
     * 
     * @see org.kuali.ole.coa.service.impl.AccountServiceImpl#getByPrimaryId(java.lang.String, java.lang.String)
     */
    @Override
    @Cacheable(value=Account.CACHE_NAME, key="#p0+'-'+#p1")
    ...
    /**
     * @see org.kuali.ole.coa.service.AccountService#getAccountsThatUserIsResponsibleFor(org.kuali.bo.user.KualiUser)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.coa.service.AccountService#hasResponsibilityOnAccount(org.kuali.rice.kim.api.identity.Person,
    ...
    /**
     * @see org.kuali.ole.coa.service.AccountService#getPrimaryDelegationByExample(org.kuali.ole.coa.businessobject.AccountDelegate,
     *      java.lang.String)
     */
    ...
    public AccountDelegate getPrimaryDelegationByExample(AccountDelegate delegateExample, String totalDollarAmount) {
        ...
        for (Iterator<AccountDelegate> iterator = primaryDelegations.iterator(); iterator.hasNext();) {
            ...
            if (!OLEConstants.ROOT_DOCUMENT_TYPE.equals(delegate.getFinancialDocumentTypeCode())) {
                return delegate;
            }
        }
    ...
    /**
     * @see org.kuali.ole.coa.service.AccountService#getSecondaryDelegationsByExample(org.kuali.ole.coa.businessobject.AccountDelegate,
     *      java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.coa.service.AccountService#getActiveAccountsForAccountSupervisor(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.coa.service.AccountService#getActiveAccountsForFiscalOfficer(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.coa.service.AccountService#getExpiredAccountsForAccountSupervisor(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.coa.service.AccountService#getExpiredAccountsForFiscalOfficer(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.coa.service.AccountService#isPrincipalInAnyWayShapeOrFormAccountManager(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.coa.service.AccountService#isPrincipalInAnyWayShapeOrFormAccountSupervisor(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.coa.service.AccountService#isPrincipalInAnyWayShapeOrFormFiscalOfficer(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.coa.service.AccountService#getAccountsForAccountNumber(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.coa.service.AccountService#isFridgeBenefitCalculationEnable()
     */
    @Override
    public Boolean isFridgeBenefitCalculationEnable(){
        ...
        if(parameterService.parameterExists(OleParameterConstants.FINANCIAL_SYSTEM_ALL.class, "ENABLE_FRINGE_BENEFIT_CALC_BY_BENEFIT_RATE_CATEGORY_IND")){
          //check the system param to see if the labor benefit rate category should be editable
            isFringeBeneCalcEnable = SpringContext.getBean(ParameterService.class).getParameterValueAsBoolean(OleParameterConstants.FINANCIAL_SYSTEM_ALL.class, "ENABLE_FRINGE_BENEFIT_CALC_BY_BENEFIT_RATE_CATEGORY_IND");
    ...
    /**
     * @see org.kuali.ole.coa.service.AccountService#getUniqueAccountForAccountNumber(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.coa.service.AccountService#accountsCanCrossCharts()
     */
    @Override
    public boolean accountsCanCrossCharts() {
        return parameterService.getParameterValueAsBoolean(OleParameterConstants.FINANCIAL_SYSTEM_ALL.class, SystemGroupParameterNames.ACCOUNTS_CAN_CROSS_CHARTS_IND);
    }
