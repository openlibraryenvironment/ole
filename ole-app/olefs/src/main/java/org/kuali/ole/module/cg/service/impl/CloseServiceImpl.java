...
public class CloseServiceImpl implements CloseService {
     ...
     * </ul>
     * 
     * @see org.kuali.ole.module.cg.service.CloseService#close()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.cg.service.CloseService#getMostRecentClose()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.cg.service.CloseService#getMaxApprovedClose(java.sql.Date)
     */
    @Override
