...
import org.kuali.ole.pdp.businessobject.AchAccountNumber;
import org.kuali.ole.pdp.businessobject.PaymentChangeCode;
...
import org.kuali.ole.pdp.dataaccess.PaymentGroupDao;
import org.kuali.ole.pdp.service.PaymentGroupService;
import org.kuali.ole.pdp.service.PaymentMaintenanceService;
...
/**
 * @see org.kuali.ole.pdp.service.PaymentMaintenanceService
 */
@Transactional
public class PaymentMaintenanceServiceImpl implements PaymentMaintenanceService {
    ...
    /**
     * @see org.kuali.ole.pdp.document.service.PaymentMaintenanceService#cancelPendingPayment(java.lang.Integer, java.lang.Integer,
    ...
    public boolean cancelPendingPayment(Integer paymentGroupId, Integer paymentDetailId, String note, Person user) {
        ...
        if (paymentGroup == null) {
            ...
            GlobalVariables.getMessageMap().putError(OLEConstants.GLOBAL_ERRORS, PdpKeyConstants.PaymentDetail.ErrorMessages.ERROR_PAYMENT_NOT_FOUND);
            return false;
        }
        ...
        if (!(PdpConstants.PaymentStatusCodes.CANCEL_PAYMENT.equals(paymentStatus))) {
            ...
            if ((PdpConstants.PaymentStatusCodes.HELD_TAX_EMPLOYEE_CD.equals(paymentStatus)) || (PdpConstants.PaymentStatusCodes.HELD_TAX_NRA_CD.equals(paymentStatus)) || (PdpConstants.PaymentStatusCodes.HELD_TAX_NRA_EMPL_CD.equals(paymentStatus))) {
                ...
                GlobalVariables.getMessageMap().putError(OLEConstants.GLOBAL_ERRORS, PdpKeyConstants.PaymentDetail.ErrorMessages.ERROR_PAYMENT_INVALID_STATUS_TO_CANCEL);
                return false;
            }
        }
        else {
    ...
    /**
     * @see org.kuali.ole.pdp.document.service.PaymentMaintenanceService#holdPendingPayment(java.lang.Integer, java.lang.String,
    ...
    public boolean holdPendingPayment(Integer paymentGroupId, String note, Person user) {
        ...
        if (!(PdpConstants.PaymentStatusCodes.HELD_CD.equals(paymentStatus))) {
            if (PdpConstants.PaymentStatusCodes.OPEN.equals(paymentStatus)) {
                ...
                GlobalVariables.getMessageMap().putError(OLEConstants.GLOBAL_ERRORS, PdpKeyConstants.PaymentDetail.ErrorMessages.ERROR_PAYMENT_INVALID_STATUS_TO_HOLD);
                return false;
            }
        }
        else {
    ...
    /**
     * @see org.kuali.ole.pdp.document.service.PaymentMaintenanceService#removeHoldPendingPayment(java.lang.Integer,
     *      java.lang.String, org.kuali.rice.kim.api.identity.Person)
     */
    @Override
    public boolean removeHoldPendingPayment(Integer paymentGroupId, String note, Person user) {
        ...
        if (!(PdpConstants.PaymentStatusCodes.OPEN.equals(paymentStatus))) {
            ...
            if ((PdpConstants.PaymentStatusCodes.HELD_TAX_EMPLOYEE_CD.equals(paymentStatus)) || (PdpConstants.PaymentStatusCodes.HELD_TAX_NRA_CD.equals(paymentStatus)) || (PdpConstants.PaymentStatusCodes.HELD_TAX_NRA_EMPL_CD.equals(paymentStatus))) {
                ...
                GlobalVariables.getMessageMap().putError(OLEConstants.GLOBAL_ERRORS, PdpKeyConstants.PaymentDetail.ErrorMessages.ERROR_PAYMENT_INVALID_STATUS_TO_REMOVE_HOLD);
                return false;
            }
        }
        else {
    ...
    /**
     * @see org.kuali.ole.pdp.document.service.PaymentMaintenanceService#changeImmediateFlag(java.lang.Integer, java.lang.String,
     *      org.kuali.rice.kim.api.identity.Person)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.pdp.document.service.PaymentMaintenanceService#cancelDisbursement(java.lang.Integer, java.lang.Integer,
     *      java.lang.String, org.kuali.rice.kim.api.identity.Person)
     */
    @Override
    public boolean cancelDisbursement(Integer paymentGroupId, Integer paymentDetailId, String note, Person user) {
        ...
        if (paymentGroup == null) {
            ...
            GlobalVariables.getMessageMap().putError(OLEConstants.GLOBAL_ERRORS, PdpKeyConstants.PaymentDetail.ErrorMessages.ERROR_DISBURSEMENT_NOT_FOUND);
            return false;
        }
        ...
        if (!(PdpConstants.PaymentStatusCodes.CANCEL_DISBURSEMENT.equals(paymentStatus))) {
            if (((PdpConstants.PaymentStatusCodes.EXTRACTED.equals(paymentStatus)) && (ObjectUtils.isNotNull(paymentGroup.getDisbursementDate()))) || (PdpConstants.PaymentStatusCodes.PENDING_ACH.equals(paymentStatus))) {
                ...
                GlobalVariables.getMessageMap().putError(OLEConstants.GLOBAL_ERRORS, PdpKeyConstants.PaymentDetail.ErrorMessages.ERROR_DISBURSEMENT_INVALID_TO_CANCEL);
                return false;
            }
        }
        else {
    ...
    /**
     * @see org.kuali.ole.pdp.document.service.PaymentMaintenanceService#reissueDisbursement(java.lang.Integer,
     *      java.lang.String, org.kuali.rice.kim.api.identity.Person)
     */
    @Override
    public boolean reissueDisbursement(Integer paymentGroupId, String note, Person user) {
        ...
        if (!(PdpConstants.PaymentStatusCodes.OPEN.equals(paymentStatus))) {
            if (((PdpConstants.PaymentStatusCodes.CANCEL_DISBURSEMENT.equals(paymentStatus)) && (ObjectUtils.isNotNull(paymentGroup.getDisbursementDate())))) {
                ...
                GlobalVariables.getMessageMap().putError(OLEConstants.GLOBAL_ERRORS, PdpKeyConstants.PaymentDetail.ErrorMessages.ERROR_DISBURSEMENT_INVALID_TO_CANCEL_AND_REISSUE);
                return false;
            }
        }
        else {
    ...
    /**
     * @see org.kuali.ole.pdp.document.service.PaymentMaintenanceService#cancelReissueDisbursement(java.lang.Integer,
     *      java.lang.String, org.kuali.rice.kim.api.identity.Person)
     */
    @Override
