...
import org.kuali.ole.gl.businessobject.LedgerEntryForReporting;
...
import org.kuali.ole.gl.service.ReversalService;
 ...
 * 
 * @see org.kuali.ole.gl.service.ReversalService
 */
@Transactional
public class ReversalServiceImpl implements ReversalService {
     ...
     * @see org.kuali.ole.gl.service.ReversalService#delete(org.kuali.ole.gl.businessobject.Reversal)
     */
     ...
     * @see org.kuali.ole.gl.service.ReversalService#getByDate(java.util.Date)
     */
     ...
     * @see org.kuali.ole.gl.service.ReversalService#getSummaryByDate(java.util.Date)
     */
    ...
    protected LedgerEntryForReporting buildLedgerEntryFromReversal(Reversal reversal) {
        ...
        if (OLEConstants.GL_CREDIT_CODE.equals(reversal.getTransactionDebitCreditCode())) {
            entry.setCreditAmount(reversal.getTransactionLedgerEntryAmount());
            entry.setCreditCount(1);
        }
        else if (OLEConstants.GL_DEBIT_CODE.equals(reversal.getTransactionDebitCreditCode())) {
     ...
     * @see org.kuali.ole.gl.service.ReversalService#save(org.kuali.ole.gl.businessobject.Reversal)
     */
     ...
     * @see org.kuali.ole.gl.dataaccess.ReversalDao
     */
     ...
     * @see org.kuali.ole.coa.service.AccountingPeriodService
     */
     ...
     * @see org.kuali.ole.sys.service.UniversityDateService
     */
