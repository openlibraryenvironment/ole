...
/**
 * Value Finder for Invoice Statuses.
 */
public class InvoiceStatusValuesFinder extends KeyValuesBase {

    /**
     * Overide this method to sort the PO statuses for proper display.
     *
     * @see PurApStatusKeyValuesBase#getKeyValues()
     */
    public List getKeyValues() {
        // get all Invoice statuses
        HashMap<String, String> keyValues = InvoiceStatuses.getAllAppDocStatuses();
