...
/**
 * OleLicenseRequestWorkflowType is the business object class for License Request WorkFlow Type Document.
 */
public class OleLicenseRequestWorkflowType extends PersistableBusinessObjectBase {
