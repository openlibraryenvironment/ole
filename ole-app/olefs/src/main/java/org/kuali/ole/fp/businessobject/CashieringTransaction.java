...
public class CashieringTransaction extends TransientBusinessObjectBase {
    public static final String DETAIL_DOCUMENT_TYPE = "OLE_CMD";
    ...
    public void prepareForSave() {
        ...
        moneyInCoin.setCashieringStatus(OLEConstants.CurrencyCoinSources.CASH_MANAGEMENT_IN);
        ...
        moneyInCurrency.setCashieringStatus(OLEConstants.CurrencyCoinSources.CASH_MANAGEMENT_IN);
        ...
        moneyOutCoin.setCashieringStatus(OLEConstants.CurrencyCoinSources.DEPOSITS);
        ...
        moneyOutCurrency.setCashieringStatus(OLEConstants.CurrencyCoinSources.DEPOSITS);
