...
public class PaymentRequestDocumentPreRules extends AccountsPayableDocumentPreRulesBase {
    ...
    public boolean confirmExpiredAccount(PaymentRequestDocument preq) {
        ...
        if (!rulePassed) {
            return askForConfirmation(PREQDocumentsStrings.EXPIRED_ACCOUNT_QUESTION, OLEKeyConstants.ERROR_ACCOUNT_EXPIRED);
        }
        return true;
    }
    ...
    /**
     * @see org.kuali.ole.module.purap.document.validation.impl.AccountsPayableDocumentPreRulesBase#getDocumentName()
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.module.purap.document.validation.impl.AccountsPayableDocumentPreRulesBase#createInvoiceNoMatchQuestionText(org.kuali.ole.module.purap.document.AccountsPayableDocument)
     */
    @Override
