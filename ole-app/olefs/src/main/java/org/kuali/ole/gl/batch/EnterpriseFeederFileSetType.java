...
import org.kuali.ole.sys.batch.BatchInputFileSetType;
...
public class EnterpriseFeederFileSetType implements BatchInputFileSetType {
     ...
     * @see org.kuali.ole.sys.batch.BatchInputFileSetType#getDirectoryPath(java.lang.String)
     */
     ...
     * @see org.kuali.ole.sys.batch.BatchInputFileSetType#getFileTypes()
     */
    public List<String> getFileTypes() {
        List<String> types = new ArrayList<String>();
        types.add(OLEConstants.DATA_FILE_TYPE);
        types.add(OLEConstants.RECON_FILE_TYPE);
        return types;
    }
    ...
    protected String getFileExtension(String fileType) {
        if (OLEConstants.DATA_FILE_TYPE.equals(fileType)) {
            return EnterpriseFeederService.DATA_FILE_SUFFIX;
        }
        if (OLEConstants.RECON_FILE_TYPE.equals(fileType)) {
     ...
     * @see org.kuali.ole.sys.batch.BatchInputFileSetType#getFileTypeDescription()
     */
    public Map<String, String> getFileTypeDescription() {
        Map<String, String> values = new HashMap<String, String>();
        values.put(OLEConstants.DATA_FILE_TYPE, "Data File");
        values.put(OLEConstants.RECON_FILE_TYPE, "Reconciliation File");
        return values;
    }
     ...
     * @see org.kuali.ole.sys.batch.BatchInputFileSetType#getFileName(java.lang.String, org.kuali.rice.kim.api.identity.Person,
     *      java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.sys.batch.BatchInputFileSetType#getFileSetTypeIdentifer()
     */
    public String getFileSetTypeIdentifer() {
        return OLEConstants.ENTERPRISE_FEEDER_FILE_SET_TYPE_INDENTIFIER;
    }
    ...
    public String getTitleKey() {
        return OLEKeyConstants.MESSAGE_BATCH_UPLOAD_TITLE_ENTERPRISE_FEEDER;
    }
     ...
     * @see org.kuali.ole.sys.batch.BatchInputFileSetType#isFileRequired(java.lang.String)
     */
    public boolean isFileRequired(String fileType) {
        if (OLEConstants.DATA_FILE_TYPE.equals(fileType) || OLEConstants.RECON_FILE_TYPE.equals(fileType)) {
            return true;
        }
        throw new IllegalArgumentException("Unknown file type found: " + fileType);
    }
    ...
    /**
     * @see org.kuali.ole.sys.batch.BatchInputFileSetType#getDoneFileDirectoryPath()
     */
    ...
    /**
     * @see org.kuali.ole.sys.batch.BatchInputFileSetType#getDoneFileExtension()
     */
     ...
     * @see org.kuali.ole.sys.batch.BatchInputFileSetType#getDoneFileName(org.kuali.rice.kim.api.identity.Person, java.lang.String)
     */
