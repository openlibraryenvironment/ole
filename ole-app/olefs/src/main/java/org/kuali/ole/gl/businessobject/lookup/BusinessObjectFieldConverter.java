...
public class BusinessObjectFieldConverter {
    ...
    private static Map getPropertyMappingTable() {
        ...
        propertyMappingTable.put(OLEPropertyConstants.OBJECT_CODE, OLEPropertyConstants.FINANCIAL_OBJECT_CODE);
        propertyMappingTable.put(OLEPropertyConstants.SUB_OBJECT_CODE, OLEPropertyConstants.FINANCIAL_SUB_OBJECT_CODE);
        propertyMappingTable.put(OLEPropertyConstants.OBJECT_TYPE_CODE, OLEPropertyConstants.FINANCIAL_OBJECT_TYPE_CODE);

        propertyMappingTable.put(OLEPropertyConstants.BALANCE_TYPE_CODE, OLEPropertyConstants.FINANCIAL_BALANCE_TYPE_CODE);
        propertyMappingTable.put(OLEPropertyConstants.ENCUMBRANCE_DOCUMENT_TYPE_CODE, OLEPropertyConstants.FINANCIAL_DOCUMENT_TYPE_CODE);
        propertyMappingTable.put(OLEPropertyConstants.ORIGIN_CODE, OLEPropertyConstants.FINANCIAL_SYSTEM_ORIGINATION_CODE);
        propertyMappingTable.put(OLEPropertyConstants.DOCUMENT_NUMBER, OLEPropertyConstants.DOCUMENT_NUMBER);
