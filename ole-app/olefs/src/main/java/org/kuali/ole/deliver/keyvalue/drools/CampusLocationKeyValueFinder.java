 ...
 */
public class CampusLocationKeyValueFinder extends KeyValuesBase {
    @Override
    public List getKeyValues() {
        ...
        if (CollectionUtils.isNotEmpty(oleLocations)) {
            for (OleLocation oleLocation : oleLocations) {
                if(oleLocation.getLevelId().equalsIgnoreCase(String.valueOf(ItemInfoUtil.LEVEL_CODES.CAMPUS.getId()))){
