 ...
 */
public class LibraryLocationKeyValueFinder extends KeyValuesBase {
    @Override
    public List getKeyValues() {
        ...
        if (CollectionUtils.isNotEmpty(oleLocations)) {
            for (OleLocation oleLocation : oleLocations) {
                if(oleLocation.getLevelId().equalsIgnoreCase(String.valueOf(ItemInfoUtil.LEVEL_CODES.LIBRARY.getId()))){
