 ...
 */
package org.kuali.ole.vnd.document.service;
...
public interface VendorService {
     ...
     * <br>
     * First it checks to see if an existing {@link org.kuali.ole.vnd.businessobject.VendorContractOrganization} object exists for the
     * associated parameters. If one exists and it is not excluded (see
     * {@link org.kuali.ole.vnd.businessobject.VendorContractOrganization#isVendorContractExcludeIndicator()}) this will return the value
     * of {@link org.kuali.ole.vnd.businessobject.VendorContractOrganization#getVendorContractPurchaseOrderLimitAmount()}.<br>
     * <br>
     * If an associated {@link org.kuali.ole.vnd.businessobject.VendorContractOrganization} object cannot be found then a valid
     * {@link org.kuali.ole.vnd.businessobject.VendorContract} object will be sought. If one is found this method will return the value of
     * {@link org.kuali.ole.vnd.businessobject.VendorContract#getOrganizationAutomaticPurchaseOrderLimit()}.<br>
     * <br>
     * If no valid {@link org.kuali.ole.vnd.businessobject.VendorContractOrganization} or
     * {@link org.kuali.ole.vnd.businessobject.VendorContract} objects can be found for the given parameters this method will return null.
     *
     * @param contractId id used to find {@link org.kuali.ole.vnd.businessobject.VendorContractOrganization} object and
     *        {@link org.kuali.ole.vnd.businessobject.VendorContract} object
     * @param chart chart code for use in finding {@link org.kuali.ole.vnd.businessobject.VendorContractOrganization} object
     * @param org org code for use in finding {@link org.kuali.ole.vnd.businessobject.VendorContractOrganization} object
     ...
     * {@link org.kuali.ole.vnd.VendorConstants#TAX_TYPE_SSN}).
     *
     * @param vendorHeaderGeneratedIdentifier The Header Id in Integer form
     ...
     * by checking the value of {@link org.kuali.ole.vnd.businessobject.VendorHeader#getVendorForeignIndicator()}.
     *
     * @param vendorHeaderGeneratedIdentifier The Header Id in Integer form
     ...
     * by checking the value of {@link org.kuali.ole.vnd.businessobject.VendorHeader#getVendorTypeCode()} to see if it equals "SP".
     *
     * @param vendorHeaderGeneratedIdentifier The Header Id in Integer form
     ...
     * by checking the value of {@link org.kuali.ole.vnd.businessobject.VendorHeader#getVendorTypeCode()} to see if it equals "RF".
     *
     * @param vendorHeaderGeneratedIdentifier The Header Id in Integer form
