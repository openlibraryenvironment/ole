...
public abstract class PurApItemBase extends PersistableBusinessObjectBase implements PurApItem {
    ...
    /**
     * @see org.kuali.ole.module.purap.businessobject.PurApItem#getItemIdentifierString()
     */
    @Override
    ...
    public ItemType getItemType() {
        // JHK : short circuit the item type reference if there is no item type
    ...
    public KualiDecimal getItemTaxAmount() {
        ...
        if (ObjectUtils.isNotNull(purapDocument) && purapDocument.isUseTaxIndicator() == false) {
    ...
    public void resetAccount(BigDecimal initialPercent) {
        ...
        purApAccountingLine.setPurapItem(this);
        purApAccountingLine.setSequenceNumber(0);
        purApAccountingLine.setAccountLinePercent(initialPercent);
        setNewSourceLine(purApAccountingLine);
    }
     ...
     *
     * @see org.kuali.ole.module.purap.businessobject.PurApItem#fixAccountReferences()
     */
    @Override
