...
public class BalanceHistoryDaoOjb extends PlatformAwareDaoBaseOjb implements LedgerBalanceHistoryBalancingDao {
    ...
    /**
     * @see org.kuali.ole.gl.dataaccess.LedgerBalanceHistoryBalancingDao#findDistinctFiscalYears()
     */
    public List<Integer> findDistinctFiscalYears() {
        ...
        q.setAttributes(new String[] { OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR });
        q.setDistinct(true);
