...
public class CapitalAssetAccountsGroupDetails extends PersistableBusinessObjectBase {
    ...
    protected LinkedHashMap toStringMapper() {
        ...
        m.put(OLEPropertyConstants.CAPITAL_ASSET_ACCOUNT_LINE_NUMBER, this.getCapitalAssetAccountLineNumber());
    ...
    public Map<String, Object> getValuesMap() {
        ...
        simpleValues.put(OLEPropertyConstants.CAPITAL_ASSET_ACCOUNT_LINE_NUMBER, this.getCapitalAssetAccountLineNumber());
        simpleValues.put(OLEPropertyConstants.FINANCIAL_DOCUMENT_LINE_TYPE_CODE, this.getFinancialDocumentLineTypeCode());
        simpleValues.put(OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, this.getChartOfAccountsCode());
        simpleValues.put(OLEPropertyConstants.ACCOUNT_NUMBER, this.getAccountNumber());
        simpleValues.put(OLEPropertyConstants.FINANCIAL_OBJECT_CODE, this.getFinancialObjectCode());
        simpleValues.put(OLEPropertyConstants.AMOUNT, this.getAmount());
        simpleValues.put(OLEPropertyConstants.SEQUENCE_NUMBER, this.getSequenceNumber());
