...
public abstract class AbstractStep extends InitiateDirectoryBase implements Step, BeanNameAware, InitializingBean, InitiateDirectory{
     ...
     * 
     * @see org.kuali.ole.sys.batch.service.InitiateDirectoryInterface#getRequiredDirectoryNames()
     */
    @Override
     ...
     * 
     * @return boolean
     * @see org.kuali.ole.sys.batch.Step#isInterrupted()
     */
    @Override
     ...
     * 
     * @param interrupted
     * @see org.kuali.ole.sys.batch.Step#setInterrupted(boolean)
     */
    @Override
     ...
     * 
     * @see org.kuali.ole.sys.batch.Step#interrupt()
     */
    @Override
