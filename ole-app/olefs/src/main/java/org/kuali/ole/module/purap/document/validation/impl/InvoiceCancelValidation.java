...
public class InvoiceCancelValidation extends GenericValidation {

    public boolean validate(AttributedDocumentEvent event) {
        boolean valid = true;
        InvoiceDocument preq = (InvoiceDocument) event.getDocument();
...
//        InvoiceDocumentActionAuthorizer preqAuth = new InvoiceDocumentActionAuthorizer(preq, null);
