 ...
 */
public class OleAddressTypeKeyValues extends KeyValuesBase {
    ...
    public List getKeyValues() {
        ...
        Collection<EntityAddressTypeBo> agendaBo = KRADServiceLocator.getBusinessObjectService().findAll(EntityAddressTypeBo.class);
        keyValues.add(new ConcreteKeyValue("", ""));
        for (EntityAddressTypeBo typ : agendaBo) {
