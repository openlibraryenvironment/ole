...
import org.kuali.ole.module.purap.businessobject.OrganizationParameter;
...
public class OrganizationParameterRule extends MaintenanceDocumentRuleBase {
    ...
    protected boolean checkChartOfAccountsCode() {
        ...
        if (ObjectUtils.isNull(chart)) {
            success &= false;
            errorMap.putError(OLEPropertyConstants.DOCUMENT + "." + OLEPropertyConstants.NEW_MAINTAINABLE_OBJECT + "." + OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, PurapKeyConstants.ERROR_INVALID_CHART_OF_ACCOUNTS_CODE);
        }
        return success;
    }
    ...
    protected boolean checkOrganizationCode() {
        ...
        if (ObjectUtils.isNull(org)) {
            success &= false;
            errorMap.putError(OLEPropertyConstants.DOCUMENT + "." + OLEPropertyConstants.NEW_MAINTAINABLE_OBJECT + "." + OLEPropertyConstants.ORGANIZATION_CODE, PurapKeyConstants.ERROR_INVALID_ORGANIZATION_CODE);
        }
        return success;
    }
