...
import org.kuali.ole.gl.businessobject.inquiry.BalanceInquirableImpl;
        ...
        if (superResults != null) {
            for (Row row : superResults) {
                for (Field field : row.getFields()) {
                    if (OLEPropertyConstants.ACCOUNT_NUMBER.equals(field.getPropertyName())) {
                        ...
                        Class clazz = getPersistenceStructureService().getBusinessObjectAttributeClass(businessObjectClass, OLEPropertyConstants.ACCOUNT);
