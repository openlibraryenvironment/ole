...
import org.kuali.ole.sys.document.datadictionary.AccountingLineViewFieldDefinition;
import org.kuali.ole.sys.document.service.AccountingLineAuthorizationTransformer;
...
import org.kuali.ole.sys.document.service.AccountingLineRenderingTransformation;
import org.kuali.ole.sys.document.service.AccountingLineTableTransformation;
import org.kuali.ole.sys.document.web.AccountingLineTableRow;
import org.kuali.ole.sys.document.web.TableJoining;
import org.kuali.ole.sys.document.web.renderers.CheckboxRenderer;
import org.kuali.ole.sys.document.web.renderers.CurrencyRenderer;
import org.kuali.ole.sys.document.web.renderers.DateRenderer;
import org.kuali.ole.sys.document.web.renderers.DropDownRenderer;
import org.kuali.ole.sys.document.web.renderers.FieldRenderer;
import org.kuali.ole.sys.document.web.renderers.HiddenRenderer;
import org.kuali.ole.sys.document.web.renderers.RadioButtonGroupRenderer;
import org.kuali.ole.sys.document.web.renderers.ReadOnlyRenderer;
import org.kuali.ole.sys.document.web.renderers.TextAreaRenderer;
import org.kuali.ole.sys.document.web.renderers.TextRenderer;
...
public class AccountingLineRenderingServiceImpl implements AccountingLineRenderingService {
    ...
    /**
     * @see org.kuali.ole.sys.document.service.AccountingLineRenderingService#performPreTablificationTransformations(java.util.List, org.kuali.ole.sys.document.datadictionary.AccountingLineGroupDefinition, org.kuali.ole.sys.document.AccountingDocument, org.kuali.ole.sys.businessobject.AccountingLine, boolean, java.util.Map, java.lang.String)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.service.AccountingLineRenderingService#performPostTablificationTransformations(java.util.List, org.kuali.ole.sys.document.datadictionary.AccountingLineGroupDefinition, org.kuali.ole.sys.document.AccountingDocument, org.kuali.ole.sys.businessobject.AccountingLine, boolean)
     */
     ...
     * @see org.kuali.ole.sys.document.service.AccountingLineRenderingService#tablify(java.util.List)
     */
    ...
    /**
     * @see org.kuali.ole.sys.document.service.AccountingLineRenderingService#getFieldRendererForField(org.kuali.rice.kns.web.ui.Field, org.kuali.ole.sys.businessobject.AccountingLine)
     * 
    ...
    public FieldRenderer getFieldRendererForField(Field field, AccountingLine accountingLineToRender) {
        ...
        else if (field.getPropertyName().equals(OLEConstants.CHART_OF_ACCOUNTS_CODE_PROPERTY_NAME) && !SpringContext.getBean(AccountService.class).accountsCanCrossCharts()) {
