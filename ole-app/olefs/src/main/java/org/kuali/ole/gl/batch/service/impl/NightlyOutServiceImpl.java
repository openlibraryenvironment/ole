...
import org.kuali.ole.gl.businessobject.PendingEntrySummary;
...
public class NightlyOutServiceImpl implements NightlyOutService {
     ...
     * @see org.kuali.ole.gl.service.NightlyOutService#deleteCopiedPendingLedgerEntries()
     */
    public void deleteCopiedPendingLedgerEntries() {
        LOG.debug("deleteCopiedPendingLedgerEntries() started");

        generalLedgerPendingEntryService.deleteByFinancialDocumentApprovedCode(OLEConstants.PENDING_ENTRY_APPROVED_STATUS_CODE.PROCESSED);
    }

    /**
     * Copies the approved pending ledger entries to origin entry table and generates a report
     * @see org.kuali.ole.gl.service.NightlyOutService#copyApprovedPendingLedgerEntries()
     */
    public void copyApprovedPendingLedgerEntries() {
        ...
        while (pendingEntries.hasNext()) {
            ...
            pendingEntry.setFinancialDocumentApprovedCode(OLEConstants.PENDING_ENTRY_APPROVED_STATUS_CODE.PROCESSED);
    ...
    protected class EntryListReport {
        ...
        protected void writeDocumentTotalLine(EntryReportDocumentNumberTotalLine documentNumberTotal, ReportWriterService reportWriterService) {
            ...
            final int amountLength = getDataDictionaryService().getAttributeMaxLength(Entry.class, OLEPropertyConstants.TRANSACTION_LEDGER_ENTRY_AMOUNT);
        ...
        protected class EntryReportDocumentTypeTotalLine extends EntryReportTotalLine {
             ...
             * @see org.kuali.ole.gl.batch.service.impl.NightlyOutServiceImpl.EntryReportTotalLine#addBudgetAmount(org.kuali.rice.core.api.util.type.KualiDecimal)
             */
            @Override
            public void addBudgetAmount(KualiDecimal budgetAmount) {
             ...
             * @see org.kuali.ole.gl.batch.service.impl.NightlyOutServiceImpl.EntryReportTotalLine#addCreditAmount(org.kuali.rice.core.api.util.type.KualiDecimal)
             */
            @Override
            public void addCreditAmount(KualiDecimal creditAmount) {
            ...
            /**
             * Overridden to automagically update the entry count
             * @see org.kuali.ole.gl.batch.service.impl.NightlyOutServiceImpl.EntryReportTotalLine#addDebitAmount(org.kuali.rice.core.api.util.type.KualiDecimal)
             */
            @Override
            public void addDebitAmount(KualiDecimal debitAmount) {
