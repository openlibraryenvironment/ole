...
import org.kuali.ole.fp.businessobject.TravelPerDiem;
...
public class DisbursementVoucherForm extends KualiAccountingDocumentFormBase {
    ...
    public List<TravelPerDiem> getTravelPerDiemCategoryCodes() {
        ...
        criteria.put(OLEPropertyConstants.UNIVERSITY_FISCAL_YEAR, SpringContext.getBean(UniversityDateService.class).getCurrentFiscalYear());
