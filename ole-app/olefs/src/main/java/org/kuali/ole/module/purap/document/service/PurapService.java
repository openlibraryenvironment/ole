...
import org.kuali.ole.module.purap.document.PurapItemOperations;
...
public interface PurapService {
     ...
     * {@link org.kuali.ole.vnd.document.service.VendorService#getApoLimitFromContract(Integer, String, String)}) and if that is null
     * then based on the {@link org.kuali.ole.module.purap.businessobject.OrganizationParameter} associated with the given 'chart' and 'org' values.
     *
     * @param vendorContractGeneratedIdentifier
     *
     * @param chart chart code to use when looking up limit amount on {@link org.kuali.ole.vnd.businessobject.VendorContract} and
     *              {@link org.kuali.ole.module.purap.businessobject.OrganizationParameter}
     * @param org   organization code to use when looking up limit amount on {@link org.kuali.ole.vnd.businessobject.VendorContract} and
     *              {@link org.kuali.ole.module.purap.businessobject.OrganizationParameter}
