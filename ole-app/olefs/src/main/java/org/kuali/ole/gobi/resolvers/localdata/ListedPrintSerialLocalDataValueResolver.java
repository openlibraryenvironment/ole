 ...
 */
public class ListedPrintSerialLocalDataValueResolver extends LocalDataMappingValueResolver {
    @Override
    ...
    private String getAttributeValue() {
        ...
        PurchaseOrder.Order.ListedPrintSerial listedPrintSerial = order.getListedPrintSerial();
        if (null != listedPrintSerial) {
            PurchaseOrder.Order.ListedPrintSerial.OrderDetail orderDetail = listedPrintSerial.getOrderDetail();
