...
import org.kuali.ole.sys.OLEConstants.ChartApcParms;
import org.kuali.ole.sys.OLEPropertyConstants;
import org.kuali.ole.sys.businessobject.ChartOrgHolderImpl;
...
public class OrganizationServiceImpl implements OrganizationService {
    ...
    /**
     * 
     * @see org.kuali.ole.coa.service.OrganizationService#getByPrimaryId(java.lang.String, java.lang.String)
     */
    @Override
    public Organization getByPrimaryId(String chartOfAccountsCode, String organizationCode) {
        ...
        keys.put(OLEPropertyConstants.ORGANIZATION_CODE, organizationCode);
     ...
     * 
     * @see org.kuali.ole.coa.service.impl.OrganizationServiceImpl#getByPrimaryId(java.lang.String, java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.kuali.ole.coa.service.OrganizationService#getActiveAccountsByOrg(java.lang.String, java.lang.String)
     */
    @Override
    public List<Account> getActiveAccountsByOrg(String chartOfAccountsCode, String organizationCode) {
        ...
        criteria.put(OLEPropertyConstants.CHART_OF_ACCOUNTS_CODE, chartOfAccountsCode);
        criteria.put(OLEPropertyConstants.ORGANIZATION_CODE, organizationCode);
    ...
    /**
     * @see org.kuali.ole.coa.service.OrganizationService#getActiveChildOrgs(java.lang.String, java.lang.String)
     */
    @Override
    public List<Organization> getActiveChildOrgs(String chartOfAccountsCode, String organizationCode) {
        ...
        Map<String, Object> criteria = new HashMap<String, Object>();
        criteria.put(OLEPropertyConstants.REPORTS_TO_CHART_OF_ACCOUNTS_CODE, chartOfAccountsCode);
        criteria.put(OLEPropertyConstants.REPORTS_TO_ORGANIZATION_CODE, organizationCode);
        criteria.put(OLEPropertyConstants.ACTIVE, Boolean.TRUE);
    ...
    protected void loadParentOrgCache() {
        ...
        Collection<Organization> orgs = boService.findMatching(Organization.class, Collections.singletonMap(OLEPropertyConstants.ACTIVE, true));
    ...
    /**
     * 
     * @see org.kuali.ole.coa.service.OrganizationService#getActiveOrgsByType(java.lang.String)
     */
    @Override
    public List<Organization> getActiveOrgsByType(String organizationTypeCode) {
        ...
        Map<String, Object> criteria = new HashMap<String, Object>();
        criteria.put(OLEPropertyConstants.ORGANIZATION_TYPE_CODE, organizationTypeCode);
        criteria.put(OLEPropertyConstants.ACTIVE, Boolean.TRUE);
    ...
    /**
     * 
     * @see org.kuali.ole.coa.service.OrganizationService#getActiveFinancialOrgs()
     */
    @Override
    public List<Organization> getActiveFinancialOrgs() {
        Map<String, Object> criteria = new HashMap<String, Object>();
        criteria.put(OLEPropertyConstants.ORGANIZATION_IN_FINANCIAL_PROCESSING_INDICATOR, Boolean.TRUE);
        criteria.put(OLEPropertyConstants.ACTIVE, Boolean.TRUE);
        return new ArrayList<Organization>( boService.findMatching(Organization.class, criteria) );
    }
     ...
     * 
     * @see org.kuali.ole.coa.service.OrganizationService#getRootOrganizationCode()
     */
    @Override
