...
import org.kuali.ole.coa.batch.CfdaBatchStep;
...
public class CfdaServiceImpl implements CfdaService {
    ...
    public SortedMap<String, CFDA> getGovCodes() throws IOException {
        ...
        String govURL = SpringContext.getBean(ParameterService.class).getParameterValueAsString(CfdaBatchStep.class, OLEConstants.SOURCE_URL_PARAMETER);
