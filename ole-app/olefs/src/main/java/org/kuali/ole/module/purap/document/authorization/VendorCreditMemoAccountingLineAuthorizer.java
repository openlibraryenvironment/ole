...
public class VendorCreditMemoAccountingLineAuthorizer extends PurapAccountingLineAuthorizer {
    ...
    public boolean renderNewLine(AccountingDocument accountingDocument, String accountingGroupProperty) {
        ...
        if (workflowDocument.getCurrentNodeNames().equals(VendorCreditMemoAccountingLineAuthorizer.INITIATOR_NODE) || workflowDocument.getCurrentNodeNames().equals(VendorCreditMemoAccountingLineAuthorizer.CONTENT_REVIEW_NODE))
            return true;
