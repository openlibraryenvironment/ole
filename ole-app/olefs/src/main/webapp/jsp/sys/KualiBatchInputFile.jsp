	...
	<kul:tabTop tabTitle="Manage Batch Files" defaultOpen="true" tabErrorKey="">
      <div class="tab-container" align="center">
          ...
          <table width="100%" summary="" cellpadding="0" cellspacing="0">
            <tr>
              <th><div align="left"><label for="batchUpload.batchDestinationFilePath">File Path:</label></div></th>
              <td><div align="left" width="100%"><kul:htmlControlAttribute attributeEntry="${batchUploadAttributes.batchDestinationFilePath}" property="batchUpload.batchDestinationFilePath" /></div></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr>
