...
<%@ taglib tagdir="/WEB-INF/tags/module/select" prefix="select"%>
...
<%@ taglib tagdir="/WEB-INF/tags/portal/channel/oleAdmin" prefix="oleAdminChannel"%>
<%@ taglib tagdir="/WEB-INF/tags/portal/channel/oleDeliver" prefix="oleDeliverChannel"%>
<%@ taglib tagdir="/WEB-INF/tags/portal/channel/oleDescribe" prefix="oleDescribeChannel"%>
