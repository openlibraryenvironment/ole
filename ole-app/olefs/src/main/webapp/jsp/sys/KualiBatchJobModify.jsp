...
<kul:page showDocumentInfo="false"
	...
	<div style="text-align: right;">
		<a href="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.ole.sys.batch.BatchJobStatus&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true&conversionFields=name:name,group:group">Return to Lookup</a>
	</div>
		...
		<div class="tab-container" align="center">
	      <table width="100%" cellpadding=0 cellspacing=0 class="datatable">
			...
			<tr>
				...
				<td>${job.status}&nbsp;</td>
				<td colspan="2"><portal:portalLink displayTitle="true" title="Batch File lookup (to retrieve logs and reports)" url="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.ole.sys.batch.BatchFile&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></td>
			</tr>
		</table>
	  </div>		
	</kul:tabTop>
