...
<kul:documentPage showDocumentInfo="true"
	...
	<kul:tab tabTitle="Cash Reconciliation" defaultOpen="true"
		tabErrorKey="${OLEConstants.EDIT_CASH_RECEIPT_CASH_RECONCILIATION_ERRORS}">
  ...
  <kul:tab tabTitle="Currency and Coin Detail" defaultOpen="true" tabErrorKey="${OLEConstants.EDIT_CASH_RECEIPT_CURRENCY_COIN_ERRORS}">
    <div class="tab-container" align="center">
  	  <c:if test="${confirmMode}">
  	    <div>
