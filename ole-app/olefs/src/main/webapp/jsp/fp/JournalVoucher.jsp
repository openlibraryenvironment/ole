...
<kul:documentPage showDocumentInfo="true"
	...
	<kul:tab tabTitle="Journal Voucher Details" defaultOpen="true"
		tabErrorKey="${OLEConstants.EDIT_JOURNAL_VOUCHER_ERRORS}">
			...
			<tbody>
				...
				<tr>
					...
					<c:if test="${!readOnly}">
						...
						<kul:lookup
							boClassName="org.kuali.ole.coa.businessobject.BalanceType"
	...
	<kul:tab tabTitle="Accounting Lines" defaultOpen="true" tabErrorKey="${OLEConstants.NEW_SOURCE_LINE_ERRORS}">
