...
<kul:page showDocumentInfo="false"
	...
	htmlFormAction="${OLEConstants.MAPPING_BALANCE_INQUIRY_REPORT_MENU}">
	...
	<table cellpadding=0 class="container2">
		<tr>
			...
			<td><gl:balanceInquiryLookup
				boClassName="org.kuali.ole.gl.businessobject.AccountBalance"
				actionPath="${OLEConstants.GL_MODIFIED_INQUIRY_ACTION}"
		...
		<tr>
			...
			<td><gl:balanceInquiryLookup
				boClassName="org.kuali.ole.gl.businessobject.AccountBalanceByConsolidation"
				actionPath="${OLEConstants.GL_ACCOUNT_BALANCE_BY_CONSOLIDATION_LOOKUP_ACTION}"
		...
		<tr>
			...
			<td><gl:balanceInquiryLookup
				boClassName="org.kuali.ole.gl.businessobject.CashBalance"
				actionPath="${OLEConstants.GL_MODIFIED_INQUIRY_ACTION}"
		...
		<tr>
			...
			<td><gl:balanceInquiryLookup
				boClassName="org.kuali.ole.gl.businessobject.Balance"
				actionPath="${OLEConstants.GL_BALANCE_INQUIRY_ACTION}"
		...
		<tr>
			...
			<td><gl:balanceInquiryLookup
				boClassName="org.kuali.ole.gl.businessobject.Entry"
				actionPath="${OLEConstants.GL_MODIFIED_INQUIRY_ACTION}"
		...
		<tr>
			...
			<td><gl:balanceInquiryLookup
				boClassName="org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntry"
				actionPath="${OLEConstants.GL_MODIFIED_INQUIRY_ACTION}"
		...
		<tr>
			...
			<td><gl:balanceInquiryLookup
				boClassName="org.kuali.ole.gl.businessobject.Encumbrance"
				actionPath="${OLEConstants.GL_MODIFIED_INQUIRY_ACTION}"
				lookupParameters="${KualiForm.openEncumbrancesBalanceInquiryLookupParameters}"
				hideReturnLink="true" /></td>
		</tr>
		<tr>
			<td><b>Fund Lookup</b>&nbsp;</td>
			<td><gl:balanceInquiryLookup
				boClassName="org.kuali.ole.select.document.OleFundLookupDocument"
				actionPath="${OLEConstants.OLE_FUND_LOOKUP}"
				lookupParameters="${KualiForm.openEncumbrancesBalanceInquiryLookupParameters}"
				hideReturnLink="true" /></td>
		</tr>
		<tr>
