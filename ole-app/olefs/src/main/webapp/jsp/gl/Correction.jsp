            ...
            <td>
              <center>
                <html:select property="chooseSystem" styleId="chooseSystem" title="Select System">
                  <html:optionsCollection property="actionFormUtilMap.getOptionsMap~org|kuali|ole|gl|businessobject|options|CorrectionChooseSystemValuesFinder" label="value" value="key"/>
                </html:select>
                
                <html:select property="editMethod" styleId="editMethod" title="Edit Method">
                  <html:optionsCollection property="actionFormUtilMap.getOptionsMap~org|kuali|ole|gl|businessobject|options|CorrectionEditMethodValuesFinder" label="value" value="key"/>
                </html:select>
					...
					<c:when test="${KualiForm.documentType == 'LLCP'}" >
						<c:choose>
		                      <c:when test="${KualiForm.editMethod eq 'R'}">
    		                    <html:optionsCollection property="actionFormUtilMap.getOptionsMap~org|kuali|ole|module|ld|businessobject|options|ProcessingCorrectionLaborGroupEntriesFinder" label="value" value="key" />
        		              </c:when>
            		          <c:otherwise>
                		        <html:optionsCollection property="actionFormUtilMap.getOptionsMap~org|kuali|ole|module|ld|businessobject|options|CorrectionLaborGroupEntriesFinder" label="value" value="key" />
                    		  </c:otherwise>
                    	</c:choose>
                   	</c:when>
                   	<c:otherwise>
                   		<c:choose>
	                      <c:when test="${KualiForm.editMethod eq 'R'}">
    	                    <html:optionsCollection property="actionFormUtilMap.getOptionsMap~org|kuali|ole|gl|businessobject|options|ProcessingCorrectionGroupEntriesFinder" label="value" value="key" />
        	              </c:when>
            	          <c:otherwise>
                ...
                <td class="bord-l-b" style="padding: 4px; vertical-align: top;">
                  ...
                  <html:select property="groupsItem[${group.correctionChangeGroupLineNumber}].correctionCriteria.correctionFieldName" styleId="groupsItem[${group.correctionChangeGroupLineNumber}].correctionCriteria.correctionFieldName" title="Field">
                    <option value=""></option>
	                    <c:choose>
    	                	<c:when test="${KualiForm.documentType == 'LLCP'}" >
        	            		<html:optionsCollection property="actionFormUtilMap.getOptionsMap~org|kuali|ole|module|ld|businessobject|options|LaborOriginEntryFieldFinder" label="value" value="key"/>
							</c:when>
							<c:otherwise>
		            	        <html:optionsCollection property="actionFormUtilMap.getOptionsMap~org|kuali|ole|gl|businessobject|options|OriginEntryFieldFinder" label="value" value="key"/>
		                	</c:otherwise>
		                </c:choose>
                  </html:select>
                  ...
                  <html:select property="groupsItem[${group.correctionChangeGroupLineNumber}].correctionCriteria.correctionOperatorCode" styleId="groupsItem[${group.correctionChangeGroupLineNumber}].correctionCriteria.correctionOperatorCode" title="Operator">
                    <html:optionsCollection property="actionFormUtilMap.getOptionsMap~org|kuali|ole|gl|businessobject|options|SearchOperatorsFinder" label="value" value="key"/>
                  </html:select>
