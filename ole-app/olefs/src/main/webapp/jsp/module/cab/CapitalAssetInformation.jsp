			...
			<tr>
				...
				<td class="grid"><div>
					<c:set var="assetActionType" value="${detailLine.capitalAssetActionIndicator}" />
				    	<c:if test="${assetActionType eq OLEConstants.CapitalAssets.CAPITAL_ASSET_CREATE_ACTION_INDICATOR}">
					    	<c:out value="${OLEConstants.CapitalAssets.CREATE_CAPITAL_ASSETS_TAB_TITLE}" />
					    </c:if>
				        <c:if test="${assetActionType eq OLEConstants.CapitalAssets.CAPITAL_ASSET_MODIFY_ACTION_INDICATOR}">
					    	<c:out value="${OLEConstants.CapitalAssets.MODIFY_CAPITAL_ASSETS_TAB_TITLE}" />
					    </c:if>
				</div></td>
				...
				<td class="grid">
					<c:if test="${!empty detailLine.capitalAssetNumber}">
						<kul:inquiry boClassName="org.kuali.ole.integration.cam.CapitalAssetManagementAsset" keyValues="capitalAssetNumber=${detailLine.capitalAssetNumber}" render="true">
