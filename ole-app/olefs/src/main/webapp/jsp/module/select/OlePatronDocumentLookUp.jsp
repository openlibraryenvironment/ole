	  ...
	  <c:if test="${KualiForm.lookupCriteriaEnabled}">
		<tr>
			...
			<table align="center" cellpadding="0" cellspacing="0" class="datatable-100">
				...
				<c:set var="ActionName" value="ptrnlookup.do" scope="request" />
				...
				<tr align="center">
					...
					<%-- <html:image
						property="methodToCall.createNew" value="createNew"
						src="${ConfigProperties.kr.externalizable.images.url}tinybutton-createnew.gif" styleClass="tinybutton"
						alt="create new" title="create new" border="0" />  --%>
			...
			<c:if test="${!empty reqSearchResultsActualSize }">
				...
				requestURI="ptrnlookup.do?methodToCall=viewResults&reqSearchResultsActualSize=${reqSearchResultsActualSize}&searchResultKey=${searchResultKey}&searchUsingOnlyPrimaryKeyValues=${KualiForm.searchUsingOnlyPrimaryKeyValues}&actionUrlsExist=${KualiForm.actionUrlsExist}">
