...
<kul:documentPage showDocumentInfo="true"
    ...
    htmlFormAction="selectOlePaymentRequest" renderMultipart="true"
    showTabButtons="true">
	...
	<c:if test="${not KualiForm.editingMode['displayInitTab']}" >
		<select:olevendor
	        documentAttributes="${DataDictionary.PaymentRequestDocument.attributes}" 
	        displayPurchaseOrderFields="false" displayPaymentRequestFields="true" intialOpen="${KualiForm.document.vendorFlag}"/>
	
		<select:olePaymentRequestInvoiceInfo 
			documentAttributes="${DataDictionary.PaymentRequestDocument.attributes}"
	 		displayPaymentRequestInvoiceInfoFields="true" intialOpen="${KualiForm.document.invoiceInfoFlag}"/>
	    ...
	    <select:oleNotesAndAttachment
            ...
            intialOpen="${KualiForm.document.notesAndAttachmentFlag}" />
