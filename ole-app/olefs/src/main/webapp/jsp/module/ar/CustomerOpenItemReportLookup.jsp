	...
	<table width="100%" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td>
				...
				<c:if test="${!empty reqSearchResultsSize}">
					<c:if test="${param.reportName == OLEConstants.CustomerOpenItemReport.OPEN_ITEM_REPORT_NAME}">
						<table width="25%" cellspacing="0" cellpadding="0">
							<tr><td>Report Option:</td><td><c:out value="${param.reportOption}" /></td>
							 <c:choose>
								<c:when test="${param.reportOption == OLEConstants.CustomerOpenItemReport.REPORT_OPTION_ACCT}" >
