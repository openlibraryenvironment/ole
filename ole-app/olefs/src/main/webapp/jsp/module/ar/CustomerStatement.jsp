	 ...
	 <table cellpadding="0" cellspacing="0" class="datatable-80" summary="Billing Statement">
			<tr>		
                ...
                <td align=left valign=middle class="grid" style="width: 25%;">
                    ...
                    <kul:lookup boClassName="org.kuali.ole.coa.businessobject.Chart"  fieldConversions="chartOfAccountsCode:chartCode"  />
                </td>
            ...
            <tr>
                ...
                <td align=left valign=middle class="grid">
                    ...
                    <kul:lookup boClassName="org.kuali.ole.coa.businessobject.Organization"  fieldConversions="organizationCode:orgCode" lookupParameters="orgCode:organizationCode,chartCode:chartOfAccountsCode"/>
                </td>                
             ...
             <tr>
                ...
                <td align=left valign=middle class="grid">
                	...
                	<kul:lookup boClassName="org.kuali.ole.module.ar.businessobject.Customer" fieldConversions="customerNumber:customerNumber" lookupParameters="customerNumber:customerNumber" />
                </td>                
              ...
              <tr>
                ...
                <td align=left valign=middle class="grid">
                	...
                	<kul:lookup boClassName="org.kuali.ole.coa.businessobject.Account" fieldConversions="accountNbr:accountNumber" lookupParameters="accountNumber:accountNbr" />
                </td>                
