...
<div class="headerarea-small" id="headerarea-small">
    ...
    <div style="clear:both">
        <div style="float:right">
            ...
            <div style="float:left; width:39px">
                <a id="alertLink" href="${ConfigProperties.application.url}/ole-kr-krad/actionListAlertController?viewId=ActionListAlertView&methodToCall=start" ><img src="${ConfigProperties.application.url}/images-portal/tinybutton-alert.gif"  alt="alert" title="alert" /></a>
            </div>
