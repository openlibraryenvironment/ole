...
jq("input[name='document.newMaintainableObject.nonBillable']").live("change",function(){
    ...
    if(checked == "checked"){
        ...
        jq("select[title='Search Currency Type']").attr('src','');
        jq("select[title='Search Currency Type']").attr('alt','');
        ...
        jq("select[title='Search Currency Type']").attr('src','');
        jq("select[title='Search Currency Type']").attr('alt','Search Currency Type');
