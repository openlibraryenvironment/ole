...
<%@ attribute name="claimIndex" required="true" description="The index of the org.kuali.ole.sys.businessobject.ElectronicPaymentClaim in the form to display." %>
<%@ attribute name="electronicPaymentClaim" required="true" description="The ElectronicPaymentClaim being displayed" type="org.kuali.ole.sys.businessobject.ElectronicPaymentClaim" %>
