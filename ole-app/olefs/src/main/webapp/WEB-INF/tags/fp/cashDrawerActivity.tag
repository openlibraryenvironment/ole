...
<c:set var="allowRefresh" value="${KualiForm.document.rawCashDrawerStatus != OLEConstants.CashDrawerConstants.STATUS_CLOSED}" />
...
<kul:tab tabTitle="Cash Drawer Activity" defaultOpen="true" tabErrorKey="${OLEConstants.EDIT_CASH_MANAGEMENT_CASHIERING_TRANSACTION_ERRORS}" >
    <div class="tab-container" align=center>
	  <table cellspacing="0" cellpadding="0" border="0" class="datatable">
		  <tr>
        			  ...
        			  <table cellspacing=0 cellpadding=0 border=0 class="datatable">
            			...
            			<tr>
                				...
                				<td colspan=2>
                    				...
                    				<c:if test="${KualiForm.document.rawCashDrawerStatus == OLEConstants.CashDrawerConstants.STATUS_OPEN}">
                        				(opened at ${KualiForm.cashDrawerSummary.timeOpened})
                    				</c:if>
                				</td>
            			</tr>

            			<c:if test="${KualiForm.document.rawCashDrawerStatus != OLEConstants.CashDrawerConstants.STATUS_CLOSED && KualiForm.cashDrawerSummary.remainingSumTotal != null}">
                				<tr>
			...
			<td width="50%" valign="top">
				<fp:cashDrawerCurrencyCoin cashDrawerProperty="document.cashDrawer" readOnly="true" showCashDrawerSummary="${KualiForm.document.rawCashDrawerStatus != OLEConstants.CashDrawerConstants.STATUS_CLOSED && KualiForm.cashDrawerSummary.cashDrawerTotal != null}" />
			</td>
		</tr>
		<tr>
			<td colspan="2">
