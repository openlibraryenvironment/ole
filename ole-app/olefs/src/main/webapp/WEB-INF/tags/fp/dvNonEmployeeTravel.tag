...
<kul:tab tabTitle="Non-Employee Travel Expense" defaultOpen="false" tabErrorKey="${OLEConstants.DV_NON_EMPL_TRAVEL_TAB_ERRORS}">
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td valign="top" nowrap="nowrap" class="infoline">
                    	<div align="center">
                    		<kul:checkErrors keyMatch="${OLEConstants.DV_CHECK_TRAVEL_TOTAL_ERROR}"/>
