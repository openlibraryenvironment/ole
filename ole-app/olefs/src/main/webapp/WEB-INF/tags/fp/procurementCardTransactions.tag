...
<kul:tab tabTitle="Accounting Lines" defaultOpen="true" tabErrorKey="${OLEConstants.TARGET_ACCOUNTING_LINE_ERROR_PATTERN},document.transactionEntries*">
    ...
    <table cellpadding="0" class="datatable" summary="Transaction Details">
       ...
       <fp:subheadingWithDetailToggleRow columnCount="4" subheading="Transaction #${currentTransaction.transactionReferenceNumber}"/>
	      <tr>
	        ...
	        <td>
	          <kul:inquiry boClassName="org.kuali.ole.fp.businessobject.ProcurementCardHolder" 
       ...
       <tr>
          ...
          <td valign=top>
            <kul:inquiry boClassName="org.kuali.ole.fp.businessobject.ProcurementCardTransactionDetail" 
       ...
       <tr>  
          ...
          <td valign=top>
            <kul:inquiry boClassName="org.kuali.ole.fp.businessobject.ProcurementCardVendor" 
               keyValues="documentNumber=${currentTransaction.documentNumber}&financialDocumentTransactionLineNumber=${currentTransaction.financialDocumentTransactionLineNumber}" 
               render="true">
