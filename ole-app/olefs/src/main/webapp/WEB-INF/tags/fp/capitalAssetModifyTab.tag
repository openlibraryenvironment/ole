...
<kul:tab tabTitle="${OLEConstants.CapitalAssets.MODIFY_CAPITAL_ASSETS_TAB_TITLE}" defaultOpen="${defaultOpen}" tabErrorKey="${OLEConstants.EDIT_CAPITAL_ASSET_MODIFY_ERRORS}" >
