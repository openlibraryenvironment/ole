...
<c:if test="${fn:trim(ConfigProperties.environment) != fn:trim(ConfigProperties.production.environment.code)}" >
	<channel:portalChannelTop channelTitle="Testing" />
		<div class="body">
			...
			<portal:olePortalLink green="true" displayTitle="true" title="View Data Dictionary Configuration" url="dataDictionaryDumper.do" /><br/><br/>
			
	        <%-- THIS FUNCTIONALITY SHOULD ONLY BE AVAILABLE IN TEST ENVIRONMENTS --%>
			<b>Electronic Invoice</b><br/><br/>
			    
			<portal:olePortalLink grey="true" displayTitle="false" title="Generate/Upload eInvoice Files" url="purapElectronicInvoiceTest.do" hiddenTitle="true"/><br/><br/>  				
				
				
			<b>Webservices</b><br/><br/>
			    
			<portal:olePortalLink green="true" displayTitle="true" title="PreOrder Service" url="wsclient.jsp" /><br/>				
