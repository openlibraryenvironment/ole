...
<channel:portalChannelTop channelTitle="KRMS Admin" />
<div class="body">
  ...
  --%>
    ...
    <portal:portalLink displayTitle="true"   title="Attribute Lookup" url="${ConfigProperties.application.url}/kr-krad/lookup?methodToCall=start&dataObjectClassName=org.kuali.rice.krms.impl.repository.KrmsAttributeDefinitionBo&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true&showMaintenanceLinks=true" /><br/>
