...
<channel:portalChannelTop channelTitle="Kuali OLE Modules"/>
<div class="body">
   ...
   <%-- <portal:portalLink displayTitle="true" title="Instance Editor" green="true"
    ...
    <portal:portalLink displayTitle="true" title="People Flow"
                       url="${ConfigProperties.application.url}/ole-kr-krad/lookup?methodToCall=start&dataObjectClassName=org.kuali.rice.kew.impl.peopleflow.PeopleFlowBo&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true&showMaintenanceLinks=true"/><br/>
