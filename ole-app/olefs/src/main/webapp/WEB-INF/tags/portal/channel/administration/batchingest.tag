...
<div class="body">
    ...
    <portal:portalLink displayTitle="true" title="Batch Process"
                       url="${ConfigProperties.application.url}/ole-kr-krad/oleBatchProcessDefinitionController?viewId=OLEBatchProcessDefinitionView&methodToCall=docHandler&command=initiate&documentClass=org.kuali.ole.batch.document.OLEBatchProcessDefinitionDocument"/><br/>
    <portal:portalLink displayTitle="true" title="Batch Process Job Details"
                       url="${ConfigProperties.application.url}/ole-kr-krad/oleBatchProcessJobController?viewId=OLEBatchProcessJobDetailsView&methodToCall=docHandler&command=initiate&documentClass=org.kuali.ole.batch.bo.OLEBatchProcessJobDetailsBo"/><br/><br/>
    <br/>
</div>
