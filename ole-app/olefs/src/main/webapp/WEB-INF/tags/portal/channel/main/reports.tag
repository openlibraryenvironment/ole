	...
	<c:if test="${ConfigProperties.module.accounts.receivable.enabled == 'true'}">
	    ...
	    <ul class="chan">	
			<li><portal:portalLink displayTitle="true" title="Billing Statement" url="arCustomerStatement.do?methodToCall=start" /></li>
	   		<li><portal:portalLink displayTitle="true" title="Customer Aging Report" url="arCustomerAgingReportLookup.do?methodToCall=start&businessObjectClassName=org.kuali.ole.module.ar.businessobject.CustomerAgingReportDetail" /></li> 		
