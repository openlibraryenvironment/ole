...
<div class="body">
   ...
   <%-- <portal:portalLink displayTitle="true" title="License Admin"
    ...
    <portal:portalLink displayTitle="true" title="Subscription Status" url="${ConfigProperties.application.url}/ole-kr-krad/lookup?methodToCall=start&dataObjectClassName=org.kuali.ole.select.bo.OleSubscriptionStatus&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true&showMaintenanceLinks=true"/><br/>
