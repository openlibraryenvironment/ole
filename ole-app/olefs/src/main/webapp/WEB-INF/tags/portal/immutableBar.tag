...
<div class="header2">
  <div class="header2-left-focus">
    <div class="breadcrumb-focus"><a href="asdf.html"> 
        ...
        <portal:portalLink displayTitle="false" title='Search Workbench' url="${ConfigProperties.application.url}/ole-kr-krad/olesearchcontroller?viewId=OLESearchView&methodToCall=start">
        <img src="images-portal/icon-port-searchWorkbench.png" alt="Search Workbench" width="130" height="19" border="0"></portal:portalLink>
     </div>
  </div>
</div>
