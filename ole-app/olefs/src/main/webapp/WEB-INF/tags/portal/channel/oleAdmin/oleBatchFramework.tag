...
<channel:portalChannelTop channelTitle="Batch Framework"/>
<div class="body">
    ...
    <portal:portalLink displayTitle="true" title="Batch Process" url="${ConfigProperties.application.url}/ole-kr-krad/oleBatchProcessDefinitionController?viewId=OLEBatchProcessDefinitionView&methodToCall=startBatch&command=initiate&documentClass=org.kuali.ole.batch.document.OLEBatchProcessDefinitionDocument"/><br/><br/>
    ...
    <portal:portalLink displayTitle="true" title="Batch Process Schedule" url="${ConfigProperties.application.url}/ole-kr-krad/oleBatchProcessJobController?viewId=OLEBatchScheduleJob&methodToCall=jobDocHandler&command=initiate&documentClass=org.kuali.ole.batch.bo.OLEBatchProcessScheduleBo"/><br/><br/>
</div>
