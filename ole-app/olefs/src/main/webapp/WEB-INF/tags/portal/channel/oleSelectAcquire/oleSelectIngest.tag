...
<div class="body">
    ...
    <%--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <portal:olePortalLink rice2="true" riceUrl="${riceUrl}" green="true" displayTitle="true" title="Staff Upload" url="${riceUrl}/ole-kr-krad/staffuploadcontroller?viewId=StaffUploadView&methodToCall=start&__login_user=admin&user=${user}"/><br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
