...
<kul:tab tabTitle="Vendor" defaultOpen="${intialOpen}" tabErrorKey="${PurapConstants.VENDOR_ERRORS}">
        ...
        <table cellpadding="0" cellspacing="0" class="datatable" summary="Vendor Section">
            ...
            <tr>
                ...
                <td align=left valign=middle class="datacell" onkeypress="setVendorDetails(event)">
                    ...
                    <c:if test="${(fullEntryMode or amendmentEntry) and (displayRequisitionFields or displayPurchaseOrderFields or displayPaymentRequestFields or displayCreditMemoFields) and !purchaseOrderAwarded and !lockB2BEntry}" >
                        <c:if test="${displayRequisitionFields or displayPaymentRequestFields or displayCreditMemoFields or amendmentEntry}" >
            ...
            <tr>
                ...
                <td align=left valign=middle class="datacell" width="25%">
                    ...
                    <c:if test="${(fullEntryMode or amendmentEntry) and (displayRequisitionFields or displayPurchaseOrderFields or displayPaymentRequestFields) and !purchaseOrderAwarded and !lockB2BEntry}" >
            ...
            <tr>
                ...
                <td align=left valign=middle class="datacell">
	                <c:if test="${not empty KualiForm.document.vendorHeaderGeneratedIdentifier}">
		                <kul:inquiry boClassName="org.kuali.ole.vnd.businessobject.VendorDetail" keyValues="vendorHeaderGeneratedIdentifier=${KualiForm.document.vendorHeaderGeneratedIdentifier}&vendorDetailAssignedIdentifier=${KualiForm.document.vendorDetailAssignedIdentifier}" render="true">
		                    <kul:htmlControlAttribute 
                ...
                <td align=left valign=middle class="datacell">
                    ...
                    <c:if test="${(fullEntryMode or amendmentEntry) and vendorReadOnly and !lockB2BEntry}">
                      <c:if test="${KualiForm.document.vendorDetail.vendorHeader.vendorForeignIndicator}">
                        <kul:lookup  boClassName="org.kuali.ole.vnd.businessobject.VendorCustomerNumber" 
                        	...
                        	fieldConversions="vendorCustomerNumber:document.vendorCustomerNumber,vendorDiscountPercentage:newPurchasingItemLine.itemForeignDiscount,vendorDiscountType:newPurchasingItemLine.itemForeignDiscountType"/>
                      </c:if>
                   	  <c:if test="${not KualiForm.document.vendorDetail.vendorHeader.vendorForeignIndicator}">
	                  	<kul:lookup  boClassName="org.kuali.ole.vnd.businessobject.VendorCustomerNumber" 
	                        	readOnlyFields="vendorHeaderGeneratedIdentifier,vendorDetailAssignedIdentifier" autoSearch="yes"
	                        	lookupParameters="document.vendorHeaderGeneratedIdentifier:vendorHeaderGeneratedIdentifier,document.vendorDetailAssignedIdentifier:vendorDetailAssignedIdentifier" 
	                        	fieldConversions="vendorCustomerNumber:document.vendorCustomerNumber,vendorDiscountPercentage:newPurchasingItemLine.itemDiscount,vendorDiscountType:newPurchasingItemLine.itemDiscountType"/>
	                  </c:if>
                    </c:if>
                </td>
                ...
                <tr>
                    ...
                    <td align=left valign=middle class="datacell">
                        ...
                        <c:if test="${(fullEntryMode or amendmentEntry) and !lockB2BEntry}">
                            <kul:lookup  boClassName="org.kuali.ole.vnd.businessobject.VendorContract" 
                    ...
                    <td align=left valign=middle class="datacell">
                        ...
                        <c:if test="${vendorReadOnly}" >
                            <kul:lookup  boClassName="org.kuali.ole.vnd.businessobject.VendorContact" 
                            	readOnlyFields="vendorHeaderGeneratedIdentifier,vendorDetailAssignedIdentifier" autoSearch="yes" 
                            	lookupParameters="document.vendorHeaderGeneratedIdentifier:vendorHeaderGeneratedIdentifier,document.vendorDetailAssignedIdentifier:vendorDetailAssignedIdentifier" 
                ...
                <tr>
                    ...
                    <td align=left valign=middle class="datacell">
                        <kul:htmlControlAttribute 
                        	...
                        	readOnly="true" tabindexOverride="${tabindexOverrideBase + 4}"/>                    
                        <c:if test="${vendorReadOnly}" >
                            <kul:lookup  boClassName="org.kuali.ole.vnd.businessobject.VendorPhoneNumber" 
                            	readOnlyFields="vendorHeaderGeneratedIdentifier,vendorDetailAssignedIdentifier" autoSearch="yes" 
                            	lookupParameters="document.vendorHeaderGeneratedIdentifier:vendorHeaderGeneratedIdentifier,document.vendorDetailAssignedIdentifier:vendorDetailAssignedIdentifier" 
                            	hideReturnLink="true" extraButtonSource="${ConfigProperties.externalizable.images.url}buttonsmall_return.gif" />                    
                        </c:if>
            ...
            <c:if test="${(fullEntryMode or amendmentEntry) or ( (not(fullEntryMode or amendmentEntry)) and (not empty KualiForm.document.alternateVendorHeaderGeneratedIdentifier) )}">
                ...
                <td align=left valign=middle class="datacell">
					...
					<kul:lookup 
						boClassName="org.kuali.ole.vnd.businessobject.VendorDetail" 
