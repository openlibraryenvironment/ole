	...
	<c:if test="${isOpen != 'true' && isOpen != 'TRUE'}">
	    <tr style="display: none;"  id="tab-${tabKey}-div">
          ...
          <table>    
			 ...
			 <logic:notEmpty name="KualiForm" property="${accountPrefix}correctionExceptionNoteList">
			 	<tr>
	                <th>
		     ...
		     <logic:iterate indexId="ctr" name="KualiForm" property="${accountPrefix}correctionExceptionNoteList" id="itemNotes">
				<c:if test="true">				
				<c:choose>	
				...
				<tr>
					<td class="infoline">
					 <kul:htmlControlAttribute
		                property="${accountPrefix}correctionExceptionNoteList[${ctr}].exceptionTypeId"
					...
					<td class="infoline">
					    <kul:htmlControlAttribute 
                        	attributeEntry="${itemAttributes.exceptionNotes}" property="${accountPrefix}correctionExceptionNoteList[${ctr}].exceptionNotes" 
