...
<kul:tab tabTitle="General" defaultOpen="true" tabErrorKey="${OLEConstants.CUSTOMER_INVOICE_DOCUMENT_GENERAL_ERRORS}">
        ...
        <table cellpadding="0" cellspacing="0" class="datatable" summary="Invoice Section">
			...
			<tr>
                ...
                <td align=left valign=middle class="datacell" style="width: 25%;">
				    ...
				    <c:if test="${readOnly}">
					 <a href="arCustomerOpenItemReportLookup.do?methodToCall=search&businessObjectClassName=org.kuali.ole.module.ar.businessobject.CustomerOpenItemReportDetail&lookupableImplementaionServiceName=arCustomerOpenItemReportLookupable&docFormKey=88888888&returnLocation=&hideReturnLink=true&reportName=${OLEConstants.CustomerOpenItemReport.HISTORY_REPORT_NAME}&customerNumber=${KualiForm.customerInvoiceDocument.accountsReceivableDocumentHeader.customerNumber}&customerName=${KualiForm.customerInvoiceDocument.customerName}"
						target="new">
					</c:if>
                    ...
                    <c:if test="${not readOnly}">
	                    &nbsp;
	                    <kul:lookup boClassName="org.kuali.ole.module.ar.businessobject.Customer" fieldConversions="customerNumber:document.accountsReceivableDocumentHeader.customerNumber" lookupParameters="document.accountsReceivableDocumentHeader.customerNumber:customerNumber" />
                    </c:if>
                </td>			
                <th align=right valign=middle class="bord-l-b" style="width: 25%;"> 
