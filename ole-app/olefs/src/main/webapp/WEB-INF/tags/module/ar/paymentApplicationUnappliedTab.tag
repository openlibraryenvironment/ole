...
<c:set var="customerAttributes" value="${DataDictionary['Customer'].attributes}" />
    ...
    <kul:tab tabTitle="Unapplied"
        ...
        tabErrorKey="${OLEConstants.PaymentApplicationTabErrorCodes.UNAPPLIED_TAB}">
                		...
                		<tr>
                    		...
                    		<td>
								...
								<c:if test="${readOnly ne true}">
	                        		<kul:lookup boClassName="org.kuali.ole.module.ar.businessobject.Customer" autoSearch="true"
