...
<%@ attribute name="itemLine" required="true" type="org.kuali.ole.module.cab.businessobject.PurchasingAccountsPayableItemAsset" %>
<%@ attribute name="purApDocLine" required="true" type="org.kuali.ole.module.cab.businessobject.PurchasingAccountsPayableDocument" %>
...
<tr style="color:${color}">
	...
	<c:if test="${!itemLine.active}">	
		...
		<td class="infoline" align="center">
			<c:forEach items="${itemLine.approvedAssetNumbers }" var="assetNumber" >
				<kul:inquiry boClassName="org.kuali.ole.integration.cam.CapitalAssetManagementAsset" keyValues="capitalAssetNumber=${assetNumber}" render="true">
					${assetNumber }
				</kul:inquiry>
				&nbsp;
			</c:forEach>
	...
	<td class="infoline">
     		<kul:htmlControlAttribute property="${assetItemStr}.capitalAssetTransactionTypeCode" attributeEntry="${purApItemAssetAttributes.capitalAssetTransactionTypeCode}" readOnly="true" readOnlyBody="true">
				<kul:inquiry boClassName="org.kuali.ole.module.cab.businessobject.AssetTransactionType" keyValues="capitalAssetTransactionTypeCode=${itemLine.capitalAssetTransactionTypeCode}" render="true">
