		        ...
		        <logic:iterate id="acmDetail" name="KualiForm" property="document.contractManagerAssignmentDetails" indexId="ctr">
		            <tr>
		                <td align=left valign=middle class="datacell">
					        ...
					        <c:if test="${!readOnly}" >
		                        <kul:lookup boClassName="org.kuali.ole.vnd.businessobject.ContractManager" fieldConversions="contractManagerCode:document.contractManagerAssignmentDetail[${ctr}].contractManagerCode" /></div>
		                    </c:if>
						</td>
		                <td align=left valign=middle class="datacell">
		                <c:if test="${!readOnly}" >
