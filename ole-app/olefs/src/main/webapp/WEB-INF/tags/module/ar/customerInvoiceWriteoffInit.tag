...
<kul:tabTop tabTitle="Customer Invoice Writeoff Initiation" defaultOpen="true" tabErrorKey="${OLEConstants.CUSTOMER_INVOICE_WRITEOFF_INIT_ERRORS}">
            ...
            <tr>
                ...
                <td align="left" valign="middle" class="datacell" style="width: 50%;" >
                   <kul:htmlControlAttribute
                       ...
                       readOnly="false" />
                   <kul:lookup boClassName="org.kuali.ole.module.ar.businessobject.CustomerInvoiceLookup"  fieldConversions="invoiceNumber:document.financialDocumentReferenceInvoiceNumber" />    
                </td>
            </tr>
		</table> 
    </div>
