...
<tr>
	...
	<td align=left class="${cssClass}">
		...
		<c:if test="${not readOnly}">
			&nbsp;
			<kul:lookup boClassName="org.kuali.ole.coa.businessobject.ObjectCode" fieldConversions="financialObjectCode:${propertyName}.accountsReceivableObjectCode"/>
		</c:if>
	</td>
	<td align=left class="${cssClass}">
		...
		<c:if test="${not readOnly}">
			&nbsp;
			<kul:lookup boClassName="org.kuali.ole.coa.businessobject.SubObjCd" fieldConversions="financialSubObjectCode:${propertyName}.accountsReceivableSubObjectCode" lookupParameters="${propertyName}.accountsReceivableObjectCode:financialObjectCode"/>
		</c:if>		
	</td>
	<c:if test="${not readOnly}">
