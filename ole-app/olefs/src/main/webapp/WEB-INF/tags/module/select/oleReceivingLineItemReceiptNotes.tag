	...
	<c:if test="${isOpen != 'true' && isOpen != 'TRUE'}">
	    <tr style="display: none;"  id="tab-${tabKey}-div">
          ...
          <c:if test="${fullEntryMode}">
			 ...
			 <logic:notEmpty name="KualiForm" property="${accountPrefix}receiptNoteList">
			 	<tr>
			         <th>
		     ...
		     <logic:iterate indexId="ctr" name="KualiForm" property="${accountPrefix}receiptNoteList" id="itemNotes">
				<c:if test="true">				
				<c:choose>	
						...
						<c:when test="${fullEntryMode}">
							<td class="infoline">
							 <kul:htmlControlAttribute
				                property="${accountPrefix}receiptNoteList[${ctr}].noteTypeId"
							...
							<td class="infoline">
							    <kul:htmlControlAttribute 
		                        	attributeEntry="${itemAttributes.receiptNotes}" property="${accountPrefix}receiptNoteList[${ctr}].notes" 
