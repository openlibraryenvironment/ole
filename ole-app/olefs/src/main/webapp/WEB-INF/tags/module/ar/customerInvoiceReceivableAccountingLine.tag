...
<kul:tab tabTitle="Receivable" defaultOpen="true" tabErrorKey="${OLEConstants.CUSTOMER_INVOICE_DOCUMENT_RECEIVABLE_ACCOUNTING_LINE}">
        ...
        <table cellpadding="0" cellspacing="0" class="datatable" summary="Invoice Section">
            ...
            <tr>
                ...
                <td align=left valign=middle class="datacell">
				  ...
				  <c:if test="${accountsCanCrossCharts}">
					...
					<c:if test="${not readOnly}">
	                    &nbsp;
	                    <kul:lookup boClassName="org.kuali.ole.coa.businessobject.Account" fieldConversions="accountNumber:document.paymentAccountNumber" lookupParameters="document.paymentAccountNumber:accountNumber,document.paymentChartOfAccountsCode:chartOfAccountsCode"/>
                    </c:if>
                    </span>
                    <br />
                ...
                <td align=left valign=middle class="datacell">
					...
					<c:if test="${not readOnly}">
	                    &nbsp;
	                    <kul:lookup boClassName="org.kuali.ole.coa.businessobject.SubAccount" fieldConversions="subAccountNumber:document.paymentSubAccountNumber" lookupParameters="document.paymentSubAccountNumber:subAccountNumber,document.paymentAccountNumber:accountNumber,document.paymentChartOfAccountsCode:chartOfAccountsCode"/>
                    </c:if>
                    </span>
                    <br />
				...
				<td align=left valign=middle class="datacell">
					...
					<c:if test="${not readOnly}">
	                    &nbsp;
	                    <kul:lookup boClassName="org.kuali.ole.coa.businessobject.ObjectCode" fieldConversions="financialObjectCode:document.paymentFinancialObjectCode" lookupParameters="document.paymentFinancialObjectCode:financialObjectCode,document.paymentChartOfAccountsCode:chartOfAccountsCode"/>
                    </c:if>
                    </span>
                    <br />
				...
				<td align=left valign=middle class="datacell">
					...
					<c:if test="${not readOnly}">
	                    &nbsp;
	                    <kul:lookup boClassName="org.kuali.ole.coa.businessobject.ProjectCode" fieldConversions="code:document.paymentProjectCode" lookupParameters="document.paymentProjectCode:code"/>
                    </c:if>
                    </span>
                    <br />
