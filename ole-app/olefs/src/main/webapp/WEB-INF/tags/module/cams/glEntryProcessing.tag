...
<div class="tab-container" align=center>
	...
	<table width="95%" border="0" cellpadding="0" cellspacing="0" class="datatable">
		...
		<tr>
			...
			<td class="grid">
				<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.Chart" keyValues="chartOfAccountsCode=${generalLedgerEntry.chartOfAccountsCode}" render="true">
			...
			<td class="grid">
				<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.Account" keyValues="chartOfAccountsCode=${generalLedgerEntry.chartOfAccountsCode}&accountNumber=${generalLedgerEntry.accountNumber}" render="true">
			...
			<td class="grid">
				<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.ObjectCode" keyValues="universityFiscalYear=${generalLedgerEntry.universityFiscalYear}&chartOfAccountsCode=${generalLedgerEntry.chartOfAccountsCode}&financialObjectCode=${generalLedgerEntry.financialObjectCode}" render="true">
