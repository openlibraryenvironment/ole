...
<kul:tab tabTitle="Process Items" defaultOpen="${intialOpen}" tabErrorKey="${PurapConstants.ITEM_TAB_ERRORS}">
        ...
        colSpanAmountPaid="0">
			<jsp:attribute name="specialItemTotalOverride">
				<tr>
                    ...
                    <td class="datacell" colspan="${colSpanTotalBlank+colspanBlank-5}">
                        &nbsp;
                    </td>
                </tr>
			</jsp:attribute>
