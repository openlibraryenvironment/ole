        	...
        	<tr>
	            <td align=left class="${cssClass}">
					...
					<c:if test="${not readOnly}">
						&nbsp;
						<kul:lookup 
							boClassName="org.kuali.ole.coa.businessobject.Chart" 
				...
				<td align=left class="${cssClass}">
					...
					&nbsp;
					<kul:lookup 
						boClassName="org.kuali.ole.coa.businessobject.Account" 
				...
				<td align=left class="${cssClass}">
					...
					<c:if test="${not readOnly}">
						&nbsp;
						<kul:lookup 
							boClassName="org.kuali.ole.coa.businessobject.SubAccount" 
				...
				<td align=left class="${cssClass}">
					...
					<c:if test="${not readOnly}">
						&nbsp;
						<kul:lookup 
							boClassName="org.kuali.ole.coa.businessobject.ObjectCode" 
				...
				<td align=left class="${cssClass}">
				    ...
				    <c:if test="${not readOnly}">
					    &nbsp;
				        <kul:lookup
				        	boClassName="org.kuali.ole.coa.businessobject.SubObjCd" 
				...
				<td align=left class="${cssClass}">
					...
					<c:if test="${not readOnly}">
						&nbsp;
						<kul:lookup boClassName="org.kuali.ole.coa.businessobject.ProjectCode" fieldConversions="code:${propertyName}.projectCode" />
					</c:if>
				</td>
				<td align=left class="${cssClass}">
