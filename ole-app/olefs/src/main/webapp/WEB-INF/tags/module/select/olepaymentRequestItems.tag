...
<tr>
    <td colspan="${mainColumnCount+1}" class="subhead">
...
<tr>
    ...
    <th colspan="3" rowspan="1">&nbsp; Bib Editor</th>
    <td class="infoline">
...
<%--  <tr>
      <kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.itemLineNumber}" width="2%"/>
      <kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.olePoOutstandingQuantity}" width="12%"/>
      &lt;%&ndash; <kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.itemUnitOfMeasureCode}" width="12%" /> &ndash;%&gt;
      <kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.purchaseOrderItemUnitPrice}" width="12%"/>
      <kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.formatTypeId}" width="12%"/>
      <kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.itemCatalogNumber}" width="12%"/>
  </tr>
...
<tr>
    <kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.itemLineNumber}" width="2%"/>
    <td class="infoline" nowrap="nowrap" rowspan=1>
...
<tr>
    ...
    <kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.itemDescription}" width="25%" colspan="${colSpanDescription-2}"/>
...
<tr>
    ...
    <div align="right"><kul:htmlControlAttribute
            ...
            tabindexOverride="${tabindexOverrideBase + 0}" /></div>
    <th colspan="2" rowspan="1">&nbsp; Bib Editor</th>
    <td class="infoline" >
        <div align="right">
            ...
            <c:if test="${! isSaved && itemLine.itemTitleId!=null}">
                <c:if test="${! isSaved and docformat eq 'dublinunq'}">
    ...
    <kul:htmlAttributeHeaderCell
            attributeEntry="${itemAttributes.receiptStatusId}" colspan="2" width="15%"/>
    <td class="infoline" colspan="2">
        <div align="center" />
        <kul:htmlControlAttribute
                attributeEntry="${itemAttributes.receiptStatusId}"
    ...
    <%--<kul:htmlAttributeHeaderCell
            attributeEntry="${itemAttributes.purchaseOrderItemID}" />
    <td>
        <kul:htmlControlAttribute
                attributeEntry="${itemAttributes.purchaseOrderItemID}"
                property="document.item[${ctr}].purchaseOrderItemID"
                readOnly="true"
                tabindexOverride="${tabindexOverrideBase + 0}" />
        <kul:lookup
                boClassName="org.kuali.ole.select.businessobject.OLEPurchaseOrderItemSearch"
                fieldConversions="purchaseOrderItemID:document.item[${ctr}].purchaseOrderItemID,localId:document.item[${ctr}].itemTitleId,itemDescription:document.item[${ctr}].itemDescription,accountsPayableLinkIdentifier:document.accountsPayablePurchasingDocumentLinkIdentifier"
                lookupParameters="document.vendorDetailAssignedIdentifier:vendorDetailAssignedIdentifier,document.vendorHeaderGeneratedIdentifier:vendorHeaderGeneratedIdentifier"/>

        <c:if test="${itemLine.purchaseOrderItemID != null && !empty itemLine.purchaseOrderItemID}">
            <html:image
                    property="methodToCall.relinkPO.line${ctr}"
                    src="${ConfigProperties.kr.externalizable.images.url}relink.gif"
                    alt="ReLink" title="ReLink" styleClass="tinybutton"
