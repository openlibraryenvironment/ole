...
<!-- For sending OlepurchaseOrderItem attributes For New NotesTag  -->
<c:set var="oleItemAttributes" value="${DataDictionary.OlePurchaseOrderItem.attributes}"/>
...
<kul:tab tabTitle="Titles" defaultOpen="true" tabErrorKey="${PurapConstants.ITEM_TAB_ERRORS}">
	...
	<table cellpadding="0" cellspacing="0" class="datatable" summary="Items Section">
		...
		<c:if test="${(fullEntryMode or amendmentEntry) and !lockB2BEntry}">
			...
			<tr>
				...
				<kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.itemNoOfParts}"/>
                ...
                <kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.itemListPrice}" />
				<kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.itemDiscount}" forceRequired="true"/>
				<kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.itemDiscountType}" />
				...
				<kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.itemRouteToRequestorIndicator}" />
				<kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.itemPublicViewIndicator}" />  					
			...
			<tr>
			    ...
			    <td class="infoline">
				    <kul:htmlControlAttribute attributeEntry="${itemAttributes.itemNoOfParts}" property="newPurchasingItemLine.itemNoOfParts" tabindexOverride="${tabindexOverrideBase + 0}"/>
			    </td>
                <td class="infoline" >
			    ...
			    <!-- <c:if test="${displayCommodityCodeFields}">
                    <td class="infoline" >
                        ...
                        <kul:lookup boClassName="org.kuali.ole.vnd.businessobject.CommodityCode" 
				...
				<td class="infoline">
				    <kul:htmlControlAttribute attributeEntry="${itemAttributes.itemListPrice}" property="newPurchasingItemLine.itemListPrice" tabindexOverride="${tabindexOverrideBase + 0}"/>
			    </td>
			    <td class="infoline">
				    <kul:htmlControlAttribute attributeEntry="${itemAttributes.itemDiscount}" property="newPurchasingItemLine.itemDiscount" tabindexOverride="${tabindexOverrideBase + 0}"/>
			    </td>
			    <td class="infoline">
				    <kul:htmlControlAttribute attributeEntry="${itemAttributes.itemDiscountType}" property="newPurchasingItemLine.itemDiscountType" tabindexOverride="${tabindexOverrideBase + 0}"/>
			    </td>
				<td class="infoline">
				    <div align="right">
			    ...
			    <td class="infoline">
				    <div align="right">
				        <kul:htmlControlAttribute attributeEntry="${itemAttributes.itemRouteToRequestorIndicator}" property="newPurchasingItemLine.itemRouteToRequestorIndicator" tabindexOverride="${tabindexOverrideBase + 0}"/>
					</div>
				</td>
				<td class="infoline">
 				    <div align="right">
 				        <kul:htmlControlAttribute attributeEntry="${itemAttributes.itemPublicViewIndicator}" property="newPurchasingItemLine.itemPublicViewIndicator" tabindexOverride="${tabindexOverrideBase + 0}" />
					</div>
				</td>	
					<td class="infoline">
				    <kul:htmlControlAttribute attributeEntry="${itemAttributes.categoryId}" property="newPurchasingItemLine.categoryId"   tabindexOverride="${tabindexOverrideBase + 0}"/>
			    </td>
			    <td class="infoline">
				    <kul:htmlControlAttribute attributeEntry="${itemAttributes.formatTypeId}" property="newPurchasingItemLine.formatTypeId" extraReadOnlyProperty="newPurchasingItemLine.formatType.format"  tabindexOverride="${tabindexOverrideBase + 0}"/>
			    </td>
			    
			    <td class="infoline">
				    <kul:htmlControlAttribute attributeEntry="${itemAttributes.itemPriceSourceId}" property="newPurchasingItemLine.itemPriceSourceId" extraReadOnlyProperty="newPurchasingItemLine.itemPriceSource.itemPriceSource"  tabindexOverride="${tabindexOverrideBase + 0}"/>
			    </td>
			    <td class="infoline">
				    <kul:htmlControlAttribute attributeEntry="${itemAttributes.requestSourceTypeId}" property="newPurchasingItemLine.requestSourceTypeId" extraReadOnlyProperty="newPurchasingItemLine.formatType.format"  tabindexOverride="${tabindexOverrideBase + 0}"/>
			    </td>	
		...
		<tr>
			<td colspan="${mainColumnCount+20}" class="subhead">
        ...
        <c:if test="${!lockB2BEntry and hasLineItems or lockB2BEntry and hasItems}">
			<tr>
				...
				<kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.itemListPrice}" />
				<kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.itemDiscount}" />
				<kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.itemDiscountType}" />
				...
				<c:if test="${isATypeOfPODoc}">
                    ...
                    <kul:htmlAttributeHeaderCell literalLabel="Amount Paid" colspan="${colSpanAction+3}"/>
                </c:if>
                <c:if test="${!isATypeOfPODoc}">
                    <kul:htmlAttributeHeaderCell literalLabel="Actions" colspan="${colSpanAction}"/>
                </c:if>
		...
		<logic:iterate indexId="ctr" name="KualiForm" property="document.items" id="itemLine">
			<c:if test="${itemLine.itemType.lineItemIndicator == true}">
				...
				<tr>
					<td colspan="${mainColumnCount+30}" class="tab-subhead" style="border-right: none;">
					    Item ${ctr+1}
					</td>
				</tr>
				...
				<tr>
					<td class="infoline" nowrap="nowrap" rowspan="5">	    
				  ...
				  <c:if test="${not KualiForm.document.vendorDetail.vendorHeader.vendorForeignIndicator}">	
					     <c:if test="${KualiForm.document.items[ctr].oleRequestSourceType.requestSourceType !='BATCHINGEST'}">
	               ...
	               <c:if test="${KualiForm.document.items[ctr].oleRequestSourceType.requestSourceType =='BATCHINGEST'}">
					...
					<td class="infoline" rowspan="1" colspan="${colSpanAction}">
					    <div align="center">				
					    	<c:choose>		    	
					...
					<c:if test="${isATypeOfPODoc}">
					    <td class="infoline" rowspan="1" colspan="3">
					        <div align="right">
					        <kul:htmlControlAttribute
				...
				<tr>
					...
					<td class="infoline" colspan="3">
				         <div align="right">
				             <kul:htmlControlAttribute
				              attributeEntry="${itemAttributes.itemTitle}"
				              property="document.item[${ctr}].itemTitle"
				              readOnly="${false}" 
				              tabindexOverride="${tabindexOverrideBase + 0}"/>
				      	</div>
				     </td>
					<td class="infoline">
				     ...
				     <td class="infoline" colspan="3">
				         <div align="right">
				             <kul:htmlControlAttribute
				              attributeEntry="${itemAttributes.itemAuthor}"
				              property="document.item[${ctr}].itemAuthor"
				              readOnly="${false}" 
				              tabindexOverride="${tabindexOverrideBase + 0}"/>
				      	</div>
				     </td>
				     ...
				     <td class="infoline" colspan="3">
				        <div align="right">
				            <c:if test="${not empty KualiForm.document.items[ctr].requestorId}">
				             <kul:inquiry boClassName="org.kuali.ole.select.businessobject.OleRequestor"
                                          keyValues="requesortId=${KualiForm.document.items[ctr].requestorId}" render="true">
				            <kul:htmlControlAttribute
				           ...
				           <select:perreqlookup boClassName="org.kuali.ole.select.businessobject.OlePersonRequestor"  
				              fieldConversions="internalRequestorId:document.item[${ctr}].internalRequestorId,externalRequestorId:document.item[${ctr}].requestorId,name:document.item[${ctr}].requestorFirstName" />
				            
				            </c:if>
				            <c:if test="${empty KualiForm.document.items[ctr].requestorId}">
				             	<c:if test="${not empty KualiForm.document.items[ctr].requestorFirstName}">
				             	  <kul:inquiry boClassName="org.kuali.rice.kim.api.identity.Person" keyValues="principalId=${KualiForm.document.items[ctr].internalRequestorId}" render="true">
				             	     <kul:htmlControlAttribute
							              attributeEntry="${itemAttributes.requestorFirstName}"
							              property="document.item[${ctr}].requestorFirstName"
							              readOnly="${true}"
				...
				<tr>
					...
					<kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.categoryId}"/>
					...
					<kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.formatTypeId}"/>
					<td class="infoline" colspan="1">
					    <kul:htmlControlAttribute
					...
					<kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.itemPriceSourceId}"/>
					<td class="infoline" colspan="1">
					    <kul:htmlControlAttribute
					...
					<kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.requestSourceTypeId}"/>
						<td class="infoline" colspan="1">
					    <kul:htmlControlAttribute
