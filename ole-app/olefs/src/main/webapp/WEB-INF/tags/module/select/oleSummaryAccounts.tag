...
<kul:tab tabTitle="Account Summary" defaultOpen="${intialOpen}" tabErrorKey="${PurapConstants.ACCOUNT_SUMMARY_TAB_ERRORS}">
				...
				<logic:iterate id="summaryAccount" name="KualiForm" property="summaryAccounts" indexId="ctr">		
					...
					<tr>
						<td class="datacell center">
							<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.Chart" keyValues="chartOfAccountsCode=${summaryAccount.account.chartOfAccountsCode}" render="true">
								<bean:write name="KualiForm" property="summaryAccounts[${ctr}].account.chartOfAccountsCode"/>
							</kul:inquiry>
							&nbsp;
						</td>
						<td class="datacell center">
							<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.Account" keyValues="chartOfAccountsCode=${summaryAccount.account.chartOfAccountsCode}&accountNumber=${summaryAccount.account.accountNumber}" render="true">
								<bean:write name="KualiForm" property="summaryAccounts[${ctr}].account.accountNumber"/>
							</kul:inquiry>
							&nbsp;
						</td>
						<td class="datacell center">
							<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.SubAccount" keyValues="chartOfAccountsCode=${summaryAccount.account.chartOfAccountsCode}&accountNumber=${summaryAccount.account.accountNumber}&subAccountNumber=${summaryAccount.account.subAccountNumber}" render="true">
						...
						<td class="datacell center">
						    <c:choose>
  						        <c:when test="${KualiForm.document.inquiryRendered}">
							        <kul:inquiry boClassName="org.kuali.ole.coa.businessobject.ObjectCode" keyValues="financialObjectCode=${summaryAccount.account.financialObjectCode}&chartOfAccountsCode=${summaryAccount.account.chartOfAccountsCode}&universityFiscalYear=${KualiForm.document.postingYear}" render="true">
						...
						<td class="datacell center">
							<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.ProjectCode" keyValues="projectCode=${summaryAccount.account.projectCode}" render="true">
