...
<kul:tab tabTitle="Apply to Invoice Detail" defaultOpen="true"
	tabErrorKey="${OLEConstants.PaymentApplicationTabErrorCodes.APPLY_TO_INVOICE_DETAIL_TAB}">
	<div class="tab-container" align="center">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="datatable">
			<tr>
				...
				<td>
					...
					<c:if test="${readOnly ne true}">
						<kul:lookup
							boClassName="org.kuali.ole.module.ar.businessobject.Customer"
			...
			<tr>
				...
				<td>
					<kul:checkErrors keyMatch="${OLEConstants.PaymentApplicationTabErrorCodes.APPLY_TO_INVOICE_DETAIL_TAB}"/>
					<c:choose>						
