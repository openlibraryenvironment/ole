...
<c:set var="nonInvoicedAddLine" value="${KualiForm.nonInvoicedAddLine}" scope="request" />
    ...
    <kul:tab tabTitle="Non-AR" defaultOpen="true"
        tabErrorKey="${OLEConstants.PaymentApplicationTabErrorCodes.NON_AR_TAB}">
				...
				<c:if test="${readOnly ne true}">
	                <tr>
	                    ...
	                    <td>
	                        ...
	                        <kul:lookup boClassName="org.kuali.ole.coa.businessobject.SubAccount" 
	                            autoSearch="true"
	                    ...
	                    <td>
	                        ...
	                        <kul:lookup boClassName="org.kuali.ole.coa.businessobject.SubObjectCode" 
	                            autoSearch="true"
	                    ...
	                    <td>
	                        ...
	                        <kul:lookup boClassName="org.kuali.ole.coa.businessobject.ProjectCode" 
	                            autoSearch="true"
