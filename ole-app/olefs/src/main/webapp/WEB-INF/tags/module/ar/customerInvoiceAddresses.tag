...
<kul:tab tabTitle="Billing/Shipping" defaultOpen="true" tabErrorKey="${OLEConstants.CUSTOMER_INVOICE_DOCUMENT_ADDRESS}">
			...
			<tr>
				...
				<td align=left valign=middle class="datacell" style="width: 25%;">
					...
					<c:if test="${not readOnly}">
					    &nbsp;
					    <kul:lookup boClassName="org.kuali.ole.module.ar.businessobject.CustomerAddress"
