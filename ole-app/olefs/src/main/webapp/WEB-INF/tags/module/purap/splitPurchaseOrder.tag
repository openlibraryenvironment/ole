...
<kul:tabTop tabTitle="Split a PO" defaultOpen="false" tabErrorKey="${PurapConstants.SPLIT_PURCHASE_ORDER_TAB_ERRORS}">
    ...
    <div class="tab-container" align=center>
        ...
        <table cellpadding="0" cellspacing="0" class="datatable" summary="Splitting Item Selection">
        	<tr>
				...
				<kul:htmlAttributeHeaderCell attributeEntry="${itemAttributes.vendorItemPoNumber}" />
       				...
       				<tr>
						...
						<td class="datacell">
						    <kul:htmlControlAttribute
							    ...
							    property="document.item[${ctr}].vendorItemPoNumber" readOnly="true" />
					    </td>
					    <td class="datacell">
					    	<kul:htmlControlAttribute 
