			...
			<table cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td align=left class="${cssClass}">&nbsp				
						...
						<kul:lookup boClassName="org.kuali.ole.module.cam.businessobject.AssetCondition" fieldConversions="assetConditionCode:document.currentConditionCode"
					...
					<td align=left class="${cssClass}">&nbsp
						...
						<kul:lookup boClassName="org.kuali.ole.module.cam.businessobject.AssetCondition" fieldConversions="assetConditionCode:document.newConditionCode"
