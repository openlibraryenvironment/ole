...
<%@ attribute name="assetValue" type="org.kuali.ole.module.cam.businessobject.Asset" required="false" description="Asset object value" %>
		    ...
		    <tr>
		      	...
		      	<td class="grid" width="75%" colspan="3">
		      		<kul:htmlControlAttribute property="${assetValueObj}.capitalAssetNumber" attributeEntry="${assetAttributes.capitalAssetNumber}" readOnly="true" readOnlyBody="true">
						<kul:inquiry boClassName="org.kuali.ole.module.cam.businessobject.Asset" keyValues="capitalAssetNumber=${assetValue.capitalAssetNumber}" render="true">
			...
			<tr>
				...
				<td class="grid" width="25%">
					<kul:htmlControlAttribute property="${assetValueObj}.organizationOwnerChartOfAccountsCode" attributeEntry="${assetAttributes.organizationOwnerChartOfAccountsCode}" readOnly="true" readOnlyBody="true">								
		      			<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.Chart" keyValues="chartOfAccountsCode=" render="true">
				...
				<td class="grid" width="25%">
					<kul:htmlControlAttribute property="${assetValueObj}.organizationOwnerAccountNumber" attributeEntry="${assetAttributes.organizationOwnerAccountNumber}" readOnly="true" readOnlyBody="true">								
						<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.Account" keyValues="chartOfAccountsCode=${assetValue.organizationOwnerChartOfAccountsCode}&amp;accountNumber=${assetValue.organizationOwnerAccountNumber}" render="true">
			...
			<tr>
				...
				<td class="grid" width="25%">
					<kul:htmlControlAttribute property="${assetValueObj}.agencyNumber" attributeEntry="${assetAttributes.agencyNumber}" readOnly="true" readOnlyBody="true">								
						<kul:inquiry boClassName="org.kuali.ole.module.cg.businessobject.Agency" keyValues="agencyNumber=${assetValue.agencyNumber}" render="true">
		        ...
		        <th class="grid" width="25%" align="right"><kul:htmlAttributeLabel attributeEntry="${assetAttributes.organizationCode}" readOnly="true" /></th>
	   	        <td class="grid" width="25%">
	   	        	<kul:htmlControlAttribute property="${assetValueObj}.organizationOwnerAccount.organizationCode" attributeEntry="${assetAttributes['organizationOwnerAccount.organizationCode']}" readOnly="true" readOnlyBody="true"> 
						<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.Account" keyValues="chartOfAccountsCode=${assetValue.organizationOwnerChartOfAccountsCode}&amp;accountNumber=${assetValue.organizationOwnerAccountNumber}&amp;organizationCode=${assetValue.organizationOwnerAccount.organizationCode}" render="true">
			...
			<tr>
				...
				<td class="grid" width="25%">
	   	        	<kul:htmlControlAttribute property="${assetValueObj}.inventoryStatusCode" attributeEntry="${assetAttributes.inventoryStatusCode}" readOnly="true" readOnlyBody="true"> 
						<kul:inquiry boClassName="org.kuali.ole.module.cam.businessobject.AssetStatus" keyValues="inventoryStatusCode=${assetValue.inventoryStatusCode}" render="true">
				...
				<td class="grid" width="25%">
	   	        	<kul:htmlControlAttribute property="${assetValueObj}.conditionCode" attributeEntry="${assetAttributes.conditionCode}" readOnly="true" readOnlyBody="true"> 
						<kul:inquiry boClassName="org.kuali.ole.module.cam.businessobject.AssetCondition" keyValues="assetConditionCode=${assetValue.conditionCode}" render="true">
			...
			<tr>
				...
				<td class="grid" width="25%">
	   	        	<kul:htmlControlAttribute property="${assetValueObj}.acquisitionTypeCode" attributeEntry="${assetAttributes.acquisitionTypeCode}" readOnly="true" readOnlyBody="true"> 
						<kul:inquiry boClassName="org.kuali.ole.module.cam.businessobject.AssetAcquisitionType" keyValues="acquisitionTypeCode=${assetValue.acquisitionTypeCode}" render="true">
				...
				<td class="grid" width="25%">
	   	        	<kul:htmlControlAttribute property="${assetValueObj}.capitalAssetTypeCode" attributeEntry="${assetAttributes.capitalAssetTypeCode}" readOnly="true" readOnlyBody="true"> 
						<kul:inquiry boClassName="org.kuali.ole.module.cam.businessobject.AssetType" keyValues="capitalAssetTypeCode=${assetValue.capitalAssetTypeCode}" render="true">
			...
			<tr>
				...
				<td class="grid" width="25%">
	   	        	<kul:htmlControlAttribute property="${assetValueObj}.financialDocumentPostingYear" attributeEntry="${assetAttributes.financialDocumentPostingYear}" readOnly="true" readOnlyBody="true"> 
						<kul:inquiry boClassName="org.kuali.ole.sys.businessobject.SystemOptions" keyValues="universityFiscalYear=${assetValue.financialDocumentPostingYear}" render="true">
			...
			<tr>
				...
				<td class="grid" width="25%">
	   	        	<kul:htmlControlAttribute property="${assetValueObj}.financialDocumentPostingPeriodCode" attributeEntry="${assetAttributes.financialDocumentPostingPeriodCode}" readOnly="true" readOnlyBody="true"> 
						<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.AccountingPeriod" keyValues="universityFiscalYear=${assetValue.financialDocumentPostingYear}&amp;universityFiscalPeriodCode=${assetValue.financialDocumentPostingPeriodCode}" render="true">
