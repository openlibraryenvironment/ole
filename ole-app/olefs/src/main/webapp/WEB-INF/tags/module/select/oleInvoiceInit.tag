...
<%@ attribute name="displayInvoiceInitFields" required="false"
              description="Boolean to indicate if PO specific fields should be displayed" %>

<kul:tabTop tabTitle="Invoice Initiation" defaultOpen="true" tabErrorKey="*">
	
	

    <div class="tab-container" align=center>
            <h3>Invoice Initiation</h3>

        <table cellpadding="0" cellspacing="0" class="datatable" summary="Invoice Initiation Section">
            ...
            <tr>
                ...
                <th align=right valign=middle class="bord-l-b">
                   <div align="right"><kul:htmlAttributeLabel  attributeEntry="${documentAttributes.foreignVendorInvoiceAmount}" /></div>
                </th>
                <td align=left valign=middle class="datacell">
                   <kul:htmlControlAttribute 
                   		attributeEntry="${documentAttributes.foreignVendorInvoiceAmount}" property="document.foreignVendorInvoiceAmount" /><br/>
                </td>
