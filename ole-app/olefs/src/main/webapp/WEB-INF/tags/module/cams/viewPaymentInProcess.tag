...
<%@ attribute name="assetPaymentAssetDetail" type="org.kuali.ole.module.cam.businessobject.AssetPaymentAssetDetail" required="true" description="Asset payment in process list" %>
