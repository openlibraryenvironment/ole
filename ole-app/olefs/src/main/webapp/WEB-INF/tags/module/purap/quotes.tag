	...
	<table cellpadding="0" cellspacing="0" class="datatable" summary="Quotes Section">			
		...
		<tr>
			<td colspan="4" class="subhead">
				...
				<span class="subhead-right">
					<html:image property="methodToCall.performLookup.(!!org.kuali.ole.module.purap.businessobject.PurchaseOrderQuoteList!!).(((purchaseOrderQuoteListIdentifier:document.purchaseOrderQuoteListIdentifier)))" 
