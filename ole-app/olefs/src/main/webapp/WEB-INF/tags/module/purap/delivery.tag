...
<kul:tab tabTitle="Delivery" defaultOpen="${intialOpen}" tabErrorKey="${PurapConstants.DELIVERY_TAB_ERRORS}">
            ...
            <tr>
                ...
                <td align=left valign=middle class="datacell">
                    ...
                    <c:if test="${(fullEntryMode or amendmentEntry) && !deliveryReadOnly}">
                        <kul:lookup boClassName="org.kuali.ole.vnd.businessobject.CampusParameter"
            ...
            <tr>
                ...
                <td align=left valign=middle class="datacell">
                    <kul:htmlControlAttribute 
                        ...
                        <!-- MSU Contribution DTT-330 OLEMI-8582 OLECNTRB-943 -->
                        <c:if test="${hasErrors}">
              				<kul:fieldShowErrorIcon />
            			</c:if>
                    <c:if test="${(fullEntryMode or amendmentEntry) && !deliveryReadOnly}">
                        <kul:lookup boClassName="org.kuali.ole.sys.businessobject.Building"
                            lookupParameters="document.deliveryCampusCode:campusCode"
			...
			<tr>
                ...
                <td align=left valign=middle class="datacell">
			        ...
			        <c:if test="${(fullEntryMode or amendmentEntry) && !deliveryReadOnly && notOtherDeliveryBuilding && (not empty KualiForm.document.deliveryBuildingCode)}">
			            <kul:lookup boClassName="org.kuali.ole.sys.businessobject.Room" 
			...
			<tr>
                ...
                <td align=left valign=middle class="datacell">
                    <c:if test="${fullEntryMode || amendmentEntry}" > 
                    	<kul:lookup boClassName="org.kuali.ole.module.purap.businessobject.ReceivingAddress"
