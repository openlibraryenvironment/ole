...
<c:if test="${empty intialOpen}">
    <c:set var="intialOpen" value="false" />
</c:if>
...
<kul:tab tabTitle="General Ledger Pending Entries" defaultOpen="${intialOpen}" tabErrorKey="${OLEConstants.GENERAL_LEDGER_PENDING_ENTRIES_TAB_ERRORS}">
<div class="tab-container" align=center>
		<h3>General Ledger Pending Entries <kul:lookup boClassName="org.kuali.ole.sys.businessobject.GeneralLedgerPendingEntry" lookupParameters="document.documentNumber:documentNumber" hideReturnLink="true" suppressActions="true"/></h3>
          ...
          <!--  END RSMART CUSTOMIZATION -->
			<tr>
				...
				<td class="datacell center">
					<kul:inquiry boClassName="org.kuali.ole.sys.businessobject.SystemOptions" keyValues="universityFiscalYear=${generalLedgerPendingEntry.universityFiscalYear}" render="true">
            <html:hidden property="${generalLedgerPendingEntryProperty}[${ctr}].universityFiscalYear" value="${generalLedgerPendingEntry.universityFiscalYear}" write="true" />
				...
				<td class="datacell center">
					<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.Chart" keyValues="chartOfAccountsCode=${generalLedgerPendingEntry.chartOfAccountsCode}" render="true">
				...
				<td class="datacell center">
					<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.Account" keyValues="chartOfAccountsCode=${generalLedgerPendingEntry.chartOfAccountsCode}&accountNumber=${generalLedgerPendingEntry.accountNumber}" render="true">
				...
				<td class="datacell center">
					<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.SubObjCd" keyValues="financialSubObjectCode=${generalLedgerPendingEntry.financialSubObjectCode}&financialObjectCode=${generalLedgerPendingEntry.financialObjectCode}&chartOfAccountsCode=${generalLedgerPendingEntry.chartOfAccountsCode}&universityFiscalYear=${generalLedgerPendingEntry.universityFiscalYear}" render="${ ! generalLedgerPendingEntry.financialSubObjectCodeBlank}">
				...
				<td class="datacell center">
					<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.ProjectCode" keyValues="code=${generalLedgerPendingEntry.projectCode}" render="${ ! generalLedgerPendingEntry.projectCodeBlank}">
				...
				<td class="datacell center">
					<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.BalanceType" keyValues="code=${generalLedgerPendingEntry.financialBalanceTypeCode}" render="true">
				...
				<td class="datacell center">
					<kul:inquiry boClassName="org.kuali.ole.coa.businessobject.ObjectType" keyValues="code=${generalLedgerPendingEntry.financialObjectTypeCode}" render="${ ! generalLedgerPendingEntry.financialObjectTypeCodeBlank}">
