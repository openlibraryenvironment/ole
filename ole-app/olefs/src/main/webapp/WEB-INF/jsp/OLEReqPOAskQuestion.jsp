...
<kul:page showDocumentInfo="false"
          headerTitle="${KualiForm.title}" docTitle=""
          transactionalDocument="false" htmlFormAction="oleReqPOAskQuestion"
          errorKey="*">
    ...
    <br>
    <div align="center">
            ${KualiForm.questionText}
    </div>
    <br>

    <c:if test="${KualiForm.showReasonField}">
        <div class="topblurb">
            <div align=center>
                <table cellpadding=0 class="container2">
                    <tr>
                        <td>
                            <div align=left><font color="red">*</font>&nbsp;&nbsp;Cancellation Reason:</div>
                        </td>
                        <td>
                            <html:select property="cancellationReason" styleId="cancellationReason" title="Cancellation Reason">
                                <html:optionsCollection property="actionFormUtilMap.getOptionsMap~org|kuali|ole|select|businessobject|options|OLECancellationReasonValueFinder" label="value" value="key"/>
                            </html:select>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div align=left>&nbsp;&nbsp;Please enter the reason:</div>
                        </td>
                        <td>
                ...
                <tr>
                    <td>
                        <div id="globalbuttons"><c:forEach
                                items="${KualiForm.buttons}" var="button"
                                varStatus="status">
                            <html:image
