...
;(function (window, undefined) {
    ...
    $.fn.tableExport = function (options) {
        ...
        return this.each(function () {
            ...
            function createButton(dataURL, myFile, myContent, myClass) {
                var exportButton = "<a href='" + dataURL + "' download='" + myFile + "' role='button' class='" + bootstrapClass + bootstrapTheme + myClass + "'style='float: right; width: 15px; height: 22px; padding: 3px 5px;'" +"'>" + myContent + "</a>";
    ...
    $.fn.tableExport.defaults = {
        ...
        formats: ["csv", "xls"],           // (String[]), filetype for the export, (default: ["xls", "csv", "txt"])
    ...
    $.fn.tableExport.defaultFileName = "export";

    $.fn.tableExport.defaultButton = "DTTT_button";

    $.fn.tableExport.bootstrap = ["DTTT_button", "DTTT_button_text", ""];
