...
/
INSERT INTO KRIM_ROLE_T (ACTV_IND,DESC_TXT,KIM_TYP_ID,LAST_UPDT_DT,NMSPC_CD,OBJ_ID,ROLE_ID,ROLE_NM,VER_NBR)
  VALUES ('Y','This role maintains KRMS agendas and rules.','1',TO_DATE( '20120131160404', 'YYYYMMDDHH24MISS' ),'KR-RULE','B7DBFABEFD2D8CBFE0402E0AA9D757C9','98','Kuali Rules Management System Administrator',1)
/
INSERT INTO KRIM_ROLE_T (ACTV_IND,DESC_TXT,KIM_TYP_ID,LAST_UPDT_DT,NMSPC_CD,OBJ_ID,ROLE_ID,ROLE_NM,VER_NBR)
  VALUES ('Y','This role derives its members from users with the Route Document permission for a given document type.','76',TO_DATE( '20120412212324', 'YYYYMMDDHH24MISS' ),'KR-WKFLW','BD82F716EFEFF706E0402E0AA9D70A27','99','Document Router',1)
/
