...
/
INSERT INTO KRIM_PERM_T (ACTV_IND,DESC_TXT,NM,NMSPC_CD,OBJ_ID,PERM_ID,PERM_TMPL_ID,VER_NBR)
  VALUES ('Y','Allows users to access the XML Ingester screen.','Use Screen XML Ingester Screen','KR-WKFLW','606763510FF296D3E0404F8189D857A2','265','29',1)
/
INSERT INTO KRIM_PERM_T (ACTV_IND,DESC_TXT,NM,NMSPC_CD,OBJ_ID,PERM_ID,PERM_TMPL_ID,VER_NBR)
...
/
INSERT INTO KRIM_PERM_T (ACTV_IND,DESC_TXT,NM,NMSPC_CD,OBJ_ID,PERM_ID,PERM_TMPL_ID,VER_NBR)
  VALUES ('Y','Allows use of the cache administration screen','Use Cache Adminstration Screen','KR-SYS','B6FDEDA86F967F26E0402E0AA9D728AF','842','29',1)
/
INSERT INTO KRIM_PERM_T (ACTV_IND,DESC_TXT,NM,NMSPC_CD,OBJ_ID,PERM_ID,PERM_TMPL_ID,VER_NBR)
  VALUES ('Y','Allows creation and modification of agendas via the agenda editor','Maintain KRMS Agenda','KR-RULE-TEST','B7DBFABEFD2B8CBFE0402E0AA9D757C9','843','52',1)
/
INSERT INTO KRIM_PERM_T (ACTV_IND,DESC_TXT,NM,NMSPC_CD,OBJ_ID,PERM_ID,PERM_TMPL_ID,VER_NBR)
  VALUES ('Y','Allows user to create a new Term maintainence document','Create Term Maintenance Document','KR-NS','0dbce939-4f22-4e9b-a4bb-1615c0f411a2','844','42',1)
/
INSERT INTO KRIM_PERM_T (ACTV_IND,DESC_TXT,NM,NMSPC_CD,OBJ_ID,PERM_ID,PERM_TMPL_ID,VER_NBR)
  VALUES ('Y','Allows user to create a new Context maintainence document','Create Context Maintenance Document','KR-NS','cefeed6d-b5e2-40aa-9034-137db317b532','845','42',1)
/
INSERT INTO KRIM_PERM_T (ACTV_IND,DESC_TXT,NM,NMSPC_CD,OBJ_ID,PERM_ID,PERM_TMPL_ID,VER_NBR)
  VALUES ('Y','Allows user to create a new TermSpecification maintainence document','Create TermSpecification Maintenance Document','KR-NS','02bd9acd-48d9-4fec-acbd-6a441c5ea8c2','846','42',1)
/
INSERT INTO KRIM_PERM_T (ACTV_IND,NM,NMSPC_CD,OBJ_ID,PERM_ID,PERM_TMPL_ID,VER_NBR)
  VALUES ('Y','Recall Document','KR-WKFLW','BD74D7B702AB02CEE0402E0AA9D75B2D','847','68',1)
/
INSERT INTO KRIM_PERM_T (ACTV_IND,DESC_TXT,NM,NMSPC_CD,OBJ_ID,PERM_ID,PERM_TMPL_ID,VER_NBR)
  VALUES ('Y','Authorizes users to send Complete ad hoc requests for Kuali Documents','Send Complete Request Kuali Document','KR-SYS','BFCADCB34017249AE0402E0AA9D7065D','848','49',1)
/
INSERT INTO KRIM_PERM_T (ACTV_IND,DESC_TXT,NM,NMSPC_CD,OBJ_ID,PERM_ID,PERM_TMPL_ID,VER_NBR)
  VALUES ('Y','Allows users to edit Kuali documents that are in INITIATED status.','Edit Kuali ENROUTE Document Route Status Code I','KUALI','E3EF4C83B4BB5C9EE0406E0AC31D4562','KR1001','16',1)
/
INSERT INTO KRIM_PERM_T (ACTV_IND,DESC_TXT,NM,NMSPC_CD,OBJ_ID,PERM_ID,PERM_TMPL_ID,VER_NBR)
  VALUES ('Y','Allows users to edit Kuali documents that are in SAVED status.','Edit Kuali ENROUTE Document Route Status Code S','KUALI','E3EF4C83B4BF5C9EE0406E0AC31D4562','KR1002','16',1)
/
