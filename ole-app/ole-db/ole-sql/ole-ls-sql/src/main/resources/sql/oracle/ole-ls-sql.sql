...
(
      ACC_ACT_ID VARCHAR2(10)
        , OBJ_ID VARCHAR2(36)
        , VER_NBR NUMBER(8)
        , WRK_FLW_NAME VARCHAR2(40)
        , APPROVAL_TYPE VARCHAR2(40)
        , WRK_FLW_STATUS VARCHAR2(40)
        , ROW_ACT_IND VARCHAR2(1) default 'Y'
...
(
      CIR_HIS_REC_ID VARCHAR2(40)
        ...
        , CIR_POLICY_ID VARCHAR2(40) NOT NULL
        ...
        , CHECK_IN_DT_TIME TIMESTAMP NOT NULL
...
(
      OLE_RQST_HSTRY_ID VARCHAR2(40)
        ...
        , OLE_LOAN_ID VARCHAR2(80) NOT NULL
        ...
        , ARCH_DT_TIME VARCHAR2(80) NOT NULL
        , OBJ_ID VARCHAR2(36) NOT NULL
        , VER_NBR NUMBER(8) NOT NULL
...
CREATE INDEX OLE_E_RES_REC_FK2 
  ON OLE_E_RES_REC_T 
  (ACC_TYP_ID)
/
CREATE INDEX OLE_E_RES_REC_FK3 
  ON OLE_E_RES_REC_T 
  (AUTHCAT_TYP_ID)
/
...
(
      DONOR_ID VARCHAR2(10)
        ...
        , DONOR_PUBLIC_DISPLAY VARCHAR2(100)
...
DECLARE temp NUMBER;
BEGIN
	SELECT COUNT(*) INTO temp FROM user_tables WHERE table_name = 'OLE_LOAN_INTRANSIT_HISTORY_T';
	IF temp > 0 THEN EXECUTE IMMEDIATE 'DROP TABLE OLE_LOAN_INTRANSIT_HISTORY_T CASCADE CONSTRAINTS PURGE'; END IF;
END;
/
...
ALTER TABLE OLE_LOAN_INTRANSIT_HISTORY_T
    ADD CONSTRAINT OLE_LOAN_INTRANSIT_HISTORY_P1
PRIMARY KEY (ID)
/
...
SELECT TIPP.GOKB_TIPP_ID,TIPP.TIPP_STATUS,TITLE.GOKB_TITLE_ID,TITLE.TITLE_NAME,TITLE.PUBLSHR_ID,PACKAGE.GOKB_PKG_ID,PACKAGE.PKG_STATUS,PACKAGE.PKG_NAME,PLATFORM.GOKB_PLTFRM_ID,PLATFORM.PLTFRM_NAME,PLATFORM.PLTFRM_STATUS,PLATFORM.SOFTWARE_PLTFRM,ORG.GOKB_ORG_ID,ORG.ORG_NAME FROM  OLE_GOKB_TIPP_T TIPP, OLE_GOKB_PLTFRM_T PLATFORM, OLE_GOKB_ORG_T ORG, OLE_GOKB_TITLE_T TITLE, OLE_GOKB_PKG_T PACKAGE WHERE TIPP.GOKB_PLTFRM_ID=PLATFORM.GOKB_PLTFRM_ID AND TIPP.GOKB_PKG_ID=PACKAGE.GOKB_PKG_ID AND TIPP.GOKB_TITLE_ID=TITLE.GOKB_TITLE_ID AND PLATFORM.PLTFRM_PRVDR_ID=ORG.GOKB_ORG_ID
/
...
DECLARE temp NUMBER;
BEGIN
	SELECT COUNT(*) INTO temp FROM user_sequences WHERE sequence_name = 'OLE_LOAN_INTRANSIT_HISTORY_S';
	IF temp > 0 THEN EXECUTE IMMEDIATE 'DROP SEQUENCE OLE_LOAN_INTRANSIT_HISTORY_S'; END IF;
END;
/

CREATE SEQUENCE OLE_LOAN_INTRANSIT_HISTORY_S INCREMENT BY 1 START WITH 1 NOMAXVALUE NOCYCLE NOCACHE ORDER
/
...
CREATE SEQUENCE ALRT_DOC_TYP_S INCREMENT BY 1 START WITH 1 NOMAXVALUE NOCYCLE NOCACHE ORDER
/
