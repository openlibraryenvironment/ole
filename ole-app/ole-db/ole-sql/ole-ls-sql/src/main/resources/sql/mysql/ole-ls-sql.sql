...
(
      ACC_ACT_ID VARCHAR(10)
        , OBJ_ID VARCHAR(36)
        , VER_NBR DECIMAL(8)
        , WRK_FLW_NAME VARCHAR(40)
        , APPROVAL_TYPE VARCHAR(40)
        , WRK_FLW_STATUS VARCHAR(40)
        , ROW_ACT_IND VARCHAR(1) default 'Y'
...
(
      OLE_RQST_HSTRY_ID VARCHAR(40)
        ...
        , OLE_LOAN_ID VARCHAR(80) NOT NULL
        ...
        , ARCH_DT_TIME VARCHAR(80) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) NOT NULL
...
, INDEX OLE_E_RES_REC_FK2 (ACC_TYP_ID )
    
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
                                    
, INDEX OLE_E_RES_REC_FK3 (AUTHCAT_TYP_ID )
...
(
      DONOR_ID VARCHAR(10)
        ...
        , DONOR_PUBLIC_DISPLAY VARCHAR(100)
...
/
ALTER TABLE ALRT_DOC_TYP_S auto_increment = 1
/
