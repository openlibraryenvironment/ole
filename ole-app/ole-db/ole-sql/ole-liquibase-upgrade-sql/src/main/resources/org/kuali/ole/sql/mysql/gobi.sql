...
CREATE TABLE GOBI_ADDR_MAPR_T (ID INT NULL, SUB_ACCOUNT VARCHAR(100) NULL, BUILDING_CODE VARCHAR(100) NULL, ROOM_NUMBER VARCHAR(100) NULL, VER_NBR DECIMAL(8) NULL, OBJ_ID VARCHAR(36) NULL)
/
...
ALTER TABLE GOBI_ADDR_MAPR_T ADD PRIMARY KEY (ID)
/
...
CREATE TABLE GOBI_ADDR_MAPR_S (ID BIGINT(19) NULL)
/

ALTER TABLE GOBI_ADDR_MAPR_S ADD PRIMARY KEY (ID)
/

ALTER TABLE GOBI_ADDR_MAPR_S MODIFY ID BIGINT(19) AUTO_INCREMENT
/
