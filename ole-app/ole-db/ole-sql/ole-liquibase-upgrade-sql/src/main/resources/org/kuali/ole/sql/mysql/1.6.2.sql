...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('KRCR_PARM_T_UPDATE_CMPNT_CD', 'ole', 'org/kuali/ole/1.6.2/db.changelog-20150731.xml', NOW(), 26, '7:8c2bd8f6ac52cf1ee7611dfa5fdfdc3a', 'update', '', 'EXECUTED', '3.2.0')
/
