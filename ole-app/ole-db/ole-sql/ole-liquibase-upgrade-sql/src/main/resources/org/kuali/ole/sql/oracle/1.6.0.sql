...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_LOAD_KRCR_PARM_T_oracle', 'ole', 'org/kuali/ole/1.6.0/db.changelog-20141207.xml', SYSTIMESTAMP, 1, '7:8577945a1f6a6977f3b3d4b0535a1c7b', 'loadData', '', 'EXECUTED', '3.2.0')
/
...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_DLVR_RQST_HSTRY_REC_T_ARCH_DT_TIME', 'ole', 'org/kuali/ole/1.6.0/db.changelog-20141207.xml', SYSTIMESTAMP, 24, '7:992d1bd4848aff4a05ab2e67dd15acf1', 'modifyDataType', '', 'EXECUTED', '3.2.0')
/

-- Changeset org/kuali/ole/1.6.0/db.changelog-20141207.xml::ole_dlvr_loan_t_dropIndex::ole
DROP INDEX ole.loan_itm_index
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('ole_dlvr_loan_t_dropIndex', 'ole', 'org/kuali/ole/1.6.0/db.changelog-20141207.xml', SYSTIMESTAMP, 25, '7:3f21021d193a26da8c15767110521929', 'dropIndex', '', 'EXECUTED', '3.2.0')
/

-- Changeset org/kuali/ole/1.6.0/db.changelog-20141207.xml::ole_dlvr_loan_t::ole
ALTER TABLE ole.ole_dlvr_loan_t ADD CONSTRAINT itm_id_const UNIQUE (itm_id) DEFERRABLE INITIALLY DEFERRED DISABLE
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('ole_dlvr_loan_t', 'ole', 'org/kuali/ole/1.6.0/db.changelog-20141207.xml', SYSTIMESTAMP, 26, '7:87bbf9c63e36f4de6238f2e70f9a56be', 'addUniqueConstraint', '', 'EXECUTED', '3.2.0')
/

-- Changeset org/kuali/ole/1.6.0/db.changelog-20141207.xml::OLE_DLVR_ADD_T::ole
ALTER TABLE ole.OLE_DLVR_ADD_T ADD PTRN_DLVR_ADD VARCHAR2(1)
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_DLVR_ADD_T', 'ole', 'org/kuali/ole/1.6.0/db.changelog-20141207.xml', SYSTIMESTAMP, 27, '7:5d253b0650f8b4fbd898b6e909370505', 'addColumn', '', 'EXECUTED', '3.2.0')
/

-- Changeset org/kuali/ole/1.6.0/db.changelog-20141207.xml::OLE_CRCL_DSK_T::ole
ALTER TABLE ole.OLE_CRCL_DSK_T ADD RQST_EXPIRTIN_DAYS DECIMAL(8)
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_CRCL_DSK_T', 'ole', 'org/kuali/ole/1.6.0/db.changelog-20141207.xml', SYSTIMESTAMP, 28, '7:a421ca771b016ca9dbbd19d2b326adbf', 'addColumn', '', 'EXECUTED', '3.2.0')
/
...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('PATRON_VIEW_ALTER', 'ole', 'org/kuali/ole/1.6.0/db.changelog-20141207.xml', SYSTIMESTAMP, 29, '7:cf968b369107076cef561114f1ce728f', 'createView', '', 'EXECUTED', '3.2.0')
/
