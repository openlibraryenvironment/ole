...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_LOAD_KRCR_PARM_T_FINE', 'ole', 'org/kuali/ole/1.5.6/db.changelog-20141105.xml', SYSTIMESTAMP, 1, '7:eb88b6346a822c1e8529f684eb387a5d', 'sql, loadData', '', 'EXECUTED', '3.2.0')
/

-- Changeset org/kuali/ole/1.5.6/db.changelog-20141105.xml::OLE_BAT_PRCS_MNTN_FIELD_T::ole
SELECT OLE_BAT_PRCS_MNTN_FIELD_S.NEXTVAL from dual
/
...
INSERT INTO OLE_BAT_PRCS_MNTN_FIELD_T (OLE_BAT_FIELD_ID,OLE_BAT_FIELD_DISPLY_NM,OLE_BAT_FIELD_NM,OLE_BAT_FIELD_TYP,ACT_IND,OBJ_ID,VER_NBR) VALUES (OLE_BAT_PRCS_MNTN_FIELD_S.NEXTVAL,'Bib Local Id From File','LocalId_display','String','Y','1','1')
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_BAT_PRCS_MNTN_FIELD_T', 'ole', 'org/kuali/ole/1.5.6/db.changelog-20141105.xml', SYSTIMESTAMP, 2, '7:b71d90b4920edaf26dadcae660113879', 'sql (x9)', '', 'EXECUTED', '3.2.0')
/
