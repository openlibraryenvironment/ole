...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_LOAD_KRCR_PARM_T_mysql', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', NOW(), 1, '7:5bc473232022812a7c0fae3c66cca237', 'sql, loadData', '', 'EXECUTED', '3.2.0')
/
...
--  Changeset org/kuali/ole/2.1/db.changelog-20151123.xml::OLE_NG_BAT_PRCS_T::ole
CREATE TABLE OLE_NG_BAT_PRCS_T (PROCESS_ID INT(10) NOT NULL, PROCESS_NAME VARCHAR(100) NULL, PROCESS_TYPE VARCHAR(40) NULL, PRF_ID INT(10) NULL, JOB_TYPE VARCHAR(40) NULL, CRON_EXP VARCHAR(100) NULL, CREATED_BY VARCHAR(40) NULL, CREATED_ON TIMESTAMP NULL, OBJ_ID VARCHAR(36) NULL, VER_NBR DECIMAL(8) NULL, CONSTRAINT PK_OLE_NG_BAT_PRCS_T PRIMARY KEY (PROCESS_ID))
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_PRCS_T', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', NOW(), 22, '7:9c8075272eabc5f0fb60f7d579b3f111', 'createTable', '', 'EXECUTED', '3.2.0')
/

--  Changeset org/kuali/ole/2.1/db.changelog-20151123.xml::OLE_NG_BAT_PRCS_S::ole
CREATE TABLE OLE_NG_BAT_PRCS_S (ID BIGINT(19) NOT NULL, CONSTRAINT PK_OLE_NG_BAT_PRCS_S PRIMARY KEY (ID))
/

ALTER TABLE OLE_NG_BAT_PRCS_S MODIFY ID BIGINT(19) AUTO_INCREMENT
/

ALTER TABLE OLE_NG_BAT_PRCS_S AUTO_INCREMENT=1
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_PRCS_S', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', NOW(), 23, '7:be23dbf52288c86d37d53fc862692bf2', 'createTable, addAutoIncrement', '', 'EXECUTED', '3.2.0')
/

--  Changeset org/kuali/ole/2.1/db.changelog-20151123.xml::OLE_NG_BAT_JOB_T::ole
CREATE TABLE OLE_NG_BAT_JOB_T (JOB_ID INT(10) NOT NULL, JOB_NAME VARCHAR(100) NULL, PROCESS_ID INT(10) NULL, PROCESS_TYPE VARCHAR(40) NULL, PROFILE_NAME VARCHAR(100) NULL, CREATED_BY VARCHAR(40) NULL, START_TIME TIMESTAMP NULL, END_TIME TIMESTAMP NULL, PER_COMPLETED VARCHAR(40) NULL, TIME_SPENT VARCHAR(40) NULL, TOTAL_RECORDS VARCHAR(40) NULL, TOTAL_RECORDS_PRCSD VARCHAR(40) NULL, STATUS VARCHAR(40) NULL, OBJ_ID VARCHAR(36) NULL, VER_NBR DECIMAL(8) NULL, CONSTRAINT PK_OLE_NG_BAT_JOB_T PRIMARY KEY (JOB_ID))
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_JOB_T', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', NOW(), 24, '7:5a63511f8371d5e371e5aa330b488f1c', 'createTable', '', 'EXECUTED', '3.2.0')
/

--  Changeset org/kuali/ole/2.1/db.changelog-20151123.xml::OLE_NG_BAT_JOB_S::ole
CREATE TABLE OLE_NG_BAT_JOB_S (ID BIGINT(19) NOT NULL, CONSTRAINT PK_OLE_NG_BAT_JOB_S PRIMARY KEY (ID))
/
...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_JOB_S', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', NOW(), 25, '7:81b0bd2b05ddef8932d41cd935a2d595', 'createTable, addAutoIncrement', '', 'EXECUTED', '3.2.0')
/

--  Changeset org/kuali/ole/2.1/db.changelog-20151123.xml::OLE_NG_BAT_PRF_ID_FK::ole
ALTER TABLE ole.OLE_NG_BAT_PRCS_T ADD CONSTRAINT OLE_NG_BAT_PRF_ID_FK FOREIGN KEY (PRF_ID) REFERENCES OLE_NG_BAT_PRF_T (PRF_ID) ON UPDATE RESTRICT ON DELETE CASCADE
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_PRF_ID_FK', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', NOW(), 26, '7:f51b87cc1bb41ba026afa96f81dfb412', 'addForeignKeyConstraint', '', 'EXECUTED', '3.2.0')
/

--  Changeset org/kuali/ole/2.1/db.changelog-20151123.xml::OLE_NG_BAT_PRCS_ID_FK::ole
ALTER TABLE ole.OLE_NG_BAT_JOB_T ADD CONSTRAINT OLE_NG_BAT_PRCS_ID_FK FOREIGN KEY (PROCESS_ID) REFERENCES OLE_NG_BAT_PRCS_T (PROCESS_ID) ON UPDATE RESTRICT ON DELETE CASCADE
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_PRCS_ID_FK', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', NOW(), 27, '7:8ee97a123f18c8f8dfabdfd43c85a53d', 'addForeignKeyConstraint', '', 'EXECUTED', '3.2.0')
/
