...
CREATE TABLE OLE_NG_BAT_PRCS_JOB_T (PROCESS_ID INT(10) NOT NULL, PROCESS_NAME VARCHAR(100) NULL, PROCESS_TYPE VARCHAR(40) NULL, PRF_ID INT(10) NULL, JOB_TYPE VARCHAR(40) NULL, CRON_EXP VARCHAR(100) NULL, CREATED_BY VARCHAR(40) NULL, CREATED_ON TIMESTAMP NULL, OBJ_ID VARCHAR(36) NULL, VER_NBR DECIMAL(8) NULL, CONSTRAINT PK_OLE_NG_BAT_PRCS_JOB_T PRIMARY KEY (PROCESS_ID))
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_PRCS_JOB_T', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', NOW(), 22, '7:bffd6e9a6a043009ec7ddf5e066c056a', 'createTable', '', 'EXECUTED', '3.2.0')
/
...
CREATE TABLE OLE_NG_BAT_JOB_DETAILS_T (JOB_ID INT(10) NOT NULL, JOB_NAME VARCHAR(100) NULL, PROCESS_ID INT(10) NULL, PROCESS_TYPE VARCHAR(40) NULL, PROFILE_NAME VARCHAR(100) NULL, CREATED_BY VARCHAR(40) NULL, START_TIME TIMESTAMP NULL, END_TIME TIMESTAMP NULL, PER_COMPLETED VARCHAR(40) NULL, TIME_SPENT VARCHAR(40) NULL, TOTAL_RECORDS VARCHAR(40) NULL, TOTAL_RECORDS_PRCSD VARCHAR(40) NULL, STATUS VARCHAR(40) NULL, OBJ_ID VARCHAR(36) NULL, VER_NBR DECIMAL(8) NULL, CONSTRAINT PK_OLE_NG_BAT_JOB_DETAILS_T PRIMARY KEY (JOB_ID))
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_JOB_DETAILS_T', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', NOW(), 24, '7:12d1cd663b3bf4888bee0c422d0a4c75', 'createTable', '', 'EXECUTED', '3.2.0')
/
...
ALTER TABLE ole.OLE_NG_BAT_JOB_DETAILS_T ADD CONSTRAINT OLE_NG_BAT_PRCS_ID_FK FOREIGN KEY (PROCESS_ID) REFERENCES OLE_NG_BAT_PRCS_JOB_T (PROCESS_ID) ON UPDATE RESTRICT ON DELETE CASCADE
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_PRCS_ID_FK', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', NOW(), 27, '7:7bf0b020cbf486fa47ea64b46a0489bd', 'addForeignKeyConstraint', '', 'EXECUTED', '3.2.0')
/

--  Changeset org/kuali/ole/2.1/db.changelog-20151123.xml::OLE_DLVR_PTRN_BILL_FEE_TYP_T_ITM_LOC::ole
ALTER TABLE OLE_DLVR_PTRN_BILL_FEE_TYP_T ADD ITM_LOC VARCHAR(600) NULL
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_DLVR_PTRN_BILL_FEE_TYP_T_ITM_LOC', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', NOW(), 18, '7:dc3c8e84e9ff385b127eb1bb83c80e9b', 'addColumn', '', 'EXECUTED', '3.2.0')
/
