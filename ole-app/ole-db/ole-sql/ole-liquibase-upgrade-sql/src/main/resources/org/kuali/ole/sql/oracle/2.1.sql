...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_LOAD_KRCR_PARM_T_oracle', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 1, '7:6895eb48a24a455a9525399cc369f1dd', 'loadData', '', 'EXECUTED', '3.2.0')
/
...
CREATE TABLE OLE_NG_BAT_PRCS_T (PROCESS_ID NUMBER(10) NOT NULL, PROCESS_NAME VARCHAR2(100), PROCESS_TYPE VARCHAR2(40), PRF_ID NUMBER(10), JOB_TYPE VARCHAR2(40), CRON_EXP VARCHAR2(100), CREATED_BY VARCHAR2(40), CREATED_ON TIMESTAMP, OBJ_ID VARCHAR2(36), VER_NBR DECIMAL(8), CONSTRAINT PK_OLE_NG_BAT_PRCS_T PRIMARY KEY (PROCESS_ID))
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_PRCS_T', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 22, '7:9c8075272eabc5f0fb60f7d579b3f111', 'createTable', '', 'EXECUTED', '3.2.0')
/

-- Changeset org/kuali/ole/2.1/db.changelog-20151123.xml::OLE_NG_BAT_PRCS_S::ole
CREATE SEQUENCE OLE_NG_BAT_PRCS_S START WITH 1 INCREMENT BY 1 ORDER
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_PRCS_S', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 23, '7:d87929bd514531a05e6c75d13ec426a9', 'createSequence', '', 'EXECUTED', '3.2.0')
/

-- Changeset org/kuali/ole/2.1/db.changelog-20151123.xml::OLE_NG_BAT_JOB_T::ole
CREATE TABLE OLE_NG_BAT_JOB_T (JOB_ID NUMBER(10) NOT NULL, JOB_NAME VARCHAR2(100), PROCESS_ID NUMBER(10), PROCESS_TYPE VARCHAR2(40), PROFILE_NAME VARCHAR2(100), CREATED_BY VARCHAR2(40), START_TIME TIMESTAMP, END_TIME TIMESTAMP, PER_COMPLETED VARCHAR2(40), TIME_SPENT VARCHAR2(40), TOTAL_RECORDS VARCHAR2(40), TOTAL_RECORDS_PRCSD VARCHAR2(40), STATUS VARCHAR2(40), OBJ_ID VARCHAR2(36), VER_NBR DECIMAL(8), CONSTRAINT PK_OLE_NG_BAT_JOB_T PRIMARY KEY (JOB_ID))
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_JOB_T', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 24, '7:5a63511f8371d5e371e5aa330b488f1c', 'createTable', '', 'EXECUTED', '3.2.0')
/

-- Changeset org/kuali/ole/2.1/db.changelog-20151123.xml::OLE_NG_BAT_JOB_S::ole
CREATE SEQUENCE OLE_NG_BAT_JOB_S START WITH 1 INCREMENT BY 1 ORDER
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_JOB_S', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 25, '7:416786dbffb9cffb311913024b44653d', 'createSequence', '', 'EXECUTED', '3.2.0')
/

-- Changeset org/kuali/ole/2.1/db.changelog-20151123.xml::OLE_NG_BAT_PRF_ID_FK::ole
ALTER TABLE ole.OLE_NG_BAT_PRCS_T ADD CONSTRAINT OLE_NG_BAT_PRF_ID_FK FOREIGN KEY (PRF_ID) REFERENCES OLE_NG_BAT_PRF_T (PRF_ID) ON DELETE CASCADE
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_PRF_ID_FK', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 26, '7:f51b87cc1bb41ba026afa96f81dfb412', 'addForeignKeyConstraint', '', 'EXECUTED', '3.2.0')
/

-- Changeset org/kuali/ole/2.1/db.changelog-20151123.xml::OLE_NG_BAT_PRCS_ID_FK::ole
ALTER TABLE ole.OLE_NG_BAT_JOB_T ADD CONSTRAINT OLE_NG_BAT_PRCS_ID_FK FOREIGN KEY (PROCESS_ID) REFERENCES OLE_NG_BAT_PRCS_T (PROCESS_ID) ON DELETE CASCADE
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_PRCS_ID_FK', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 27, '7:8ee97a123f18c8f8dfabdfd43c85a53d', 'addForeignKeyConstraint', '', 'EXECUTED', '3.2.0')
/
