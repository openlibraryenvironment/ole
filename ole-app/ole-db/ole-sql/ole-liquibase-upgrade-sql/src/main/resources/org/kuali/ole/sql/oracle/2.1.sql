...
CREATE TABLE OLE_NG_BAT_PRCS_JOB_T (PROCESS_ID NUMBER(10) NOT NULL, PROCESS_NAME VARCHAR2(100), PROCESS_TYPE VARCHAR2(40), PRF_ID NUMBER(10), JOB_TYPE VARCHAR2(40), CRON_EXP VARCHAR2(100), CREATED_BY VARCHAR2(40), CREATED_ON TIMESTAMP, OBJ_ID VARCHAR2(36), VER_NBR DECIMAL(8), CONSTRAINT PK_OLE_NG_BAT_PRCS_JOB_T PRIMARY KEY (PROCESS_ID))
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_PRCS_JOB_T', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 22, '7:bffd6e9a6a043009ec7ddf5e066c056a', 'createTable', '', 'EXECUTED', '3.2.0')
/
...
CREATE TABLE OLE_NG_BAT_JOB_DETAILS_T (JOB_ID NUMBER(10) NOT NULL, JOB_NAME VARCHAR2(100), PROCESS_ID NUMBER(10), PROCESS_TYPE VARCHAR2(40), PROFILE_NAME VARCHAR2(100), CREATED_BY VARCHAR2(40), START_TIME TIMESTAMP, END_TIME TIMESTAMP, PER_COMPLETED VARCHAR2(40), TIME_SPENT VARCHAR2(40), TOTAL_RECORDS VARCHAR2(40), TOTAL_RECORDS_PRCSD VARCHAR2(40), STATUS VARCHAR2(40), OBJ_ID VARCHAR2(36), VER_NBR DECIMAL(8), CONSTRAINT PK_OLE_NG_BAT_JOB_DETAILS_T PRIMARY KEY (JOB_ID))
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_JOB_DETAILS_T', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 24, '7:12d1cd663b3bf4888bee0c422d0a4c75', 'createTable', '', 'EXECUTED', '3.2.0')
/
...
ALTER TABLE ole.OLE_NG_BAT_JOB_DETAILS_T ADD CONSTRAINT OLE_NG_BAT_PRCS_ID_FK FOREIGN KEY (PROCESS_ID) REFERENCES OLE_NG_BAT_PRCS_JOB_T (PROCESS_ID) ON DELETE CASCADE
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_PRCS_ID_FK', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 27, '7:7bf0b020cbf486fa47ea64b46a0489bd', 'addForeignKeyConstraint', '', 'EXECUTED', '3.2.0')
/
...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_DLVR_PTRN_BILL_FEE_TYP_T_ITM_LOC', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 18, '7:dc3c8e84e9ff385b127eb1bb83c80e9b', 'addColumn', '', 'EXECUTED', '3.2.0')
/
