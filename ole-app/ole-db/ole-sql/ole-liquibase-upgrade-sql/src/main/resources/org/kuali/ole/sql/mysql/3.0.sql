...
ALTER TABLE ole.OLE_DLVR_PTRN_BILL_T ADD MANUAL_BILL VARCHAR(1) NULL
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_DLVR_PTRN_BILL_T_ADD_COLUMN', 'ole', 'org/kuali/ole/3.0/db.changelog-20160208.xml', NOW(), 13, '7:53668f92a181de3b61bb7f8acfad73a8', 'addColumn', '', 'EXECUTED', '3.2.0')
/

--  Changeset org/kuali/ole/3.0/db.changelog-20160208.xml::OLE_DLVR_PTRN_BILL_FEE_TYP_T_ADD_COLUMN::ole
ALTER TABLE ole.OLE_DLVR_PTRN_BILL_FEE_TYP_T ADD MANUAL_BILL VARCHAR(1) NULL
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_DLVR_PTRN_BILL_FEE_TYP_T_ADD_COLUMN', 'ole', 'org/kuali/ole/3.0/db.changelog-20160208.xml', NOW(), 14, '7:e0fc5f6b97e37f299f0d60b197708706', 'addColumn', '', 'EXECUTED', '3.2.0')
/
