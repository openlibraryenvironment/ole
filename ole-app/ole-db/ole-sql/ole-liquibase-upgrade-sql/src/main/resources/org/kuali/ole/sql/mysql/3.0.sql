...
ALTER TABLE OLE_LOCN_T ADD ROW_ACT_IND VARCHAR(1) NULL
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_LOCN_T_ROW_IND', 'ole', 'org/kuali/ole/3.0/db.changelog-20160208.xml', NOW(), 24, '7:f5ebfd11cb931893bc320e1a806020fc', 'addColumn', '', 'EXECUTED', '3.2.0')
/
