...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('PUR_VNDR_DTL_T_NONBILL', 'ole', 'org/kuali/ole/3.0/db.changelog-20160208.xml', NOW(), 3, '7:918c1dcdcc36f7154db4957ef8ab4cb7', 'update', '', 'EXECUTED', '3.2.0')
/
