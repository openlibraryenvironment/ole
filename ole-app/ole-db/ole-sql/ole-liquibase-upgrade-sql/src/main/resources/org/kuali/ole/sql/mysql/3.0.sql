...
INSERT INTO OLE_BAT_PRCS_TYP_T (OLE_BAT_PRCS_TYP_ID,OLE_BAT_PRCS_TYP_CODE,OLE_BAT_PRCS_TYP_NM,ACTIVE_IND,OBJ_ID,VER_NBR) VALUES(last_insert_id(),'edi_exp','EDI Export','Y','obj11','1')
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_BAT_PRCS_TYP_T_MYSQL', 'ole', 'org/kuali/ole/3.0/db.changelog-20160208.xml', NOW(), 27, '7:ea449aabc60d2e80179c4e429b16a261', 'sql (x2)', '', 'EXECUTED', '3.2.0')
/
