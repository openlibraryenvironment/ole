...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_LOAD_KRCR_PARM_T_oracle', 'ole', 'org/kuali/ole/3.0/db.changelog-20160208.xml', SYSTIMESTAMP, 11, '7:1eed93a8dafa38c03d1e8f3fd5331cbf', 'loadData', '', 'EXECUTED', '3.2.0')
/
...
ALTER TABLE OLE_LOCN_T ADD ROW_ACT_IND VARCHAR2(1)
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_LOCN_T_ROW_IND', 'ole', 'org/kuali/ole/3.0/db.changelog-20160208.xml', SYSTIMESTAMP, 24, '7:f5ebfd11cb931893bc320e1a806020fc', 'addColumn', '', 'EXECUTED', '3.2.0')
/
