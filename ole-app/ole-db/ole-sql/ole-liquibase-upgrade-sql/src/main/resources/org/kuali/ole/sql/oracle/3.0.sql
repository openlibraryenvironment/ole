...
INSERT INTO OLE_BAT_PRCS_TYP_T (OLE_BAT_PRCS_TYP_ID,OLE_BAT_PRCS_TYP_CODE,OLE_BAT_PRCS_TYP_NM,ACTIVE_IND,OBJ_ID,VER_NBR) VALUES(OLE_BAT_PRCS_TYP_S.NEXTVAL,'edi_exp','EDI Export','Y','obj11','1')
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_BAT_PRCS_TYP_T_ORACLE', 'ole', 'org/kuali/ole/3.0/db.changelog-20160208.xml', SYSTIMESTAMP, 27, '7:d3f393c124881d7b2b85757c56655a98', 'sql', '', 'EXECUTED', '3.2.0')
/
